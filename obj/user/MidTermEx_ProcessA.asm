...
void _main(void)
{
  ...
  8000aa:	50                   	push   %eax
  8000ab:	e8 7b 25 00 00       	call   80262b <get_semaphore>
  ...
  8000c1:	50                   	push   %eax
  8000c2:	e8 64 25 00 00       	call   80262b <get_semaphore>
  ...
  8000d8:	50                   	push   %eax
  8000d9:	e8 4d 25 00 00       	call   80262b <get_semaphore>
  ...
  800147:	50                   	push   %eax
  800148:	e8 37 25 00 00       	call   802684 <env_sleep>
  ...
  800188:	50                   	push   %eax
  800189:	e8 f6 24 00 00       	call   802684 <env_sleep>
  ...
  8001c7:	50                   	push   %eax
  8001c8:	e8 b7 24 00 00       	call   802684 <env_sleep>
  ...
  8001e0:	e8 7a 24 00 00       	call   80265f <signal_semaphore>
  ...
  8001fa:	e8 ea 25 00 00       	call   8027e9 <release_uspinlock>
  ...
  800212:	e8 48 24 00 00       	call   80265f <signal_semaphore>
  800217:	83 c4 10             	add    $0x10,%esp

		wait_semaphore(finishedCountMutex);
  80021a:	83 ec 0c             	sub    $0xc,%esp
  80021d:	ff 75 b4             	pushl  -0x4c(%ebp)
  800220:	e8 20 24 00 00       	call   802645 <wait_semaphore>
  ...
  80023b:	e8 1f 24 00 00       	call   80265f <signal_semaphore>
  ...
  800255:	e8 37 25 00 00       	call   802791 <acquire_uspinlock>
  ...
  800270:	e8 74 25 00 00       	call   8027e9 <release_uspinlock>
...
libmain(int argc, char **argv)
{
  ...
  8002c5:	a3 20 40 80 00       	mov    %eax,0x804020

	//SET THE PROGRAM NAME
	if (myEnv->prog_name[0] != '\0')
  8002ca:	a1 20 40 80 00       	mov    0x804020,%eax
  8002cf:	8a 40 20             	mov    0x20(%eax),%al
  8002d2:	84 c0                	test   %al,%al
  8002d4:	74 0d                	je     8002e3 <libmain+0x4f>
		binaryname = myEnv->prog_name;
  8002d6:	a1 20 40 80 00       	mov    0x804020,%eax
  ...
  8002ee:	a3 04 40 80 00       	mov    %eax,0x804004
  ...
  800301:	83 c4 10             	add    $0x10,%esp
	...
	if (printStats)
  800304:	a1 00 40 80 00       	mov    0x804000,%eax
  ...
  800317:	bb d0 2d 80 00       	mov    $0x802dd0,%ebx
  ...
  80035c:	68 f0 2c 80 00       	push   $0x802cf0
  ...
  800378:	50                   	push   %eax
  800379:	68 18 2d 80 00       	push   $0x802d18
  ...
  8003a1:	52                   	push   %edx
  8003a2:	50                   	push   %eax
  8003a3:	68 3c 2d 80 00       	push   $0x802d3c
...
static void putch(int ch, struct printbuf *b) {
  ...
  800470:	8b 15 18 c1 81 00    	mov    0x81c118,%edx
  800476:	a0 44 40 80 00       	mov    0x804044,%al
...
int vcprintf(const char *fmt, va_list ap) {
  ...
  8004e9:	83 c4 10             	add    $0x10,%esp
	sys_cputs(b.buf, b.idx, printProgName, curTextClr);
  8004ec:	8b 15 18 c1 81 00    	mov    0x81c118,%edx
  8004f2:	a0 44 40 80 00       	mov    0x804044,%al
  ...
  800512:	83 c4 10             	add    $0x10,%esp
	...
	printProgName = 0;
  800515:	c6 05 44 40 80 00 00 	movb   $0x0,0x804044
	return b.cnt;
...
int cprintf(const char *fmt, ...) {
  ...
  800527:	83 ec 18             	sub    $0x18,%esp
	...
	int cnt;
	printProgName = 1 ;
  80052a:	c6 05 44 40 80 00 01 	movb   $0x1,0x804044
	va_start(ap, fmt);
...
int cprintf_colored(int textClr, const char *fmt, ...) {
  ...
  800554:	83 ec 18             	sub    $0x18,%esp
	...
	int cnt;
	printProgName = 1 ;
  800557:	c6 05 44 40 80 00 01 	movb   $0x1,0x804044
	curTextClr = (textClr << 8) ; //set text color by the given value
  80055e:	8b 45 08             	mov    0x8(%ebp),%eax
  800561:	c1 e0 08             	shl    $0x8,%eax
  800564:	a3 18 c1 81 00       	mov    %eax,0x81c118
	va_start(ap, fmt);
  ...
  800587:	c7 05 18 c1 81 00 00 	movl   $0x700,0x81c118
  80058e:	07 00 00 
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800606:	e8 2d 24 00 00       	call   802a38 <__udivdi3>
  ...
  800654:	52                   	push   %edx
  800655:	50                   	push   %eax
  800656:	e8 ed 24 00 00       	call   802b48 <__umoddi3>
  80065b:	83 c4 10             	add    $0x10,%esp
  80065e:	05 54 30 80 00       	add    $0x803054,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8007b1:	8b 04 85 78 30 80 00 	mov    0x803078(,%eax,4),%eax
  ...
  800892:	8b 34 9d c0 2e 80 00 	mov    0x802ec0(,%ebx,4),%esi
  800899:	85 f6                	test   %esi,%esi
  80089b:	75 19                	jne    8008b6 <vprintfmt+0x173>
				printfmt(putch, putdat, "error %d", err);
  80089d:	53                   	push   %ebx
  80089e:	68 65 30 80 00       	push   $0x803065
  ...
  8008b1:	e9 5b 02 00 00       	jmp    800b11 <vprintfmt+0x3ce>
			...
			if (err > MAXERROR || (p = error_string[err]) == NULL)
				...
				printfmt(putch, putdat, "%s", p);
  8008b6:	56                   	push   %esi
  8008b7:	68 6e 30 80 00       	push   $0x80306e
  ...
  8008e2:	75 05                	jne    8008e9 <vprintfmt+0x1a6>
				p = "(null)";
  8008e4:	be 71 30 80 00       	mov    $0x803071,%esi
			if (width > 0 && padc != '-')
  ...
  800ada:	eb 35                	jmp    800b11 <vprintfmt+0x3ce>
		...
		case '~':
			printProgName = 0;
  800adc:	c6 05 44 40 80 00 00 	movb   $0x0,0x804044
			break;
  800ae3:	eb 2c                	jmp    800b11 <vprintfmt+0x3ce>
		// Print Program Name & UD
		case '@':
			printProgName = 1;
  800ae5:	c6 05 44 40 80 00 01 	movb   $0x1,0x804044
			break;
...
void uheap_init()
{
  ...
  801432:	a3 60 c0 81 00       	mov    %eax,0x81c060
		uheapPageAllocStart = dynAllocEnd + PAGE_SIZE;
  801437:	a1 40 40 80 00       	mov    0x804040,%eax
  80143c:	05 00 10 00 00       	add    $0x1000,%eax
  801441:	a3 10 c1 81 00       	mov    %eax,0x81c110
		uheapPageAllocBreak = uheapPageAllocStart;
  801446:	a1 10 c1 81 00       	mov    0x81c110,%eax
  80144b:	a3 68 c0 81 00       	mov    %eax,0x81c068

		__firstTimeFlag = 0;
  801450:	c7 05 08 40 80 00 00 	movl   $0x0,0x804008
  801457:	00 00 00 
	}
}
  80145a:	90                   	nop
...
int get_page(void* va)
{
  ...
  80148e:	68 e8 31 80 00       	push   $0x8031e8
  801493:	6a 1f                	push   $0x1f
  801495:	68 24 32 80 00       	push   $0x803224
  80149a:	e8 ab 13 00 00       	call   80284a <_panic>
	return 0;
...
void return_page(void* va)
{
  ...
  8014d2:	68 30 32 80 00       	push   $0x803230
  8014d7:	6a 2a                	push   $0x2a
  8014d9:	68 24 32 80 00       	push   $0x803224
  8014de:	e8 67 13 00 00       	call   80284a <_panic>
}
  8014e3:	90                   	nop
  8014e4:	c9                   	leave  
  8014e5:	c3                   	ret    
...
void* malloc(uint32 size)
{
  ...
  801501:	68 70 32 80 00       	push   $0x803270
  801506:	6a 3e                	push   $0x3e
  801508:	68 24 32 80 00       	push   $0x803224
  80150d:	e8 38 13 00 00       	call   80284a <_panic>
}
  801512:	c9                   	leave  
  801513:	c3                   	ret    
...
void free(void* virtual_address)
{
  ...
  80151d:	68 98 32 80 00       	push   $0x803298
  801522:	6a 49                	push   $0x49
  801524:	68 24 32 80 00       	push   $0x803224
  801529:	e8 1c 13 00 00       	call   80284a <_panic>
...
void* smalloc(char *sharedVarName, uint32 size, uint8 isWritable)
{
  ...
  80154f:	68 bc 32 80 00       	push   $0x8032bc
  801554:	6a 5a                	push   $0x5a
  801556:	68 24 32 80 00       	push   $0x803224
  80155b:	e8 ea 12 00 00       	call   80284a <_panic>
}
  801560:	c9                   	leave  
  801561:	c3                   	ret    
...
void* sget(int32 ownerEnvID, char *sharedVarName)
{
  ...
  801570:	68 e4 32 80 00       	push   $0x8032e4
  801575:	6a 6a                	push   $0x6a
  801577:	68 24 32 80 00       	push   $0x803224
  80157c:	e8 c9 12 00 00       	call   80284a <_panic>
...
void *realloc(void *virtual_address, uint32 new_size)
{
  ...
  80158f:	68 08 33 80 00       	push   $0x803308
  801594:	68 88 00 00 00       	push   $0x88
  801599:	68 24 32 80 00       	push   $0x803224
  80159e:	e8 a7 12 00 00       	call   80284a <_panic>
...
void sfree(void* virtual_address)
{
  ...
  8015ac:	68 30 33 80 00       	push   $0x803330
  8015b1:	68 9b 00 00 00       	push   $0x9b
  8015b6:	68 24 32 80 00       	push   $0x803224
  8015bb:	e8 8a 12 00 00       	call   80284a <_panic>
...
uint32 sys_get_uheap_strategy()
{
  ...
  801a30:	a3 60 c0 81 00       	mov    %eax,0x81c060
	return uheapPlaceStrategy ;
  801a35:	a1 60 c0 81 00       	mov    0x81c060,%eax
}
  801a3a:	c9                   	leave  
  801a3b:	c3                   	ret    
...
void sys_set_uheap_strategy(uint32 heapStrategy)
{
  ...
  801a42:	a3 60 c0 81 00       	mov    %eax,0x81c060
...
void sys_env_set_priority(int32 envID, int priority)
{
  ...
  801b56:	68 54 33 80 00       	push   $0x803354
  801b5b:	68 25 01 00 00       	push   $0x125
  801b60:	68 87 33 80 00       	push   $0x803387
  801b65:	e8 e0 0c 00 00       	call   80284a <_panic>
...
__inline__ uint32 to_page_va(struct PageInfoElement *ptrPageInfo)
{
  ...
  801b70:	81 7d 08 60 40 80 00 	cmpl   $0x804060,0x8(%ebp)
  801b77:	72 09                	jb     801b82 <to_page_va+0x18>
  801b79:	81 7d 08 60 c0 81 00 	cmpl   $0x81c060,0x8(%ebp)
  801b80:	72 14                	jb     801b96 <to_page_va+0x2c>
			panic("to_page_va called with invalid pageInfoPtr");
  801b82:	83 ec 04             	sub    $0x4,%esp
  801b85:	68 98 33 80 00       	push   $0x803398
  801b8a:	6a 15                	push   $0x15
  801b8c:	68 c3 33 80 00       	push   $0x8033c3
  801b91:	e8 b4 0c 00 00       	call   80284a <_panic>
	//Get start VA of the page from the corresponding Page Info pointer
	int idxInPageInfoArr = (ptrPageInfo - pageBlockInfoArr);
  801b96:	8b 45 08             	mov    0x8(%ebp),%eax
  801b99:	ba 60 40 80 00       	mov    $0x804060,%edx
  ...
  801bd3:	a1 64 c0 81 00       	mov    0x81c064,%eax
...
__inline__ struct PageInfoElement * to_page_info(uint32 va)
{
  ...
  801be2:	a1 64 c0 81 00       	mov    0x81c064,%eax
  ...
  801c06:	68 dc 33 80 00       	push   $0x8033dc
  801c0b:	6a 22                	push   $0x22
  801c0d:	68 c3 33 80 00       	push   $0x8033c3
  801c12:	e8 33 0c 00 00       	call   80284a <_panic>
  ...
  801c23:	05 60 40 80 00       	add    $0x804060,%eax
}
  801c28:	c9                   	leave  
  801c29:	c3                   	ret    
...
void initialize_dynamic_allocator(uint32 daStart, uint32 daEnd)
{
  ...
  801c3d:	68 00 34 80 00       	push   $0x803400
  801c42:	68 26 34 80 00       	push   $0x803426
  801c47:	6a 34                	push   $0x34
  801c49:	68 c3 33 80 00       	push   $0x8033c3
  801c4e:	e8 f7 0b 00 00       	call   80284a <_panic>
		is_initialized = 1;
  801c53:	c7 05 24 40 80 00 01 	movl   $0x1,0x804024
  801c5a:	00 00 00 
	//==================================================================================
	//==================================================================================
  ...
  801c60:	a3 64 c0 81 00       	mov    %eax,0x81c064
	dynAllocEnd = daEnd;
  801c65:	8b 45 0c             	mov    0xc(%ebp),%eax
  801c68:	a3 40 40 80 00       	mov    %eax,0x804040
	// init the list that keep track of all free pageBlockInfoArr instances.
	LIST_INIT(&freePagesList);
  801c6d:	c7 05 48 40 80 00 00 	movl   $0x0,0x804048
  801c74:	00 00 00 
  801c77:	c7 05 4c 40 80 00 00 	movl   $0x0,0x80404c
  801c7e:	00 00 00 
  801c81:	c7 05 54 40 80 00 00 	movl   $0x0,0x804054
  801c88:	00 00 00 

	// no.of pages in the dynamic allocator.
	int pCount = (daEnd - daStart) / PAGE_SIZE;
  801c8b:	8b 45 0c             	mov    0xc(%ebp),%eax
  801c8e:	2b 45 08             	sub    0x8(%ebp),%eax
  801c91:	c1 e8 0c             	shr    $0xc,%eax
  801c94:	89 45 ec             	mov    %eax,-0x14(%ebp)
	// iterate over each page and init its data in pageBlockInfoArr and reset it.
	for (int i = 0; i < pCount; ++i) {
  801c97:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  801c9e:	e9 c8 00 00 00       	jmp    801d6b <initialize_dynamic_allocator+0x141>
  ...
  801caf:	05 68 40 80 00       	add    $0x804068,%eax
  801cb4:	66 c7 00 00 00       	movw   $0x0,(%eax)
  ...
  801cc5:	05 6a 40 80 00       	add    $0x80406a,%eax
  801cca:	66 c7 00 00 00       	movw   $0x0,(%eax)
	    LIST_INSERT_TAIL(&freePagesList, &pageBlockInfoArr[i]);
  801ccf:	8b 15 4c 40 80 00    	mov    0x80404c,%edx
  801cd5:	8b 4d f4             	mov    -0xc(%ebp),%ecx
  801cd8:	89 c8                	mov    %ecx,%eax
  801cda:	01 c0                	add    %eax,%eax
  801cdc:	01 c8                	add    %ecx,%eax
  801cde:	c1 e0 02             	shl    $0x2,%eax
  801ce1:	05 64 40 80 00       	add    $0x804064,%eax
  801ce6:	89 10                	mov    %edx,(%eax)
  801ce8:	8b 55 f4             	mov    -0xc(%ebp),%edx
  801ceb:	89 d0                	mov    %edx,%eax
  801ced:	01 c0                	add    %eax,%eax
  801cef:	01 d0                	add    %edx,%eax
  801cf1:	c1 e0 02             	shl    $0x2,%eax
  801cf4:	05 64 40 80 00       	add    $0x804064,%eax
  801cf9:	8b 00                	mov    (%eax),%eax
  801cfb:	85 c0                	test   %eax,%eax
  801cfd:	74 1b                	je     801d1a <initialize_dynamic_allocator+0xf0>
  801cff:	8b 15 4c 40 80 00    	mov    0x80404c,%edx
  801d05:	8b 4d f4             	mov    -0xc(%ebp),%ecx
  801d08:	89 c8                	mov    %ecx,%eax
  801d0a:	01 c0                	add    %eax,%eax
  801d0c:	01 c8                	add    %ecx,%eax
  801d0e:	c1 e0 02             	shl    $0x2,%eax
  801d11:	05 60 40 80 00       	add    $0x804060,%eax
  801d16:	89 02                	mov    %eax,(%edx)
  801d18:	eb 16                	jmp    801d30 <initialize_dynamic_allocator+0x106>
  ...
  801d2b:	a3 48 40 80 00       	mov    %eax,0x804048
  801d30:	8b 55 f4             	mov    -0xc(%ebp),%edx
  801d33:	89 d0                	mov    %edx,%eax
  801d35:	01 c0                	add    %eax,%eax
  801d37:	01 d0                	add    %edx,%eax
  801d39:	c1 e0 02             	shl    $0x2,%eax
  801d3c:	05 60 40 80 00       	add    $0x804060,%eax
  801d41:	a3 4c 40 80 00       	mov    %eax,0x80404c
  ...
  801d52:	05 60 40 80 00       	add    $0x804060,%eax
  801d57:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  801d5d:	a1 54 40 80 00       	mov    0x804054,%eax
  801d62:	40                   	inc    %eax
  801d63:	a3 54 40 80 00       	mov    %eax,0x804054
	LIST_INIT(&freePagesList);
	...
	// iterate over each page and init its data in pageBlockInfoArr and reset it.
	for (int i = 0; i < pCount; ++i) {
  801d68:	ff 45 f4             	incl   -0xc(%ebp)
  801d6b:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801d6e:	3b 45 ec             	cmp    -0x14(%ebp),%eax
  801d71:	0f 8c 2c ff ff ff    	jl     801ca3 <initialize_dynamic_allocator+0x79>
	    LIST_INSERT_TAIL(&freePagesList, &pageBlockInfoArr[i]);
	}
  ...
  801db6:	83 7d f0 08          	cmpl   $0x8,-0x10(%ebp)
  801dba:	7e c4                	jle    801d80 <initialize_dynamic_allocator+0x156>
		LIST_INIT(&freeBlockLists[i]);
	}
	//Comment the following line
...
__inline__ uint32 get_block_size(void *va)
{
  ...
  801dcb:	50                   	push   %eax
  801dcc:	e8 0b fe ff ff       	call   801bdc <to_page_info>
...
//and putem in suitable freeblockList index according to size.
 void split_page_to_blocks(uint32 blk_size, struct PageInfoElement *pageInfo) {
  ...
  801dee:	e8 77 fd ff ff       	call   801b6a <to_page_va>
  801df3:	83 c4 10             	add    $0x10,%esp
  801df6:	89 45 e8             	mov    %eax,-0x18(%ebp)
	 // no. of blks to save in freeblockList.
	 int blk_count = PAGE_SIZE / blk_size;
  801df9:	b8 00 10 00 00       	mov    $0x1000,%eax
  801dfe:	ba 00 00 00 00       	mov    $0x0,%edx
  801e03:	f7 75 08             	divl   0x8(%ebp)
  ...
  801e0f:	50                   	push   %eax
  801e10:	e8 48 f6 ff ff       	call   80145d <get_page>
  801e15:	83 c4 10             	add    $0x10,%esp
	 // assigning the pageInfo data block size, free block which is whole block count.
	 pageInfo->num_of_free_blocks = blk_count;
  801e18:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  801e1b:	8b 55 0c             	mov    0xc(%ebp),%edx
  801e1e:	66 89 42 0a          	mov    %ax,0xa(%edx)
	 pageInfo->block_size = blk_size;
  801e22:	8b 45 08             	mov    0x8(%ebp),%eax
  801e25:	8b 55 0c             	mov    0xc(%ebp),%edx
  801e28:	66 89 42 08          	mov    %ax,0x8(%edx)
	 // get index by size block in freeblocklist.
	 int idx = 0;
  801e2c:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
	 for (int i = LOG2_MIN_SIZE; i <= LOG2_MAX_SIZE; i++) {
  801e33:	c7 45 f0 03 00 00 00 	movl   $0x3,-0x10(%ebp)
  801e3a:	eb 19                	jmp    801e55 <split_page_to_blocks+0x73>
	     if ((1 << i) == blk_size)
  801e3c:	8b 45 f0             	mov    -0x10(%ebp),%eax
  801e3f:	ba 01 00 00 00       	mov    $0x1,%edx
  801e44:	88 c1                	mov    %al,%cl
  801e46:	d3 e2                	shl    %cl,%edx
  801e48:	89 d0                	mov    %edx,%eax
  801e4a:	3b 45 08             	cmp    0x8(%ebp),%eax
  801e4d:	74 0e                	je     801e5d <split_page_to_blocks+0x7b>
	         break;
	     idx++;
  801e4f:	ff 45 f4             	incl   -0xc(%ebp)
	 ...
	 int idx = 0;
	 for (int i = LOG2_MIN_SIZE; i <= LOG2_MAX_SIZE; i++) {
  801e52:	ff 45 f0             	incl   -0x10(%ebp)
  801e55:	83 7d f0 0b          	cmpl   $0xb,-0x10(%ebp)
  801e59:	7e e1                	jle    801e3c <split_page_to_blocks+0x5a>
  801e5b:	eb 01                	jmp    801e5e <split_page_to_blocks+0x7c>
	     if ((1 << i) == blk_size)
	         break;
  801e5d:	90                   	nop
	     idx++;
  ...
  801e65:	e9 a7 00 00 00       	jmp    801f11 <split_page_to_blocks+0x12f>
	     struct BlockElement *blk =(struct BlockElement*)(page_va + i * blk_size);
  801e6a:	8b 45 ec             	mov    -0x14(%ebp),%eax
  801e6d:	0f af 45 08          	imul   0x8(%ebp),%eax
  801e71:	89 c2                	mov    %eax,%edx
  801e73:	8b 45 e8             	mov    -0x18(%ebp),%eax
  801e76:	01 d0                	add    %edx,%eax
  801e78:	89 45 e0             	mov    %eax,-0x20(%ebp)
	     LIST_INSERT_TAIL(&freeBlockLists[idx],blk);
  801e7b:	83 7d e0 00          	cmpl   $0x0,-0x20(%ebp)
  801e7f:	75 14                	jne    801e95 <split_page_to_blocks+0xb3>
  801e81:	83 ec 04             	sub    $0x4,%esp
  801e84:	68 3c 34 80 00       	push   $0x80343c
  801e89:	6a 7c                	push   $0x7c
  801e8b:	68 c3 33 80 00       	push   $0x8033c3
  801e90:	e8 b5 09 00 00       	call   80284a <_panic>
  801e95:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801e98:	c1 e0 04             	shl    $0x4,%eax
  801e9b:	05 84 c0 81 00       	add    $0x81c084,%eax
  801ea0:	8b 10                	mov    (%eax),%edx
  801ea2:	8b 45 e0             	mov    -0x20(%ebp),%eax
  801ea5:	89 50 04             	mov    %edx,0x4(%eax)
  801ea8:	8b 45 e0             	mov    -0x20(%ebp),%eax
  801eab:	8b 40 04             	mov    0x4(%eax),%eax
  801eae:	85 c0                	test   %eax,%eax
  801eb0:	74 14                	je     801ec6 <split_page_to_blocks+0xe4>
  801eb2:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801eb5:	c1 e0 04             	shl    $0x4,%eax
  801eb8:	05 84 c0 81 00       	add    $0x81c084,%eax
  801ebd:	8b 00                	mov    (%eax),%eax
  801ebf:	8b 55 e0             	mov    -0x20(%ebp),%edx
  801ec2:	89 10                	mov    %edx,(%eax)
  801ec4:	eb 11                	jmp    801ed7 <split_page_to_blocks+0xf5>
  801ec6:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801ec9:	c1 e0 04             	shl    $0x4,%eax
  801ecc:	8d 90 80 c0 81 00    	lea    0x81c080(%eax),%edx
  801ed2:	8b 45 e0             	mov    -0x20(%ebp),%eax
  801ed5:	89 02                	mov    %eax,(%edx)
  801ed7:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801eda:	c1 e0 04             	shl    $0x4,%eax
  801edd:	8d 90 84 c0 81 00    	lea    0x81c084(%eax),%edx
  ...
  801efe:	8d 50 01             	lea    0x1(%eax),%edx
  801f01:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801f04:	c1 e0 04             	shl    $0x4,%eax
  801f07:	05 8c c0 81 00       	add    $0x81c08c,%eax
  801f0c:	89 10                	mov    %edx,(%eax)
	 ...
	 // starting from the page_va.
	 for (uint32 i = 0; i < blk_count; ++i) {
  801f0e:	ff 45 ec             	incl   -0x14(%ebp)
  801f11:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  801f14:	39 45 ec             	cmp    %eax,-0x14(%ebp)
  801f17:	0f 82 4d ff ff ff    	jb     801e6a <split_page_to_blocks+0x88>
	     struct BlockElement *blk =(struct BlockElement*)(page_va + i * blk_size);
	     LIST_INSERT_TAIL(&freeBlockLists[idx],blk);
	 }
 }
...
void *alloc_block(uint32 size)
{
  ...
  801f23:	83 ec 38             	sub    $0x38,%esp
	//==================================================================================
	//DON'T CHANGE THESE LINES==========================================================
	//==================================================================================
	{
		assert(size <= DYN_ALLOC_MAX_BLOCK_SIZE);
  801f26:	81 7d 08 00 08 00 00 	cmpl   $0x800,0x8(%ebp)
  801f2d:	76 19                	jbe    801f48 <alloc_block+0x28>
  801f2f:	68 60 34 80 00       	push   $0x803460
  801f34:	68 26 34 80 00       	push   $0x803426
  801f39:	68 8a 00 00 00       	push   $0x8a
  801f3e:	68 c3 33 80 00       	push   $0x8033c3
  801f43:	e8 02 09 00 00       	call   80284a <_panic>
	//==================================================================================
  ...
  801f48:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
	for (int i = LOG2_MIN_SIZE; i <= LOG2_MAX_SIZE; ++i){
  801f4f:	c7 45 f0 03 00 00 00 	movl   $0x3,-0x10(%ebp)
  801f56:	eb 19                	jmp    801f71 <alloc_block+0x51>
		if((1 << i) >= size) break;
  801f58:	8b 45 f0             	mov    -0x10(%ebp),%eax
  801f5b:	ba 01 00 00 00       	mov    $0x1,%edx
  801f60:	88 c1                	mov    %al,%cl
  801f62:	d3 e2                	shl    %cl,%edx
  801f64:	89 d0                	mov    %edx,%eax
  801f66:	3b 45 08             	cmp    0x8(%ebp),%eax
  801f69:	73 0e                	jae    801f79 <alloc_block+0x59>
		idx++;
  801f6b:	ff 45 f4             	incl   -0xc(%ebp)
	...
	uint32 idx = 0;
	for (int i = LOG2_MIN_SIZE; i <= LOG2_MAX_SIZE; ++i){
  801f6e:	ff 45 f0             	incl   -0x10(%ebp)
  801f71:	83 7d f0 0b          	cmpl   $0xb,-0x10(%ebp)
  801f75:	7e e1                	jle    801f58 <alloc_block+0x38>
  801f77:	eb 01                	jmp    801f7a <alloc_block+0x5a>
		if((1 << i) >= size) break;
  801f79:	90                   	nop
		idx++;
	}
  ...
  801f80:	05 8c c0 81 00       	add    $0x81c08c,%eax
  801f85:	8b 00                	mov    (%eax),%eax
  801f87:	85 c0                	test   %eax,%eax
  801f89:	0f 84 df 00 00 00    	je     80206e <alloc_block+0x14e>
  ...
  801f95:	05 80 c0 81 00       	add    $0x81c080,%eax
  801f9a:	8b 00                	mov    (%eax),%eax
  801f9c:	89 45 ec             	mov    %eax,-0x14(%ebp)
	    LIST_REMOVE(&freeBlockLists[idx], blk);
  801f9f:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
  801fa3:	75 17                	jne    801fbc <alloc_block+0x9c>
  801fa5:	83 ec 04             	sub    $0x4,%esp
  801fa8:	68 81 34 80 00       	push   $0x803481
  801fad:	68 9e 00 00 00       	push   $0x9e
  801fb2:	68 c3 33 80 00       	push   $0x8033c3
  801fb7:	e8 8e 08 00 00       	call   80284a <_panic>
  801fbc:	8b 45 ec             	mov    -0x14(%ebp),%eax
  801fbf:	8b 00                	mov    (%eax),%eax
  801fc1:	85 c0                	test   %eax,%eax
  801fc3:	74 10                	je     801fd5 <alloc_block+0xb5>
  801fc5:	8b 45 ec             	mov    -0x14(%ebp),%eax
  801fc8:	8b 00                	mov    (%eax),%eax
  801fca:	8b 55 ec             	mov    -0x14(%ebp),%edx
  801fcd:	8b 52 04             	mov    0x4(%edx),%edx
  801fd0:	89 50 04             	mov    %edx,0x4(%eax)
  801fd3:	eb 14                	jmp    801fe9 <alloc_block+0xc9>
  ...
  801fe1:	81 c2 84 c0 81 00    	add    $0x81c084,%edx
  801fe7:	89 02                	mov    %eax,(%edx)
  801fe9:	8b 45 ec             	mov    -0x14(%ebp),%eax
  801fec:	8b 40 04             	mov    0x4(%eax),%eax
  801fef:	85 c0                	test   %eax,%eax
  801ff1:	74 0f                	je     802002 <alloc_block+0xe2>
  801ff3:	8b 45 ec             	mov    -0x14(%ebp),%eax
  801ff6:	8b 40 04             	mov    0x4(%eax),%eax
  801ff9:	8b 55 ec             	mov    -0x14(%ebp),%edx
  801ffc:	8b 12                	mov    (%edx),%edx
  801ffe:	89 10                	mov    %edx,(%eax)
  802000:	eb 13                	jmp    802015 <alloc_block+0xf5>
  802002:	8b 45 ec             	mov    -0x14(%ebp),%eax
  802005:	8b 00                	mov    (%eax),%eax
  802007:	8b 55 f4             	mov    -0xc(%ebp),%edx
  80200a:	c1 e2 04             	shl    $0x4,%edx
  80200d:	81 c2 80 c0 81 00    	add    $0x81c080,%edx
  ...
  80202e:	05 8c c0 81 00       	add    $0x81c08c,%eax
  802033:	8b 00                	mov    (%eax),%eax
  802035:	8d 50 ff             	lea    -0x1(%eax),%edx
  802038:	8b 45 f4             	mov    -0xc(%ebp),%eax
  80203b:	c1 e0 04             	shl    $0x4,%eax
  80203e:	05 8c c0 81 00       	add    $0x81c08c,%eax
  ...
  80204b:	50                   	push   %eax
  80204c:	e8 8b fb ff ff       	call   801bdc <to_page_info>
  802051:	83 c4 10             	add    $0x10,%esp
  802054:	89 45 e8             	mov    %eax,-0x18(%ebp)
	    pageInfo->num_of_free_blocks--;
  802057:	8b 45 e8             	mov    -0x18(%ebp),%eax
  80205a:	66 8b 40 0a          	mov    0xa(%eax),%ax
  80205e:	48                   	dec    %eax
  80205f:	8b 55 e8             	mov    -0x18(%ebp),%edx
  802062:	66 89 42 0a          	mov    %ax,0xa(%edx)
	    return blk;
  802066:	8b 45 ec             	mov    -0x14(%ebp),%eax
  802069:	e9 bc 02 00 00       	jmp    80232a <alloc_block+0x40a>
	}else{ //case(2, 3): 2. no free blocks available in the freeblocklist but there is free pages.
				//3. no free blocks and no available freepages so search in higher block sizes.
		// case 2:
		if(freePagesList.size > 0){ //have free pages.
  80206e:	a1 54 40 80 00       	mov    0x804054,%eax
  802073:	85 c0                	test   %eax,%eax
  802075:	0f 84 7d 02 00 00    	je     8022f8 <alloc_block+0x3d8>
			// get page to split and use from freepagesList.
			struct PageInfoElement *ptr_new_page = LIST_FIRST(&freePagesList);
  80207b:	a1 48 40 80 00       	mov    0x804048,%eax
  802080:	89 45 e4             	mov    %eax,-0x1c(%ebp)
			LIST_REMOVE(&freePagesList, ptr_new_page);
  802083:	83 7d e4 00          	cmpl   $0x0,-0x1c(%ebp)
  802087:	75 17                	jne    8020a0 <alloc_block+0x180>
  802089:	83 ec 04             	sub    $0x4,%esp
  80208c:	68 81 34 80 00       	push   $0x803481
  802091:	68 a9 00 00 00       	push   $0xa9
  802096:	68 c3 33 80 00       	push   $0x8033c3
  80209b:	e8 aa 07 00 00       	call   80284a <_panic>
  8020a0:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  8020a3:	8b 00                	mov    (%eax),%eax
  8020a5:	85 c0                	test   %eax,%eax
  8020a7:	74 10                	je     8020b9 <alloc_block+0x199>
  8020a9:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  8020ac:	8b 00                	mov    (%eax),%eax
  8020ae:	8b 55 e4             	mov    -0x1c(%ebp),%edx
  8020b1:	8b 52 04             	mov    0x4(%edx),%edx
  8020b4:	89 50 04             	mov    %edx,0x4(%eax)
  8020b7:	eb 0b                	jmp    8020c4 <alloc_block+0x1a4>
  8020b9:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  8020bc:	8b 40 04             	mov    0x4(%eax),%eax
  8020bf:	a3 4c 40 80 00       	mov    %eax,0x80404c
  8020c4:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  8020c7:	8b 40 04             	mov    0x4(%eax),%eax
  8020ca:	85 c0                	test   %eax,%eax
  8020cc:	74 0f                	je     8020dd <alloc_block+0x1bd>
  ...
  8020db:	eb 0a                	jmp    8020e7 <alloc_block+0x1c7>
  8020dd:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  8020e0:	8b 00                	mov    (%eax),%eax
  8020e2:	a3 48 40 80 00       	mov    %eax,0x804048
  ...
  8020fa:	a1 54 40 80 00       	mov    0x804054,%eax
  8020ff:	48                   	dec    %eax
  802100:	a3 54 40 80 00       	mov    %eax,0x804054
			// from page to freeblockList by the pageInfo and the block size.
			split_page_to_blocks(1 << (idx + LOG2_MIN_SIZE), ptr_new_page);
  802105:	8b 45 f4             	mov    -0xc(%ebp),%eax
  802108:	83 c0 03             	add    $0x3,%eax
  80210b:	ba 01 00 00 00       	mov    $0x1,%edx
  802110:	88 c1                	mov    %al,%cl
  802112:	d3 e2                	shl    %cl,%edx
  802114:	89 d0                	mov    %edx,%eax
  802116:	83 ec 08             	sub    $0x8,%esp
  802119:	ff 75 e4             	pushl  -0x1c(%ebp)
  80211c:	50                   	push   %eax
  80211d:	e8 c0 fc ff ff       	call   801de2 <split_page_to_blocks>
  ...
  80212b:	05 80 c0 81 00       	add    $0x81c080,%eax
  802130:	8b 00                	mov    (%eax),%eax
  802132:	89 45 e0             	mov    %eax,-0x20(%ebp)
		    LIST_REMOVE(&freeBlockLists[idx], blk);
  802135:	83 7d e0 00          	cmpl   $0x0,-0x20(%ebp)
  802139:	75 17                	jne    802152 <alloc_block+0x232>
  80213b:	83 ec 04             	sub    $0x4,%esp
  80213e:	68 81 34 80 00       	push   $0x803481
  802143:	68 b0 00 00 00       	push   $0xb0
  802148:	68 c3 33 80 00       	push   $0x8033c3
  80214d:	e8 f8 06 00 00       	call   80284a <_panic>
  802152:	8b 45 e0             	mov    -0x20(%ebp),%eax
  802155:	8b 00                	mov    (%eax),%eax
  802157:	85 c0                	test   %eax,%eax
  802159:	74 10                	je     80216b <alloc_block+0x24b>
  80215b:	8b 45 e0             	mov    -0x20(%ebp),%eax
  80215e:	8b 00                	mov    (%eax),%eax
  802160:	8b 55 e0             	mov    -0x20(%ebp),%edx
  802163:	8b 52 04             	mov    0x4(%edx),%edx
  802166:	89 50 04             	mov    %edx,0x4(%eax)
  802169:	eb 14                	jmp    80217f <alloc_block+0x25f>
  ...
  8021e1:	50                   	push   %eax
  8021e2:	e8 f5 f9 ff ff       	call   801bdc <to_page_info>
  8021e7:	83 c4 10             	add    $0x10,%esp
  8021ea:	89 45 dc             	mov    %eax,-0x24(%ebp)
		    pageInfo->num_of_free_blocks--;
  8021ed:	8b 45 dc             	mov    -0x24(%ebp),%eax
  8021f0:	66 8b 40 0a          	mov    0xa(%eax),%ax
  8021f4:	48                   	dec    %eax
  8021f5:	8b 55 dc             	mov    -0x24(%ebp),%edx
  8021f8:	66 89 42 0a          	mov    %ax,0xa(%edx)
		    return blk;
  8021fc:	8b 45 e0             	mov    -0x20(%ebp),%eax
  8021ff:	e9 26 01 00 00       	jmp    80232a <alloc_block+0x40a>
		}else{//case 3: no free block and no free page so iterate and try to find bigger size.
			// iterate over the list until finding available block
			while (idx <= (LOG2_MAX_SIZE - LOG2_MIN_SIZE) && freeBlockLists[idx].size == 0) {
				idx++;
  802204:	ff 45 f4             	incl   -0xc(%ebp)
				// found free block
				if(freeBlockLists[idx].size > 0){
  802207:	8b 45 f4             	mov    -0xc(%ebp),%eax
  80220a:	c1 e0 04             	shl    $0x4,%eax
  80220d:	05 8c c0 81 00       	add    $0x81c08c,%eax
  802212:	8b 00                	mov    (%eax),%eax
  802214:	85 c0                	test   %eax,%eax
  802216:	0f 84 dc 00 00 00    	je     8022f8 <alloc_block+0x3d8>
					// remove from the list and updat the pageInfoArr free blocks.
					// pop from the freeBlockList.
					struct BlockElement *blk = LIST_FIRST(&freeBlockLists[idx]);
  80221c:	8b 45 f4             	mov    -0xc(%ebp),%eax
  80221f:	c1 e0 04             	shl    $0x4,%eax
  802222:	05 80 c0 81 00       	add    $0x81c080,%eax
  802227:	8b 00                	mov    (%eax),%eax
  802229:	89 45 d8             	mov    %eax,-0x28(%ebp)
				    LIST_REMOVE(&freeBlockLists[idx], blk);
  80222c:	83 7d d8 00          	cmpl   $0x0,-0x28(%ebp)
  802230:	75 17                	jne    802249 <alloc_block+0x329>
  802232:	83 ec 04             	sub    $0x4,%esp
  802235:	68 81 34 80 00       	push   $0x803481
  80223a:	68 be 00 00 00       	push   $0xbe
  80223f:	68 c3 33 80 00       	push   $0x8033c3
  802244:	e8 01 06 00 00       	call   80284a <_panic>
  802249:	8b 45 d8             	mov    -0x28(%ebp),%eax
  80224c:	8b 00                	mov    (%eax),%eax
  80224e:	85 c0                	test   %eax,%eax
  802250:	74 10                	je     802262 <alloc_block+0x342>
  802252:	8b 45 d8             	mov    -0x28(%ebp),%eax
  802255:	8b 00                	mov    (%eax),%eax
  802257:	8b 55 d8             	mov    -0x28(%ebp),%edx
  80225a:	8b 52 04             	mov    0x4(%edx),%edx
  80225d:	89 50 04             	mov    %edx,0x4(%eax)
  802260:	eb 14                	jmp    802276 <alloc_block+0x356>
  802262:	8b 45 d8             	mov    -0x28(%ebp),%eax
  802265:	8b 40 04             	mov    0x4(%eax),%eax
  802268:	8b 55 f4             	mov    -0xc(%ebp),%edx
  80226b:	c1 e2 04             	shl    $0x4,%edx
  80226e:	81 c2 84 c0 81 00    	add    $0x81c084,%edx
  802274:	89 02                	mov    %eax,(%edx)
  802276:	8b 45 d8             	mov    -0x28(%ebp),%eax
  802279:	8b 40 04             	mov    0x4(%eax),%eax
  80227c:	85 c0                	test   %eax,%eax
  80227e:	74 0f                	je     80228f <alloc_block+0x36f>
  802280:	8b 45 d8             	mov    -0x28(%ebp),%eax
  802283:	8b 40 04             	mov    0x4(%eax),%eax
  802286:	8b 55 d8             	mov    -0x28(%ebp),%edx
  802289:	8b 12                	mov    (%edx),%edx
  80228b:	89 10                	mov    %edx,(%eax)
  80228d:	eb 13                	jmp    8022a2 <alloc_block+0x382>
  80228f:	8b 45 d8             	mov    -0x28(%ebp),%eax
  802292:	8b 00                	mov    (%eax),%eax
  802294:	8b 55 f4             	mov    -0xc(%ebp),%edx
  802297:	c1 e2 04             	shl    $0x4,%edx
  80229a:	81 c2 80 c0 81 00    	add    $0x81c080,%edx
  8022a0:	89 02                	mov    %eax,(%edx)
  8022a2:	8b 45 d8             	mov    -0x28(%ebp),%eax
  8022a5:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  8022ab:	8b 45 d8             	mov    -0x28(%ebp),%eax
  8022ae:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
  8022b5:	8b 45 f4             	mov    -0xc(%ebp),%eax
  8022b8:	c1 e0 04             	shl    $0x4,%eax
  8022bb:	05 8c c0 81 00       	add    $0x81c08c,%eax
  8022c0:	8b 00                	mov    (%eax),%eax
  8022c2:	8d 50 ff             	lea    -0x1(%eax),%edx
  8022c5:	8b 45 f4             	mov    -0xc(%ebp),%eax
  8022c8:	c1 e0 04             	shl    $0x4,%eax
  8022cb:	05 8c c0 81 00       	add    $0x81c08c,%eax
  8022d0:	89 10                	mov    %edx,(%eax)
				    // update pageBlockInfoArr
				    struct PageInfoElement *pageInfo = to_page_info((uint32)blk);
  8022d2:	8b 45 d8             	mov    -0x28(%ebp),%eax
  8022d5:	83 ec 0c             	sub    $0xc,%esp
  8022d8:	50                   	push   %eax
  8022d9:	e8 fe f8 ff ff       	call   801bdc <to_page_info>
  8022de:	83 c4 10             	add    $0x10,%esp
  8022e1:	89 45 d4             	mov    %eax,-0x2c(%ebp)
				    pageInfo->num_of_free_blocks--;
  8022e4:	8b 45 d4             	mov    -0x2c(%ebp),%eax
  8022e7:	66 8b 40 0a          	mov    0xa(%eax),%ax
  8022eb:	48                   	dec    %eax
  8022ec:	8b 55 d4             	mov    -0x2c(%ebp),%edx
  8022ef:	66 89 42 0a          	mov    %ax,0xa(%edx)
				    return blk;
  8022f3:	8b 45 d8             	mov    -0x28(%ebp),%eax
  8022f6:	eb 32                	jmp    80232a <alloc_block+0x40a>
		    struct PageInfoElement *pageInfo = to_page_info((uint32)blk);
		    pageInfo->num_of_free_blocks--;
		    return blk;
		}else{//case 3: no free block and no free page so iterate and try to find bigger size.
			// iterate over the list until finding available block
			while (idx <= (LOG2_MAX_SIZE - LOG2_MIN_SIZE) && freeBlockLists[idx].size == 0) {
  8022f8:	83 7d f4 08          	cmpl   $0x8,-0xc(%ebp)
  8022fc:	77 15                	ja     802313 <alloc_block+0x3f3>
  8022fe:	8b 45 f4             	mov    -0xc(%ebp),%eax
  802301:	c1 e0 04             	shl    $0x4,%eax
  802304:	05 8c c0 81 00       	add    $0x81c08c,%eax
  802309:	8b 00                	mov    (%eax),%eax
  80230b:	85 c0                	test   %eax,%eax
  80230d:	0f 84 f1 fe ff ff    	je     802204 <alloc_block+0x2e4>
				}
			}
		}
	}
  ...
  802316:	68 9f 34 80 00       	push   $0x80349f
  80231b:	68 c8 00 00 00       	push   $0xc8
  802320:	68 c3 33 80 00       	push   $0x8033c3
  802325:	e8 20 05 00 00       	call   80284a <_panic>
...
void free_block(void *va)
{
  ...
  802335:	a1 64 c0 81 00       	mov    0x81c064,%eax
  80233a:	39 c2                	cmp    %eax,%edx
  80233c:	72 0c                	jb     80234a <free_block+0x1e>
  80233e:	8b 55 08             	mov    0x8(%ebp),%edx
  802341:	a1 40 40 80 00       	mov    0x804040,%eax
  802346:	39 c2                	cmp    %eax,%edx
  802348:	72 19                	jb     802363 <free_block+0x37>
  80234a:	68 b0 34 80 00       	push   $0x8034b0
  80234f:	68 26 34 80 00       	push   $0x803426
  802354:	68 d7 00 00 00       	push   $0xd7
  802359:	68 c3 33 80 00       	push   $0x8033c3
  80235e:	e8 e7 04 00 00       	call   80284a <_panic>
  ...
  80236f:	50                   	push   %eax
  802370:	e8 67 f8 ff ff       	call   801bdc <to_page_info>
  802375:	83 c4 10             	add    $0x10,%esp
  802378:	89 45 e4             	mov    %eax,-0x1c(%ebp)
	uint32 blk_size = pageInfo->block_size;
  80237b:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  80237e:	8b 40 08             	mov    0x8(%eax),%eax
  802381:	0f b7 c0             	movzwl %ax,%eax
  802384:	89 45 e0             	mov    %eax,-0x20(%ebp)

	// its index in the freeBlocklist.
	int idx = 0;
  802387:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
	for (int i = LOG2_MIN_SIZE; i <= LOG2_MAX_SIZE; i++) {
  80238e:	c7 45 f0 03 00 00 00 	movl   $0x3,-0x10(%ebp)
  802395:	eb 19                	jmp    8023b0 <free_block+0x84>
	    if ((1 << i) == blk_size)
  802397:	8b 45 f0             	mov    -0x10(%ebp),%eax
  80239a:	ba 01 00 00 00       	mov    $0x1,%edx
  80239f:	88 c1                	mov    %al,%cl
  8023a1:	d3 e2                	shl    %cl,%edx
  8023a3:	89 d0                	mov    %edx,%eax
  8023a5:	3b 45 e0             	cmp    -0x20(%ebp),%eax
  8023a8:	74 0e                	je     8023b8 <free_block+0x8c>
	        break;
	    idx++;
  8023aa:	ff 45 f4             	incl   -0xc(%ebp)
	...
	int idx = 0;
	for (int i = LOG2_MIN_SIZE; i <= LOG2_MAX_SIZE; i++) {
  8023ad:	ff 45 f0             	incl   -0x10(%ebp)
  8023b0:	83 7d f0 0b          	cmpl   $0xb,-0x10(%ebp)
  8023b4:	7e e1                	jle    802397 <free_block+0x6b>
  8023b6:	eb 01                	jmp    8023b9 <free_block+0x8d>
	    if ((1 << i) == blk_size)
	        break;
  8023b8:	90                   	nop
	    idx++;
  ...
  8023bc:	66 8b 40 0a          	mov    0xa(%eax),%ax
  8023c0:	40                   	inc    %eax
  8023c1:	8b 55 e4             	mov    -0x1c(%ebp),%edx
  8023c4:	66 89 42 0a          	mov    %ax,0xa(%edx)
	LIST_INSERT_TAIL(&freeBlockLists[idx], blk_to_free);
  8023c8:	83 7d e8 00          	cmpl   $0x0,-0x18(%ebp)
  8023cc:	75 17                	jne    8023e5 <free_block+0xb9>
  8023ce:	83 ec 04             	sub    $0x4,%esp
  8023d1:	68 3c 34 80 00       	push   $0x80343c
  8023d6:	68 ee 00 00 00       	push   $0xee
  8023db:	68 c3 33 80 00       	push   $0x8033c3
  8023e0:	e8 65 04 00 00       	call   80284a <_panic>
  8023e5:	8b 45 f4             	mov    -0xc(%ebp),%eax
  8023e8:	c1 e0 04             	shl    $0x4,%eax
  8023eb:	05 84 c0 81 00       	add    $0x81c084,%eax
  8023f0:	8b 10                	mov    (%eax),%edx
  8023f2:	8b 45 e8             	mov    -0x18(%ebp),%eax
  8023f5:	89 50 04             	mov    %edx,0x4(%eax)
  8023f8:	8b 45 e8             	mov    -0x18(%ebp),%eax
  8023fb:	8b 40 04             	mov    0x4(%eax),%eax
  8023fe:	85 c0                	test   %eax,%eax
  802400:	74 14                	je     802416 <free_block+0xea>
  802402:	8b 45 f4             	mov    -0xc(%ebp),%eax
  802405:	c1 e0 04             	shl    $0x4,%eax
  802408:	05 84 c0 81 00       	add    $0x81c084,%eax
  80240d:	8b 00                	mov    (%eax),%eax
  80240f:	8b 55 e8             	mov    -0x18(%ebp),%edx
  802412:	89 10                	mov    %edx,(%eax)
  802414:	eb 11                	jmp    802427 <free_block+0xfb>
  802416:	8b 45 f4             	mov    -0xc(%ebp),%eax
  802419:	c1 e0 04             	shl    $0x4,%eax
  80241c:	8d 90 80 c0 81 00    	lea    0x81c080(%eax),%edx
  802422:	8b 45 e8             	mov    -0x18(%ebp),%eax
  802425:	89 02                	mov    %eax,(%edx)
  802427:	8b 45 f4             	mov    -0xc(%ebp),%eax
  80242a:	c1 e0 04             	shl    $0x4,%eax
  80242d:	8d 90 84 c0 81 00    	lea    0x81c084(%eax),%edx
  802433:	8b 45 e8             	mov    -0x18(%ebp),%eax
  802436:	89 02                	mov    %eax,(%edx)
  802438:	8b 45 e8             	mov    -0x18(%ebp),%eax
  80243b:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  802441:	8b 45 f4             	mov    -0xc(%ebp),%eax
  802444:	c1 e0 04             	shl    $0x4,%eax
  802447:	05 8c c0 81 00       	add    $0x81c08c,%eax
  80244c:	8b 00                	mov    (%eax),%eax
  80244e:	8d 50 01             	lea    0x1(%eax),%edx
  ...
  80245c:	89 10                	mov    %edx,(%eax)
	...
	int blk_count = PAGE_SIZE / blk_size;
  80245e:	b8 00 10 00 00       	mov    $0x1000,%eax
  802463:	ba 00 00 00 00       	mov    $0x0,%edx
  802468:	f7 75 e0             	divl   -0x20(%ebp)
  80246b:	89 45 dc             	mov    %eax,-0x24(%ebp)
	// the blk count in the page is same as number fo free blocks free up the page.
	if (pageInfo->num_of_free_blocks == blk_count) {
  80246e:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  802471:	66 8b 40 0a          	mov    0xa(%eax),%ax
  802475:	0f b7 c0             	movzwl %ax,%eax
  802478:	3b 45 dc             	cmp    -0x24(%ebp),%eax
  80247b:	0f 85 70 01 00 00    	jne    8025f1 <free_block+0x2c5>
		uint32 page_va = to_page_va(pageInfo);
  802481:	83 ec 0c             	sub    $0xc,%esp
  802484:	ff 75 e4             	pushl  -0x1c(%ebp)
  802487:	e8 de f6 ff ff       	call   801b6a <to_page_va>
  80248c:	83 c4 10             	add    $0x10,%esp
  80248f:	89 45 d8             	mov    %eax,-0x28(%ebp)
		// remove all blk in the freeBlockList.
		for (uint32 off = 0; off < PAGE_SIZE; off += blk_size) {
  802492:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  802499:	e9 b7 00 00 00       	jmp    802555 <free_block+0x229>
			struct BlockElement *blk = (struct BlockElement*)(page_va + off);
  80249e:	8b 55 d8             	mov    -0x28(%ebp),%edx
  8024a1:	8b 45 ec             	mov    -0x14(%ebp),%eax
  8024a4:	01 d0                	add    %edx,%eax
  8024a6:	89 45 d4             	mov    %eax,-0x2c(%ebp)
			LIST_REMOVE(&freeBlockLists[idx], blk);
  8024a9:	83 7d d4 00          	cmpl   $0x0,-0x2c(%ebp)
  8024ad:	75 17                	jne    8024c6 <free_block+0x19a>
  8024af:	83 ec 04             	sub    $0x4,%esp
  8024b2:	68 81 34 80 00       	push   $0x803481
  8024b7:	68 f8 00 00 00       	push   $0xf8
  8024bc:	68 c3 33 80 00       	push   $0x8033c3
  8024c1:	e8 84 03 00 00       	call   80284a <_panic>
  8024c6:	8b 45 d4             	mov    -0x2c(%ebp),%eax
  8024c9:	8b 00                	mov    (%eax),%eax
  8024cb:	85 c0                	test   %eax,%eax
  8024cd:	74 10                	je     8024df <free_block+0x1b3>
  ...
  8024dd:	eb 14                	jmp    8024f3 <free_block+0x1c7>
  ...
  8024eb:	81 c2 84 c0 81 00    	add    $0x81c084,%edx
  8024f1:	89 02                	mov    %eax,(%edx)
  8024f3:	8b 45 d4             	mov    -0x2c(%ebp),%eax
  8024f6:	8b 40 04             	mov    0x4(%eax),%eax
  8024f9:	85 c0                	test   %eax,%eax
  8024fb:	74 0f                	je     80250c <free_block+0x1e0>
  8024fd:	8b 45 d4             	mov    -0x2c(%ebp),%eax
  802500:	8b 40 04             	mov    0x4(%eax),%eax
  802503:	8b 55 d4             	mov    -0x2c(%ebp),%edx
  802506:	8b 12                	mov    (%edx),%edx
  802508:	89 10                	mov    %edx,(%eax)
  80250a:	eb 13                	jmp    80251f <free_block+0x1f3>
  80250c:	8b 45 d4             	mov    -0x2c(%ebp),%eax
  80250f:	8b 00                	mov    (%eax),%eax
  802511:	8b 55 f4             	mov    -0xc(%ebp),%edx
  802514:	c1 e2 04             	shl    $0x4,%edx
  802517:	81 c2 80 c0 81 00    	add    $0x81c080,%edx
  80251d:	89 02                	mov    %eax,(%edx)
  80251f:	8b 45 d4             	mov    -0x2c(%ebp),%eax
  ...
  802535:	c1 e0 04             	shl    $0x4,%eax
  802538:	05 8c c0 81 00       	add    $0x81c08c,%eax
  80253d:	8b 00                	mov    (%eax),%eax
  80253f:	8d 50 ff             	lea    -0x1(%eax),%edx
  802542:	8b 45 f4             	mov    -0xc(%ebp),%eax
  802545:	c1 e0 04             	shl    $0x4,%eax
  802548:	05 8c c0 81 00       	add    $0x81c08c,%eax
  ...
  802552:	01 45 ec             	add    %eax,-0x14(%ebp)
  802555:	81 7d ec ff 0f 00 00 	cmpl   $0xfff,-0x14(%ebp)
  80255c:	0f 86 3c ff ff ff    	jbe    80249e <free_block+0x172>
			struct BlockElement *blk = (struct BlockElement*)(page_va + off);
			LIST_REMOVE(&freeBlockLists[idx], blk);
		}
		// reset page info.
  ...
  802565:	66 c7 40 08 00 00    	movw   $0x0,0x8(%eax)
		pageInfo->num_of_free_blocks = 0;
  80256b:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  80256e:	66 c7 40 0a 00 00    	movw   $0x0,0xa(%eax)
		// add it to the available pages.
		LIST_INSERT_TAIL(&freePagesList, pageInfo);
  802574:	83 7d e4 00          	cmpl   $0x0,-0x1c(%ebp)
  802578:	75 17                	jne    802591 <free_block+0x265>
  80257a:	83 ec 04             	sub    $0x4,%esp
  80257d:	68 3c 34 80 00       	push   $0x80343c
  802582:	68 fe 00 00 00       	push   $0xfe
  802587:	68 c3 33 80 00       	push   $0x8033c3
  80258c:	e8 b9 02 00 00       	call   80284a <_panic>
  802591:	8b 15 4c 40 80 00    	mov    0x80404c,%edx
  ...
  8025a5:	74 0c                	je     8025b3 <free_block+0x287>
  8025a7:	a1 4c 40 80 00       	mov    0x80404c,%eax
  8025ac:	8b 55 e4             	mov    -0x1c(%ebp),%edx
  8025af:	89 10                	mov    %edx,(%eax)
  8025b1:	eb 08                	jmp    8025bb <free_block+0x28f>
  8025b3:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  8025b6:	a3 48 40 80 00       	mov    %eax,0x804048
  8025bb:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  8025be:	a3 4c 40 80 00       	mov    %eax,0x80404c
  8025c3:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  8025c6:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  8025cc:	a1 54 40 80 00       	mov    0x804054,%eax
  8025d1:	40                   	inc    %eax
  8025d2:	a3 54 40 80 00       	mov    %eax,0x804054
		// make it available in memory.
		return_page((uint32 *)to_page_va(pageInfo));
  8025d7:	83 ec 0c             	sub    $0xc,%esp
  8025da:	ff 75 e4             	pushl  -0x1c(%ebp)
  8025dd:	e8 88 f5 ff ff       	call   801b6a <to_page_va>
  8025e2:	83 c4 10             	add    $0x10,%esp
  8025e5:	83 ec 0c             	sub    $0xc,%esp
  8025e8:	50                   	push   %eax
  8025e9:	e8 b8 ee ff ff       	call   8014a6 <return_page>
...
void *realloc_block(void* va, uint32 new_size)
{
  ...
  8025fd:	68 e8 34 80 00       	push   $0x8034e8
  802602:	68 11 01 00 00       	push   $0x111
  802607:	68 c3 33 80 00       	push   $0x8033c3
  80260c:	e8 39 02 00 00       	call   80284a <_panic>

00802611 <create_semaphore>:
...
struct semaphore create_semaphore(char *semaphoreName, uint32 value)
{
  ...
  80261a:	68 0c 35 80 00       	push   $0x80350c
  80261f:	6a 07                	push   $0x7
  802621:	68 3b 35 80 00       	push   $0x80353b
  802626:	e8 1f 02 00 00       	call   80284a <_panic>

0080262b <get_semaphore>:
}
struct semaphore get_semaphore(int32 ownerEnvID, char* semaphoreName)
{
  ...
  802634:	68 4c 35 80 00       	push   $0x80354c
  802639:	6a 0b                	push   $0xb
  80263b:	68 3b 35 80 00       	push   $0x80353b
  802640:	e8 05 02 00 00       	call   80284a <_panic>

00802645 <wait_semaphore>:
}
...
void wait_semaphore(struct semaphore sem)
{
  ...
  80264e:	68 78 35 80 00       	push   $0x803578
  802653:	6a 10                	push   $0x10
  802655:	68 3b 35 80 00       	push   $0x80353b
  80265a:	e8 eb 01 00 00       	call   80284a <_panic>

0080265f <signal_semaphore>:
}
...
void signal_semaphore(struct semaphore sem)
{
  ...
  802668:	68 a8 35 80 00       	push   $0x8035a8
  80266d:	6a 15                	push   $0x15
  80266f:	68 3b 35 80 00       	push   $0x80353b
  802674:	e8 d1 01 00 00       	call   80284a <_panic>

00802679 <semaphore_count>:
}
...
int semaphore_count(struct semaphore sem)
{
  ...
  80267f:	8b 40 10             	mov    0x10(%eax),%eax
}
  802682:	5d                   	pop    %ebp
  802683:	c3                   	ret    
...
env_sleep(uint32 approxMilliSeconds)
{
  ...
  802687:	83 ec 30             	sub    $0x30,%esp
//	cprintf("%s go to sleep...\n", myEnv->prog_name);
	uint32 time_in_cycles=approxMilliSeconds*CYCLES_PER_MILLISEC;
  80268a:	8b 55 08             	mov    0x8(%ebp),%edx
  80268d:	89 d0                	mov    %edx,%eax
  80268f:	c1 e0 02             	shl    $0x2,%eax
  802692:	01 d0                	add    %edx,%eax
  802694:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
  80269b:	01 d0                	add    %edx,%eax
  80269d:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
  8026a4:	01 d0                	add    %edx,%eax
  8026a6:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
  8026ad:	01 d0                	add    %edx,%eax
  8026af:	c1 e0 04             	shl    $0x4,%eax
  8026b2:	89 45 f8             	mov    %eax,-0x8(%ebp)
	uint32 cycles_counter =0;
  8026b5:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%ebp)
...
static inline __attribute__((always_inline)) struct uint64 get_virtual_time_user()
{
  ...
  8026c7:	8b 55 ec             	mov    -0x14(%ebp),%edx
  8026ca:	89 45 f0             	mov    %eax,-0x10(%ebp)
  8026cd:	89 55 f4             	mov    %edx,-0xc(%ebp)

	/*2024*/ //USE A USER-SIDE VERSION OF THIS FUNCTION TO AVOID SLOW-DOWN THE PERFORMANCE DUE SYS_CALL (el7 :))
	//struct uint64 baseTime = sys_get_virtual_time() ;
	struct uint64 baseTime = get_virtual_time_user() ;
	while(cycles_counter<time_in_cycles)
  8026d0:	eb 46                	jmp    802718 <env_sleep+0x94>
...
static inline __attribute__((always_inline)) struct uint64 get_virtual_time_user()
{
  ...
  8026d7:	89 55 d4             	mov    %edx,-0x2c(%ebp)
	...
	return result;
  8026da:	8b 45 d0             	mov    -0x30(%ebp),%eax
  8026dd:	8b 55 d4             	mov    -0x2c(%ebp),%edx
  8026e0:	89 45 e0             	mov    %eax,-0x20(%ebp)
  8026e3:	89 55 e4             	mov    %edx,-0x1c(%ebp)
  ...
  80271b:	3b 45 f8             	cmp    -0x8(%ebp),%eax
  80271e:	72 b2                	jb     8026d2 <env_sleep+0x4e>
//				,cycles_counter
//				);
	}
...
uint32 busy_wait(uint32 loopMax)
{
  ...
  802726:	83 ec 10             	sub    $0x10,%esp
	uint32 i = 0 ;
  802729:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%ebp)
	while (i < loopMax) i++;
  802730:	eb 03                	jmp    802735 <busy_wait+0x12>
  802732:	ff 45 fc             	incl   -0x4(%ebp)
  802735:	8b 45 fc             	mov    -0x4(%ebp),%eax
  802738:	3b 45 08             	cmp    0x8(%ebp),%eax
  80273b:	72 f5                	jb     802732 <busy_wait+0xf>
	return i;
...
void init_uspinlock(struct uspinlock *lk, char *name, bool isOpened)
{
  ...
  80274c:	74 1c                	je     80276a <init_uspinlock+0x28>
  80274e:	83 7d 10 01          	cmpl   $0x1,0x10(%ebp)
  802752:	74 16                	je     80276a <init_uspinlock+0x28>
  802754:	68 d8 35 80 00       	push   $0x8035d8
  802759:	68 f7 35 80 00       	push   $0x8035f7
  80275e:	6a 10                	push   $0x10
  802760:	68 0c 36 80 00       	push   $0x80360c
  802765:	e8 e0 00 00 00       	call   80284a <_panic>
	strcpy(lk->name, name);
  80276a:	8b 45 08             	mov    0x8(%ebp),%eax
  80276d:	83 c0 04             	add    $0x4,%eax
  802770:	83 ec 08             	sub    $0x8,%esp
  802773:	ff 75 0c             	pushl  0xc(%ebp)
  802776:	50                   	push   %eax
  802777:	e8 d0 e4 ff ff       	call   800c4c <strcpy>
  80277c:	83 c4 10             	add    $0x10,%esp
	lk->locked = (1 - isOpened);
  80277f:	b8 01 00 00 00       	mov    $0x1,%eax
  802784:	2b 45 10             	sub    0x10(%ebp),%eax
...
void acquire_uspinlock(struct uspinlock *lk)
{
  ...
  80279e:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%ebp)
xchg(volatile uint32 *addr, uint32 newval)
{
  ...
  8027ab:	8b 4d f4             	mov    -0xc(%ebp),%ecx
  8027ae:	f0 87 02             	lock xchg %eax,(%edx)
  ...
  8027b9:	75 dd                	jne    802798 <acquire_uspinlock+0x7>

	cprintf("[%d: %s] ACQUIRED spinlock [%s]\n", myEnv->env_id, myEnv->prog_name, lk->name);
  8027bb:	8b 45 08             	mov    0x8(%ebp),%eax
  8027be:	8d 48 04             	lea    0x4(%eax),%ecx
  8027c1:	a1 20 40 80 00       	mov    0x804020,%eax
  8027c6:	8d 50 20             	lea    0x20(%eax),%edx
  8027c9:	a1 20 40 80 00       	mov    0x804020,%eax
  8027ce:	8b 40 10             	mov    0x10(%eax),%eax
  8027d1:	51                   	push   %ecx
  8027d2:	52                   	push   %edx
  8027d3:	50                   	push   %eax
  8027d4:	68 1c 36 80 00       	push   $0x80361c
  8027d9:	e8 46 dd ff ff       	call   800524 <cprintf>
  8027de:	83 c4 10             	add    $0x10,%esp
	...
	__sync_synchronize();
  8027e1:	f0 83 0c 24 00       	lock orl $0x0,(%esp)
}
  8027e6:	90                   	nop
  8027e7:	c9                   	leave  
  8027e8:	c3                   	ret    

008027e9 <release_uspinlock>:
...
void release_uspinlock(struct uspinlock *lk)
{
  ...
  8027f6:	75 18                	jne    802810 <release_uspinlock+0x27>
	{
		panic("release: lock \"%s\" is not held!", lk->name);
  8027f8:	8b 45 08             	mov    0x8(%ebp),%eax
  8027fb:	83 c0 04             	add    $0x4,%eax
  8027fe:	50                   	push   %eax
  8027ff:	68 40 36 80 00       	push   $0x803640
  802804:	6a 2b                	push   $0x2b
  802806:	68 0c 36 80 00       	push   $0x80360c
  80280b:	e8 3a 00 00 00       	call   80284a <_panic>
	// Tell the C compiler and the processor to not move loads or stores
	...
	__sync_synchronize();
  802810:	f0 83 0c 24 00       	lock orl $0x0,(%esp)
  ...
  802824:	8d 48 04             	lea    0x4(%eax),%ecx
  802827:	a1 20 40 80 00       	mov    0x804020,%eax
  80282c:	8d 50 20             	lea    0x20(%eax),%edx
  80282f:	a1 20 40 80 00       	mov    0x804020,%eax
  802834:	8b 40 10             	mov    0x10(%eax),%eax
  802837:	51                   	push   %ecx
  802838:	52                   	push   %edx
  802839:	50                   	push   %eax
  80283a:	68 60 36 80 00       	push   $0x803660
  80283f:	e8 e0 dc ff ff       	call   800524 <cprintf>
...
_panic(const char *file, int line, const char *fmt,...)
{
  ...
  80284d:	83 ec 18             	sub    $0x18,%esp
	va_list ap;
	va_start(ap, fmt);
  802850:	8d 45 10             	lea    0x10(%ebp),%eax
  802853:	83 c0 04             	add    $0x4,%eax
  802856:	89 45 f4             	mov    %eax,-0xc(%ebp)
	// Print the panic message
	if (argv0)
  802859:	a1 1c c1 81 00       	mov    0x81c11c,%eax
  80285e:	85 c0                	test   %eax,%eax
  802860:	74 16                	je     802878 <_panic+0x2e>
		cprintf("%s: ", argv0);
  802862:	a1 1c c1 81 00       	mov    0x81c11c,%eax
  802867:	83 ec 08             	sub    $0x8,%esp
  80286a:	50                   	push   %eax
  80286b:	68 84 36 80 00       	push   $0x803684
  802870:	e8 af dc ff ff       	call   800524 <cprintf>
  802875:	83 c4 10             	add    $0x10,%esp
	cprintf_colored(TEXT_PANIC_CLR, "user [EVAL_FINAL]panic in %s at %s:%d: ", binaryname, file, line);
  802878:	a1 04 40 80 00       	mov    0x804004,%eax
  80287d:	83 ec 0c             	sub    $0xc,%esp
  802880:	ff 75 0c             	pushl  0xc(%ebp)
  802883:	ff 75 08             	pushl  0x8(%ebp)
  802886:	50                   	push   %eax
  802887:	68 8c 36 80 00       	push   $0x80368c
  80288c:	6a 74                	push   $0x74
  80288e:	e8 be dc ff ff       	call   800551 <cprintf_colored>
  802893:	83 c4 20             	add    $0x20,%esp
	vcprintf(fmt, ap);
  802896:	8b 45 10             	mov    0x10(%ebp),%eax
  802899:	83 ec 08             	sub    $0x8,%esp
  80289c:	ff 75 f4             	pushl  -0xc(%ebp)
  80289f:	50                   	push   %eax
  8028a0:	e8 10 dc ff ff       	call   8004b5 <vcprintf>
  8028a5:	83 c4 10             	add    $0x10,%esp
	vcprintf("\n", NULL);
  8028a8:	83 ec 08             	sub    $0x8,%esp
  8028ab:	6a 00                	push   $0x0
  8028ad:	68 b4 36 80 00       	push   $0x8036b4
  8028b2:	e8 fe db ff ff       	call   8004b5 <vcprintf>
...
//		asm volatile("int3");
	...
	exit() ;
  8028ba:	e8 77 db ff ff       	call   800436 <exit>

	// should not return here
	while (1) ;
  8028bf:	eb fe                	jmp    8028bf <_panic+0x75>

008028c1 <CheckWSArrayWithoutLastIndex>:
}
...
void CheckWSArrayWithoutLastIndex(uint32 *expectedPages, int arraySize)
{
  ...
  8028c7:	a1 20 40 80 00       	mov    0x804020,%eax
  8028cc:	8b 90 84 00 00 00    	mov    0x84(%eax),%edx
  8028d2:	8b 45 0c             	mov    0xc(%ebp),%eax
  8028d5:	39 c2                	cmp    %eax,%edx
  8028d7:	74 14                	je     8028ed <CheckWSArrayWithoutLastIndex+0x2c>
	{
		panic("number of expected pages SHOULD BE EQUAL to max WS size... review your TA!!");
  8028d9:	83 ec 04             	sub    $0x4,%esp
  8028dc:	68 b8 36 80 00       	push   $0x8036b8
  8028e1:	6a 26                	push   $0x26
  8028e3:	68 04 37 80 00       	push   $0x803704
  8028e8:	e8 5d ff ff ff       	call   80284a <_panic>
	}
	int expectedNumOfEmptyLocs = 0;
  8028ed:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
	for (int e = 0; e < arraySize; e++) {
  8028f4:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  8028fb:	e9 c5 00 00 00       	jmp    8029c5 <CheckWSArrayWithoutLastIndex+0x104>
		if (expectedPages[e] == 0) {
  802900:	8b 45 f0             	mov    -0x10(%ebp),%eax
  802903:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
  80290a:	8b 45 08             	mov    0x8(%ebp),%eax
  80290d:	01 d0                	add    %edx,%eax
  80290f:	8b 00                	mov    (%eax),%eax
  802911:	85 c0                	test   %eax,%eax
  802913:	75 08                	jne    80291d <CheckWSArrayWithoutLastIndex+0x5c>
			expectedNumOfEmptyLocs++;
  802915:	ff 45 f4             	incl   -0xc(%ebp)
			continue;
  802918:	e9 a5 00 00 00       	jmp    8029c2 <CheckWSArrayWithoutLastIndex+0x101>
		}
		int found = 0;
  80291d:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
		for (int w = 0; w < myEnv->page_WS_max_size; w++) {
  802924:	c7 45 e8 00 00 00 00 	movl   $0x0,-0x18(%ebp)
  80292b:	eb 69                	jmp    802996 <CheckWSArrayWithoutLastIndex+0xd5>
			if (myEnv->__uptr_pws[w].empty == 0) {
  80292d:	a1 20 40 80 00       	mov    0x804020,%eax
  802932:	8b 88 90 05 00 00    	mov    0x590(%eax),%ecx
  802938:	8b 55 e8             	mov    -0x18(%ebp),%edx
  80293b:	89 d0                	mov    %edx,%eax
  80293d:	01 c0                	add    %eax,%eax
  80293f:	01 d0                	add    %edx,%eax
  802941:	c1 e0 03             	shl    $0x3,%eax
  802944:	01 c8                	add    %ecx,%eax
  802946:	8a 40 04             	mov    0x4(%eax),%al
  802949:	84 c0                	test   %al,%al
  80294b:	75 46                	jne    802993 <CheckWSArrayWithoutLastIndex+0xd2>
				if (ROUNDDOWN(myEnv->__uptr_pws[w].virtual_address, PAGE_SIZE)
  80294d:	a1 20 40 80 00       	mov    0x804020,%eax
  802952:	8b 88 90 05 00 00    	mov    0x590(%eax),%ecx
  802958:	8b 55 e8             	mov    -0x18(%ebp),%edx
  80295b:	89 d0                	mov    %edx,%eax
  80295d:	01 c0                	add    %eax,%eax
  80295f:	01 d0                	add    %edx,%eax
  802961:	c1 e0 03             	shl    $0x3,%eax
  802964:	01 c8                	add    %ecx,%eax
  802966:	8b 00                	mov    (%eax),%eax
  802968:	89 45 dc             	mov    %eax,-0x24(%ebp)
  80296b:	8b 45 dc             	mov    -0x24(%ebp),%eax
  80296e:	25 00 f0 ff ff       	and    $0xfffff000,%eax
  802973:	89 c2                	mov    %eax,%edx
						== expectedPages[e]) {
  802975:	8b 45 f0             	mov    -0x10(%ebp),%eax
  802978:	8d 0c 85 00 00 00 00 	lea    0x0(,%eax,4),%ecx
  80297f:	8b 45 08             	mov    0x8(%ebp),%eax
  802982:	01 c8                	add    %ecx,%eax
  ...
  802988:	75 09                	jne    802993 <CheckWSArrayWithoutLastIndex+0xd2>
						== expectedPages[e]) {
					found = 1;
  80298a:	c7 45 ec 01 00 00 00 	movl   $0x1,-0x14(%ebp)
					break;
  802991:	eb 15                	jmp    8029a8 <CheckWSArrayWithoutLastIndex+0xe7>
		if (expectedPages[e] == 0) {
			expectedNumOfEmptyLocs++;
			continue;
		}
		int found = 0;
		for (int w = 0; w < myEnv->page_WS_max_size; w++) {
  802993:	ff 45 e8             	incl   -0x18(%ebp)
  802996:	a1 20 40 80 00       	mov    0x804020,%eax
  80299b:	8b 90 84 00 00 00    	mov    0x84(%eax),%edx
  8029a1:	8b 45 e8             	mov    -0x18(%ebp),%eax
  8029a4:	39 c2                	cmp    %eax,%edx
  8029a6:	77 85                	ja     80292d <CheckWSArrayWithoutLastIndex+0x6c>
					found = 1;
					break;
				}
			}
		...
		if (!found)
  8029a8:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
  8029ac:	75 14                	jne    8029c2 <CheckWSArrayWithoutLastIndex+0x101>
			panic(
  8029ae:	83 ec 04             	sub    $0x4,%esp
  8029b1:	68 10 37 80 00       	push   $0x803710
  8029b6:	6a 3a                	push   $0x3a
  8029b8:	68 04 37 80 00       	push   $0x803704
  8029bd:	e8 88 fe ff ff       	call   80284a <_panic>
	if (arraySize != myEnv->page_WS_max_size)
	{
		panic("number of expected pages SHOULD BE EQUAL to max WS size... review your TA!!");
	}
	int expectedNumOfEmptyLocs = 0;
	for (int e = 0; e < arraySize; e++) {
  8029c2:	ff 45 f0             	incl   -0x10(%ebp)
  8029c5:	8b 45 f0             	mov    -0x10(%ebp),%eax
  8029c8:	3b 45 0c             	cmp    0xc(%ebp),%eax
  8029cb:	0f 8c 2f ff ff ff    	jl     802900 <CheckWSArrayWithoutLastIndex+0x3f>
		}
		if (!found)
			panic(
  ...
  8029d1:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
	for (int w = 0; w < myEnv->page_WS_max_size; w++) {
  8029d8:	c7 45 e0 00 00 00 00 	movl   $0x0,-0x20(%ebp)
  8029df:	eb 26                	jmp    802a07 <CheckWSArrayWithoutLastIndex+0x146>
		if (myEnv->__uptr_pws[w].empty == 1) {
  8029e1:	a1 20 40 80 00       	mov    0x804020,%eax
  8029e6:	8b 88 90 05 00 00    	mov    0x590(%eax),%ecx
  8029ec:	8b 55 e0             	mov    -0x20(%ebp),%edx
  8029ef:	89 d0                	mov    %edx,%eax
  8029f1:	01 c0                	add    %eax,%eax
  8029f3:	01 d0                	add    %edx,%eax
  8029f5:	c1 e0 03             	shl    $0x3,%eax
  8029f8:	01 c8                	add    %ecx,%eax
  8029fa:	8a 40 04             	mov    0x4(%eax),%al
  8029fd:	3c 01                	cmp    $0x1,%al
  8029ff:	75 03                	jne    802a04 <CheckWSArrayWithoutLastIndex+0x143>
			actualNumOfEmptyLocs++;
  802a01:	ff 45 e4             	incl   -0x1c(%ebp)
		if (!found)
			panic(
					"PAGE WS entry checking failed... trace it by printing page WS before & after fault");
	}
	int actualNumOfEmptyLocs = 0;
	for (int w = 0; w < myEnv->page_WS_max_size; w++) {
  802a04:	ff 45 e0             	incl   -0x20(%ebp)
  802a07:	a1 20 40 80 00       	mov    0x804020,%eax
  802a0c:	8b 90 84 00 00 00    	mov    0x84(%eax),%edx
  802a12:	8b 45 e0             	mov    -0x20(%ebp),%eax
  802a15:	39 c2                	cmp    %eax,%edx
  802a17:	77 c8                	ja     8029e1 <CheckWSArrayWithoutLastIndex+0x120>
		if (myEnv->__uptr_pws[w].empty == 1) {
			actualNumOfEmptyLocs++;
		}
	}
  ...
  802a1c:	3b 45 e4             	cmp    -0x1c(%ebp),%eax
  802a1f:	74 14                	je     802a35 <CheckWSArrayWithoutLastIndex+0x174>
		panic(
  802a21:	83 ec 04             	sub    $0x4,%esp
  802a24:	68 64 37 80 00       	push   $0x803764
  802a29:	6a 44                	push   $0x44
  802a2b:	68 04 37 80 00       	push   $0x803704
  802a30:	e8 15 fe ff ff       	call   80284a <_panic>
