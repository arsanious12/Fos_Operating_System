...
void _main(void)
{
  ...
  80005d:	68 70 1c 80 00       	push   $0x801c70
...
libmain(int argc, char **argv)
{
  ...
  8000ff:	bb 8c 1d 80 00       	mov    $0x801d8c,%ebx
  ...
  800144:	68 ac 1c 80 00       	push   $0x801cac
  ...
  800160:	50                   	push   %eax
  800161:	68 d4 1c 80 00       	push   $0x801cd4
  ...
  800189:	52                   	push   %edx
  80018a:	50                   	push   %eax
  80018b:	68 f8 1c 80 00       	push   $0x801cf8
  ...
  8001ba:	52                   	push   %edx
  8001bb:	50                   	push   %eax
  8001bc:	68 20 1d 80 00       	push   $0x801d20
  ...
  8001d7:	50                   	push   %eax
  8001d8:	68 78 1d 80 00       	push   $0x801d78
  8001dd:	e8 18 03 00 00       	call   8004fa <cprintf>
  8001e2:	83 c4 10             	add    $0x10,%esp
			cprintf("**************************************\n");
  8001e5:	83 ec 0c             	sub    $0xc,%esp
  8001e8:	68 ac 1c 80 00       	push   $0x801cac
...
_panic(const char *file, int line, const char *fmt,...)
{
  ...
  80024c:	50                   	push   %eax
  80024d:	68 f0 1d 80 00       	push   $0x801df0
  ...
  800268:	50                   	push   %eax
  800269:	68 f8 1d 80 00       	push   $0x801df8
  ...
  80028f:	68 20 1e 80 00       	push   $0x801e20
...
void CheckWSArrayWithoutLastIndex(uint32 *expectedPages, int arraySize)
{
  ...
  8002be:	68 24 1e 80 00       	push   $0x801e24
  8002c3:	6a 26                	push   $0x26
  8002c5:	68 70 1e 80 00       	push   $0x801e70
  ...
  800393:	68 7c 1e 80 00       	push   $0x801e7c
  800398:	6a 3a                	push   $0x3a
  80039a:	68 70 1e 80 00       	push   $0x801e70
  ...
  800406:	68 d0 1e 80 00       	push   $0x801ed0
  80040b:	6a 44                	push   $0x44
  80040d:	68 70 1e 80 00       	push   $0x801e70
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800634:	05 34 21 80 00       	add    $0x802134,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800787:	8b 04 85 58 21 80 00 	mov    0x802158(,%eax,4),%eax
  ...
  800868:	8b 34 9d a0 1f 80 00 	mov    0x801fa0(,%ebx,4),%esi
  80086f:	85 f6                	test   %esi,%esi
  800871:	75 19                	jne    80088c <vprintfmt+0x173>
				printfmt(putch, putdat, "error %d", err);
  800873:	53                   	push   %ebx
  800874:	68 45 21 80 00       	push   $0x802145
  ...
  800887:	e9 5b 02 00 00       	jmp    800ae7 <vprintfmt+0x3ce>
			...
			if (err > MAXERROR || (p = error_string[err]) == NULL)
				...
				printfmt(putch, putdat, "%s", p);
  80088c:	56                   	push   %esi
  80088d:	68 4e 21 80 00       	push   $0x80214e
  ...
  8008b8:	75 05                	jne    8008bf <vprintfmt+0x1a6>
				p = "(null)";
  8008ba:	be 51 21 80 00       	mov    $0x802151,%esi
			if (width > 0 && padc != '-')
...
void sys_env_set_priority(int32 envID, int priority)
{
  ...
  801975:	68 c8 22 80 00       	push   $0x8022c8
  80197a:	68 25 01 00 00       	push   $0x125
  80197f:	68 fb 22 80 00       	push   $0x8022fb
