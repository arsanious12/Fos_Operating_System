...
void _main(void)
{
  ...
  80004b:	68 14 1c 80 00       	push   $0x801c14
...
libmain(int argc, char **argv)
{
  ...
  80009b:	a3 e0 30 80 00       	mov    %eax,0x8030e0

	//SET THE PROGRAM NAME
	if (myEnv->prog_name[0] != '\0')
  8000a0:	a1 e0 30 80 00       	mov    0x8030e0,%eax
  8000a5:	8a 40 20             	mov    0x20(%eax),%al
  8000a8:	84 c0                	test   %al,%al
  8000aa:	74 0d                	je     8000b9 <libmain+0x64>
		binaryname = myEnv->prog_name;
  8000ac:	a1 e0 30 80 00       	mov    0x8030e0,%eax
  8000b1:	83 c0 20             	add    $0x20,%eax
  8000b4:	a3 d4 30 80 00       	mov    %eax,0x8030d4
  ...
  8000c4:	a3 d4 30 80 00       	mov    %eax,0x8030d4
  ...
  8000d7:	83 c4 10             	add    $0x10,%esp
	...
	if (printStats)
  8000da:	a1 d0 30 80 00       	mov    0x8030d0,%eax
  ...
  8000ed:	bb 34 1d 80 00       	mov    $0x801d34,%ebx
  ...
  800132:	68 54 1c 80 00       	push   $0x801c54
  ...
  80014e:	50                   	push   %eax
  80014f:	68 7c 1c 80 00       	push   $0x801c7c
...
_panic(const char *file, int line, const char *fmt,...)
{
  ...
  80027d:	68 c8 1d 80 00       	push   $0x801dc8
...
void CheckWSArrayWithoutLastIndex(uint32 *expectedPages, int arraySize)
{
  ...
  800297:	a1 e0 30 80 00       	mov    0x8030e0,%eax
  ...
  8002ac:	68 cc 1d 80 00       	push   $0x801dcc
  8002b1:	6a 26                	push   $0x26
  8002b3:	68 18 1e 80 00       	push   $0x801e18
  ...
  8002fd:	a1 e0 30 80 00       	mov    0x8030e0,%eax
  ...
  80031d:	a1 e0 30 80 00       	mov    0x8030e0,%eax
  ...
  800366:	a1 e0 30 80 00       	mov    0x8030e0,%eax
  ...
  800381:	68 24 1e 80 00       	push   $0x801e24
  800386:	6a 3a                	push   $0x3a
  800388:	68 18 1e 80 00       	push   $0x801e18
  ...
  8003b1:	a1 e0 30 80 00       	mov    0x8030e0,%eax
  ...
  8003d7:	a1 e0 30 80 00       	mov    0x8030e0,%eax
  ...
  8003f4:	68 78 1e 80 00       	push   $0x801e78
  8003f9:	6a 44                	push   $0x44
  8003fb:	68 18 1e 80 00       	push   $0x801e18
...
static void putch(int ch, struct printbuf *b) {
  ...
  800434:	8b 15 fc 71 82 00    	mov    0x8271fc,%edx
  80043a:	a0 04 31 80 00       	mov    0x803104,%al
...
int vcprintf(const char *fmt, va_list ap) {
  ...
  8004ad:	83 c4 10             	add    $0x10,%esp
	sys_cputs(b.buf, b.idx, printProgName, curTextClr);
  8004b0:	8b 15 fc 71 82 00    	mov    0x8271fc,%edx
  8004b6:	a0 04 31 80 00       	mov    0x803104,%al
  ...
  8004d6:	83 c4 10             	add    $0x10,%esp
	...
	printProgName = 0;
  8004d9:	c6 05 04 31 80 00 00 	movb   $0x0,0x803104
	return b.cnt;
...
int cprintf(const char *fmt, ...) {
  ...
  8004eb:	83 ec 18             	sub    $0x18,%esp
	...
	int cnt;
	printProgName = 1 ;
  8004ee:	c6 05 04 31 80 00 01 	movb   $0x1,0x803104
	va_start(ap, fmt);
...
int cprintf_colored(int textClr, const char *fmt, ...) {
  ...
  800518:	83 ec 18             	sub    $0x18,%esp
	...
	int cnt;
	printProgName = 1 ;
  80051b:	c6 05 04 31 80 00 01 	movb   $0x1,0x803104
	curTextClr = (textClr << 8) ; //set text color by the given value
  800522:	8b 45 08             	mov    0x8(%ebp),%eax
  800525:	c1 e0 08             	shl    $0x8,%eax
  800528:	a3 fc 71 82 00       	mov    %eax,0x8271fc
	va_start(ap, fmt);
  ...
  80054b:	c7 05 fc 71 82 00 00 	movl   $0x700,0x8271fc
  800552:	07 00 00 
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800622:	05 f4 20 80 00       	add    $0x8020f4,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800775:	8b 04 85 18 21 80 00 	mov    0x802118(,%eax,4),%eax
  ...
  800856:	8b 34 9d 60 1f 80 00 	mov    0x801f60(,%ebx,4),%esi
  80085d:	85 f6                	test   %esi,%esi
  80085f:	75 19                	jne    80087a <vprintfmt+0x173>
				printfmt(putch, putdat, "error %d", err);
  800861:	53                   	push   %ebx
  800862:	68 05 21 80 00       	push   $0x802105
  ...
  800875:	e9 5b 02 00 00       	jmp    800ad5 <vprintfmt+0x3ce>
			...
			if (err > MAXERROR || (p = error_string[err]) == NULL)
				...
				printfmt(putch, putdat, "%s", p);
  80087a:	56                   	push   %esi
  80087b:	68 0e 21 80 00       	push   $0x80210e
  ...
  8008a6:	75 05                	jne    8008ad <vprintfmt+0x1a6>
				p = "(null)";
  8008a8:	be 11 21 80 00       	mov    $0x802111,%esi
			if (width > 0 && padc != '-')
  ...
  800a9e:	eb 35                	jmp    800ad5 <vprintfmt+0x3ce>
		...
		case '~':
			printProgName = 0;
  800aa0:	c6 05 04 31 80 00 00 	movb   $0x0,0x803104
			break;
  800aa7:	eb 2c                	jmp    800ad5 <vprintfmt+0x3ce>
		// Print Program Name & UD
		case '@':
			printProgName = 1;
  800aa9:	c6 05 04 31 80 00 01 	movb   $0x1,0x803104
			break;
...
uint32 sys_get_uheap_strategy()
{
  ...
  80183d:	a3 40 71 82 00       	mov    %eax,0x827140
	return uheapPlaceStrategy ;
  801842:	a1 40 71 82 00       	mov    0x827140,%eax
}
  801847:	c9                   	leave  
  801848:	c3                   	ret    
...
void sys_set_uheap_strategy(uint32 heapStrategy)
{
  ...
  80184f:	a3 40 71 82 00       	mov    %eax,0x827140
...
void sys_env_set_priority(int32 envID, int priority)
{
  ...
  801963:	68 88 22 80 00       	push   $0x802288
  801968:	68 25 01 00 00       	push   $0x125
  80196d:	68 bb 22 80 00       	push   $0x8022bb
