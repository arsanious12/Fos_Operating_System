...
libmain(int argc, char **argv)
{
  ...
  8001a8:	a3 20 40 80 00       	mov    %eax,0x804020
  ...
  8001c1:	a3 04 40 80 00       	mov    %eax,0x804004
  ...
  8001d1:	a3 04 40 80 00       	mov    %eax,0x804004
  ...
  8001e4:	83 c4 10             	add    $0x10,%esp
	...
	if (printStats)
  8001e7:	a1 00 40 80 00       	mov    0x804000,%eax
  ...
  8001fa:	bb cc 2c 80 00       	mov    $0x802ccc,%ebx
  ...
  80023f:	68 ec 2b 80 00       	push   $0x802bec
  ...
  80025b:	50                   	push   %eax
  80025c:	68 14 2c 80 00       	push   $0x802c14
  ...
  80026b:	a1 20 40 80 00       	mov    0x804020,%eax
  800270:	8b 90 a8 05 00 00    	mov    0x5a8(%eax),%edx
  800276:	a1 20 40 80 00       	mov    0x804020,%eax
  80027b:	8b 80 98 05 00 00    	mov    0x598(%eax),%eax
  800281:	83 ec 04             	sub    $0x4,%esp
  800284:	52                   	push   %edx
  800285:	50                   	push   %eax
  800286:	68 38 2c 80 00       	push   $0x802c38
  ...
  80029e:	a1 20 40 80 00       	mov    0x804020,%eax
  ...
  8002b5:	52                   	push   %edx
  8002b6:	50                   	push   %eax
  8002b7:	68 60 2c 80 00       	push   $0x802c60
...
static void putch(int ch, struct printbuf *b) {
  ...
  800353:	8b 15 18 c1 81 00    	mov    0x81c118,%edx
  800359:	a0 44 40 80 00       	mov    0x804044,%al
...
int vcprintf(const char *fmt, va_list ap) {
  ...
  8003cc:	83 c4 10             	add    $0x10,%esp
	sys_cputs(b.buf, b.idx, printProgName, curTextClr);
  8003cf:	8b 15 18 c1 81 00    	mov    0x81c118,%edx
  8003d5:	a0 44 40 80 00       	mov    0x804044,%al
  ...
  8003f5:	83 c4 10             	add    $0x10,%esp
	...
	printProgName = 0;
  8003f8:	c6 05 44 40 80 00 00 	movb   $0x0,0x804044
	return b.cnt;
...
int cprintf(const char *fmt, ...) {
  ...
  80040a:	83 ec 18             	sub    $0x18,%esp
	...
	int cnt;
	printProgName = 1 ;
  80040d:	c6 05 44 40 80 00 01 	movb   $0x1,0x804044
	va_start(ap, fmt);
...
int cprintf_colored(int textClr, const char *fmt, ...) {
  ...
  800437:	83 ec 18             	sub    $0x18,%esp
	...
	int cnt;
	printProgName = 1 ;
  80043a:	c6 05 44 40 80 00 01 	movb   $0x1,0x804044
	curTextClr = (textClr << 8) ; //set text color by the given value
  800441:	8b 45 08             	mov    0x8(%ebp),%eax
  800444:	c1 e0 08             	shl    $0x8,%eax
  800447:	a3 18 c1 81 00       	mov    %eax,0x81c118
	va_start(ap, fmt);
  ...
  80046a:	c7 05 18 c1 81 00 00 	movl   $0x700,0x81c118
  800471:	07 00 00 
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8004e9:	e8 3a 24 00 00       	call   802928 <__udivdi3>
  ...
  800537:	52                   	push   %edx
  800538:	50                   	push   %eax
  800539:	e8 fa 24 00 00       	call   802a38 <__umoddi3>
  80053e:	83 c4 10             	add    $0x10,%esp
  800541:	05 54 2f 80 00       	add    $0x802f54,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800694:	8b 04 85 78 2f 80 00 	mov    0x802f78(,%eax,4),%eax
  ...
  800775:	8b 34 9d c0 2d 80 00 	mov    0x802dc0(,%ebx,4),%esi
  80077c:	85 f6                	test   %esi,%esi
  80077e:	75 19                	jne    800799 <vprintfmt+0x173>
				printfmt(putch, putdat, "error %d", err);
  800780:	53                   	push   %ebx
  800781:	68 65 2f 80 00       	push   $0x802f65
  ...
  800794:	e9 5b 02 00 00       	jmp    8009f4 <vprintfmt+0x3ce>
			...
			if (err > MAXERROR || (p = error_string[err]) == NULL)
				...
				printfmt(putch, putdat, "%s", p);
  800799:	56                   	push   %esi
  80079a:	68 6e 2f 80 00       	push   $0x802f6e
  ...
  8007c5:	75 05                	jne    8007cc <vprintfmt+0x1a6>
				p = "(null)";
  8007c7:	be 71 2f 80 00       	mov    $0x802f71,%esi
			if (width > 0 && padc != '-')
  ...
  8009bd:	eb 35                	jmp    8009f4 <vprintfmt+0x3ce>
		...
		case '~':
			printProgName = 0;
  8009bf:	c6 05 44 40 80 00 00 	movb   $0x0,0x804044
			break;
  8009c6:	eb 2c                	jmp    8009f4 <vprintfmt+0x3ce>
		// Print Program Name & UD
		case '@':
			printProgName = 1;
  8009c8:	c6 05 44 40 80 00 01 	movb   $0x1,0x804044
			break;
...
void readline(const char *prompt, char* buf)
{
  ...
  800af2:	68 e8 30 80 00       	push   $0x8030e8
  ...
  800b0b:	e8 1e 1c 00 00       	call   80272e <iscons>
  800b10:	83 c4 10             	add    $0x10,%esp
  800b13:	89 45 f0             	mov    %eax,-0x10(%ebp)
	while (1) {
		c = getchar();
  800b16:	e8 00 1c 00 00       	call   80271b <getchar>
  ...
  800b34:	68 eb 30 80 00       	push   $0x8030eb
  ...
  800b61:	e8 96 1b 00 00       	call   8026fc <cputchar>
  ...
  800b98:	e8 5f 1b 00 00       	call   8026fc <cputchar>
  ...
  800bc1:	e8 36 1b 00 00       	call   8026fc <cputchar>
...
void atomic_readline(const char *prompt, char* buf)
{
  ...
  800bf6:	68 e8 30 80 00       	push   $0x8030e8
  ...
  800c0f:	e8 1a 1b 00 00       	call   80272e <iscons>
  800c14:	83 c4 10             	add    $0x10,%esp
  800c17:	89 45 f0             	mov    %eax,-0x10(%ebp)
		while (1) {
			c = getchar();
  800c1a:	e8 fc 1a 00 00       	call   80271b <getchar>
  ...
  800c38:	68 eb 30 80 00       	push   $0x8030eb
  ...
  800c65:	e8 92 1a 00 00       	call   8026fc <cputchar>
  ...
  800c9c:	e8 5b 1a 00 00       	call   8026fc <cputchar>
  ...
  800cc5:	e8 32 1a 00 00       	call   8026fc <cputchar>
...
void uheap_init()
{
  ...
  80151d:	a3 60 c0 81 00       	mov    %eax,0x81c060
		uheapPageAllocStart = dynAllocEnd + PAGE_SIZE;
  801522:	a1 40 40 80 00       	mov    0x804040,%eax
  801527:	05 00 10 00 00       	add    $0x1000,%eax
  80152c:	a3 10 c1 81 00       	mov    %eax,0x81c110
		uheapPageAllocBreak = uheapPageAllocStart;
  801531:	a1 10 c1 81 00       	mov    0x81c110,%eax
  801536:	a3 68 c0 81 00       	mov    %eax,0x81c068

		__firstTimeFlag = 0;
  80153b:	c7 05 08 40 80 00 00 	movl   $0x0,0x804008
  801542:	00 00 00 
	}
}
  801545:	90                   	nop
...
int get_page(void* va)
{
  ...
  801579:	68 fc 30 80 00       	push   $0x8030fc
  80157e:	6a 1f                	push   $0x1f
  801580:	68 38 31 80 00       	push   $0x803138
  801585:	e8 ae 11 00 00       	call   802738 <_panic>
	return 0;
...
void return_page(void* va)
{
  ...
  8015bd:	68 44 31 80 00       	push   $0x803144
  8015c2:	6a 2a                	push   $0x2a
  8015c4:	68 38 31 80 00       	push   $0x803138
  8015c9:	e8 6a 11 00 00       	call   802738 <_panic>
}
  8015ce:	90                   	nop
  8015cf:	c9                   	leave  
  8015d0:	c3                   	ret    
...
void* malloc(uint32 size)
{
  ...
  8015ec:	68 84 31 80 00       	push   $0x803184
  8015f1:	6a 3e                	push   $0x3e
  8015f3:	68 38 31 80 00       	push   $0x803138
  8015f8:	e8 3b 11 00 00       	call   802738 <_panic>
}
  8015fd:	c9                   	leave  
  8015fe:	c3                   	ret    
...
void free(void* virtual_address)
{
  ...
  801608:	68 ac 31 80 00       	push   $0x8031ac
  80160d:	6a 49                	push   $0x49
  80160f:	68 38 31 80 00       	push   $0x803138
  801614:	e8 1f 11 00 00       	call   802738 <_panic>
...
void* smalloc(char *sharedVarName, uint32 size, uint8 isWritable)
{
  ...
  80163a:	68 d0 31 80 00       	push   $0x8031d0
  80163f:	6a 5a                	push   $0x5a
  801641:	68 38 31 80 00       	push   $0x803138
  801646:	e8 ed 10 00 00       	call   802738 <_panic>
}
  80164b:	c9                   	leave  
  80164c:	c3                   	ret    
...
void* sget(int32 ownerEnvID, char *sharedVarName)
{
  ...
  80165b:	68 f8 31 80 00       	push   $0x8031f8
  801660:	6a 6a                	push   $0x6a
  801662:	68 38 31 80 00       	push   $0x803138
  801667:	e8 cc 10 00 00       	call   802738 <_panic>
...
void *realloc(void *virtual_address, uint32 new_size)
{
  ...
  80167a:	68 1c 32 80 00       	push   $0x80321c
  80167f:	68 88 00 00 00       	push   $0x88
  801684:	68 38 31 80 00       	push   $0x803138
  801689:	e8 aa 10 00 00       	call   802738 <_panic>
...
void sfree(void* virtual_address)
{
  ...
  801697:	68 44 32 80 00       	push   $0x803244
  80169c:	68 9b 00 00 00       	push   $0x9b
  8016a1:	68 38 31 80 00       	push   $0x803138
  8016a6:	e8 8d 10 00 00       	call   802738 <_panic>
...
uint32 sys_get_uheap_strategy()
{
  ...
  801b1b:	a3 60 c0 81 00       	mov    %eax,0x81c060
	return uheapPlaceStrategy ;
  801b20:	a1 60 c0 81 00       	mov    0x81c060,%eax
}
  801b25:	c9                   	leave  
  801b26:	c3                   	ret    
...
void sys_set_uheap_strategy(uint32 heapStrategy)
{
  ...
  801b2d:	a3 60 c0 81 00       	mov    %eax,0x81c060
...
void sys_env_set_priority(int32 envID, int priority)
{
  ...
  801c41:	68 68 32 80 00       	push   $0x803268
  801c46:	68 25 01 00 00       	push   $0x125
  801c4b:	68 9b 32 80 00       	push   $0x80329b
  801c50:	e8 e3 0a 00 00       	call   802738 <_panic>
...
__inline__ uint32 to_page_va(struct PageInfoElement *ptrPageInfo)
{
  ...
  801c5b:	81 7d 08 60 40 80 00 	cmpl   $0x804060,0x8(%ebp)
  801c62:	72 09                	jb     801c6d <to_page_va+0x18>
  801c64:	81 7d 08 60 c0 81 00 	cmpl   $0x81c060,0x8(%ebp)
  801c6b:	72 14                	jb     801c81 <to_page_va+0x2c>
			panic("to_page_va called with invalid pageInfoPtr");
  801c6d:	83 ec 04             	sub    $0x4,%esp
  801c70:	68 ac 32 80 00       	push   $0x8032ac
  801c75:	6a 15                	push   $0x15
  801c77:	68 d7 32 80 00       	push   $0x8032d7
  801c7c:	e8 b7 0a 00 00       	call   802738 <_panic>
	//Get start VA of the page from the corresponding Page Info pointer
	int idxInPageInfoArr = (ptrPageInfo - pageBlockInfoArr);
  801c81:	8b 45 08             	mov    0x8(%ebp),%eax
  801c84:	ba 60 40 80 00       	mov    $0x804060,%edx
  ...
  801cbe:	a1 64 c0 81 00       	mov    0x81c064,%eax
...
__inline__ struct PageInfoElement * to_page_info(uint32 va)
{
  ...
  801ccd:	a1 64 c0 81 00       	mov    0x81c064,%eax
  ...
  801cf1:	68 f0 32 80 00       	push   $0x8032f0
  801cf6:	6a 22                	push   $0x22
  801cf8:	68 d7 32 80 00       	push   $0x8032d7
  801cfd:	e8 36 0a 00 00       	call   802738 <_panic>
  ...
  801d0e:	05 60 40 80 00       	add    $0x804060,%eax
}
  801d13:	c9                   	leave  
  801d14:	c3                   	ret    
...
void initialize_dynamic_allocator(uint32 daStart, uint32 daEnd)
{
  ...
  801d28:	68 14 33 80 00       	push   $0x803314
  801d2d:	68 3a 33 80 00       	push   $0x80333a
  801d32:	6a 34                	push   $0x34
  801d34:	68 d7 32 80 00       	push   $0x8032d7
  801d39:	e8 fa 09 00 00       	call   802738 <_panic>
		is_initialized = 1;
  801d3e:	c7 05 24 40 80 00 01 	movl   $0x1,0x804024
  801d45:	00 00 00 
	//==================================================================================
	//==================================================================================
  ...
  801d4b:	a3 64 c0 81 00       	mov    %eax,0x81c064
	dynAllocEnd = daEnd;
  801d50:	8b 45 0c             	mov    0xc(%ebp),%eax
  801d53:	a3 40 40 80 00       	mov    %eax,0x804040
	// init the list that keep track of all free pageBlockInfoArr instances.
	LIST_INIT(&freePagesList);
  801d58:	c7 05 48 40 80 00 00 	movl   $0x0,0x804048
  801d5f:	00 00 00 
  801d62:	c7 05 4c 40 80 00 00 	movl   $0x0,0x80404c
  801d69:	00 00 00 
  801d6c:	c7 05 54 40 80 00 00 	movl   $0x0,0x804054
  801d73:	00 00 00 

	// no.of pages in the dynamic allocator.
	int pCount = (daEnd - daStart) / PAGE_SIZE;
  801d76:	8b 45 0c             	mov    0xc(%ebp),%eax
  801d79:	2b 45 08             	sub    0x8(%ebp),%eax
  801d7c:	c1 e8 0c             	shr    $0xc,%eax
  801d7f:	89 45 ec             	mov    %eax,-0x14(%ebp)
	// iterate over each page and init its data in pageBlockInfoArr and reset it.
	for (int i = 0; i < pCount; ++i) {
  801d82:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  801d89:	e9 c8 00 00 00       	jmp    801e56 <initialize_dynamic_allocator+0x141>
  ...
  801d9a:	05 68 40 80 00       	add    $0x804068,%eax
  801d9f:	66 c7 00 00 00       	movw   $0x0,(%eax)
  ...
  801db0:	05 6a 40 80 00       	add    $0x80406a,%eax
  801db5:	66 c7 00 00 00       	movw   $0x0,(%eax)
	    LIST_INSERT_TAIL(&freePagesList, &pageBlockInfoArr[i]);
  801dba:	8b 15 4c 40 80 00    	mov    0x80404c,%edx
  801dc0:	8b 4d f4             	mov    -0xc(%ebp),%ecx
  801dc3:	89 c8                	mov    %ecx,%eax
  801dc5:	01 c0                	add    %eax,%eax
  801dc7:	01 c8                	add    %ecx,%eax
  801dc9:	c1 e0 02             	shl    $0x2,%eax
  801dcc:	05 64 40 80 00       	add    $0x804064,%eax
  ...
  801ddf:	05 64 40 80 00       	add    $0x804064,%eax
  801de4:	8b 00                	mov    (%eax),%eax
  801de6:	85 c0                	test   %eax,%eax
  801de8:	74 1b                	je     801e05 <initialize_dynamic_allocator+0xf0>
  801dea:	8b 15 4c 40 80 00    	mov    0x80404c,%edx
  801df0:	8b 4d f4             	mov    -0xc(%ebp),%ecx
  801df3:	89 c8                	mov    %ecx,%eax
  801df5:	01 c0                	add    %eax,%eax
  801df7:	01 c8                	add    %ecx,%eax
  801df9:	c1 e0 02             	shl    $0x2,%eax
  801dfc:	05 60 40 80 00       	add    $0x804060,%eax
  801e01:	89 02                	mov    %eax,(%edx)
  801e03:	eb 16                	jmp    801e1b <initialize_dynamic_allocator+0x106>
  ...
  801e16:	a3 48 40 80 00       	mov    %eax,0x804048
  ...
  801e27:	05 60 40 80 00       	add    $0x804060,%eax
  801e2c:	a3 4c 40 80 00       	mov    %eax,0x80404c
  ...
  801e3d:	05 60 40 80 00       	add    $0x804060,%eax
  801e42:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  801e48:	a1 54 40 80 00       	mov    0x804054,%eax
  801e4d:	40                   	inc    %eax
  801e4e:	a3 54 40 80 00       	mov    %eax,0x804054
	LIST_INIT(&freePagesList);
	...
	// iterate over each page and init its data in pageBlockInfoArr and reset it.
	for (int i = 0; i < pCount; ++i) {
  801e53:	ff 45 f4             	incl   -0xc(%ebp)
  801e56:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801e59:	3b 45 ec             	cmp    -0x14(%ebp),%eax
  801e5c:	0f 8c 2c ff ff ff    	jl     801d8e <initialize_dynamic_allocator+0x79>
	    LIST_INSERT_TAIL(&freePagesList, &pageBlockInfoArr[i]);
	}
  ...
  801e62:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  801e69:	eb 36                	jmp    801ea1 <initialize_dynamic_allocator+0x18c>
		LIST_INIT(&freeBlockLists[i]);
  801e6b:	8b 45 f0             	mov    -0x10(%ebp),%eax
  801e6e:	c1 e0 04             	shl    $0x4,%eax
  801e71:	05 80 c0 81 00       	add    $0x81c080,%eax
  801e76:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  801e7c:	8b 45 f0             	mov    -0x10(%ebp),%eax
  801e7f:	c1 e0 04             	shl    $0x4,%eax
  801e82:	05 84 c0 81 00       	add    $0x81c084,%eax
  801e87:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  801e8d:	8b 45 f0             	mov    -0x10(%ebp),%eax
  801e90:	c1 e0 04             	shl    $0x4,%eax
  801e93:	05 8c c0 81 00       	add    $0x81c08c,%eax
  801e98:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
	...
	// 0 1  2  3   4  5    6   7    8
	for (int i = 0; i <= (LOG2_MAX_SIZE - LOG2_MIN_SIZE); ++i){
  801e9e:	ff 45 f0             	incl   -0x10(%ebp)
  801ea1:	83 7d f0 08          	cmpl   $0x8,-0x10(%ebp)
  801ea5:	7e c4                	jle    801e6b <initialize_dynamic_allocator+0x156>
		LIST_INIT(&freeBlockLists[i]);
	}
	//Comment the following line
...
__inline__ uint32 get_block_size(void *va)
{
  ...
  801eb6:	50                   	push   %eax
  801eb7:	e8 0b fe ff ff       	call   801cc7 <to_page_info>
...
//and putem in suitable freeblockList index according to size.
 void split_page_to_blocks(uint32 blk_size, struct PageInfoElement *pageInfo) {
  ...
  801ed9:	e8 77 fd ff ff       	call   801c55 <to_page_va>
  801ede:	83 c4 10             	add    $0x10,%esp
  801ee1:	89 45 e8             	mov    %eax,-0x18(%ebp)
	 // no. of blks to save in freeblockList.
	 int blk_count = PAGE_SIZE / blk_size;
  801ee4:	b8 00 10 00 00       	mov    $0x1000,%eax
  801ee9:	ba 00 00 00 00       	mov    $0x0,%edx
  801eee:	f7 75 08             	divl   0x8(%ebp)
  801ef1:	89 45 e4             	mov    %eax,-0x1c(%ebp)
	 // save page in memory.
	 get_page((uint32*)page_va);
  801ef4:	8b 45 e8             	mov    -0x18(%ebp),%eax
  801ef7:	83 ec 0c             	sub    $0xc,%esp
  801efa:	50                   	push   %eax
  801efb:	e8 48 f6 ff ff       	call   801548 <get_page>
  801f00:	83 c4 10             	add    $0x10,%esp
	 // assigning the pageInfo data block size, free block which is whole block count.
	 pageInfo->num_of_free_blocks = blk_count;
  801f03:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  801f06:	8b 55 0c             	mov    0xc(%ebp),%edx
  801f09:	66 89 42 0a          	mov    %ax,0xa(%edx)
	 pageInfo->block_size = blk_size;
  801f0d:	8b 45 08             	mov    0x8(%ebp),%eax
  801f10:	8b 55 0c             	mov    0xc(%ebp),%edx
  801f13:	66 89 42 08          	mov    %ax,0x8(%edx)
	 // get index by size block in freeblocklist.
	 int idx = 0;
  801f17:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
	 for (int i = LOG2_MIN_SIZE; i <= LOG2_MAX_SIZE; i++) {
  801f1e:	c7 45 f0 03 00 00 00 	movl   $0x3,-0x10(%ebp)
  801f25:	eb 19                	jmp    801f40 <split_page_to_blocks+0x73>
	     if ((1 << i) == blk_size)
  801f27:	8b 45 f0             	mov    -0x10(%ebp),%eax
  801f2a:	ba 01 00 00 00       	mov    $0x1,%edx
  801f2f:	88 c1                	mov    %al,%cl
  801f31:	d3 e2                	shl    %cl,%edx
  801f33:	89 d0                	mov    %edx,%eax
  801f35:	3b 45 08             	cmp    0x8(%ebp),%eax
  801f38:	74 0e                	je     801f48 <split_page_to_blocks+0x7b>
	         break;
	     idx++;
  801f3a:	ff 45 f4             	incl   -0xc(%ebp)
	 // assigning the pageInfo data block size, free block which is whole block count.
	 pageInfo->num_of_free_blocks = blk_count;
	 pageInfo->block_size = blk_size;
	 // get index by size block in freeblocklist.
	 int idx = 0;
	 for (int i = LOG2_MIN_SIZE; i <= LOG2_MAX_SIZE; i++) {
  801f3d:	ff 45 f0             	incl   -0x10(%ebp)
  801f40:	83 7d f0 0b          	cmpl   $0xb,-0x10(%ebp)
  801f44:	7e e1                	jle    801f27 <split_page_to_blocks+0x5a>
  801f46:	eb 01                	jmp    801f49 <split_page_to_blocks+0x7c>
	     if ((1 << i) == blk_size)
	         break;
  801f48:	90                   	nop
	     idx++;
  ...
  801f50:	e9 a7 00 00 00       	jmp    801ffc <split_page_to_blocks+0x12f>
	     struct BlockElement *blk =(struct BlockElement*)(page_va + i * blk_size);
  801f55:	8b 45 ec             	mov    -0x14(%ebp),%eax
  801f58:	0f af 45 08          	imul   0x8(%ebp),%eax
  801f5c:	89 c2                	mov    %eax,%edx
  801f5e:	8b 45 e8             	mov    -0x18(%ebp),%eax
  801f61:	01 d0                	add    %edx,%eax
  801f63:	89 45 e0             	mov    %eax,-0x20(%ebp)
	     LIST_INSERT_TAIL(&freeBlockLists[idx],blk);
  801f66:	83 7d e0 00          	cmpl   $0x0,-0x20(%ebp)
  801f6a:	75 14                	jne    801f80 <split_page_to_blocks+0xb3>
  801f6c:	83 ec 04             	sub    $0x4,%esp
  801f6f:	68 50 33 80 00       	push   $0x803350
  801f74:	6a 7c                	push   $0x7c
  801f76:	68 d7 32 80 00       	push   $0x8032d7
  801f7b:	e8 b8 07 00 00       	call   802738 <_panic>
  801f80:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801f83:	c1 e0 04             	shl    $0x4,%eax
  801f86:	05 84 c0 81 00       	add    $0x81c084,%eax
  801f8b:	8b 10                	mov    (%eax),%edx
  801f8d:	8b 45 e0             	mov    -0x20(%ebp),%eax
  801f90:	89 50 04             	mov    %edx,0x4(%eax)
  801f93:	8b 45 e0             	mov    -0x20(%ebp),%eax
  801f96:	8b 40 04             	mov    0x4(%eax),%eax
  801f99:	85 c0                	test   %eax,%eax
  801f9b:	74 14                	je     801fb1 <split_page_to_blocks+0xe4>
  801f9d:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801fa0:	c1 e0 04             	shl    $0x4,%eax
  801fa3:	05 84 c0 81 00       	add    $0x81c084,%eax
  801fa8:	8b 00                	mov    (%eax),%eax
  801faa:	8b 55 e0             	mov    -0x20(%ebp),%edx
  801fad:	89 10                	mov    %edx,(%eax)
  801faf:	eb 11                	jmp    801fc2 <split_page_to_blocks+0xf5>
  801fb1:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801fb4:	c1 e0 04             	shl    $0x4,%eax
  801fb7:	8d 90 80 c0 81 00    	lea    0x81c080(%eax),%edx
  801fbd:	8b 45 e0             	mov    -0x20(%ebp),%eax
  801fc0:	89 02                	mov    %eax,(%edx)
  801fc2:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801fc5:	c1 e0 04             	shl    $0x4,%eax
  801fc8:	8d 90 84 c0 81 00    	lea    0x81c084(%eax),%edx
  801fce:	8b 45 e0             	mov    -0x20(%ebp),%eax
  801fd1:	89 02                	mov    %eax,(%edx)
  801fd3:	8b 45 e0             	mov    -0x20(%ebp),%eax
  801fd6:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  801fdc:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801fdf:	c1 e0 04             	shl    $0x4,%eax
  801fe2:	05 8c c0 81 00       	add    $0x81c08c,%eax
  801fe7:	8b 00                	mov    (%eax),%eax
  801fe9:	8d 50 01             	lea    0x1(%eax),%edx
  801fec:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801fef:	c1 e0 04             	shl    $0x4,%eax
  801ff2:	05 8c c0 81 00       	add    $0x81c08c,%eax
  801ff7:	89 10                	mov    %edx,(%eax)
	 ...
	 // starting from the page_va.
	 for (uint32 i = 0; i < blk_count; ++i) {
  801ff9:	ff 45 ec             	incl   -0x14(%ebp)
  801ffc:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  801fff:	39 45 ec             	cmp    %eax,-0x14(%ebp)
  802002:	0f 82 4d ff ff ff    	jb     801f55 <split_page_to_blocks+0x88>
	     struct BlockElement *blk =(struct BlockElement*)(page_va + i * blk_size);
	     LIST_INSERT_TAIL(&freeBlockLists[idx],blk);
	 }
 }
...
void *alloc_block(uint32 size)
{
  ...
  80200e:	83 ec 38             	sub    $0x38,%esp
	//==================================================================================
	//DON'T CHANGE THESE LINES==========================================================
	//==================================================================================
	{
		assert(size <= DYN_ALLOC_MAX_BLOCK_SIZE);
  802011:	81 7d 08 00 08 00 00 	cmpl   $0x800,0x8(%ebp)
  802018:	76 19                	jbe    802033 <alloc_block+0x28>
  80201a:	68 74 33 80 00       	push   $0x803374
  80201f:	68 3a 33 80 00       	push   $0x80333a
  802024:	68 8a 00 00 00       	push   $0x8a
  802029:	68 d7 32 80 00       	push   $0x8032d7
  80202e:	e8 05 07 00 00       	call   802738 <_panic>
	//==================================================================================
  ...
  802033:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
	for (int i = LOG2_MIN_SIZE; i <= LOG2_MAX_SIZE; ++i){
  80203a:	c7 45 f0 03 00 00 00 	movl   $0x3,-0x10(%ebp)
  802041:	eb 19                	jmp    80205c <alloc_block+0x51>
		if((1 << i) >= size) break;
  802043:	8b 45 f0             	mov    -0x10(%ebp),%eax
  802046:	ba 01 00 00 00       	mov    $0x1,%edx
  80204b:	88 c1                	mov    %al,%cl
  80204d:	d3 e2                	shl    %cl,%edx
  80204f:	89 d0                	mov    %edx,%eax
  802051:	3b 45 08             	cmp    0x8(%ebp),%eax
  802054:	73 0e                	jae    802064 <alloc_block+0x59>
		idx++;
  802056:	ff 45 f4             	incl   -0xc(%ebp)
	//TODO: [PROJECT'25.GM#1] DYNAMIC ALLOCATOR - #3 alloc_block
	//Your code is here
	//Comment the following line
	// get index in freeBlockList by size.
	uint32 idx = 0;
	for (int i = LOG2_MIN_SIZE; i <= LOG2_MAX_SIZE; ++i){
  802059:	ff 45 f0             	incl   -0x10(%ebp)
  80205c:	83 7d f0 0b          	cmpl   $0xb,-0x10(%ebp)
  802060:	7e e1                	jle    802043 <alloc_block+0x38>
  802062:	eb 01                	jmp    802065 <alloc_block+0x5a>
		if((1 << i) >= size) break;
  802064:	90                   	nop
		idx++;
	}
  ...
  80206b:	05 8c c0 81 00       	add    $0x81c08c,%eax
  802070:	8b 00                	mov    (%eax),%eax
  802072:	85 c0                	test   %eax,%eax
  802074:	0f 84 df 00 00 00    	je     802159 <alloc_block+0x14e>
  ...
  802080:	05 80 c0 81 00       	add    $0x81c080,%eax
  802085:	8b 00                	mov    (%eax),%eax
  802087:	89 45 ec             	mov    %eax,-0x14(%ebp)
	    LIST_REMOVE(&freeBlockLists[idx], blk);
  80208a:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
  80208e:	75 17                	jne    8020a7 <alloc_block+0x9c>
  802090:	83 ec 04             	sub    $0x4,%esp
  802093:	68 95 33 80 00       	push   $0x803395
  802098:	68 9e 00 00 00       	push   $0x9e
  80209d:	68 d7 32 80 00       	push   $0x8032d7
  8020a2:	e8 91 06 00 00       	call   802738 <_panic>
  8020a7:	8b 45 ec             	mov    -0x14(%ebp),%eax
  8020aa:	8b 00                	mov    (%eax),%eax
  8020ac:	85 c0                	test   %eax,%eax
  8020ae:	74 10                	je     8020c0 <alloc_block+0xb5>
  8020b0:	8b 45 ec             	mov    -0x14(%ebp),%eax
  8020b3:	8b 00                	mov    (%eax),%eax
  8020b5:	8b 55 ec             	mov    -0x14(%ebp),%edx
  8020b8:	8b 52 04             	mov    0x4(%edx),%edx
  8020bb:	89 50 04             	mov    %edx,0x4(%eax)
  8020be:	eb 14                	jmp    8020d4 <alloc_block+0xc9>
  ...
  802116:	c1 e0 04             	shl    $0x4,%eax
  802119:	05 8c c0 81 00       	add    $0x81c08c,%eax
  80211e:	8b 00                	mov    (%eax),%eax
  802120:	8d 50 ff             	lea    -0x1(%eax),%edx
  802123:	8b 45 f4             	mov    -0xc(%ebp),%eax
  802126:	c1 e0 04             	shl    $0x4,%eax
  802129:	05 8c c0 81 00       	add    $0x81c08c,%eax
  ...
  802136:	50                   	push   %eax
  802137:	e8 8b fb ff ff       	call   801cc7 <to_page_info>
  80213c:	83 c4 10             	add    $0x10,%esp
  80213f:	89 45 e8             	mov    %eax,-0x18(%ebp)
	    pageInfo->num_of_free_blocks--;
  802142:	8b 45 e8             	mov    -0x18(%ebp),%eax
  802145:	66 8b 40 0a          	mov    0xa(%eax),%ax
  802149:	48                   	dec    %eax
  80214a:	8b 55 e8             	mov    -0x18(%ebp),%edx
  80214d:	66 89 42 0a          	mov    %ax,0xa(%edx)
	    return blk;
  802151:	8b 45 ec             	mov    -0x14(%ebp),%eax
  802154:	e9 bc 02 00 00       	jmp    802415 <alloc_block+0x40a>
	}else{ //case(2, 3): 2. no free blocks available in the freeblocklist but there is free pages.
				//3. no free blocks and no available freepages so search in higher block sizes.
		// case 2:
		if(freePagesList.size > 0){ //have free pages.
  802159:	a1 54 40 80 00       	mov    0x804054,%eax
  80215e:	85 c0                	test   %eax,%eax
  802160:	0f 84 7d 02 00 00    	je     8023e3 <alloc_block+0x3d8>
			// get page to split and use from freepagesList.
			struct PageInfoElement *ptr_new_page = LIST_FIRST(&freePagesList);
  802166:	a1 48 40 80 00       	mov    0x804048,%eax
  80216b:	89 45 e4             	mov    %eax,-0x1c(%ebp)
			LIST_REMOVE(&freePagesList, ptr_new_page);
  80216e:	83 7d e4 00          	cmpl   $0x0,-0x1c(%ebp)
  802172:	75 17                	jne    80218b <alloc_block+0x180>
  802174:	83 ec 04             	sub    $0x4,%esp
  802177:	68 95 33 80 00       	push   $0x803395
  80217c:	68 a9 00 00 00       	push   $0xa9
  802181:	68 d7 32 80 00       	push   $0x8032d7
  802186:	e8 ad 05 00 00       	call   802738 <_panic>
  80218b:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  80218e:	8b 00                	mov    (%eax),%eax
  802190:	85 c0                	test   %eax,%eax
  802192:	74 10                	je     8021a4 <alloc_block+0x199>
  ...
  8021a2:	eb 0b                	jmp    8021af <alloc_block+0x1a4>
  ...
  8021b7:	74 0f                	je     8021c8 <alloc_block+0x1bd>
  ...
  8021c6:	eb 0a                	jmp    8021d2 <alloc_block+0x1c7>
  8021c8:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  8021cb:	8b 00                	mov    (%eax),%eax
  8021cd:	a3 48 40 80 00       	mov    %eax,0x804048
  ...
  8021e5:	a1 54 40 80 00       	mov    0x804054,%eax
  8021ea:	48                   	dec    %eax
  8021eb:	a3 54 40 80 00       	mov    %eax,0x804054
			// from page to freeblockList by the pageInfo and the block size.
			split_page_to_blocks(1 << (idx + LOG2_MIN_SIZE), ptr_new_page);
  8021f0:	8b 45 f4             	mov    -0xc(%ebp),%eax
  8021f3:	83 c0 03             	add    $0x3,%eax
  8021f6:	ba 01 00 00 00       	mov    $0x1,%edx
  8021fb:	88 c1                	mov    %al,%cl
  8021fd:	d3 e2                	shl    %cl,%edx
  8021ff:	89 d0                	mov    %edx,%eax
  802201:	83 ec 08             	sub    $0x8,%esp
  802204:	ff 75 e4             	pushl  -0x1c(%ebp)
  802207:	50                   	push   %eax
  802208:	e8 c0 fc ff ff       	call   801ecd <split_page_to_blocks>
  ...
  802216:	05 80 c0 81 00       	add    $0x81c080,%eax
  80221b:	8b 00                	mov    (%eax),%eax
  80221d:	89 45 e0             	mov    %eax,-0x20(%ebp)
		    LIST_REMOVE(&freeBlockLists[idx], blk);
  802220:	83 7d e0 00          	cmpl   $0x0,-0x20(%ebp)
  802224:	75 17                	jne    80223d <alloc_block+0x232>
  802226:	83 ec 04             	sub    $0x4,%esp
  802229:	68 95 33 80 00       	push   $0x803395
  80222e:	68 b0 00 00 00       	push   $0xb0
  802233:	68 d7 32 80 00       	push   $0x8032d7
  802238:	e8 fb 04 00 00       	call   802738 <_panic>
  80223d:	8b 45 e0             	mov    -0x20(%ebp),%eax
  802240:	8b 00                	mov    (%eax),%eax
  802242:	85 c0                	test   %eax,%eax
  802244:	74 10                	je     802256 <alloc_block+0x24b>
  ...
  802254:	eb 14                	jmp    80226a <alloc_block+0x25f>
  ...
  802262:	81 c2 84 c0 81 00    	add    $0x81c084,%edx
  802268:	89 02                	mov    %eax,(%edx)
  80226a:	8b 45 e0             	mov    -0x20(%ebp),%eax
  80226d:	8b 40 04             	mov    0x4(%eax),%eax
  802270:	85 c0                	test   %eax,%eax
  802272:	74 0f                	je     802283 <alloc_block+0x278>
  802274:	8b 45 e0             	mov    -0x20(%ebp),%eax
  802277:	8b 40 04             	mov    0x4(%eax),%eax
  80227a:	8b 55 e0             	mov    -0x20(%ebp),%edx
  80227d:	8b 12                	mov    (%edx),%edx
  80227f:	89 10                	mov    %edx,(%eax)
  802281:	eb 13                	jmp    802296 <alloc_block+0x28b>
  802283:	8b 45 e0             	mov    -0x20(%ebp),%eax
  802286:	8b 00                	mov    (%eax),%eax
  802288:	8b 55 f4             	mov    -0xc(%ebp),%edx
  80228b:	c1 e2 04             	shl    $0x4,%edx
  80228e:	81 c2 80 c0 81 00    	add    $0x81c080,%edx
  802294:	89 02                	mov    %eax,(%edx)
  802296:	8b 45 e0             	mov    -0x20(%ebp),%eax
  802299:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  80229f:	8b 45 e0             	mov    -0x20(%ebp),%eax
  8022a2:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
  8022a9:	8b 45 f4             	mov    -0xc(%ebp),%eax
  8022ac:	c1 e0 04             	shl    $0x4,%eax
  8022af:	05 8c c0 81 00       	add    $0x81c08c,%eax
  8022b4:	8b 00                	mov    (%eax),%eax
  8022b6:	8d 50 ff             	lea    -0x1(%eax),%edx
  8022b9:	8b 45 f4             	mov    -0xc(%ebp),%eax
  8022bc:	c1 e0 04             	shl    $0x4,%eax
  8022bf:	05 8c c0 81 00       	add    $0x81c08c,%eax
  8022c4:	89 10                	mov    %edx,(%eax)
		    // update pageBlockInfoArr
		    struct PageInfoElement *pageInfo = to_page_info((uint32)blk);
  8022c6:	8b 45 e0             	mov    -0x20(%ebp),%eax
  8022c9:	83 ec 0c             	sub    $0xc,%esp
  8022cc:	50                   	push   %eax
  8022cd:	e8 f5 f9 ff ff       	call   801cc7 <to_page_info>
  8022d2:	83 c4 10             	add    $0x10,%esp
  8022d5:	89 45 dc             	mov    %eax,-0x24(%ebp)
		    pageInfo->num_of_free_blocks--;
  8022d8:	8b 45 dc             	mov    -0x24(%ebp),%eax
  8022db:	66 8b 40 0a          	mov    0xa(%eax),%ax
  8022df:	48                   	dec    %eax
  8022e0:	8b 55 dc             	mov    -0x24(%ebp),%edx
  8022e3:	66 89 42 0a          	mov    %ax,0xa(%edx)
		    return blk;
  8022e7:	8b 45 e0             	mov    -0x20(%ebp),%eax
  8022ea:	e9 26 01 00 00       	jmp    802415 <alloc_block+0x40a>
		}else{//case 3: no free block and no free page so iterate and try to find bigger size.
			// iterate over the list until finding available block
			while (idx <= (LOG2_MAX_SIZE - LOG2_MIN_SIZE) && freeBlockLists[idx].size == 0) {
				idx++;
  8022ef:	ff 45 f4             	incl   -0xc(%ebp)
				// found free block
				if(freeBlockLists[idx].size > 0){
  ...
  802301:	0f 84 dc 00 00 00    	je     8023e3 <alloc_block+0x3d8>
					// remove from the list and updat the pageInfoArr free blocks.
					// pop from the freeBlockList.
					struct BlockElement *blk = LIST_FIRST(&freeBlockLists[idx]);
  802307:	8b 45 f4             	mov    -0xc(%ebp),%eax
  80230a:	c1 e0 04             	shl    $0x4,%eax
  80230d:	05 80 c0 81 00       	add    $0x81c080,%eax
  802312:	8b 00                	mov    (%eax),%eax
  802314:	89 45 d8             	mov    %eax,-0x28(%ebp)
				    LIST_REMOVE(&freeBlockLists[idx], blk);
  802317:	83 7d d8 00          	cmpl   $0x0,-0x28(%ebp)
  80231b:	75 17                	jne    802334 <alloc_block+0x329>
  80231d:	83 ec 04             	sub    $0x4,%esp
  802320:	68 95 33 80 00       	push   $0x803395
  802325:	68 be 00 00 00       	push   $0xbe
  80232a:	68 d7 32 80 00       	push   $0x8032d7
  80232f:	e8 04 04 00 00       	call   802738 <_panic>
  802334:	8b 45 d8             	mov    -0x28(%ebp),%eax
  802337:	8b 00                	mov    (%eax),%eax
  802339:	85 c0                	test   %eax,%eax
  80233b:	74 10                	je     80234d <alloc_block+0x342>
  ...
  80234b:	eb 14                	jmp    802361 <alloc_block+0x356>
  ...
  802359:	81 c2 84 c0 81 00    	add    $0x81c084,%edx
  80235f:	89 02                	mov    %eax,(%edx)
  802361:	8b 45 d8             	mov    -0x28(%ebp),%eax
  802364:	8b 40 04             	mov    0x4(%eax),%eax
  802367:	85 c0                	test   %eax,%eax
  802369:	74 0f                	je     80237a <alloc_block+0x36f>
  80236b:	8b 45 d8             	mov    -0x28(%ebp),%eax
  80236e:	8b 40 04             	mov    0x4(%eax),%eax
  802371:	8b 55 d8             	mov    -0x28(%ebp),%edx
  802374:	8b 12                	mov    (%edx),%edx
  802376:	89 10                	mov    %edx,(%eax)
  802378:	eb 13                	jmp    80238d <alloc_block+0x382>
  80237a:	8b 45 d8             	mov    -0x28(%ebp),%eax
  80237d:	8b 00                	mov    (%eax),%eax
  80237f:	8b 55 f4             	mov    -0xc(%ebp),%edx
  802382:	c1 e2 04             	shl    $0x4,%edx
  802385:	81 c2 80 c0 81 00    	add    $0x81c080,%edx
  80238b:	89 02                	mov    %eax,(%edx)
  80238d:	8b 45 d8             	mov    -0x28(%ebp),%eax
  802390:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  802396:	8b 45 d8             	mov    -0x28(%ebp),%eax
  802399:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
  8023a0:	8b 45 f4             	mov    -0xc(%ebp),%eax
  8023a3:	c1 e0 04             	shl    $0x4,%eax
  8023a6:	05 8c c0 81 00       	add    $0x81c08c,%eax
  8023ab:	8b 00                	mov    (%eax),%eax
  8023ad:	8d 50 ff             	lea    -0x1(%eax),%edx
  8023b0:	8b 45 f4             	mov    -0xc(%ebp),%eax
  8023b3:	c1 e0 04             	shl    $0x4,%eax
  8023b6:	05 8c c0 81 00       	add    $0x81c08c,%eax
  8023bb:	89 10                	mov    %edx,(%eax)
				    // update pageBlockInfoArr
				    struct PageInfoElement *pageInfo = to_page_info((uint32)blk);
  8023bd:	8b 45 d8             	mov    -0x28(%ebp),%eax
  8023c0:	83 ec 0c             	sub    $0xc,%esp
  8023c3:	50                   	push   %eax
  8023c4:	e8 fe f8 ff ff       	call   801cc7 <to_page_info>
  8023c9:	83 c4 10             	add    $0x10,%esp
  8023cc:	89 45 d4             	mov    %eax,-0x2c(%ebp)
				    pageInfo->num_of_free_blocks--;
  8023cf:	8b 45 d4             	mov    -0x2c(%ebp),%eax
  8023d2:	66 8b 40 0a          	mov    0xa(%eax),%ax
  8023d6:	48                   	dec    %eax
  8023d7:	8b 55 d4             	mov    -0x2c(%ebp),%edx
  8023da:	66 89 42 0a          	mov    %ax,0xa(%edx)
				    return blk;
  8023de:	8b 45 d8             	mov    -0x28(%ebp),%eax
  8023e1:	eb 32                	jmp    802415 <alloc_block+0x40a>
		    struct PageInfoElement *pageInfo = to_page_info((uint32)blk);
		    pageInfo->num_of_free_blocks--;
		    return blk;
		}else{//case 3: no free block and no free page so iterate and try to find bigger size.
			// iterate over the list until finding available block
			while (idx <= (LOG2_MAX_SIZE - LOG2_MIN_SIZE) && freeBlockLists[idx].size == 0) {
  8023e3:	83 7d f4 08          	cmpl   $0x8,-0xc(%ebp)
  8023e7:	77 15                	ja     8023fe <alloc_block+0x3f3>
  ...
  8023f8:	0f 84 f1 fe ff ff    	je     8022ef <alloc_block+0x2e4>
				}
			}
		}
	}
  ...
  802401:	68 b3 33 80 00       	push   $0x8033b3
  802406:	68 c8 00 00 00       	push   $0xc8
  80240b:	68 d7 32 80 00       	push   $0x8032d7
  802410:	e8 23 03 00 00       	call   802738 <_panic>
...
void free_block(void *va)
{
  ...
  802420:	a1 64 c0 81 00       	mov    0x81c064,%eax
  802425:	39 c2                	cmp    %eax,%edx
  802427:	72 0c                	jb     802435 <free_block+0x1e>
  802429:	8b 55 08             	mov    0x8(%ebp),%edx
  80242c:	a1 40 40 80 00       	mov    0x804040,%eax
  802431:	39 c2                	cmp    %eax,%edx
  802433:	72 19                	jb     80244e <free_block+0x37>
  802435:	68 c4 33 80 00       	push   $0x8033c4
  80243a:	68 3a 33 80 00       	push   $0x80333a
  80243f:	68 d7 00 00 00       	push   $0xd7
  802444:	68 d7 32 80 00       	push   $0x8032d7
  802449:	e8 ea 02 00 00       	call   802738 <_panic>
  ...
  80245a:	50                   	push   %eax
  80245b:	e8 67 f8 ff ff       	call   801cc7 <to_page_info>
  ...
  802472:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
	for (int i = LOG2_MIN_SIZE; i <= LOG2_MAX_SIZE; i++) {
  802479:	c7 45 f0 03 00 00 00 	movl   $0x3,-0x10(%ebp)
  802480:	eb 19                	jmp    80249b <free_block+0x84>
	    if ((1 << i) == blk_size)
  ...
  802490:	3b 45 e0             	cmp    -0x20(%ebp),%eax
  802493:	74 0e                	je     8024a3 <free_block+0x8c>
	        break;
	    idx++;
  802495:	ff 45 f4             	incl   -0xc(%ebp)
	...
	int idx = 0;
	for (int i = LOG2_MIN_SIZE; i <= LOG2_MAX_SIZE; i++) {
  802498:	ff 45 f0             	incl   -0x10(%ebp)
  80249b:	83 7d f0 0b          	cmpl   $0xb,-0x10(%ebp)
  80249f:	7e e1                	jle    802482 <free_block+0x6b>
  8024a1:	eb 01                	jmp    8024a4 <free_block+0x8d>
	    if ((1 << i) == blk_size)
	        break;
  8024a3:	90                   	nop
	    idx++;
  ...
  8024a7:	66 8b 40 0a          	mov    0xa(%eax),%ax
  8024ab:	40                   	inc    %eax
  8024ac:	8b 55 e4             	mov    -0x1c(%ebp),%edx
  8024af:	66 89 42 0a          	mov    %ax,0xa(%edx)
	LIST_INSERT_TAIL(&freeBlockLists[idx], blk_to_free);
  8024b3:	83 7d e8 00          	cmpl   $0x0,-0x18(%ebp)
  8024b7:	75 17                	jne    8024d0 <free_block+0xb9>
  8024b9:	83 ec 04             	sub    $0x4,%esp
  8024bc:	68 50 33 80 00       	push   $0x803350
  8024c1:	68 ee 00 00 00       	push   $0xee
  8024c6:	68 d7 32 80 00       	push   $0x8032d7
  8024cb:	e8 68 02 00 00       	call   802738 <_panic>
  8024d0:	8b 45 f4             	mov    -0xc(%ebp),%eax
  8024d3:	c1 e0 04             	shl    $0x4,%eax
  8024d6:	05 84 c0 81 00       	add    $0x81c084,%eax
  8024db:	8b 10                	mov    (%eax),%edx
  ...
  8024eb:	74 14                	je     802501 <free_block+0xea>
  8024ed:	8b 45 f4             	mov    -0xc(%ebp),%eax
  8024f0:	c1 e0 04             	shl    $0x4,%eax
  8024f3:	05 84 c0 81 00       	add    $0x81c084,%eax
  8024f8:	8b 00                	mov    (%eax),%eax
  8024fa:	8b 55 e8             	mov    -0x18(%ebp),%edx
  8024fd:	89 10                	mov    %edx,(%eax)
  8024ff:	eb 11                	jmp    802512 <free_block+0xfb>
  802501:	8b 45 f4             	mov    -0xc(%ebp),%eax
  802504:	c1 e0 04             	shl    $0x4,%eax
  802507:	8d 90 80 c0 81 00    	lea    0x81c080(%eax),%edx
  80250d:	8b 45 e8             	mov    -0x18(%ebp),%eax
  802510:	89 02                	mov    %eax,(%edx)
  802512:	8b 45 f4             	mov    -0xc(%ebp),%eax
  802515:	c1 e0 04             	shl    $0x4,%eax
  802518:	8d 90 84 c0 81 00    	lea    0x81c084(%eax),%edx
  80251e:	8b 45 e8             	mov    -0x18(%ebp),%eax
  802521:	89 02                	mov    %eax,(%edx)
  802523:	8b 45 e8             	mov    -0x18(%ebp),%eax
  802526:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  80252c:	8b 45 f4             	mov    -0xc(%ebp),%eax
  80252f:	c1 e0 04             	shl    $0x4,%eax
  802532:	05 8c c0 81 00       	add    $0x81c08c,%eax
  802537:	8b 00                	mov    (%eax),%eax
  802539:	8d 50 01             	lea    0x1(%eax),%edx
  80253c:	8b 45 f4             	mov    -0xc(%ebp),%eax
  80253f:	c1 e0 04             	shl    $0x4,%eax
  802542:	05 8c c0 81 00       	add    $0x81c08c,%eax
  802547:	89 10                	mov    %edx,(%eax)

	// now, case 1: the page all blocks are freed so you free the page.
	int blk_count = PAGE_SIZE / blk_size;
  802549:	b8 00 10 00 00       	mov    $0x1000,%eax
  80254e:	ba 00 00 00 00       	mov    $0x0,%edx
  802553:	f7 75 e0             	divl   -0x20(%ebp)
  802556:	89 45 dc             	mov    %eax,-0x24(%ebp)
	// the blk count in the page is same as number fo free blocks free up the page.
	if (pageInfo->num_of_free_blocks == blk_count) {
  802559:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  80255c:	66 8b 40 0a          	mov    0xa(%eax),%ax
  802560:	0f b7 c0             	movzwl %ax,%eax
  802563:	3b 45 dc             	cmp    -0x24(%ebp),%eax
  802566:	0f 85 70 01 00 00    	jne    8026dc <free_block+0x2c5>
		uint32 page_va = to_page_va(pageInfo);
  80256c:	83 ec 0c             	sub    $0xc,%esp
  80256f:	ff 75 e4             	pushl  -0x1c(%ebp)
  802572:	e8 de f6 ff ff       	call   801c55 <to_page_va>
  802577:	83 c4 10             	add    $0x10,%esp
  80257a:	89 45 d8             	mov    %eax,-0x28(%ebp)
		// remove all blk in the freeBlockList.
		for (uint32 off = 0; off < PAGE_SIZE; off += blk_size) {
  80257d:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  802584:	e9 b7 00 00 00       	jmp    802640 <free_block+0x229>
  ...
  802591:	89 45 d4             	mov    %eax,-0x2c(%ebp)
			LIST_REMOVE(&freeBlockLists[idx], blk);
  802594:	83 7d d4 00          	cmpl   $0x0,-0x2c(%ebp)
  802598:	75 17                	jne    8025b1 <free_block+0x19a>
  80259a:	83 ec 04             	sub    $0x4,%esp
  80259d:	68 95 33 80 00       	push   $0x803395
  8025a2:	68 f8 00 00 00       	push   $0xf8
  8025a7:	68 d7 32 80 00       	push   $0x8032d7
  8025ac:	e8 87 01 00 00       	call   802738 <_panic>
  8025b1:	8b 45 d4             	mov    -0x2c(%ebp),%eax
  8025b4:	8b 00                	mov    (%eax),%eax
  8025b6:	85 c0                	test   %eax,%eax
  8025b8:	74 10                	je     8025ca <free_block+0x1b3>
  ...
  8025c8:	eb 14                	jmp    8025de <free_block+0x1c7>
  ...
  80263d:	01 45 ec             	add    %eax,-0x14(%ebp)
  802640:	81 7d ec ff 0f 00 00 	cmpl   $0xfff,-0x14(%ebp)
  802647:	0f 86 3c ff ff ff    	jbe    802589 <free_block+0x172>
			struct BlockElement *blk = (struct BlockElement*)(page_va + off);
			LIST_REMOVE(&freeBlockLists[idx], blk);
		}
		// reset page info.
  ...
  802650:	66 c7 40 08 00 00    	movw   $0x0,0x8(%eax)
		pageInfo->num_of_free_blocks = 0;
  802656:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  802659:	66 c7 40 0a 00 00    	movw   $0x0,0xa(%eax)
		// add it to the available pages.
		LIST_INSERT_TAIL(&freePagesList, pageInfo);
  80265f:	83 7d e4 00          	cmpl   $0x0,-0x1c(%ebp)
  802663:	75 17                	jne    80267c <free_block+0x265>
  802665:	83 ec 04             	sub    $0x4,%esp
  802668:	68 50 33 80 00       	push   $0x803350
  80266d:	68 fe 00 00 00       	push   $0xfe
  802672:	68 d7 32 80 00       	push   $0x8032d7
  802677:	e8 bc 00 00 00       	call   802738 <_panic>
  80267c:	8b 15 4c 40 80 00    	mov    0x80404c,%edx
  ...
  802690:	74 0c                	je     80269e <free_block+0x287>
  802692:	a1 4c 40 80 00       	mov    0x80404c,%eax
  802697:	8b 55 e4             	mov    -0x1c(%ebp),%edx
  80269a:	89 10                	mov    %edx,(%eax)
  80269c:	eb 08                	jmp    8026a6 <free_block+0x28f>
  80269e:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  8026a1:	a3 48 40 80 00       	mov    %eax,0x804048
  8026a6:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  8026a9:	a3 4c 40 80 00       	mov    %eax,0x80404c
  8026ae:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  8026b1:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  8026b7:	a1 54 40 80 00       	mov    0x804054,%eax
  8026bc:	40                   	inc    %eax
  8026bd:	a3 54 40 80 00       	mov    %eax,0x804054
		// make it available in memory.
		return_page((uint32 *)to_page_va(pageInfo));
  8026c2:	83 ec 0c             	sub    $0xc,%esp
  8026c5:	ff 75 e4             	pushl  -0x1c(%ebp)
  8026c8:	e8 88 f5 ff ff       	call   801c55 <to_page_va>
  8026cd:	83 c4 10             	add    $0x10,%esp
  8026d0:	83 ec 0c             	sub    $0xc,%esp
  8026d3:	50                   	push   %eax
  8026d4:	e8 b8 ee ff ff       	call   801591 <return_page>
...
void *realloc_block(void* va, uint32 new_size)
{
  ...
  8026e8:	68 fc 33 80 00       	push   $0x8033fc
  8026ed:	68 11 01 00 00       	push   $0x111
  8026f2:	68 d7 32 80 00       	push   $0x8032d7
  8026f7:	e8 3c 00 00 00       	call   802738 <_panic>
...
cputchar(int ch)
{
  ...
  802705:	88 45 f7             	mov    %al,-0x9(%ebp)
	...
	sys_cputc(c);
  802708:	0f be 45 f7          	movsbl -0x9(%ebp),%eax
  80270c:	83 ec 0c             	sub    $0xc,%esp
  80270f:	50                   	push   %eax
  802710:	e8 4d f1 ff ff       	call   801862 <sys_cputc>
...
getchar(void)
{
  ...
  80271e:	83 ec 18             	sub    $0x18,%esp
	int c =sys_cgetc();
  802721:	e8 db ef ff ff       	call   801701 <sys_cgetc>
...
_panic(const char *file, int line, const char *fmt,...)
{
  ...
  802741:	83 c0 04             	add    $0x4,%eax
  802744:	89 45 f4             	mov    %eax,-0xc(%ebp)
	// Print the panic message
	if (argv0)
  802747:	a1 1c c1 81 00       	mov    0x81c11c,%eax
  80274c:	85 c0                	test   %eax,%eax
  80274e:	74 16                	je     802766 <_panic+0x2e>
		cprintf("%s: ", argv0);
  802750:	a1 1c c1 81 00       	mov    0x81c11c,%eax
  802755:	83 ec 08             	sub    $0x8,%esp
  802758:	50                   	push   %eax
  802759:	68 20 34 80 00       	push   $0x803420
  80275e:	e8 a4 dc ff ff       	call   800407 <cprintf>
  802763:	83 c4 10             	add    $0x10,%esp
	cprintf_colored(TEXT_PANIC_CLR, "user [EVAL_FINAL]panic in %s at %s:%d: ", binaryname, file, line);
  802766:	a1 04 40 80 00       	mov    0x804004,%eax
  80276b:	83 ec 0c             	sub    $0xc,%esp
  80276e:	ff 75 0c             	pushl  0xc(%ebp)
  802771:	ff 75 08             	pushl  0x8(%ebp)
  802774:	50                   	push   %eax
  802775:	68 28 34 80 00       	push   $0x803428
  80277a:	6a 74                	push   $0x74
  80277c:	e8 b3 dc ff ff       	call   800434 <cprintf_colored>
  ...
  80278d:	50                   	push   %eax
  80278e:	e8 05 dc ff ff       	call   800398 <vcprintf>
  802793:	83 c4 10             	add    $0x10,%esp
	vcprintf("\n", NULL);
  802796:	83 ec 08             	sub    $0x8,%esp
  802799:	6a 00                	push   $0x0
  80279b:	68 50 34 80 00       	push   $0x803450
  8027a0:	e8 f3 db ff ff       	call   800398 <vcprintf>
...
//		asm volatile("int3");
	...
	exit() ;
  8027a8:	e8 6c db ff ff       	call   800319 <exit>

	// should not return here
	while (1) ;
  8027ad:	eb fe                	jmp    8027ad <_panic+0x75>

008027af <CheckWSArrayWithoutLastIndex>:
}
...
void CheckWSArrayWithoutLastIndex(uint32 *expectedPages, int arraySize)
{
  ...
  8027b5:	a1 20 40 80 00       	mov    0x804020,%eax
  8027ba:	8b 90 84 00 00 00    	mov    0x84(%eax),%edx
  8027c0:	8b 45 0c             	mov    0xc(%ebp),%eax
  8027c3:	39 c2                	cmp    %eax,%edx
  8027c5:	74 14                	je     8027db <CheckWSArrayWithoutLastIndex+0x2c>
	{
		panic("number of expected pages SHOULD BE EQUAL to max WS size... review your TA!!");
  8027c7:	83 ec 04             	sub    $0x4,%esp
  8027ca:	68 54 34 80 00       	push   $0x803454
  8027cf:	6a 26                	push   $0x26
  8027d1:	68 a0 34 80 00       	push   $0x8034a0
  8027d6:	e8 5d ff ff ff       	call   802738 <_panic>
	}
	int expectedNumOfEmptyLocs = 0;
  8027db:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
	for (int e = 0; e < arraySize; e++) {
  8027e2:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  8027e9:	e9 c5 00 00 00       	jmp    8028b3 <CheckWSArrayWithoutLastIndex+0x104>
		if (expectedPages[e] == 0) {
  8027ee:	8b 45 f0             	mov    -0x10(%ebp),%eax
  8027f1:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
  8027f8:	8b 45 08             	mov    0x8(%ebp),%eax
  8027fb:	01 d0                	add    %edx,%eax
  8027fd:	8b 00                	mov    (%eax),%eax
  8027ff:	85 c0                	test   %eax,%eax
  802801:	75 08                	jne    80280b <CheckWSArrayWithoutLastIndex+0x5c>
			expectedNumOfEmptyLocs++;
  802803:	ff 45 f4             	incl   -0xc(%ebp)
			continue;
  802806:	e9 a5 00 00 00       	jmp    8028b0 <CheckWSArrayWithoutLastIndex+0x101>
		}
		int found = 0;
  80280b:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
		for (int w = 0; w < myEnv->page_WS_max_size; w++) {
  802812:	c7 45 e8 00 00 00 00 	movl   $0x0,-0x18(%ebp)
  802819:	eb 69                	jmp    802884 <CheckWSArrayWithoutLastIndex+0xd5>
			if (myEnv->__uptr_pws[w].empty == 0) {
  80281b:	a1 20 40 80 00       	mov    0x804020,%eax
  802820:	8b 88 90 05 00 00    	mov    0x590(%eax),%ecx
  802826:	8b 55 e8             	mov    -0x18(%ebp),%edx
  802829:	89 d0                	mov    %edx,%eax
  80282b:	01 c0                	add    %eax,%eax
  80282d:	01 d0                	add    %edx,%eax
  80282f:	c1 e0 03             	shl    $0x3,%eax
  802832:	01 c8                	add    %ecx,%eax
  802834:	8a 40 04             	mov    0x4(%eax),%al
  802837:	84 c0                	test   %al,%al
  802839:	75 46                	jne    802881 <CheckWSArrayWithoutLastIndex+0xd2>
				if (ROUNDDOWN(myEnv->__uptr_pws[w].virtual_address, PAGE_SIZE)
  80283b:	a1 20 40 80 00       	mov    0x804020,%eax
  802840:	8b 88 90 05 00 00    	mov    0x590(%eax),%ecx
  802846:	8b 55 e8             	mov    -0x18(%ebp),%edx
  802849:	89 d0                	mov    %edx,%eax
  80284b:	01 c0                	add    %eax,%eax
  80284d:	01 d0                	add    %edx,%eax
  80284f:	c1 e0 03             	shl    $0x3,%eax
  802852:	01 c8                	add    %ecx,%eax
  802854:	8b 00                	mov    (%eax),%eax
  802856:	89 45 dc             	mov    %eax,-0x24(%ebp)
  802859:	8b 45 dc             	mov    -0x24(%ebp),%eax
  80285c:	25 00 f0 ff ff       	and    $0xfffff000,%eax
  802861:	89 c2                	mov    %eax,%edx
						== expectedPages[e]) {
  802863:	8b 45 f0             	mov    -0x10(%ebp),%eax
  802866:	8d 0c 85 00 00 00 00 	lea    0x0(,%eax,4),%ecx
  ...
  802876:	75 09                	jne    802881 <CheckWSArrayWithoutLastIndex+0xd2>
						== expectedPages[e]) {
					found = 1;
  802878:	c7 45 ec 01 00 00 00 	movl   $0x1,-0x14(%ebp)
					break;
  80287f:	eb 15                	jmp    802896 <CheckWSArrayWithoutLastIndex+0xe7>
		if (expectedPages[e] == 0) {
			expectedNumOfEmptyLocs++;
			continue;
		}
		int found = 0;
		for (int w = 0; w < myEnv->page_WS_max_size; w++) {
  802881:	ff 45 e8             	incl   -0x18(%ebp)
  802884:	a1 20 40 80 00       	mov    0x804020,%eax
  802889:	8b 90 84 00 00 00    	mov    0x84(%eax),%edx
  80288f:	8b 45 e8             	mov    -0x18(%ebp),%eax
  802892:	39 c2                	cmp    %eax,%edx
  802894:	77 85                	ja     80281b <CheckWSArrayWithoutLastIndex+0x6c>
					found = 1;
					break;
				}
			}
		...
		if (!found)
  802896:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
  80289a:	75 14                	jne    8028b0 <CheckWSArrayWithoutLastIndex+0x101>
			panic(
  80289c:	83 ec 04             	sub    $0x4,%esp
  80289f:	68 ac 34 80 00       	push   $0x8034ac
  8028a4:	6a 3a                	push   $0x3a
  8028a6:	68 a0 34 80 00       	push   $0x8034a0
  8028ab:	e8 88 fe ff ff       	call   802738 <_panic>
	if (arraySize != myEnv->page_WS_max_size)
	{
		panic("number of expected pages SHOULD BE EQUAL to max WS size... review your TA!!");
	}
	int expectedNumOfEmptyLocs = 0;
	for (int e = 0; e < arraySize; e++) {
  8028b0:	ff 45 f0             	incl   -0x10(%ebp)
  8028b3:	8b 45 f0             	mov    -0x10(%ebp),%eax
  8028b6:	3b 45 0c             	cmp    0xc(%ebp),%eax
  8028b9:	0f 8c 2f ff ff ff    	jl     8027ee <CheckWSArrayWithoutLastIndex+0x3f>
		}
		if (!found)
			panic(
  ...
  8028bf:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
	for (int w = 0; w < myEnv->page_WS_max_size; w++) {
  8028c6:	c7 45 e0 00 00 00 00 	movl   $0x0,-0x20(%ebp)
  8028cd:	eb 26                	jmp    8028f5 <CheckWSArrayWithoutLastIndex+0x146>
		if (myEnv->__uptr_pws[w].empty == 1) {
  8028cf:	a1 20 40 80 00       	mov    0x804020,%eax
  8028d4:	8b 88 90 05 00 00    	mov    0x590(%eax),%ecx
  ...
  8028eb:	3c 01                	cmp    $0x1,%al
  8028ed:	75 03                	jne    8028f2 <CheckWSArrayWithoutLastIndex+0x143>
			actualNumOfEmptyLocs++;
  8028ef:	ff 45 e4             	incl   -0x1c(%ebp)
		if (!found)
			panic(
					"PAGE WS entry checking failed... trace it by printing page WS before & after fault");
	}
	int actualNumOfEmptyLocs = 0;
	for (int w = 0; w < myEnv->page_WS_max_size; w++) {
  8028f2:	ff 45 e0             	incl   -0x20(%ebp)
  8028f5:	a1 20 40 80 00       	mov    0x804020,%eax
  8028fa:	8b 90 84 00 00 00    	mov    0x84(%eax),%edx
  802900:	8b 45 e0             	mov    -0x20(%ebp),%eax
  802903:	39 c2                	cmp    %eax,%edx
  802905:	77 c8                	ja     8028cf <CheckWSArrayWithoutLastIndex+0x120>
		if (myEnv->__uptr_pws[w].empty == 1) {
			actualNumOfEmptyLocs++;
		}
	}
  ...
  80290a:	3b 45 e4             	cmp    -0x1c(%ebp),%eax
  80290d:	74 14                	je     802923 <CheckWSArrayWithoutLastIndex+0x174>
		panic(
  80290f:	83 ec 04             	sub    $0x4,%esp
  802912:	68 00 35 80 00       	push   $0x803500
  802917:	6a 44                	push   $0x44
  802919:	68 a0 34 80 00       	push   $0x8034a0
  80291e:	e8 15 fe ff ff       	call   802738 <_panic>
