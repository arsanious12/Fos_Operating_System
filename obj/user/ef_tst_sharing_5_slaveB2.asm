...
_main(void)
{
  ...
  80005b:	68 40 2a 80 00       	push   $0x802a40
  800060:	6a 0b                	push   $0xb
  800062:	68 5c 2a 80 00       	push   $0x802a5c
  ...
  80007b:	68 7c 2a 80 00       	push   $0x802a7c
  800080:	50                   	push   %eax
  ...
  800094:	68 80 2a 80 00       	push   $0x802a80
  800099:	e8 76 05 00 00       	call   800614 <cprintf>
  80009e:	83 c4 10             	add    $0x10,%esp

	cprintf("Slave B2 please be patient ...\n");
  8000a1:	83 ec 0c             	sub    $0xc,%esp
  8000a4:	68 a8 2a 80 00       	push   $0x802aa8
  ...
  8000b9:	e8 43 26 00 00       	call   802701 <env_sleep>
  ...
  8000ea:	68 c8 2a 80 00       	push   $0x802ac8
  ...
  800114:	68 e0 2a 80 00       	push   $0x802ae0
  800119:	6a 29                	push   $0x29
  80011b:	68 5c 2a 80 00       	push   $0x802a5c
  ...
  800172:	68 b7 2b 80 00       	push   $0x802bb7
...
libmain(int argc, char **argv)
{
  ...
  8001c7:	a3 20 40 80 00       	mov    %eax,0x804020
  ...
  8001e0:	a3 04 40 80 00       	mov    %eax,0x804004
  ...
  800203:	83 c4 10             	add    $0x10,%esp
	...
	if (printStats)
  800206:	a1 00 40 80 00       	mov    0x804000,%eax
  ...
  800219:	bb c0 2c 80 00       	mov    $0x802cc0,%ebx
  ...
  80025e:	68 e0 2b 80 00       	push   $0x802be0
  ...
  80027a:	50                   	push   %eax
  80027b:	68 08 2c 80 00       	push   $0x802c08
  ...
  8002a3:	52                   	push   %edx
  8002a4:	50                   	push   %eax
  8002a5:	68 2c 2c 80 00       	push   $0x802c2c
...
_panic(const char *file, int line, const char *fmt,...)
{
  ...
  8003a9:	68 54 2d 80 00       	push   $0x802d54
...
void CheckWSArrayWithoutLastIndex(uint32 *expectedPages, int arraySize)
{
  ...
  8003d8:	68 58 2d 80 00       	push   $0x802d58
  8003dd:	6a 26                	push   $0x26
  8003df:	68 a4 2d 80 00       	push   $0x802da4
  ...
  800492:	a1 20 40 80 00       	mov    0x804020,%eax
  ...
  8004ad:	68 b0 2d 80 00       	push   $0x802db0
  8004b2:	6a 3a                	push   $0x3a
  8004b4:	68 a4 2d 80 00       	push   $0x802da4
  ...
  8004dd:	a1 20 40 80 00       	mov    0x804020,%eax
  ...
  800520:	68 04 2e 80 00       	push   $0x802e04
  800525:	6a 44                	push   $0x44
  800527:	68 a4 2d 80 00       	push   $0x802da4
...
static void putch(int ch, struct printbuf *b) {
  ...
  800560:	8b 15 1c c1 81 00    	mov    0x81c11c,%edx
  800566:	a0 44 40 80 00       	mov    0x804044,%al
...
int vcprintf(const char *fmt, va_list ap) {
  ...
  8005d9:	83 c4 10             	add    $0x10,%esp
	sys_cputs(b.buf, b.idx, printProgName, curTextClr);
  8005dc:	8b 15 1c c1 81 00    	mov    0x81c11c,%edx
  8005e2:	a0 44 40 80 00       	mov    0x804044,%al
  ...
  800602:	83 c4 10             	add    $0x10,%esp
	...
	printProgName = 0;
  800605:	c6 05 44 40 80 00 00 	movb   $0x0,0x804044
	return b.cnt;
...
int cprintf(const char *fmt, ...) {
  ...
  800617:	83 ec 18             	sub    $0x18,%esp
	...
	int cnt;
	printProgName = 1 ;
  80061a:	c6 05 44 40 80 00 01 	movb   $0x1,0x804044
	va_start(ap, fmt);
...
int cprintf_colored(int textClr, const char *fmt, ...) {
  ...
  800644:	83 ec 18             	sub    $0x18,%esp
	...
	int cnt;
	printProgName = 1 ;
  800647:	c6 05 44 40 80 00 01 	movb   $0x1,0x804044
	curTextClr = (textClr << 8) ; //set text color by the given value
  80064e:	8b 45 08             	mov    0x8(%ebp),%eax
  800651:	c1 e0 08             	shl    $0x8,%eax
  800654:	a3 1c c1 81 00       	mov    %eax,0x81c11c
	va_start(ap, fmt);
  ...
  800677:	c7 05 1c c1 81 00 00 	movl   $0x700,0x81c11c
  80067e:	07 00 00 
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8006f6:	e8 c5 20 00 00       	call   8027c0 <__udivdi3>
  ...
  800744:	52                   	push   %edx
  800745:	50                   	push   %eax
  800746:	e8 85 21 00 00       	call   8028d0 <__umoddi3>
  80074b:	83 c4 10             	add    $0x10,%esp
  80074e:	05 74 30 80 00       	add    $0x803074,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8008a1:	8b 04 85 98 30 80 00 	mov    0x803098(,%eax,4),%eax
  ...
  800982:	8b 34 9d e0 2e 80 00 	mov    0x802ee0(,%ebx,4),%esi
  800989:	85 f6                	test   %esi,%esi
  80098b:	75 19                	jne    8009a6 <vprintfmt+0x173>
				printfmt(putch, putdat, "error %d", err);
  80098d:	53                   	push   %ebx
  80098e:	68 85 30 80 00       	push   $0x803085
  ...
  8009a1:	e9 5b 02 00 00       	jmp    800c01 <vprintfmt+0x3ce>
			...
			if (err > MAXERROR || (p = error_string[err]) == NULL)
				...
				printfmt(putch, putdat, "%s", p);
  8009a6:	56                   	push   %esi
  8009a7:	68 8e 30 80 00       	push   $0x80308e
  ...
  8009d2:	75 05                	jne    8009d9 <vprintfmt+0x1a6>
				p = "(null)";
  8009d4:	be 91 30 80 00       	mov    $0x803091,%esi
			if (width > 0 && padc != '-')
  ...
  800bca:	eb 35                	jmp    800c01 <vprintfmt+0x3ce>
		...
		case '~':
			printProgName = 0;
  800bcc:	c6 05 44 40 80 00 00 	movb   $0x0,0x804044
			break;
  800bd3:	eb 2c                	jmp    800c01 <vprintfmt+0x3ce>
		// Print Program Name & UD
		case '@':
			printProgName = 1;
  800bd5:	c6 05 44 40 80 00 01 	movb   $0x1,0x804044
			break;
...
void uheap_init()
{
  ...
  801522:	a3 60 c0 81 00       	mov    %eax,0x81c060
		uheapPageAllocStart = dynAllocEnd + PAGE_SIZE;
  801527:	a1 40 40 80 00       	mov    0x804040,%eax
  80152c:	05 00 10 00 00       	add    $0x1000,%eax
  801531:	a3 10 c1 81 00       	mov    %eax,0x81c110
		uheapPageAllocBreak = uheapPageAllocStart;
  801536:	a1 10 c1 81 00       	mov    0x81c110,%eax
  80153b:	a3 68 c0 81 00       	mov    %eax,0x81c068

		__firstTimeFlag = 0;
  801540:	c7 05 08 40 80 00 00 	movl   $0x0,0x804008
  801547:	00 00 00 
	}
}
  80154a:	90                   	nop
...
int get_page(void* va)
{
  ...
  80157e:	68 08 32 80 00       	push   $0x803208
  801583:	6a 1f                	push   $0x1f
  801585:	68 44 32 80 00       	push   $0x803244
...
void return_page(void* va)
{
  ...
  8015c2:	68 50 32 80 00       	push   $0x803250
  8015c7:	6a 2a                	push   $0x2a
  8015c9:	68 44 32 80 00       	push   $0x803244
...
void* malloc(uint32 size)
{
  ...
  8015f1:	68 90 32 80 00       	push   $0x803290
  8015f6:	6a 3e                	push   $0x3e
  8015f8:	68 44 32 80 00       	push   $0x803244
...
void free(void* virtual_address)
{
  ...
  80160d:	68 b8 32 80 00       	push   $0x8032b8
  801612:	6a 49                	push   $0x49
  801614:	68 44 32 80 00       	push   $0x803244
...
void* smalloc(char *sharedVarName, uint32 size, uint8 isWritable)
{
  ...
  80163f:	68 dc 32 80 00       	push   $0x8032dc
  801644:	6a 5a                	push   $0x5a
  801646:	68 44 32 80 00       	push   $0x803244
...
void* sget(int32 ownerEnvID, char *sharedVarName)
{
  ...
  801660:	68 04 33 80 00       	push   $0x803304
  801665:	6a 6a                	push   $0x6a
  801667:	68 44 32 80 00       	push   $0x803244
...
void *realloc(void *virtual_address, uint32 new_size)
{
  ...
  80167f:	68 28 33 80 00       	push   $0x803328
  801684:	68 88 00 00 00       	push   $0x88
  801689:	68 44 32 80 00       	push   $0x803244
...
void sfree(void* virtual_address)
{
  ...
  80169c:	68 50 33 80 00       	push   $0x803350
  8016a1:	68 9b 00 00 00       	push   $0x9b
  8016a6:	68 44 32 80 00       	push   $0x803244
...
uint32 sys_get_uheap_strategy()
{
  ...
  801b20:	a3 60 c0 81 00       	mov    %eax,0x81c060
	return uheapPlaceStrategy ;
  801b25:	a1 60 c0 81 00       	mov    0x81c060,%eax
}
  801b2a:	c9                   	leave  
  801b2b:	c3                   	ret    
...
void sys_env_set_priority(int32 envID, int priority)
{
  ...
  801c46:	68 74 33 80 00       	push   $0x803374
  801c4b:	68 25 01 00 00       	push   $0x125
  801c50:	68 a7 33 80 00       	push   $0x8033a7
...
__inline__ uint32 to_page_va(struct PageInfoElement *ptrPageInfo)
{
  ...
  801cc3:	a1 64 c0 81 00       	mov    0x81c064,%eax
...
__inline__ struct PageInfoElement * to_page_info(uint32 va)
{
  ...
  801cd2:	a1 64 c0 81 00       	mov    0x81c064,%eax
  ...
  801cf6:	68 fc 33 80 00       	push   $0x8033fc
  801cfb:	6a 22                	push   $0x22
  801cfd:	68 e3 33 80 00       	push   $0x8033e3
  ...
  801d13:	05 60 40 80 00       	add    $0x804060,%eax
}
  801d18:	c9                   	leave  
  801d19:	c3                   	ret    
...
void initialize_dynamic_allocator(uint32 daStart, uint32 daEnd)
{
  ...
  801d2d:	68 20 34 80 00       	push   $0x803420
  801d32:	68 46 34 80 00       	push   $0x803446
  801d37:	6a 34                	push   $0x34
  801d39:	68 e3 33 80 00       	push   $0x8033e3
  801d3e:	e8 03 e6 ff ff       	call   800346 <_panic>
		is_initialized = 1;
  801d43:	c7 05 24 40 80 00 01 	movl   $0x1,0x804024
  801d4a:	00 00 00 
	//==================================================================================
	//==================================================================================
  ...
  801d50:	a3 64 c0 81 00       	mov    %eax,0x81c064
	dynAllocEnd = daEnd;
  801d55:	8b 45 0c             	mov    0xc(%ebp),%eax
  801d58:	a3 40 40 80 00       	mov    %eax,0x804040
	// init the list that keep track of all free pageBlockInfoArr instances.
	LIST_INIT(&freePagesList);
  801d5d:	c7 05 48 40 80 00 00 	movl   $0x0,0x804048
  801d64:	00 00 00 
  801d67:	c7 05 4c 40 80 00 00 	movl   $0x0,0x80404c
  801d6e:	00 00 00 
  801d71:	c7 05 54 40 80 00 00 	movl   $0x0,0x804054
  801d78:	00 00 00 

	// no.of pages in the dynamic allocator.
	int pCount = (daEnd - daStart) / PAGE_SIZE;
  801d7b:	8b 45 0c             	mov    0xc(%ebp),%eax
  801d7e:	2b 45 08             	sub    0x8(%ebp),%eax
  ...
  801d8e:	e9 c8 00 00 00       	jmp    801e5b <initialize_dynamic_allocator+0x141>
  ...
  801d9f:	05 68 40 80 00       	add    $0x804068,%eax
  801da4:	66 c7 00 00 00       	movw   $0x0,(%eax)
  ...
  801db5:	05 6a 40 80 00       	add    $0x80406a,%eax
  801dba:	66 c7 00 00 00       	movw   $0x0,(%eax)
	    LIST_INSERT_TAIL(&freePagesList, &pageBlockInfoArr[i]);
  801dbf:	8b 15 4c 40 80 00    	mov    0x80404c,%edx
  801dc5:	8b 4d f4             	mov    -0xc(%ebp),%ecx
  801dc8:	89 c8                	mov    %ecx,%eax
  801dca:	01 c0                	add    %eax,%eax
  801dcc:	01 c8                	add    %ecx,%eax
  801dce:	c1 e0 02             	shl    $0x2,%eax
  801dd1:	05 64 40 80 00       	add    $0x804064,%eax
  ...
  801de4:	05 64 40 80 00       	add    $0x804064,%eax
  801de9:	8b 00                	mov    (%eax),%eax
  801deb:	85 c0                	test   %eax,%eax
  801ded:	74 1b                	je     801e0a <initialize_dynamic_allocator+0xf0>
  801def:	8b 15 4c 40 80 00    	mov    0x80404c,%edx
  801df5:	8b 4d f4             	mov    -0xc(%ebp),%ecx
  801df8:	89 c8                	mov    %ecx,%eax
  801dfa:	01 c0                	add    %eax,%eax
  801dfc:	01 c8                	add    %ecx,%eax
  801dfe:	c1 e0 02             	shl    $0x2,%eax
  801e01:	05 60 40 80 00       	add    $0x804060,%eax
  801e06:	89 02                	mov    %eax,(%edx)
  801e08:	eb 16                	jmp    801e20 <initialize_dynamic_allocator+0x106>
  ...
  801e16:	05 60 40 80 00       	add    $0x804060,%eax
  801e1b:	a3 48 40 80 00       	mov    %eax,0x804048
  ...
  801e2c:	05 60 40 80 00       	add    $0x804060,%eax
  801e31:	a3 4c 40 80 00       	mov    %eax,0x80404c
  ...
  801e42:	05 60 40 80 00       	add    $0x804060,%eax
  801e47:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  801e4d:	a1 54 40 80 00       	mov    0x804054,%eax
  801e52:	40                   	inc    %eax
  801e53:	a3 54 40 80 00       	mov    %eax,0x804054
	LIST_INIT(&freePagesList);
  ...
  801e5e:	3b 45 ec             	cmp    -0x14(%ebp),%eax
  801e61:	0f 8c 2c ff ff ff    	jl     801d93 <initialize_dynamic_allocator+0x79>
	    LIST_INSERT_TAIL(&freePagesList, &pageBlockInfoArr[i]);
	}
  ...
  801e6e:	eb 36                	jmp    801ea6 <initialize_dynamic_allocator+0x18c>
		LIST_INIT(&freeBlockLists[i]);
  801e70:	8b 45 f0             	mov    -0x10(%ebp),%eax
  801e73:	c1 e0 04             	shl    $0x4,%eax
  801e76:	05 80 c0 81 00       	add    $0x81c080,%eax
  801e7b:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  801e81:	8b 45 f0             	mov    -0x10(%ebp),%eax
  801e84:	c1 e0 04             	shl    $0x4,%eax
  801e87:	05 84 c0 81 00       	add    $0x81c084,%eax
  801e8c:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  801e92:	8b 45 f0             	mov    -0x10(%ebp),%eax
  801e95:	c1 e0 04             	shl    $0x4,%eax
  801e98:	05 8c c0 81 00       	add    $0x81c08c,%eax
  801e9d:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
	    LIST_INSERT_TAIL(&freePagesList, &pageBlockInfoArr[i]);
	}
	// init the array of lists of each size..
	// 8 16 32 64 128 256 512 1024 2056
  ...
  801ea6:	83 7d f0 08          	cmpl   $0x8,-0x10(%ebp)
  801eaa:	7e c4                	jle    801e70 <initialize_dynamic_allocator+0x156>
		LIST_INIT(&freeBlockLists[i]);
	}
	//Comment the following line
...
__inline__ uint32 get_block_size(void *va)
{
  ...
  801ebb:	50                   	push   %eax
  801ebc:	e8 0b fe ff ff       	call   801ccc <to_page_info>
...
//and putem in suitable freeblockList index according to size.
 void split_page_to_blocks(uint32 blk_size, struct PageInfoElement *pageInfo) {
  ...
  801ede:	e8 77 fd ff ff       	call   801c5a <to_page_va>
  801ee3:	83 c4 10             	add    $0x10,%esp
  801ee6:	89 45 e8             	mov    %eax,-0x18(%ebp)
	 // no. of blks to save in freeblockList.
	 int blk_count = PAGE_SIZE / blk_size;
  801ee9:	b8 00 10 00 00       	mov    $0x1000,%eax
  801eee:	ba 00 00 00 00       	mov    $0x0,%edx
  801ef3:	f7 75 08             	divl   0x8(%ebp)
  801ef6:	89 45 e4             	mov    %eax,-0x1c(%ebp)
	 // save page in memory.
	 get_page((uint32*)page_va);
  801ef9:	8b 45 e8             	mov    -0x18(%ebp),%eax
  801efc:	83 ec 0c             	sub    $0xc,%esp
  801eff:	50                   	push   %eax
  801f00:	e8 48 f6 ff ff       	call   80154d <get_page>
  801f05:	83 c4 10             	add    $0x10,%esp
	 // assigning the pageInfo data block size, free block which is whole block count.
	 pageInfo->num_of_free_blocks = blk_count;
  801f08:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  801f0b:	8b 55 0c             	mov    0xc(%ebp),%edx
  801f0e:	66 89 42 0a          	mov    %ax,0xa(%edx)
	 pageInfo->block_size = blk_size;
  801f12:	8b 45 08             	mov    0x8(%ebp),%eax
  801f15:	8b 55 0c             	mov    0xc(%ebp),%edx
  801f18:	66 89 42 08          	mov    %ax,0x8(%edx)
	 // get index by size block in freeblocklist.
	 int idx = 0;
  801f1c:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
	 for (int i = LOG2_MIN_SIZE; i <= LOG2_MAX_SIZE; i++) {
  801f23:	c7 45 f0 03 00 00 00 	movl   $0x3,-0x10(%ebp)
  801f2a:	eb 19                	jmp    801f45 <split_page_to_blocks+0x73>
	     if ((1 << i) == blk_size)
  801f2c:	8b 45 f0             	mov    -0x10(%ebp),%eax
  801f2f:	ba 01 00 00 00       	mov    $0x1,%edx
  801f34:	88 c1                	mov    %al,%cl
  801f36:	d3 e2                	shl    %cl,%edx
  801f38:	89 d0                	mov    %edx,%eax
  801f3a:	3b 45 08             	cmp    0x8(%ebp),%eax
  801f3d:	74 0e                	je     801f4d <split_page_to_blocks+0x7b>
	         break;
	     idx++;
  801f3f:	ff 45 f4             	incl   -0xc(%ebp)
	 ...
	 int idx = 0;
	 for (int i = LOG2_MIN_SIZE; i <= LOG2_MAX_SIZE; i++) {
  801f42:	ff 45 f0             	incl   -0x10(%ebp)
  801f45:	83 7d f0 0b          	cmpl   $0xb,-0x10(%ebp)
  801f49:	7e e1                	jle    801f2c <split_page_to_blocks+0x5a>
  801f4b:	eb 01                	jmp    801f4e <split_page_to_blocks+0x7c>
	     if ((1 << i) == blk_size)
	         break;
  801f4d:	90                   	nop
	     idx++;
  ...
  801f4e:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  801f55:	e9 a7 00 00 00       	jmp    802001 <split_page_to_blocks+0x12f>
	     struct BlockElement *blk =(struct BlockElement*)(page_va + i * blk_size);
  801f5a:	8b 45 ec             	mov    -0x14(%ebp),%eax
  801f5d:	0f af 45 08          	imul   0x8(%ebp),%eax
  801f61:	89 c2                	mov    %eax,%edx
  801f63:	8b 45 e8             	mov    -0x18(%ebp),%eax
  801f66:	01 d0                	add    %edx,%eax
  801f68:	89 45 e0             	mov    %eax,-0x20(%ebp)
	     LIST_INSERT_TAIL(&freeBlockLists[idx],blk);
  801f6b:	83 7d e0 00          	cmpl   $0x0,-0x20(%ebp)
  801f6f:	75 14                	jne    801f85 <split_page_to_blocks+0xb3>
  801f71:	83 ec 04             	sub    $0x4,%esp
  801f74:	68 5c 34 80 00       	push   $0x80345c
  801f79:	6a 7c                	push   $0x7c
  801f7b:	68 e3 33 80 00       	push   $0x8033e3
  801f80:	e8 c1 e3 ff ff       	call   800346 <_panic>
  801f85:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801f88:	c1 e0 04             	shl    $0x4,%eax
  801f8b:	05 84 c0 81 00       	add    $0x81c084,%eax
  801f90:	8b 10                	mov    (%eax),%edx
  801f92:	8b 45 e0             	mov    -0x20(%ebp),%eax
  801f95:	89 50 04             	mov    %edx,0x4(%eax)
  801f98:	8b 45 e0             	mov    -0x20(%ebp),%eax
  801f9b:	8b 40 04             	mov    0x4(%eax),%eax
  801f9e:	85 c0                	test   %eax,%eax
  801fa0:	74 14                	je     801fb6 <split_page_to_blocks+0xe4>
  801fa2:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801fa5:	c1 e0 04             	shl    $0x4,%eax
  801fa8:	05 84 c0 81 00       	add    $0x81c084,%eax
  801fad:	8b 00                	mov    (%eax),%eax
  801faf:	8b 55 e0             	mov    -0x20(%ebp),%edx
  801fb2:	89 10                	mov    %edx,(%eax)
  801fb4:	eb 11                	jmp    801fc7 <split_page_to_blocks+0xf5>
  801fb6:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801fb9:	c1 e0 04             	shl    $0x4,%eax
  801fbc:	8d 90 80 c0 81 00    	lea    0x81c080(%eax),%edx
  801fc2:	8b 45 e0             	mov    -0x20(%ebp),%eax
  801fc5:	89 02                	mov    %eax,(%edx)
  801fc7:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801fca:	c1 e0 04             	shl    $0x4,%eax
  801fcd:	8d 90 84 c0 81 00    	lea    0x81c084(%eax),%edx
  801fd3:	8b 45 e0             	mov    -0x20(%ebp),%eax
  801fd6:	89 02                	mov    %eax,(%edx)
  801fd8:	8b 45 e0             	mov    -0x20(%ebp),%eax
  801fdb:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  801fe1:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801fe4:	c1 e0 04             	shl    $0x4,%eax
  801fe7:	05 8c c0 81 00       	add    $0x81c08c,%eax
  801fec:	8b 00                	mov    (%eax),%eax
  801fee:	8d 50 01             	lea    0x1(%eax),%edx
  ...
  801ffc:	89 10                	mov    %edx,(%eax)
	 ...
	 // starting from the page_va.
	 for (uint32 i = 0; i < blk_count; ++i) {
  801ffe:	ff 45 ec             	incl   -0x14(%ebp)
  802001:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  802004:	39 45 ec             	cmp    %eax,-0x14(%ebp)
  802007:	0f 82 4d ff ff ff    	jb     801f5a <split_page_to_blocks+0x88>
	     struct BlockElement *blk =(struct BlockElement*)(page_va + i * blk_size);
	     LIST_INSERT_TAIL(&freeBlockLists[idx],blk);
	 }
 }
...
void *alloc_block(uint32 size)
{
  ...
  802013:	83 ec 38             	sub    $0x38,%esp
	//==================================================================================
	//DON'T CHANGE THESE LINES==========================================================
	//==================================================================================
	{
		assert(size <= DYN_ALLOC_MAX_BLOCK_SIZE);
  802016:	81 7d 08 00 08 00 00 	cmpl   $0x800,0x8(%ebp)
  80201d:	76 19                	jbe    802038 <alloc_block+0x28>
  80201f:	68 80 34 80 00       	push   $0x803480
  802024:	68 46 34 80 00       	push   $0x803446
  802029:	68 8a 00 00 00       	push   $0x8a
  80202e:	68 e3 33 80 00       	push   $0x8033e3
  802033:	e8 0e e3 ff ff       	call   800346 <_panic>
	//==================================================================================
  ...
  802038:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
	for (int i = LOG2_MIN_SIZE; i <= LOG2_MAX_SIZE; ++i){
  80203f:	c7 45 f0 03 00 00 00 	movl   $0x3,-0x10(%ebp)
  802046:	eb 19                	jmp    802061 <alloc_block+0x51>
		if((1 << i) >= size) break;
  802048:	8b 45 f0             	mov    -0x10(%ebp),%eax
  80204b:	ba 01 00 00 00       	mov    $0x1,%edx
  802050:	88 c1                	mov    %al,%cl
  802052:	d3 e2                	shl    %cl,%edx
  802054:	89 d0                	mov    %edx,%eax
  802056:	3b 45 08             	cmp    0x8(%ebp),%eax
  802059:	73 0e                	jae    802069 <alloc_block+0x59>
		idx++;
  80205b:	ff 45 f4             	incl   -0xc(%ebp)
	...
	uint32 idx = 0;
	for (int i = LOG2_MIN_SIZE; i <= LOG2_MAX_SIZE; ++i){
  80205e:	ff 45 f0             	incl   -0x10(%ebp)
  802061:	83 7d f0 0b          	cmpl   $0xb,-0x10(%ebp)
  802065:	7e e1                	jle    802048 <alloc_block+0x38>
  802067:	eb 01                	jmp    80206a <alloc_block+0x5a>
		if((1 << i) >= size) break;
  802069:	90                   	nop
		idx++;
	}
  ...
  80206d:	c1 e0 04             	shl    $0x4,%eax
  802070:	05 8c c0 81 00       	add    $0x81c08c,%eax
  802075:	8b 00                	mov    (%eax),%eax
  802077:	85 c0                	test   %eax,%eax
  802079:	0f 84 df 00 00 00    	je     80215e <alloc_block+0x14e>

		// remove from the list and updat the pageInfoArr free blocks.
		// pop from the freeBlockList.
		struct BlockElement *blk = LIST_FIRST(&freeBlockLists[idx]);
  80207f:	8b 45 f4             	mov    -0xc(%ebp),%eax
  802082:	c1 e0 04             	shl    $0x4,%eax
  802085:	05 80 c0 81 00       	add    $0x81c080,%eax
  80208a:	8b 00                	mov    (%eax),%eax
  80208c:	89 45 ec             	mov    %eax,-0x14(%ebp)
	    LIST_REMOVE(&freeBlockLists[idx], blk);
  80208f:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
  802093:	75 17                	jne    8020ac <alloc_block+0x9c>
  802095:	83 ec 04             	sub    $0x4,%esp
  802098:	68 a1 34 80 00       	push   $0x8034a1
  80209d:	68 9e 00 00 00       	push   $0x9e
  8020a2:	68 e3 33 80 00       	push   $0x8033e3
  8020a7:	e8 9a e2 ff ff       	call   800346 <_panic>
  8020ac:	8b 45 ec             	mov    -0x14(%ebp),%eax
  8020af:	8b 00                	mov    (%eax),%eax
  8020b1:	85 c0                	test   %eax,%eax
  8020b3:	74 10                	je     8020c5 <alloc_block+0xb5>
  8020b5:	8b 45 ec             	mov    -0x14(%ebp),%eax
  8020b8:	8b 00                	mov    (%eax),%eax
  8020ba:	8b 55 ec             	mov    -0x14(%ebp),%edx
  8020bd:	8b 52 04             	mov    0x4(%edx),%edx
  8020c0:	89 50 04             	mov    %edx,0x4(%eax)
  8020c3:	eb 14                	jmp    8020d9 <alloc_block+0xc9>
  ...
  80211e:	05 8c c0 81 00       	add    $0x81c08c,%eax
  ...
  80213b:	50                   	push   %eax
  80213c:	e8 8b fb ff ff       	call   801ccc <to_page_info>
  802141:	83 c4 10             	add    $0x10,%esp
  802144:	89 45 e8             	mov    %eax,-0x18(%ebp)
	    pageInfo->num_of_free_blocks--;
  802147:	8b 45 e8             	mov    -0x18(%ebp),%eax
  80214a:	66 8b 40 0a          	mov    0xa(%eax),%ax
  80214e:	48                   	dec    %eax
  80214f:	8b 55 e8             	mov    -0x18(%ebp),%edx
  802152:	66 89 42 0a          	mov    %ax,0xa(%edx)
	    return blk;
  802156:	8b 45 ec             	mov    -0x14(%ebp),%eax
  802159:	e9 bc 02 00 00       	jmp    80241a <alloc_block+0x40a>
	}else{ //case(2, 3): 2. no free blocks available in the freeblocklist but there is free pages.
				//3. no free blocks and no available freepages so search in higher block sizes.
		// case 2:
		if(freePagesList.size > 0){ //have free pages.
  80215e:	a1 54 40 80 00       	mov    0x804054,%eax
  802163:	85 c0                	test   %eax,%eax
  802165:	0f 84 7d 02 00 00    	je     8023e8 <alloc_block+0x3d8>
			// get page to split and use from freepagesList.
			struct PageInfoElement *ptr_new_page = LIST_FIRST(&freePagesList);
  80216b:	a1 48 40 80 00       	mov    0x804048,%eax
  802170:	89 45 e4             	mov    %eax,-0x1c(%ebp)
			LIST_REMOVE(&freePagesList, ptr_new_page);
  802173:	83 7d e4 00          	cmpl   $0x0,-0x1c(%ebp)
  802177:	75 17                	jne    802190 <alloc_block+0x180>
  802179:	83 ec 04             	sub    $0x4,%esp
  80217c:	68 a1 34 80 00       	push   $0x8034a1
  802181:	68 a9 00 00 00       	push   $0xa9
  802186:	68 e3 33 80 00       	push   $0x8033e3
  80218b:	e8 b6 e1 ff ff       	call   800346 <_panic>
  802190:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  802193:	8b 00                	mov    (%eax),%eax
  802195:	85 c0                	test   %eax,%eax
  802197:	74 10                	je     8021a9 <alloc_block+0x199>
  802199:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  80219c:	8b 00                	mov    (%eax),%eax
  80219e:	8b 55 e4             	mov    -0x1c(%ebp),%edx
  8021a1:	8b 52 04             	mov    0x4(%edx),%edx
  8021a4:	89 50 04             	mov    %edx,0x4(%eax)
  8021a7:	eb 0b                	jmp    8021b4 <alloc_block+0x1a4>
  ...
  8021bc:	74 0f                	je     8021cd <alloc_block+0x1bd>
  8021be:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  8021c1:	8b 40 04             	mov    0x4(%eax),%eax
  8021c4:	8b 55 e4             	mov    -0x1c(%ebp),%edx
  8021c7:	8b 12                	mov    (%edx),%edx
  8021c9:	89 10                	mov    %edx,(%eax)
  8021cb:	eb 0a                	jmp    8021d7 <alloc_block+0x1c7>
  8021cd:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  8021d0:	8b 00                	mov    (%eax),%eax
  8021d2:	a3 48 40 80 00       	mov    %eax,0x804048
  ...
  8021ea:	a1 54 40 80 00       	mov    0x804054,%eax
  8021ef:	48                   	dec    %eax
  8021f0:	a3 54 40 80 00       	mov    %eax,0x804054
			// from page to freeblockList by the pageInfo and the block size.
			split_page_to_blocks(1 << (idx + LOG2_MIN_SIZE), ptr_new_page);
  8021f5:	8b 45 f4             	mov    -0xc(%ebp),%eax
  8021f8:	83 c0 03             	add    $0x3,%eax
  8021fb:	ba 01 00 00 00       	mov    $0x1,%edx
  802200:	88 c1                	mov    %al,%cl
  802202:	d3 e2                	shl    %cl,%edx
  802204:	89 d0                	mov    %edx,%eax
  802206:	83 ec 08             	sub    $0x8,%esp
  802209:	ff 75 e4             	pushl  -0x1c(%ebp)
  80220c:	50                   	push   %eax
  80220d:	e8 c0 fc ff ff       	call   801ed2 <split_page_to_blocks>
  ...
  802218:	c1 e0 04             	shl    $0x4,%eax
  80221b:	05 80 c0 81 00       	add    $0x81c080,%eax
  802220:	8b 00                	mov    (%eax),%eax
  802222:	89 45 e0             	mov    %eax,-0x20(%ebp)
		    LIST_REMOVE(&freeBlockLists[idx], blk);
  802225:	83 7d e0 00          	cmpl   $0x0,-0x20(%ebp)
  802229:	75 17                	jne    802242 <alloc_block+0x232>
  80222b:	83 ec 04             	sub    $0x4,%esp
  80222e:	68 a1 34 80 00       	push   $0x8034a1
  802233:	68 b0 00 00 00       	push   $0xb0
  802238:	68 e3 33 80 00       	push   $0x8033e3
  80223d:	e8 04 e1 ff ff       	call   800346 <_panic>
  802242:	8b 45 e0             	mov    -0x20(%ebp),%eax
  802245:	8b 00                	mov    (%eax),%eax
  802247:	85 c0                	test   %eax,%eax
  802249:	74 10                	je     80225b <alloc_block+0x24b>
  80224b:	8b 45 e0             	mov    -0x20(%ebp),%eax
  80224e:	8b 00                	mov    (%eax),%eax
  802250:	8b 55 e0             	mov    -0x20(%ebp),%edx
  802253:	8b 52 04             	mov    0x4(%edx),%edx
  802256:	89 50 04             	mov    %edx,0x4(%eax)
  802259:	eb 14                	jmp    80226f <alloc_block+0x25f>
  ...
  8022b4:	05 8c c0 81 00       	add    $0x81c08c,%eax
  8022b9:	8b 00                	mov    (%eax),%eax
  8022bb:	8d 50 ff             	lea    -0x1(%eax),%edx
  ...
  8022d1:	50                   	push   %eax
  8022d2:	e8 f5 f9 ff ff       	call   801ccc <to_page_info>
  8022d7:	83 c4 10             	add    $0x10,%esp
  8022da:	89 45 dc             	mov    %eax,-0x24(%ebp)
		    pageInfo->num_of_free_blocks--;
  8022dd:	8b 45 dc             	mov    -0x24(%ebp),%eax
  8022e0:	66 8b 40 0a          	mov    0xa(%eax),%ax
  8022e4:	48                   	dec    %eax
  8022e5:	8b 55 dc             	mov    -0x24(%ebp),%edx
  8022e8:	66 89 42 0a          	mov    %ax,0xa(%edx)
		    return blk;
  8022ec:	8b 45 e0             	mov    -0x20(%ebp),%eax
  8022ef:	e9 26 01 00 00       	jmp    80241a <alloc_block+0x40a>
  ...
  802306:	0f 84 dc 00 00 00    	je     8023e8 <alloc_block+0x3d8>
					// remove from the list and updat the pageInfoArr free blocks.
					// pop from the freeBlockList.
					struct BlockElement *blk = LIST_FIRST(&freeBlockLists[idx]);
  80230c:	8b 45 f4             	mov    -0xc(%ebp),%eax
  80230f:	c1 e0 04             	shl    $0x4,%eax
  802312:	05 80 c0 81 00       	add    $0x81c080,%eax
  802317:	8b 00                	mov    (%eax),%eax
  802319:	89 45 d8             	mov    %eax,-0x28(%ebp)
				    LIST_REMOVE(&freeBlockLists[idx], blk);
  80231c:	83 7d d8 00          	cmpl   $0x0,-0x28(%ebp)
  802320:	75 17                	jne    802339 <alloc_block+0x329>
  802322:	83 ec 04             	sub    $0x4,%esp
  802325:	68 a1 34 80 00       	push   $0x8034a1
  80232a:	68 be 00 00 00       	push   $0xbe
  80232f:	68 e3 33 80 00       	push   $0x8033e3
  802334:	e8 0d e0 ff ff       	call   800346 <_panic>
  802339:	8b 45 d8             	mov    -0x28(%ebp),%eax
  80233c:	8b 00                	mov    (%eax),%eax
  80233e:	85 c0                	test   %eax,%eax
  802340:	74 10                	je     802352 <alloc_block+0x342>
  802342:	8b 45 d8             	mov    -0x28(%ebp),%eax
  802345:	8b 00                	mov    (%eax),%eax
  802347:	8b 55 d8             	mov    -0x28(%ebp),%edx
  80234a:	8b 52 04             	mov    0x4(%edx),%edx
  80234d:	89 50 04             	mov    %edx,0x4(%eax)
  802350:	eb 14                	jmp    802366 <alloc_block+0x356>
  802352:	8b 45 d8             	mov    -0x28(%ebp),%eax
  802355:	8b 40 04             	mov    0x4(%eax),%eax
  802358:	8b 55 f4             	mov    -0xc(%ebp),%edx
  80235b:	c1 e2 04             	shl    $0x4,%edx
  80235e:	81 c2 84 c0 81 00    	add    $0x81c084,%edx
  802364:	89 02                	mov    %eax,(%edx)
  802366:	8b 45 d8             	mov    -0x28(%ebp),%eax
  802369:	8b 40 04             	mov    0x4(%eax),%eax
  80236c:	85 c0                	test   %eax,%eax
  80236e:	74 0f                	je     80237f <alloc_block+0x36f>
  802370:	8b 45 d8             	mov    -0x28(%ebp),%eax
  802373:	8b 40 04             	mov    0x4(%eax),%eax
  802376:	8b 55 d8             	mov    -0x28(%ebp),%edx
  802379:	8b 12                	mov    (%edx),%edx
  80237b:	89 10                	mov    %edx,(%eax)
  80237d:	eb 13                	jmp    802392 <alloc_block+0x382>
  80237f:	8b 45 d8             	mov    -0x28(%ebp),%eax
  802382:	8b 00                	mov    (%eax),%eax
  802384:	8b 55 f4             	mov    -0xc(%ebp),%edx
  802387:	c1 e2 04             	shl    $0x4,%edx
  80238a:	81 c2 80 c0 81 00    	add    $0x81c080,%edx
  802390:	89 02                	mov    %eax,(%edx)
  802392:	8b 45 d8             	mov    -0x28(%ebp),%eax
  802395:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  80239b:	8b 45 d8             	mov    -0x28(%ebp),%eax
  80239e:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
  8023a5:	8b 45 f4             	mov    -0xc(%ebp),%eax
  8023a8:	c1 e0 04             	shl    $0x4,%eax
  8023ab:	05 8c c0 81 00       	add    $0x81c08c,%eax
  8023b0:	8b 00                	mov    (%eax),%eax
  8023b2:	8d 50 ff             	lea    -0x1(%eax),%edx
  ...
  8023c8:	50                   	push   %eax
  8023c9:	e8 fe f8 ff ff       	call   801ccc <to_page_info>
  8023ce:	83 c4 10             	add    $0x10,%esp
  8023d1:	89 45 d4             	mov    %eax,-0x2c(%ebp)
				    pageInfo->num_of_free_blocks--;
  8023d4:	8b 45 d4             	mov    -0x2c(%ebp),%eax
  8023d7:	66 8b 40 0a          	mov    0xa(%eax),%ax
  8023db:	48                   	dec    %eax
  8023dc:	8b 55 d4             	mov    -0x2c(%ebp),%edx
  8023df:	66 89 42 0a          	mov    %ax,0xa(%edx)
				    return blk;
  8023e3:	8b 45 d8             	mov    -0x28(%ebp),%eax
  8023e6:	eb 32                	jmp    80241a <alloc_block+0x40a>
		    struct PageInfoElement *pageInfo = to_page_info((uint32)blk);
		    pageInfo->num_of_free_blocks--;
		    return blk;
		}else{//case 3: no free block and no free page so iterate and try to find bigger size.
			// iterate over the list until finding available block
			while (idx <= (LOG2_MAX_SIZE - LOG2_MIN_SIZE) && freeBlockLists[idx].size == 0) {
  8023e8:	83 7d f4 08          	cmpl   $0x8,-0xc(%ebp)
  8023ec:	77 15                	ja     802403 <alloc_block+0x3f3>
  ...
  8023fd:	0f 84 f1 fe ff ff    	je     8022f4 <alloc_block+0x2e4>
				}
			}
		}
	}
  ...
  802406:	68 bf 34 80 00       	push   $0x8034bf
  80240b:	68 c8 00 00 00       	push   $0xc8
  802410:	68 e3 33 80 00       	push   $0x8033e3
  802415:	e8 2c df ff ff       	call   800346 <_panic>
...
void free_block(void *va)
{
  ...
  802425:	a1 64 c0 81 00       	mov    0x81c064,%eax
  80242a:	39 c2                	cmp    %eax,%edx
  80242c:	72 0c                	jb     80243a <free_block+0x1e>
  80242e:	8b 55 08             	mov    0x8(%ebp),%edx
  802431:	a1 40 40 80 00       	mov    0x804040,%eax
  802436:	39 c2                	cmp    %eax,%edx
  802438:	72 19                	jb     802453 <free_block+0x37>
  80243a:	68 d0 34 80 00       	push   $0x8034d0
  80243f:	68 46 34 80 00       	push   $0x803446
  802444:	68 d7 00 00 00       	push   $0xd7
  802449:	68 e3 33 80 00       	push   $0x8033e3
  80244e:	e8 f3 de ff ff       	call   800346 <_panic>
  ...
  80245f:	50                   	push   %eax
  802460:	e8 67 f8 ff ff       	call   801ccc <to_page_info>
  ...
  802471:	0f b7 c0             	movzwl %ax,%eax
  802474:	89 45 e0             	mov    %eax,-0x20(%ebp)

	// its index in the freeBlocklist.
	int idx = 0;
  802477:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
	for (int i = LOG2_MIN_SIZE; i <= LOG2_MAX_SIZE; i++) {
  80247e:	c7 45 f0 03 00 00 00 	movl   $0x3,-0x10(%ebp)
  802485:	eb 19                	jmp    8024a0 <free_block+0x84>
	    if ((1 << i) == blk_size)
  802487:	8b 45 f0             	mov    -0x10(%ebp),%eax
  80248a:	ba 01 00 00 00       	mov    $0x1,%edx
  80248f:	88 c1                	mov    %al,%cl
  802491:	d3 e2                	shl    %cl,%edx
  802493:	89 d0                	mov    %edx,%eax
  802495:	3b 45 e0             	cmp    -0x20(%ebp),%eax
  802498:	74 0e                	je     8024a8 <free_block+0x8c>
	        break;
	    idx++;
  80249a:	ff 45 f4             	incl   -0xc(%ebp)
	struct PageInfoElement *pageInfo = to_page_info((uint32)va);
	uint32 blk_size = pageInfo->block_size;
	...
	int idx = 0;
	for (int i = LOG2_MIN_SIZE; i <= LOG2_MAX_SIZE; i++) {
  80249d:	ff 45 f0             	incl   -0x10(%ebp)
  8024a0:	83 7d f0 0b          	cmpl   $0xb,-0x10(%ebp)
  8024a4:	7e e1                	jle    802487 <free_block+0x6b>
  8024a6:	eb 01                	jmp    8024a9 <free_block+0x8d>
	    if ((1 << i) == blk_size)
	        break;
  8024a8:	90                   	nop
	    idx++;
  ...
  8024ac:	66 8b 40 0a          	mov    0xa(%eax),%ax
  8024b0:	40                   	inc    %eax
  8024b1:	8b 55 e4             	mov    -0x1c(%ebp),%edx
  8024b4:	66 89 42 0a          	mov    %ax,0xa(%edx)
	LIST_INSERT_TAIL(&freeBlockLists[idx], blk_to_free);
  8024b8:	83 7d e8 00          	cmpl   $0x0,-0x18(%ebp)
  8024bc:	75 17                	jne    8024d5 <free_block+0xb9>
  8024be:	83 ec 04             	sub    $0x4,%esp
  8024c1:	68 5c 34 80 00       	push   $0x80345c
  8024c6:	68 ee 00 00 00       	push   $0xee
  8024cb:	68 e3 33 80 00       	push   $0x8033e3
  8024d0:	e8 71 de ff ff       	call   800346 <_panic>
  8024d5:	8b 45 f4             	mov    -0xc(%ebp),%eax
  8024d8:	c1 e0 04             	shl    $0x4,%eax
  8024db:	05 84 c0 81 00       	add    $0x81c084,%eax
  8024e0:	8b 10                	mov    (%eax),%edx
  8024e2:	8b 45 e8             	mov    -0x18(%ebp),%eax
  8024e5:	89 50 04             	mov    %edx,0x4(%eax)
  8024e8:	8b 45 e8             	mov    -0x18(%ebp),%eax
  8024eb:	8b 40 04             	mov    0x4(%eax),%eax
  8024ee:	85 c0                	test   %eax,%eax
  8024f0:	74 14                	je     802506 <free_block+0xea>
  8024f2:	8b 45 f4             	mov    -0xc(%ebp),%eax
  8024f5:	c1 e0 04             	shl    $0x4,%eax
  8024f8:	05 84 c0 81 00       	add    $0x81c084,%eax
  8024fd:	8b 00                	mov    (%eax),%eax
  8024ff:	8b 55 e8             	mov    -0x18(%ebp),%edx
  802502:	89 10                	mov    %edx,(%eax)
  802504:	eb 11                	jmp    802517 <free_block+0xfb>
  802506:	8b 45 f4             	mov    -0xc(%ebp),%eax
  802509:	c1 e0 04             	shl    $0x4,%eax
  80250c:	8d 90 80 c0 81 00    	lea    0x81c080(%eax),%edx
  802512:	8b 45 e8             	mov    -0x18(%ebp),%eax
  802515:	89 02                	mov    %eax,(%edx)
  802517:	8b 45 f4             	mov    -0xc(%ebp),%eax
  80251a:	c1 e0 04             	shl    $0x4,%eax
  80251d:	8d 90 84 c0 81 00    	lea    0x81c084(%eax),%edx
  ...
  80253e:	8d 50 01             	lea    0x1(%eax),%edx
  ...
  80254c:	89 10                	mov    %edx,(%eax)
	...
	int blk_count = PAGE_SIZE / blk_size;
  80254e:	b8 00 10 00 00       	mov    $0x1000,%eax
  802553:	ba 00 00 00 00       	mov    $0x0,%edx
  802558:	f7 75 e0             	divl   -0x20(%ebp)
  80255b:	89 45 dc             	mov    %eax,-0x24(%ebp)
	// the blk count in the page is same as number fo free blocks free up the page.
	if (pageInfo->num_of_free_blocks == blk_count) {
  80255e:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  802561:	66 8b 40 0a          	mov    0xa(%eax),%ax
  802565:	0f b7 c0             	movzwl %ax,%eax
  802568:	3b 45 dc             	cmp    -0x24(%ebp),%eax
  80256b:	0f 85 70 01 00 00    	jne    8026e1 <free_block+0x2c5>
		uint32 page_va = to_page_va(pageInfo);
  802571:	83 ec 0c             	sub    $0xc,%esp
  802574:	ff 75 e4             	pushl  -0x1c(%ebp)
  802577:	e8 de f6 ff ff       	call   801c5a <to_page_va>
  80257c:	83 c4 10             	add    $0x10,%esp
  80257f:	89 45 d8             	mov    %eax,-0x28(%ebp)
		// remove all blk in the freeBlockList.
		for (uint32 off = 0; off < PAGE_SIZE; off += blk_size) {
  802582:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  802589:	e9 b7 00 00 00       	jmp    802645 <free_block+0x229>
			struct BlockElement *blk = (struct BlockElement*)(page_va + off);
  80258e:	8b 55 d8             	mov    -0x28(%ebp),%edx
  802591:	8b 45 ec             	mov    -0x14(%ebp),%eax
  802594:	01 d0                	add    %edx,%eax
  802596:	89 45 d4             	mov    %eax,-0x2c(%ebp)
			LIST_REMOVE(&freeBlockLists[idx], blk);
  802599:	83 7d d4 00          	cmpl   $0x0,-0x2c(%ebp)
  80259d:	75 17                	jne    8025b6 <free_block+0x19a>
  80259f:	83 ec 04             	sub    $0x4,%esp
  8025a2:	68 a1 34 80 00       	push   $0x8034a1
  8025a7:	68 f8 00 00 00       	push   $0xf8
  8025ac:	68 e3 33 80 00       	push   $0x8033e3
  8025b1:	e8 90 dd ff ff       	call   800346 <_panic>
  8025b6:	8b 45 d4             	mov    -0x2c(%ebp),%eax
  8025b9:	8b 00                	mov    (%eax),%eax
  8025bb:	85 c0                	test   %eax,%eax
  8025bd:	74 10                	je     8025cf <free_block+0x1b3>
  8025bf:	8b 45 d4             	mov    -0x2c(%ebp),%eax
  8025c2:	8b 00                	mov    (%eax),%eax
  8025c4:	8b 55 d4             	mov    -0x2c(%ebp),%edx
  8025c7:	8b 52 04             	mov    0x4(%edx),%edx
  8025ca:	89 50 04             	mov    %edx,0x4(%eax)
  8025cd:	eb 14                	jmp    8025e3 <free_block+0x1c7>
  ...
  802642:	01 45 ec             	add    %eax,-0x14(%ebp)
  802645:	81 7d ec ff 0f 00 00 	cmpl   $0xfff,-0x14(%ebp)
  80264c:	0f 86 3c ff ff ff    	jbe    80258e <free_block+0x172>
			struct BlockElement *blk = (struct BlockElement*)(page_va + off);
			LIST_REMOVE(&freeBlockLists[idx], blk);
		}
		// reset page info.
  ...
  802655:	66 c7 40 08 00 00    	movw   $0x0,0x8(%eax)
		pageInfo->num_of_free_blocks = 0;
  80265b:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  80265e:	66 c7 40 0a 00 00    	movw   $0x0,0xa(%eax)
		// add it to the available pages.
		LIST_INSERT_TAIL(&freePagesList, pageInfo);
  802664:	83 7d e4 00          	cmpl   $0x0,-0x1c(%ebp)
  802668:	75 17                	jne    802681 <free_block+0x265>
  80266a:	83 ec 04             	sub    $0x4,%esp
  80266d:	68 5c 34 80 00       	push   $0x80345c
  802672:	68 fe 00 00 00       	push   $0xfe
  802677:	68 e3 33 80 00       	push   $0x8033e3
  80267c:	e8 c5 dc ff ff       	call   800346 <_panic>
  802681:	8b 15 4c 40 80 00    	mov    0x80404c,%edx
  ...
  802695:	74 0c                	je     8026a3 <free_block+0x287>
  802697:	a1 4c 40 80 00       	mov    0x80404c,%eax
  80269c:	8b 55 e4             	mov    -0x1c(%ebp),%edx
  80269f:	89 10                	mov    %edx,(%eax)
  8026a1:	eb 08                	jmp    8026ab <free_block+0x28f>
  8026a3:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  8026a6:	a3 48 40 80 00       	mov    %eax,0x804048
  8026ab:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  8026ae:	a3 4c 40 80 00       	mov    %eax,0x80404c
  8026b3:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  8026b6:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  8026bc:	a1 54 40 80 00       	mov    0x804054,%eax
  8026c1:	40                   	inc    %eax
  8026c2:	a3 54 40 80 00       	mov    %eax,0x804054
		// make it available in memory.
		return_page((uint32 *)to_page_va(pageInfo));
  8026c7:	83 ec 0c             	sub    $0xc,%esp
  8026ca:	ff 75 e4             	pushl  -0x1c(%ebp)
  8026cd:	e8 88 f5 ff ff       	call   801c5a <to_page_va>
  8026d2:	83 c4 10             	add    $0x10,%esp
  8026d5:	83 ec 0c             	sub    $0xc,%esp
  8026d8:	50                   	push   %eax
  8026d9:	e8 b8 ee ff ff       	call   801596 <return_page>
...
void *realloc_block(void* va, uint32 new_size)
{
  ...
  8026ed:	68 08 35 80 00       	push   $0x803508
  8026f2:	68 11 01 00 00       	push   $0x111
  8026f7:	68 e3 33 80 00       	push   $0x8033e3
  8026fc:	e8 45 dc ff ff       	call   800346 <_panic>
...
//	cprintf("%s go to sleep...\n", myEnv->prog_name);
  ...
  802711:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
  802718:	01 d0                	add    %edx,%eax
  80271a:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
  802721:	01 d0                	add    %edx,%eax
  802723:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
  80272a:	01 d0                	add    %edx,%eax
  80272c:	c1 e0 04             	shl    $0x4,%eax
  80272f:	89 45 f8             	mov    %eax,-0x8(%ebp)
	uint32 cycles_counter =0;
  802732:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%ebp)
...
static inline __attribute__((always_inline)) struct uint64 get_virtual_time_user()
{
  ...
  802744:	8b 55 ec             	mov    -0x14(%ebp),%edx
  802747:	89 45 f0             	mov    %eax,-0x10(%ebp)
  80274a:	89 55 f4             	mov    %edx,-0xc(%ebp)

	/*2024*/ //USE A USER-SIDE VERSION OF THIS FUNCTION TO AVOID SLOW-DOWN THE PERFORMANCE DUE SYS_CALL (el7 :))
	//struct uint64 baseTime = sys_get_virtual_time() ;
	struct uint64 baseTime = get_virtual_time_user() ;
	while(cycles_counter<time_in_cycles)
  80274d:	eb 46                	jmp    802795 <env_sleep+0x94>
...
static inline __attribute__((always_inline)) struct uint64 get_virtual_time_user()
{
  ...
  802754:	89 55 d4             	mov    %edx,-0x2c(%ebp)
	: "=a" (result.low), "=d" (result.hi)
	);

	return result;
  802757:	8b 45 d0             	mov    -0x30(%ebp),%eax
  80275a:	8b 55 d4             	mov    -0x2c(%ebp),%edx
  80275d:	89 45 e0             	mov    %eax,-0x20(%ebp)
  802760:	89 55 e4             	mov    %edx,-0x1c(%ebp)
  ...
  802769:	29 c2                	sub    %eax,%edx
  80276b:	89 d0                	mov    %edx,%eax
  80276d:	89 45 d8             	mov    %eax,-0x28(%ebp)
		res.hi = (currentTime.hi - baseTime.hi - (res.low > currentTime.low)) & M32;
  802770:	8b 55 e4             	mov    -0x1c(%ebp),%edx
  802773:	8b 45 f4             	mov    -0xc(%ebp),%eax
  802776:	89 d1                	mov    %edx,%ecx
  802778:	29 c1                	sub    %eax,%ecx
  80277a:	8b 55 d8             	mov    -0x28(%ebp),%edx
  80277d:	8b 45 e0             	mov    -0x20(%ebp),%eax
  802780:	39 c2                	cmp    %eax,%edx
  802782:	0f 97 c0             	seta   %al
  802785:	0f b6 c0             	movzbl %al,%eax
  802788:	29 c1                	sub    %eax,%ecx
  80278a:	89 c8                	mov    %ecx,%eax
  ...
  802798:	3b 45 f8             	cmp    -0x8(%ebp),%eax
  80279b:	72 b2                	jb     80274f <env_sleep+0x4e>
//				,cycles_counter
//				);
	}
...
uint32 busy_wait(uint32 loopMax)
{
  ...
  8027a3:	83 ec 10             	sub    $0x10,%esp
	uint32 i = 0 ;
  8027a6:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%ebp)
	while (i < loopMax) i++;
  8027ad:	eb 03                	jmp    8027b2 <busy_wait+0x12>
  8027af:	ff 45 fc             	incl   -0x4(%ebp)
  8027b2:	8b 45 fc             	mov    -0x4(%ebp),%eax
  8027b5:	3b 45 08             	cmp    0x8(%ebp),%eax
  8027b8:	72 f5                	jb     8027af <busy_wait+0xf>
	return i;
...
008027c0 <__udivdi3>:
  ...
  802812:	77 28                	ja     80283c <__udivdi3+0x7c>
  802814:	0f bd fe             	bsr    %esi,%edi
  802817:	83 f7 1f             	xor    $0x1f,%edi
  80281a:	75 40                	jne    80285c <__udivdi3+0x9c>
  80281c:	39 ce                	cmp    %ecx,%esi
  80281e:	72 0a                	jb     80282a <__udivdi3+0x6a>
  802820:	3b 44 24 08          	cmp    0x8(%esp),%eax
  802824:	0f 87 9e 00 00 00    	ja     8028c8 <__udivdi3+0x108>
  ...
  802837:	5d                   	pop    %ebp
  802838:	c3                   	ret    
  802839:	8d 76 00             	lea    0x0(%esi),%esi
  ...
  80285a:	5d                   	pop    %ebp
  80285b:	c3                   	ret    
  80285c:	bd 20 00 00 00       	mov    $0x20,%ebp
  802861:	89 eb                	mov    %ebp,%ebx
  802863:	29 fb                	sub    %edi,%ebx
  802865:	89 f9                	mov    %edi,%ecx
  802867:	d3 e6                	shl    %cl,%esi
  802869:	89 c5                	mov    %eax,%ebp
  80286b:	88 d9                	mov    %bl,%cl
  80286d:	d3 ed                	shr    %cl,%ebp
  80286f:	89 e9                	mov    %ebp,%ecx
  802871:	09 f1                	or     %esi,%ecx
  802873:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
  802877:	89 f9                	mov    %edi,%ecx
  802879:	d3 e0                	shl    %cl,%eax
  80287b:	89 c5                	mov    %eax,%ebp
  80287d:	89 d6                	mov    %edx,%esi
  80287f:	88 d9                	mov    %bl,%cl
  802881:	d3 ee                	shr    %cl,%esi
  802883:	89 f9                	mov    %edi,%ecx
  802885:	d3 e2                	shl    %cl,%edx
  802887:	8b 44 24 08          	mov    0x8(%esp),%eax
  80288b:	88 d9                	mov    %bl,%cl
  80288d:	d3 e8                	shr    %cl,%eax
  80288f:	09 c2                	or     %eax,%edx
  802891:	89 d0                	mov    %edx,%eax
  802893:	89 f2                	mov    %esi,%edx
  802895:	f7 74 24 0c          	divl   0xc(%esp)
  802899:	89 d6                	mov    %edx,%esi
  80289b:	89 c3                	mov    %eax,%ebx
  80289d:	f7 e5                	mul    %ebp
  80289f:	39 d6                	cmp    %edx,%esi
  8028a1:	72 19                	jb     8028bc <__udivdi3+0xfc>
  8028a3:	74 0b                	je     8028b0 <__udivdi3+0xf0>
  8028a5:	89 d8                	mov    %ebx,%eax
  8028a7:	31 ff                	xor    %edi,%edi
  8028a9:	e9 58 ff ff ff       	jmp    802806 <__udivdi3+0x46>
  8028ae:	66 90                	xchg   %ax,%ax
  8028b0:	8b 54 24 08          	mov    0x8(%esp),%edx
  8028b4:	89 f9                	mov    %edi,%ecx
  8028b6:	d3 e2                	shl    %cl,%edx
  8028b8:	39 c2                	cmp    %eax,%edx
  8028ba:	73 e9                	jae    8028a5 <__udivdi3+0xe5>
  8028bc:	8d 43 ff             	lea    -0x1(%ebx),%eax
  8028bf:	31 ff                	xor    %edi,%edi
  8028c1:	e9 40 ff ff ff       	jmp    802806 <__udivdi3+0x46>
  8028c6:	66 90                	xchg   %ax,%ax
  8028c8:	31 c0                	xor    %eax,%eax
  8028ca:	e9 37 ff ff ff       	jmp    802806 <__udivdi3+0x46>
  8028cf:	90                   	nop
...
008028d0 <__umoddi3>:
  ...
  8028d7:	8b 4c 24 30          	mov    0x30(%esp),%ecx
  8028db:	8b 74 24 34          	mov    0x34(%esp),%esi
  8028df:	8b 7c 24 38          	mov    0x38(%esp),%edi
  8028e3:	8b 44 24 3c          	mov    0x3c(%esp),%eax
  8028e7:	89 44 24 0c          	mov    %eax,0xc(%esp)
  8028eb:	89 4c 24 08          	mov    %ecx,0x8(%esp)
  8028ef:	89 f3                	mov    %esi,%ebx
  8028f1:	89 fa                	mov    %edi,%edx
  8028f3:	89 4c 24 04          	mov    %ecx,0x4(%esp)
  8028f7:	89 34 24             	mov    %esi,(%esp)
  8028fa:	85 c0                	test   %eax,%eax
  8028fc:	75 1a                	jne    802918 <__umoddi3+0x48>
  8028fe:	39 f7                	cmp    %esi,%edi
  802900:	0f 86 a2 00 00 00    	jbe    8029a8 <__umoddi3+0xd8>
  ...
  802916:	5d                   	pop    %ebp
  802917:	c3                   	ret    
  802918:	39 f0                	cmp    %esi,%eax
  80291a:	0f 87 ac 00 00 00    	ja     8029cc <__umoddi3+0xfc>
  802920:	0f bd e8             	bsr    %eax,%ebp
  802923:	83 f5 1f             	xor    $0x1f,%ebp
  802926:	0f 84 ac 00 00 00    	je     8029d8 <__umoddi3+0x108>
  80292c:	bf 20 00 00 00       	mov    $0x20,%edi
  802931:	29 ef                	sub    %ebp,%edi
  802933:	89 fe                	mov    %edi,%esi
  802935:	89 7c 24 0c          	mov    %edi,0xc(%esp)
  802939:	89 e9                	mov    %ebp,%ecx
  80293b:	d3 e0                	shl    %cl,%eax
  80293d:	89 d7                	mov    %edx,%edi
  80293f:	89 f1                	mov    %esi,%ecx
  802941:	d3 ef                	shr    %cl,%edi
  802943:	09 c7                	or     %eax,%edi
  802945:	89 e9                	mov    %ebp,%ecx
  802947:	d3 e2                	shl    %cl,%edx
  802949:	89 14 24             	mov    %edx,(%esp)
  80294c:	89 d8                	mov    %ebx,%eax
  80294e:	d3 e0                	shl    %cl,%eax
  802950:	89 c2                	mov    %eax,%edx
  802952:	8b 44 24 08          	mov    0x8(%esp),%eax
  802956:	d3 e0                	shl    %cl,%eax
  802958:	89 44 24 04          	mov    %eax,0x4(%esp)
  80295c:	8b 44 24 08          	mov    0x8(%esp),%eax
  802960:	89 f1                	mov    %esi,%ecx
  802962:	d3 e8                	shr    %cl,%eax
  802964:	09 d0                	or     %edx,%eax
  802966:	d3 eb                	shr    %cl,%ebx
  802968:	89 da                	mov    %ebx,%edx
  80296a:	f7 f7                	div    %edi
  80296c:	89 d3                	mov    %edx,%ebx
  80296e:	f7 24 24             	mull   (%esp)
  802971:	89 c6                	mov    %eax,%esi
  802973:	89 d1                	mov    %edx,%ecx
  802975:	39 d3                	cmp    %edx,%ebx
  802977:	0f 82 87 00 00 00    	jb     802a04 <__umoddi3+0x134>
  80297d:	0f 84 91 00 00 00    	je     802a14 <__umoddi3+0x144>
  802983:	8b 54 24 04          	mov    0x4(%esp),%edx
  802987:	29 f2                	sub    %esi,%edx
  802989:	19 cb                	sbb    %ecx,%ebx
  80298b:	89 d8                	mov    %ebx,%eax
  80298d:	8a 4c 24 0c          	mov    0xc(%esp),%cl
  802991:	d3 e0                	shl    %cl,%eax
  802993:	89 e9                	mov    %ebp,%ecx
  802995:	d3 ea                	shr    %cl,%edx
  802997:	09 d0                	or     %edx,%eax
  802999:	89 e9                	mov    %ebp,%ecx
  80299b:	d3 eb                	shr    %cl,%ebx
  80299d:	89 da                	mov    %ebx,%edx
  80299f:	83 c4 1c             	add    $0x1c,%esp
  8029a2:	5b                   	pop    %ebx
  8029a3:	5e                   	pop    %esi
  8029a4:	5f                   	pop    %edi
  8029a5:	5d                   	pop    %ebp
  8029a6:	c3                   	ret    
  8029a7:	90                   	nop
  8029a8:	89 fd                	mov    %edi,%ebp
  8029aa:	85 ff                	test   %edi,%edi
  8029ac:	75 0b                	jne    8029b9 <__umoddi3+0xe9>
  8029ae:	b8 01 00 00 00       	mov    $0x1,%eax
  8029b3:	31 d2                	xor    %edx,%edx
  8029b5:	f7 f7                	div    %edi
  8029b7:	89 c5                	mov    %eax,%ebp
  8029b9:	89 f0                	mov    %esi,%eax
  8029bb:	31 d2                	xor    %edx,%edx
  8029bd:	f7 f5                	div    %ebp
  8029bf:	89 c8                	mov    %ecx,%eax
  8029c1:	f7 f5                	div    %ebp
  8029c3:	89 d0                	mov    %edx,%eax
  8029c5:	e9 44 ff ff ff       	jmp    80290e <__umoddi3+0x3e>
  8029ca:	66 90                	xchg   %ax,%ax
  8029cc:	89 c8                	mov    %ecx,%eax
  ...
  8029d6:	5d                   	pop    %ebp
  8029d7:	c3                   	ret    
  8029d8:	3b 04 24             	cmp    (%esp),%eax
  8029db:	72 06                	jb     8029e3 <__umoddi3+0x113>
  8029dd:	3b 7c 24 04          	cmp    0x4(%esp),%edi
  8029e1:	77 0f                	ja     8029f2 <__umoddi3+0x122>
  8029e3:	89 f2                	mov    %esi,%edx
  8029e5:	29 f9                	sub    %edi,%ecx
  8029e7:	1b 54 24 0c          	sbb    0xc(%esp),%edx
  8029eb:	89 14 24             	mov    %edx,(%esp)
  8029ee:	89 4c 24 04          	mov    %ecx,0x4(%esp)
  8029f2:	8b 44 24 04          	mov    0x4(%esp),%eax
  8029f6:	8b 14 24             	mov    (%esp),%edx
  ...
  802a04:	2b 04 24             	sub    (%esp),%eax
  802a07:	19 fa                	sbb    %edi,%edx
  802a09:	89 d1                	mov    %edx,%ecx
  802a0b:	89 c6                	mov    %eax,%esi
  802a0d:	e9 71 ff ff ff       	jmp    802983 <__umoddi3+0xb3>
  802a12:	66 90                	xchg   %ax,%ax
  802a14:	39 44 24 04          	cmp    %eax,0x4(%esp)
  802a18:	72 ea                	jb     802a04 <__umoddi3+0x134>
  802a1a:	89 d9                	mov    %ebx,%ecx
  802a1c:	e9 62 ff ff ff       	jmp    802983 <__umoddi3+0xb3>
