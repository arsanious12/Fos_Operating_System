...
libmain(int argc, char **argv)
{
  ...
  800303:	a3 20 40 80 00       	mov    %eax,0x804020
  ...
  80031c:	a3 04 40 80 00       	mov    %eax,0x804004
  ...
  80032c:	a3 04 40 80 00       	mov    %eax,0x804004
  ...
  80033f:	83 c4 10             	add    $0x10,%esp
	...
	if (printStats)
  800342:	a1 00 40 80 00       	mov    0x804000,%eax
  ...
  800355:	bb 84 2e 80 00       	mov    $0x802e84,%ebx
  ...
  80039a:	68 a4 2d 80 00       	push   $0x802da4
  ...
  8003b6:	50                   	push   %eax
  8003b7:	68 cc 2d 80 00       	push   $0x802dcc
  ...
  8003df:	52                   	push   %edx
  8003e0:	50                   	push   %eax
  8003e1:	68 f0 2d 80 00       	push   $0x802df0
  ...
  8003f9:	a1 20 40 80 00       	mov    0x804020,%eax
...
_panic(const char *file, int line, const char *fmt,...)
{
  ...
  8004e5:	68 18 2f 80 00       	push   $0x802f18
...
void CheckWSArrayWithoutLastIndex(uint32 *expectedPages, int arraySize)
{
  ...
  800514:	68 1c 2f 80 00       	push   $0x802f1c
  800519:	6a 26                	push   $0x26
  80051b:	68 68 2f 80 00       	push   $0x802f68
  ...
  800565:	a1 20 40 80 00       	mov    0x804020,%eax
  ...
  800585:	a1 20 40 80 00       	mov    0x804020,%eax
  ...
  8005ce:	a1 20 40 80 00       	mov    0x804020,%eax
  ...
  8005e9:	68 74 2f 80 00       	push   $0x802f74
  8005ee:	6a 3a                	push   $0x3a
  8005f0:	68 68 2f 80 00       	push   $0x802f68
  ...
  800619:	a1 20 40 80 00       	mov    0x804020,%eax
  ...
  80063f:	a1 20 40 80 00       	mov    0x804020,%eax
  ...
  80065c:	68 c8 2f 80 00       	push   $0x802fc8
  800661:	6a 44                	push   $0x44
  800663:	68 68 2f 80 00       	push   $0x802f68
...
static void putch(int ch, struct printbuf *b) {
  ...
  80069c:	8b 15 1c c1 81 00    	mov    0x81c11c,%edx
  8006a2:	a0 44 40 80 00       	mov    0x804044,%al
...
int vcprintf(const char *fmt, va_list ap) {
  ...
  800715:	83 c4 10             	add    $0x10,%esp
	sys_cputs(b.buf, b.idx, printProgName, curTextClr);
  800718:	8b 15 1c c1 81 00    	mov    0x81c11c,%edx
  80071e:	a0 44 40 80 00       	mov    0x804044,%al
  ...
  80073e:	83 c4 10             	add    $0x10,%esp
	...
	printProgName = 0;
  800741:	c6 05 44 40 80 00 00 	movb   $0x0,0x804044
	return b.cnt;
...
int cprintf(const char *fmt, ...) {
  ...
  800753:	83 ec 18             	sub    $0x18,%esp
	...
	int cnt;
	printProgName = 1 ;
  800756:	c6 05 44 40 80 00 01 	movb   $0x1,0x804044
	va_start(ap, fmt);
...
int cprintf_colored(int textClr, const char *fmt, ...) {
  ...
  800780:	83 ec 18             	sub    $0x18,%esp
	...
	int cnt;
	printProgName = 1 ;
  800783:	c6 05 44 40 80 00 01 	movb   $0x1,0x804044
	curTextClr = (textClr << 8) ; //set text color by the given value
  80078a:	8b 45 08             	mov    0x8(%ebp),%eax
  80078d:	c1 e0 08             	shl    $0x8,%eax
  800790:	a3 1c c1 81 00       	mov    %eax,0x81c11c
	va_start(ap, fmt);
  ...
  8007b3:	c7 05 1c c1 81 00 00 	movl   $0x700,0x81c11c
  8007ba:	07 00 00 
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800832:	e8 09 20 00 00       	call   802840 <__udivdi3>
  ...
  800880:	52                   	push   %edx
  800881:	50                   	push   %eax
  800882:	e8 c9 20 00 00       	call   802950 <__umoddi3>
  800887:	83 c4 10             	add    $0x10,%esp
  80088a:	05 34 32 80 00       	add    $0x803234,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8009dd:	8b 04 85 58 32 80 00 	mov    0x803258(,%eax,4),%eax
  ...
  800abe:	8b 34 9d a0 30 80 00 	mov    0x8030a0(,%ebx,4),%esi
  800ac5:	85 f6                	test   %esi,%esi
  800ac7:	75 19                	jne    800ae2 <vprintfmt+0x173>
				printfmt(putch, putdat, "error %d", err);
  800ac9:	53                   	push   %ebx
  800aca:	68 45 32 80 00       	push   $0x803245
  ...
  800add:	e9 5b 02 00 00       	jmp    800d3d <vprintfmt+0x3ce>
			...
			if (err > MAXERROR || (p = error_string[err]) == NULL)
				...
				printfmt(putch, putdat, "%s", p);
  800ae2:	56                   	push   %esi
  800ae3:	68 4e 32 80 00       	push   $0x80324e
  ...
  800b0e:	75 05                	jne    800b15 <vprintfmt+0x1a6>
				p = "(null)";
  800b10:	be 51 32 80 00       	mov    $0x803251,%esi
			if (width > 0 && padc != '-')
  ...
  800d06:	eb 35                	jmp    800d3d <vprintfmt+0x3ce>
		...
		case '~':
			printProgName = 0;
  800d08:	c6 05 44 40 80 00 00 	movb   $0x0,0x804044
			break;
  800d0f:	eb 2c                	jmp    800d3d <vprintfmt+0x3ce>
		// Print Program Name & UD
		case '@':
			printProgName = 1;
  800d11:	c6 05 44 40 80 00 01 	movb   $0x1,0x804044
			break;
...
void uheap_init()
{
  ...
  801638:	83 ec 08             	sub    $0x8,%esp
	if(__firstTimeFlag)
  80163b:	a1 08 40 80 00       	mov    0x804008,%eax
  ...
  80165e:	a3 60 c0 81 00       	mov    %eax,0x81c060
		uheapPageAllocStart = dynAllocEnd + PAGE_SIZE;
  801663:	a1 40 40 80 00       	mov    0x804040,%eax
  801668:	05 00 10 00 00       	add    $0x1000,%eax
  80166d:	a3 10 c1 81 00       	mov    %eax,0x81c110
		uheapPageAllocBreak = uheapPageAllocStart;
  801672:	a1 10 c1 81 00       	mov    0x81c110,%eax
  801677:	a3 68 c0 81 00       	mov    %eax,0x81c068

		__firstTimeFlag = 0;
  80167c:	c7 05 08 40 80 00 00 	movl   $0x0,0x804008
  801683:	00 00 00 
	}
}
  801686:	90                   	nop
...
int get_page(void* va)
{
  ...
  8016ba:	68 c8 33 80 00       	push   $0x8033c8
  8016bf:	6a 1f                	push   $0x1f
  8016c1:	68 04 34 80 00       	push   $0x803404
...
void return_page(void* va)
{
  ...
  8016fe:	68 10 34 80 00       	push   $0x803410
  801703:	6a 2a                	push   $0x2a
  801705:	68 04 34 80 00       	push   $0x803404
...
void* malloc(uint32 size)
{
  ...
  80172d:	68 50 34 80 00       	push   $0x803450
  801732:	6a 3e                	push   $0x3e
  801734:	68 04 34 80 00       	push   $0x803404
...
void free(void* virtual_address)
{
  ...
  801749:	68 78 34 80 00       	push   $0x803478
  80174e:	6a 49                	push   $0x49
  801750:	68 04 34 80 00       	push   $0x803404
...
void* smalloc(char *sharedVarName, uint32 size, uint8 isWritable)
{
  ...
  80177b:	68 9c 34 80 00       	push   $0x80349c
  801780:	6a 5a                	push   $0x5a
  801782:	68 04 34 80 00       	push   $0x803404
...
void* sget(int32 ownerEnvID, char *sharedVarName)
{
  ...
  8017a3:	68 04 34 80 00       	push   $0x803404
...
void *realloc(void *virtual_address, uint32 new_size)
{
  ...
  8017bb:	68 e8 34 80 00       	push   $0x8034e8
  8017c0:	68 88 00 00 00       	push   $0x88
  8017c5:	68 04 34 80 00       	push   $0x803404
...
void sfree(void* virtual_address)
{
  ...
  8017d8:	68 10 35 80 00       	push   $0x803510
  8017dd:	68 9b 00 00 00       	push   $0x9b
  8017e2:	68 04 34 80 00       	push   $0x803404
...
uint32 sys_get_uheap_strategy()
{
  ...
  801c5c:	a3 60 c0 81 00       	mov    %eax,0x81c060
	return uheapPlaceStrategy ;
  801c61:	a1 60 c0 81 00       	mov    0x81c060,%eax
}
  801c66:	c9                   	leave  
  801c67:	c3                   	ret    
...
void sys_set_uheap_strategy(uint32 heapStrategy)
{
  ...
  801c6e:	a3 60 c0 81 00       	mov    %eax,0x81c060
...
void sys_env_set_priority(int32 envID, int priority)
{
  ...
  801d82:	68 34 35 80 00       	push   $0x803534
  801d87:	68 25 01 00 00       	push   $0x125
  801d8c:	68 67 35 80 00       	push   $0x803567
...
__inline__ uint32 to_page_va(struct PageInfoElement *ptrPageInfo)
{
  ...
  801dff:	a1 64 c0 81 00       	mov    0x81c064,%eax
...
__inline__ struct PageInfoElement * to_page_info(uint32 va)
{
  ...
  801e0e:	a1 64 c0 81 00       	mov    0x81c064,%eax
  ...
  801e32:	68 bc 35 80 00       	push   $0x8035bc
  801e37:	6a 22                	push   $0x22
  801e39:	68 a3 35 80 00       	push   $0x8035a3
...
void initialize_dynamic_allocator(uint32 daStart, uint32 daEnd)
{
  ...
  801e69:	68 e0 35 80 00       	push   $0x8035e0
  801e6e:	68 06 36 80 00       	push   $0x803606
  801e73:	6a 34                	push   $0x34
  801e75:	68 a3 35 80 00       	push   $0x8035a3
  801e7a:	e8 03 e6 ff ff       	call   800482 <_panic>
		is_initialized = 1;
  801e7f:	c7 05 24 40 80 00 01 	movl   $0x1,0x804024
  801e86:	00 00 00 
	//==================================================================================
	//==================================================================================
  ...
  801e8c:	a3 64 c0 81 00       	mov    %eax,0x81c064
	dynAllocEnd = daEnd;
  801e91:	8b 45 0c             	mov    0xc(%ebp),%eax
  801e94:	a3 40 40 80 00       	mov    %eax,0x804040
	// init the list that keep track of all free pageBlockInfoArr instances.
	LIST_INIT(&freePagesList);
  801e99:	c7 05 48 40 80 00 00 	movl   $0x0,0x804048
  801ea0:	00 00 00 
  801ea3:	c7 05 4c 40 80 00 00 	movl   $0x0,0x80404c
  801eaa:	00 00 00 
  801ead:	c7 05 54 40 80 00 00 	movl   $0x0,0x804054
  801eb4:	00 00 00 

	// no.of pages in the dynamic allocator.
	int pCount = (daEnd - daStart) / PAGE_SIZE;
  801eb7:	8b 45 0c             	mov    0xc(%ebp),%eax
  801eba:	2b 45 08             	sub    0x8(%ebp),%eax
  801ebd:	c1 e8 0c             	shr    $0xc,%eax
  801ec0:	89 45 ec             	mov    %eax,-0x14(%ebp)
	// iterate over each page and init its data in pageBlockInfoArr and reset it.
	for (int i = 0; i < pCount; ++i) {
  801ec3:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  801eca:	e9 c8 00 00 00       	jmp    801f97 <initialize_dynamic_allocator+0x141>
  ...
  801edb:	05 68 40 80 00       	add    $0x804068,%eax
  801ee0:	66 c7 00 00 00       	movw   $0x0,(%eax)
  ...
  801ef1:	05 6a 40 80 00       	add    $0x80406a,%eax
  801ef6:	66 c7 00 00 00       	movw   $0x0,(%eax)
	    LIST_INSERT_TAIL(&freePagesList, &pageBlockInfoArr[i]);
  801efb:	8b 15 4c 40 80 00    	mov    0x80404c,%edx
  801f01:	8b 4d f4             	mov    -0xc(%ebp),%ecx
  801f04:	89 c8                	mov    %ecx,%eax
  801f06:	01 c0                	add    %eax,%eax
  801f08:	01 c8                	add    %ecx,%eax
  801f0a:	c1 e0 02             	shl    $0x2,%eax
  801f0d:	05 64 40 80 00       	add    $0x804064,%eax
  ...
  801f20:	05 64 40 80 00       	add    $0x804064,%eax
  801f25:	8b 00                	mov    (%eax),%eax
  801f27:	85 c0                	test   %eax,%eax
  801f29:	74 1b                	je     801f46 <initialize_dynamic_allocator+0xf0>
  801f2b:	8b 15 4c 40 80 00    	mov    0x80404c,%edx
  ...
  801f3d:	05 60 40 80 00       	add    $0x804060,%eax
  801f42:	89 02                	mov    %eax,(%edx)
  801f44:	eb 16                	jmp    801f5c <initialize_dynamic_allocator+0x106>
  ...
  801f61:	01 c0                	add    %eax,%eax
  801f63:	01 d0                	add    %edx,%eax
  801f65:	c1 e0 02             	shl    $0x2,%eax
  801f68:	05 60 40 80 00       	add    $0x804060,%eax
  801f6d:	a3 4c 40 80 00       	mov    %eax,0x80404c
  801f72:	8b 55 f4             	mov    -0xc(%ebp),%edx
  801f75:	89 d0                	mov    %edx,%eax
  801f77:	01 c0                	add    %eax,%eax
  801f79:	01 d0                	add    %edx,%eax
  801f7b:	c1 e0 02             	shl    $0x2,%eax
  801f7e:	05 60 40 80 00       	add    $0x804060,%eax
  801f83:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  801f89:	a1 54 40 80 00       	mov    0x804054,%eax
  801f8e:	40                   	inc    %eax
  801f8f:	a3 54 40 80 00       	mov    %eax,0x804054
	LIST_INIT(&freePagesList);
	...
	// iterate over each page and init its data in pageBlockInfoArr and reset it.
	for (int i = 0; i < pCount; ++i) {
  801f94:	ff 45 f4             	incl   -0xc(%ebp)
  801f97:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801f9a:	3b 45 ec             	cmp    -0x14(%ebp),%eax
  801f9d:	0f 8c 2c ff ff ff    	jl     801ecf <initialize_dynamic_allocator+0x79>
	    LIST_INSERT_TAIL(&freePagesList, &pageBlockInfoArr[i]);
	}
  ...
  801fe2:	83 7d f0 08          	cmpl   $0x8,-0x10(%ebp)
  801fe6:	7e c4                	jle    801fac <initialize_dynamic_allocator+0x156>
		LIST_INIT(&freeBlockLists[i]);
	}
	//Comment the following line
...
__inline__ uint32 get_block_size(void *va)
{
  ...
  801ff7:	50                   	push   %eax
  801ff8:	e8 0b fe ff ff       	call   801e08 <to_page_info>
...
//and putem in suitable freeblockList index according to size.
 void split_page_to_blocks(uint32 blk_size, struct PageInfoElement *pageInfo) {
  ...
  80201a:	e8 77 fd ff ff       	call   801d96 <to_page_va>
  80201f:	83 c4 10             	add    $0x10,%esp
  802022:	89 45 e8             	mov    %eax,-0x18(%ebp)
	 // no. of blks to save in freeblockList.
	 int blk_count = PAGE_SIZE / blk_size;
  802025:	b8 00 10 00 00       	mov    $0x1000,%eax
  80202a:	ba 00 00 00 00       	mov    $0x0,%edx
  80202f:	f7 75 08             	divl   0x8(%ebp)
  802032:	89 45 e4             	mov    %eax,-0x1c(%ebp)
	 // save page in memory.
	 get_page((uint32*)page_va);
  802035:	8b 45 e8             	mov    -0x18(%ebp),%eax
  802038:	83 ec 0c             	sub    $0xc,%esp
  80203b:	50                   	push   %eax
  80203c:	e8 48 f6 ff ff       	call   801689 <get_page>
  802041:	83 c4 10             	add    $0x10,%esp
	 // assigning the pageInfo data block size, free block which is whole block count.
	 pageInfo->num_of_free_blocks = blk_count;
  802044:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  802047:	8b 55 0c             	mov    0xc(%ebp),%edx
  80204a:	66 89 42 0a          	mov    %ax,0xa(%edx)
	 pageInfo->block_size = blk_size;
  80204e:	8b 45 08             	mov    0x8(%ebp),%eax
  802051:	8b 55 0c             	mov    0xc(%ebp),%edx
  802054:	66 89 42 08          	mov    %ax,0x8(%edx)
	 // get index by size block in freeblocklist.
	 int idx = 0;
  802058:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
	 for (int i = LOG2_MIN_SIZE; i <= LOG2_MAX_SIZE; i++) {
  80205f:	c7 45 f0 03 00 00 00 	movl   $0x3,-0x10(%ebp)
  802066:	eb 19                	jmp    802081 <split_page_to_blocks+0x73>
	     if ((1 << i) == blk_size)
  802068:	8b 45 f0             	mov    -0x10(%ebp),%eax
  80206b:	ba 01 00 00 00       	mov    $0x1,%edx
  802070:	88 c1                	mov    %al,%cl
  802072:	d3 e2                	shl    %cl,%edx
  802074:	89 d0                	mov    %edx,%eax
  802076:	3b 45 08             	cmp    0x8(%ebp),%eax
  802079:	74 0e                	je     802089 <split_page_to_blocks+0x7b>
	         break;
	     idx++;
  80207b:	ff 45 f4             	incl   -0xc(%ebp)
	 // assigning the pageInfo data block size, free block which is whole block count.
	 pageInfo->num_of_free_blocks = blk_count;
	 pageInfo->block_size = blk_size;
	 // get index by size block in freeblocklist.
	 int idx = 0;
	 for (int i = LOG2_MIN_SIZE; i <= LOG2_MAX_SIZE; i++) {
  80207e:	ff 45 f0             	incl   -0x10(%ebp)
  802081:	83 7d f0 0b          	cmpl   $0xb,-0x10(%ebp)
  802085:	7e e1                	jle    802068 <split_page_to_blocks+0x5a>
  802087:	eb 01                	jmp    80208a <split_page_to_blocks+0x7c>
	     if ((1 << i) == blk_size)
	         break;
  802089:	90                   	nop
	     idx++;
  ...
  802091:	e9 a7 00 00 00       	jmp    80213d <split_page_to_blocks+0x12f>
	     struct BlockElement *blk =(struct BlockElement*)(page_va + i * blk_size);
  802096:	8b 45 ec             	mov    -0x14(%ebp),%eax
  802099:	0f af 45 08          	imul   0x8(%ebp),%eax
  ...
  8020ab:	75 14                	jne    8020c1 <split_page_to_blocks+0xb3>
  8020ad:	83 ec 04             	sub    $0x4,%esp
  8020b0:	68 1c 36 80 00       	push   $0x80361c
  8020b5:	6a 7c                	push   $0x7c
  8020b7:	68 a3 35 80 00       	push   $0x8035a3
  8020bc:	e8 c1 e3 ff ff       	call   800482 <_panic>
  8020c1:	8b 45 f4             	mov    -0xc(%ebp),%eax
  8020c4:	c1 e0 04             	shl    $0x4,%eax
  8020c7:	05 84 c0 81 00       	add    $0x81c084,%eax
  8020cc:	8b 10                	mov    (%eax),%edx
  ...
  8020dc:	74 14                	je     8020f2 <split_page_to_blocks+0xe4>
  8020de:	8b 45 f4             	mov    -0xc(%ebp),%eax
  8020e1:	c1 e0 04             	shl    $0x4,%eax
  8020e4:	05 84 c0 81 00       	add    $0x81c084,%eax
  8020e9:	8b 00                	mov    (%eax),%eax
  8020eb:	8b 55 e0             	mov    -0x20(%ebp),%edx
  8020ee:	89 10                	mov    %edx,(%eax)
  8020f0:	eb 11                	jmp    802103 <split_page_to_blocks+0xf5>
  8020f2:	8b 45 f4             	mov    -0xc(%ebp),%eax
  8020f5:	c1 e0 04             	shl    $0x4,%eax
  8020f8:	8d 90 80 c0 81 00    	lea    0x81c080(%eax),%edx
  8020fe:	8b 45 e0             	mov    -0x20(%ebp),%eax
  802101:	89 02                	mov    %eax,(%edx)
  802103:	8b 45 f4             	mov    -0xc(%ebp),%eax
  802106:	c1 e0 04             	shl    $0x4,%eax
  802109:	8d 90 84 c0 81 00    	lea    0x81c084(%eax),%edx
  ...
  802123:	05 8c c0 81 00       	add    $0x81c08c,%eax
  802128:	8b 00                	mov    (%eax),%eax
  80212a:	8d 50 01             	lea    0x1(%eax),%edx
  80212d:	8b 45 f4             	mov    -0xc(%ebp),%eax
  802130:	c1 e0 04             	shl    $0x4,%eax
  802133:	05 8c c0 81 00       	add    $0x81c08c,%eax
  802138:	89 10                	mov    %edx,(%eax)
	 ...
	 // starting from the page_va.
	 for (uint32 i = 0; i < blk_count; ++i) {
  80213a:	ff 45 ec             	incl   -0x14(%ebp)
  80213d:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  802140:	39 45 ec             	cmp    %eax,-0x14(%ebp)
  802143:	0f 82 4d ff ff ff    	jb     802096 <split_page_to_blocks+0x88>
	     struct BlockElement *blk =(struct BlockElement*)(page_va + i * blk_size);
	     LIST_INSERT_TAIL(&freeBlockLists[idx],blk);
	 }
 }
...
void *alloc_block(uint32 size)
{
  ...
  80214f:	83 ec 38             	sub    $0x38,%esp
	//==================================================================================
	//DON'T CHANGE THESE LINES==========================================================
	//==================================================================================
	{
		assert(size <= DYN_ALLOC_MAX_BLOCK_SIZE);
  802152:	81 7d 08 00 08 00 00 	cmpl   $0x800,0x8(%ebp)
  802159:	76 19                	jbe    802174 <alloc_block+0x28>
  80215b:	68 40 36 80 00       	push   $0x803640
  802160:	68 06 36 80 00       	push   $0x803606
  802165:	68 8a 00 00 00       	push   $0x8a
  80216a:	68 a3 35 80 00       	push   $0x8035a3
  80216f:	e8 0e e3 ff ff       	call   800482 <_panic>
	//==================================================================================
	...
	uint32 idx = 0;
  802174:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
	for (int i = LOG2_MIN_SIZE; i <= LOG2_MAX_SIZE; ++i){
  80217b:	c7 45 f0 03 00 00 00 	movl   $0x3,-0x10(%ebp)
  802182:	eb 19                	jmp    80219d <alloc_block+0x51>
		if((1 << i) >= size) break;
  802184:	8b 45 f0             	mov    -0x10(%ebp),%eax
  802187:	ba 01 00 00 00       	mov    $0x1,%edx
  80218c:	88 c1                	mov    %al,%cl
  80218e:	d3 e2                	shl    %cl,%edx
  802190:	89 d0                	mov    %edx,%eax
  802192:	3b 45 08             	cmp    0x8(%ebp),%eax
  802195:	73 0e                	jae    8021a5 <alloc_block+0x59>
		idx++;
  802197:	ff 45 f4             	incl   -0xc(%ebp)
	...
	uint32 idx = 0;
	for (int i = LOG2_MIN_SIZE; i <= LOG2_MAX_SIZE; ++i){
  80219a:	ff 45 f0             	incl   -0x10(%ebp)
  80219d:	83 7d f0 0b          	cmpl   $0xb,-0x10(%ebp)
  8021a1:	7e e1                	jle    802184 <alloc_block+0x38>
  8021a3:	eb 01                	jmp    8021a6 <alloc_block+0x5a>
		if((1 << i) >= size) break;
  8021a5:	90                   	nop
		idx++;
	}
  ...
  8021a9:	c1 e0 04             	shl    $0x4,%eax
  8021ac:	05 8c c0 81 00       	add    $0x81c08c,%eax
  8021b1:	8b 00                	mov    (%eax),%eax
  8021b3:	85 c0                	test   %eax,%eax
  8021b5:	0f 84 df 00 00 00    	je     80229a <alloc_block+0x14e>
  ...
  8021c1:	05 80 c0 81 00       	add    $0x81c080,%eax
  8021c6:	8b 00                	mov    (%eax),%eax
  8021c8:	89 45 ec             	mov    %eax,-0x14(%ebp)
	    LIST_REMOVE(&freeBlockLists[idx], blk);
  8021cb:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
  8021cf:	75 17                	jne    8021e8 <alloc_block+0x9c>
  8021d1:	83 ec 04             	sub    $0x4,%esp
  8021d4:	68 61 36 80 00       	push   $0x803661
  8021d9:	68 9e 00 00 00       	push   $0x9e
  8021de:	68 a3 35 80 00       	push   $0x8035a3
  8021e3:	e8 9a e2 ff ff       	call   800482 <_panic>
  8021e8:	8b 45 ec             	mov    -0x14(%ebp),%eax
  8021eb:	8b 00                	mov    (%eax),%eax
  8021ed:	85 c0                	test   %eax,%eax
  8021ef:	74 10                	je     802201 <alloc_block+0xb5>
  8021f1:	8b 45 ec             	mov    -0x14(%ebp),%eax
  8021f4:	8b 00                	mov    (%eax),%eax
  8021f6:	8b 55 ec             	mov    -0x14(%ebp),%edx
  8021f9:	8b 52 04             	mov    0x4(%edx),%edx
  8021fc:	89 50 04             	mov    %edx,0x4(%eax)
  8021ff:	eb 14                	jmp    802215 <alloc_block+0xc9>
  ...
  802277:	50                   	push   %eax
  802278:	e8 8b fb ff ff       	call   801e08 <to_page_info>
  80227d:	83 c4 10             	add    $0x10,%esp
  802280:	89 45 e8             	mov    %eax,-0x18(%ebp)
	    pageInfo->num_of_free_blocks--;
  802283:	8b 45 e8             	mov    -0x18(%ebp),%eax
  802286:	66 8b 40 0a          	mov    0xa(%eax),%ax
  80228a:	48                   	dec    %eax
  80228b:	8b 55 e8             	mov    -0x18(%ebp),%edx
  80228e:	66 89 42 0a          	mov    %ax,0xa(%edx)
	    return blk;
  802292:	8b 45 ec             	mov    -0x14(%ebp),%eax
  802295:	e9 bc 02 00 00       	jmp    802556 <alloc_block+0x40a>
	}else{ //case(2, 3): 2. no free blocks available in the freeblocklist but there is free pages.
				//3. no free blocks and no available freepages so search in higher block sizes.
		// case 2:
		if(freePagesList.size > 0){ //have free pages.
  80229a:	a1 54 40 80 00       	mov    0x804054,%eax
  80229f:	85 c0                	test   %eax,%eax
  8022a1:	0f 84 7d 02 00 00    	je     802524 <alloc_block+0x3d8>
			// get page to split and use from freepagesList.
			struct PageInfoElement *ptr_new_page = LIST_FIRST(&freePagesList);
  8022a7:	a1 48 40 80 00       	mov    0x804048,%eax
  8022ac:	89 45 e4             	mov    %eax,-0x1c(%ebp)
			LIST_REMOVE(&freePagesList, ptr_new_page);
  8022af:	83 7d e4 00          	cmpl   $0x0,-0x1c(%ebp)
  8022b3:	75 17                	jne    8022cc <alloc_block+0x180>
  8022b5:	83 ec 04             	sub    $0x4,%esp
  8022b8:	68 61 36 80 00       	push   $0x803661
  8022bd:	68 a9 00 00 00       	push   $0xa9
  8022c2:	68 a3 35 80 00       	push   $0x8035a3
  8022c7:	e8 b6 e1 ff ff       	call   800482 <_panic>
  8022cc:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  8022cf:	8b 00                	mov    (%eax),%eax
  8022d1:	85 c0                	test   %eax,%eax
  8022d3:	74 10                	je     8022e5 <alloc_block+0x199>
  8022d5:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  8022d8:	8b 00                	mov    (%eax),%eax
  8022da:	8b 55 e4             	mov    -0x1c(%ebp),%edx
  8022dd:	8b 52 04             	mov    0x4(%edx),%edx
  8022e0:	89 50 04             	mov    %edx,0x4(%eax)
  8022e3:	eb 0b                	jmp    8022f0 <alloc_block+0x1a4>
  8022e5:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  ...
  8022f8:	74 0f                	je     802309 <alloc_block+0x1bd>
  8022fa:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  8022fd:	8b 40 04             	mov    0x4(%eax),%eax
  802300:	8b 55 e4             	mov    -0x1c(%ebp),%edx
  802303:	8b 12                	mov    (%edx),%edx
  802305:	89 10                	mov    %edx,(%eax)
  802307:	eb 0a                	jmp    802313 <alloc_block+0x1c7>
  ...
  802326:	a1 54 40 80 00       	mov    0x804054,%eax
  80232b:	48                   	dec    %eax
  80232c:	a3 54 40 80 00       	mov    %eax,0x804054
			// from page to freeblockList by the pageInfo and the block size.
			split_page_to_blocks(1 << (idx + LOG2_MIN_SIZE), ptr_new_page);
  802331:	8b 45 f4             	mov    -0xc(%ebp),%eax
  802334:	83 c0 03             	add    $0x3,%eax
  ...
  802348:	50                   	push   %eax
  802349:	e8 c0 fc ff ff       	call   80200e <split_page_to_blocks>
  ...
  802357:	05 80 c0 81 00       	add    $0x81c080,%eax
  80235c:	8b 00                	mov    (%eax),%eax
  80235e:	89 45 e0             	mov    %eax,-0x20(%ebp)
		    LIST_REMOVE(&freeBlockLists[idx], blk);
  802361:	83 7d e0 00          	cmpl   $0x0,-0x20(%ebp)
  802365:	75 17                	jne    80237e <alloc_block+0x232>
  802367:	83 ec 04             	sub    $0x4,%esp
  80236a:	68 61 36 80 00       	push   $0x803661
  80236f:	68 b0 00 00 00       	push   $0xb0
  802374:	68 a3 35 80 00       	push   $0x8035a3
  802379:	e8 04 e1 ff ff       	call   800482 <_panic>
  80237e:	8b 45 e0             	mov    -0x20(%ebp),%eax
  802381:	8b 00                	mov    (%eax),%eax
  802383:	85 c0                	test   %eax,%eax
  802385:	74 10                	je     802397 <alloc_block+0x24b>
  802387:	8b 45 e0             	mov    -0x20(%ebp),%eax
  80238a:	8b 00                	mov    (%eax),%eax
  80238c:	8b 55 e0             	mov    -0x20(%ebp),%edx
  80238f:	8b 52 04             	mov    0x4(%edx),%edx
  802392:	89 50 04             	mov    %edx,0x4(%eax)
  802395:	eb 14                	jmp    8023ab <alloc_block+0x25f>
  ...
  8023a3:	81 c2 84 c0 81 00    	add    $0x81c084,%edx
  8023a9:	89 02                	mov    %eax,(%edx)
  8023ab:	8b 45 e0             	mov    -0x20(%ebp),%eax
  8023ae:	8b 40 04             	mov    0x4(%eax),%eax
  8023b1:	85 c0                	test   %eax,%eax
  8023b3:	74 0f                	je     8023c4 <alloc_block+0x278>
  8023b5:	8b 45 e0             	mov    -0x20(%ebp),%eax
  8023b8:	8b 40 04             	mov    0x4(%eax),%eax
  8023bb:	8b 55 e0             	mov    -0x20(%ebp),%edx
  8023be:	8b 12                	mov    (%edx),%edx
  8023c0:	89 10                	mov    %edx,(%eax)
  8023c2:	eb 13                	jmp    8023d7 <alloc_block+0x28b>
  8023c4:	8b 45 e0             	mov    -0x20(%ebp),%eax
  8023c7:	8b 00                	mov    (%eax),%eax
  8023c9:	8b 55 f4             	mov    -0xc(%ebp),%edx
  8023cc:	c1 e2 04             	shl    $0x4,%edx
  8023cf:	81 c2 80 c0 81 00    	add    $0x81c080,%edx
  8023d5:	89 02                	mov    %eax,(%edx)
  8023d7:	8b 45 e0             	mov    -0x20(%ebp),%eax
  ...
  8023f0:	05 8c c0 81 00       	add    $0x81c08c,%eax
  8023f5:	8b 00                	mov    (%eax),%eax
  8023f7:	8d 50 ff             	lea    -0x1(%eax),%edx
  8023fa:	8b 45 f4             	mov    -0xc(%ebp),%eax
  8023fd:	c1 e0 04             	shl    $0x4,%eax
  802400:	05 8c c0 81 00       	add    $0x81c08c,%eax
  ...
  80240d:	50                   	push   %eax
  80240e:	e8 f5 f9 ff ff       	call   801e08 <to_page_info>
  802413:	83 c4 10             	add    $0x10,%esp
  802416:	89 45 dc             	mov    %eax,-0x24(%ebp)
		    pageInfo->num_of_free_blocks--;
  802419:	8b 45 dc             	mov    -0x24(%ebp),%eax
  80241c:	66 8b 40 0a          	mov    0xa(%eax),%ax
  802420:	48                   	dec    %eax
  802421:	8b 55 dc             	mov    -0x24(%ebp),%edx
  802424:	66 89 42 0a          	mov    %ax,0xa(%edx)
		    return blk;
  802428:	8b 45 e0             	mov    -0x20(%ebp),%eax
  80242b:	e9 26 01 00 00       	jmp    802556 <alloc_block+0x40a>
		}else{//case 3: no free block and no free page so iterate and try to find bigger size.
			// iterate over the list until finding available block
			while (idx <= (LOG2_MAX_SIZE - LOG2_MIN_SIZE) && freeBlockLists[idx].size == 0) {
				idx++;
  802430:	ff 45 f4             	incl   -0xc(%ebp)
				// found free block
				if(freeBlockLists[idx].size > 0){
  802433:	8b 45 f4             	mov    -0xc(%ebp),%eax
  802436:	c1 e0 04             	shl    $0x4,%eax
  802439:	05 8c c0 81 00       	add    $0x81c08c,%eax
  80243e:	8b 00                	mov    (%eax),%eax
  802440:	85 c0                	test   %eax,%eax
  802442:	0f 84 dc 00 00 00    	je     802524 <alloc_block+0x3d8>
					// remove from the list and updat the pageInfoArr free blocks.
					// pop from the freeBlockList.
					struct BlockElement *blk = LIST_FIRST(&freeBlockLists[idx]);
  802448:	8b 45 f4             	mov    -0xc(%ebp),%eax
  80244b:	c1 e0 04             	shl    $0x4,%eax
  80244e:	05 80 c0 81 00       	add    $0x81c080,%eax
  802453:	8b 00                	mov    (%eax),%eax
  802455:	89 45 d8             	mov    %eax,-0x28(%ebp)
				    LIST_REMOVE(&freeBlockLists[idx], blk);
  802458:	83 7d d8 00          	cmpl   $0x0,-0x28(%ebp)
  80245c:	75 17                	jne    802475 <alloc_block+0x329>
  80245e:	83 ec 04             	sub    $0x4,%esp
  802461:	68 61 36 80 00       	push   $0x803661
  802466:	68 be 00 00 00       	push   $0xbe
  80246b:	68 a3 35 80 00       	push   $0x8035a3
  802470:	e8 0d e0 ff ff       	call   800482 <_panic>
  802475:	8b 45 d8             	mov    -0x28(%ebp),%eax
  802478:	8b 00                	mov    (%eax),%eax
  80247a:	85 c0                	test   %eax,%eax
  80247c:	74 10                	je     80248e <alloc_block+0x342>
  80247e:	8b 45 d8             	mov    -0x28(%ebp),%eax
  802481:	8b 00                	mov    (%eax),%eax
  802483:	8b 55 d8             	mov    -0x28(%ebp),%edx
  802486:	8b 52 04             	mov    0x4(%edx),%edx
  802489:	89 50 04             	mov    %edx,0x4(%eax)
  80248c:	eb 14                	jmp    8024a2 <alloc_block+0x356>
  80248e:	8b 45 d8             	mov    -0x28(%ebp),%eax
  802491:	8b 40 04             	mov    0x4(%eax),%eax
  802494:	8b 55 f4             	mov    -0xc(%ebp),%edx
  802497:	c1 e2 04             	shl    $0x4,%edx
  80249a:	81 c2 84 c0 81 00    	add    $0x81c084,%edx
  8024a0:	89 02                	mov    %eax,(%edx)
  8024a2:	8b 45 d8             	mov    -0x28(%ebp),%eax
  8024a5:	8b 40 04             	mov    0x4(%eax),%eax
  8024a8:	85 c0                	test   %eax,%eax
  8024aa:	74 0f                	je     8024bb <alloc_block+0x36f>
  8024ac:	8b 45 d8             	mov    -0x28(%ebp),%eax
  8024af:	8b 40 04             	mov    0x4(%eax),%eax
  8024b2:	8b 55 d8             	mov    -0x28(%ebp),%edx
  8024b5:	8b 12                	mov    (%edx),%edx
  8024b7:	89 10                	mov    %edx,(%eax)
  8024b9:	eb 13                	jmp    8024ce <alloc_block+0x382>
  8024bb:	8b 45 d8             	mov    -0x28(%ebp),%eax
  8024be:	8b 00                	mov    (%eax),%eax
  8024c0:	8b 55 f4             	mov    -0xc(%ebp),%edx
  8024c3:	c1 e2 04             	shl    $0x4,%edx
  8024c6:	81 c2 80 c0 81 00    	add    $0x81c080,%edx
  ...
  8024e4:	c1 e0 04             	shl    $0x4,%eax
  8024e7:	05 8c c0 81 00       	add    $0x81c08c,%eax
  8024ec:	8b 00                	mov    (%eax),%eax
  8024ee:	8d 50 ff             	lea    -0x1(%eax),%edx
  8024f1:	8b 45 f4             	mov    -0xc(%ebp),%eax
  8024f4:	c1 e0 04             	shl    $0x4,%eax
  8024f7:	05 8c c0 81 00       	add    $0x81c08c,%eax
  8024fc:	89 10                	mov    %edx,(%eax)
				    // update pageBlockInfoArr
				    struct PageInfoElement *pageInfo = to_page_info((uint32)blk);
  8024fe:	8b 45 d8             	mov    -0x28(%ebp),%eax
  802501:	83 ec 0c             	sub    $0xc,%esp
  802504:	50                   	push   %eax
  802505:	e8 fe f8 ff ff       	call   801e08 <to_page_info>
  80250a:	83 c4 10             	add    $0x10,%esp
  80250d:	89 45 d4             	mov    %eax,-0x2c(%ebp)
				    pageInfo->num_of_free_blocks--;
  802510:	8b 45 d4             	mov    -0x2c(%ebp),%eax
  802513:	66 8b 40 0a          	mov    0xa(%eax),%ax
  802517:	48                   	dec    %eax
  802518:	8b 55 d4             	mov    -0x2c(%ebp),%edx
  80251b:	66 89 42 0a          	mov    %ax,0xa(%edx)
				    return blk;
  80251f:	8b 45 d8             	mov    -0x28(%ebp),%eax
  802522:	eb 32                	jmp    802556 <alloc_block+0x40a>
		    struct PageInfoElement *pageInfo = to_page_info((uint32)blk);
		    pageInfo->num_of_free_blocks--;
		    return blk;
		}else{//case 3: no free block and no free page so iterate and try to find bigger size.
			// iterate over the list until finding available block
			while (idx <= (LOG2_MAX_SIZE - LOG2_MIN_SIZE) && freeBlockLists[idx].size == 0) {
  802524:	83 7d f4 08          	cmpl   $0x8,-0xc(%ebp)
  802528:	77 15                	ja     80253f <alloc_block+0x3f3>
  80252a:	8b 45 f4             	mov    -0xc(%ebp),%eax
  80252d:	c1 e0 04             	shl    $0x4,%eax
  802530:	05 8c c0 81 00       	add    $0x81c08c,%eax
  802535:	8b 00                	mov    (%eax),%eax
  802537:	85 c0                	test   %eax,%eax
  802539:	0f 84 f1 fe ff ff    	je     802430 <alloc_block+0x2e4>
				}
			}
		}
	}
  ...
  802542:	68 7f 36 80 00       	push   $0x80367f
  802547:	68 c8 00 00 00       	push   $0xc8
  80254c:	68 a3 35 80 00       	push   $0x8035a3
  802551:	e8 2c df ff ff       	call   800482 <_panic>
...
void free_block(void *va)
{
  ...
  802561:	a1 64 c0 81 00       	mov    0x81c064,%eax
  802566:	39 c2                	cmp    %eax,%edx
  802568:	72 0c                	jb     802576 <free_block+0x1e>
  80256a:	8b 55 08             	mov    0x8(%ebp),%edx
  80256d:	a1 40 40 80 00       	mov    0x804040,%eax
  802572:	39 c2                	cmp    %eax,%edx
  802574:	72 19                	jb     80258f <free_block+0x37>
  802576:	68 90 36 80 00       	push   $0x803690
  80257b:	68 06 36 80 00       	push   $0x803606
  802580:	68 d7 00 00 00       	push   $0xd7
  802585:	68 a3 35 80 00       	push   $0x8035a3
  80258a:	e8 f3 de ff ff       	call   800482 <_panic>
  ...
  80259b:	50                   	push   %eax
  80259c:	e8 67 f8 ff ff       	call   801e08 <to_page_info>
  8025a1:	83 c4 10             	add    $0x10,%esp
  8025a4:	89 45 e4             	mov    %eax,-0x1c(%ebp)
	uint32 blk_size = pageInfo->block_size;
  8025a7:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  8025aa:	8b 40 08             	mov    0x8(%eax),%eax
  8025ad:	0f b7 c0             	movzwl %ax,%eax
  ...
  8025b3:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
	for (int i = LOG2_MIN_SIZE; i <= LOG2_MAX_SIZE; i++) {
  8025ba:	c7 45 f0 03 00 00 00 	movl   $0x3,-0x10(%ebp)
  8025c1:	eb 19                	jmp    8025dc <free_block+0x84>
	    if ((1 << i) == blk_size)
  8025c3:	8b 45 f0             	mov    -0x10(%ebp),%eax
  8025c6:	ba 01 00 00 00       	mov    $0x1,%edx
  8025cb:	88 c1                	mov    %al,%cl
  8025cd:	d3 e2                	shl    %cl,%edx
  8025cf:	89 d0                	mov    %edx,%eax
  8025d1:	3b 45 e0             	cmp    -0x20(%ebp),%eax
  8025d4:	74 0e                	je     8025e4 <free_block+0x8c>
	        break;
	    idx++;
  8025d6:	ff 45 f4             	incl   -0xc(%ebp)
	struct PageInfoElement *pageInfo = to_page_info((uint32)va);
	uint32 blk_size = pageInfo->block_size;
	...
	int idx = 0;
	for (int i = LOG2_MIN_SIZE; i <= LOG2_MAX_SIZE; i++) {
  8025d9:	ff 45 f0             	incl   -0x10(%ebp)
  8025dc:	83 7d f0 0b          	cmpl   $0xb,-0x10(%ebp)
  8025e0:	7e e1                	jle    8025c3 <free_block+0x6b>
  8025e2:	eb 01                	jmp    8025e5 <free_block+0x8d>
	    if ((1 << i) == blk_size)
	        break;
  8025e4:	90                   	nop
	    idx++;
  ...
  8025e8:	66 8b 40 0a          	mov    0xa(%eax),%ax
  8025ec:	40                   	inc    %eax
  8025ed:	8b 55 e4             	mov    -0x1c(%ebp),%edx
  8025f0:	66 89 42 0a          	mov    %ax,0xa(%edx)
	LIST_INSERT_TAIL(&freeBlockLists[idx], blk_to_free);
  8025f4:	83 7d e8 00          	cmpl   $0x0,-0x18(%ebp)
  8025f8:	75 17                	jne    802611 <free_block+0xb9>
  8025fa:	83 ec 04             	sub    $0x4,%esp
  8025fd:	68 1c 36 80 00       	push   $0x80361c
  802602:	68 ee 00 00 00       	push   $0xee
  802607:	68 a3 35 80 00       	push   $0x8035a3
  80260c:	e8 71 de ff ff       	call   800482 <_panic>
  802611:	8b 45 f4             	mov    -0xc(%ebp),%eax
  802614:	c1 e0 04             	shl    $0x4,%eax
  802617:	05 84 c0 81 00       	add    $0x81c084,%eax
  80261c:	8b 10                	mov    (%eax),%edx
  ...
  80267a:	8d 50 01             	lea    0x1(%eax),%edx
  80267d:	8b 45 f4             	mov    -0xc(%ebp),%eax
  802680:	c1 e0 04             	shl    $0x4,%eax
  802683:	05 8c c0 81 00       	add    $0x81c08c,%eax
  802688:	89 10                	mov    %edx,(%eax)

	// now, case 1: the page all blocks are freed so you free the page.
	int blk_count = PAGE_SIZE / blk_size;
  80268a:	b8 00 10 00 00       	mov    $0x1000,%eax
  80268f:	ba 00 00 00 00       	mov    $0x0,%edx
  802694:	f7 75 e0             	divl   -0x20(%ebp)
  802697:	89 45 dc             	mov    %eax,-0x24(%ebp)
	// the blk count in the page is same as number fo free blocks free up the page.
	if (pageInfo->num_of_free_blocks == blk_count) {
  80269a:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  80269d:	66 8b 40 0a          	mov    0xa(%eax),%ax
  8026a1:	0f b7 c0             	movzwl %ax,%eax
  8026a4:	3b 45 dc             	cmp    -0x24(%ebp),%eax
  8026a7:	0f 85 70 01 00 00    	jne    80281d <free_block+0x2c5>
		uint32 page_va = to_page_va(pageInfo);
  8026ad:	83 ec 0c             	sub    $0xc,%esp
  8026b0:	ff 75 e4             	pushl  -0x1c(%ebp)
  8026b3:	e8 de f6 ff ff       	call   801d96 <to_page_va>
  8026b8:	83 c4 10             	add    $0x10,%esp
  8026bb:	89 45 d8             	mov    %eax,-0x28(%ebp)
		// remove all blk in the freeBlockList.
		for (uint32 off = 0; off < PAGE_SIZE; off += blk_size) {
  8026be:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  8026c5:	e9 b7 00 00 00       	jmp    802781 <free_block+0x229>
			struct BlockElement *blk = (struct BlockElement*)(page_va + off);
  8026ca:	8b 55 d8             	mov    -0x28(%ebp),%edx
  8026cd:	8b 45 ec             	mov    -0x14(%ebp),%eax
  8026d0:	01 d0                	add    %edx,%eax
  8026d2:	89 45 d4             	mov    %eax,-0x2c(%ebp)
			LIST_REMOVE(&freeBlockLists[idx], blk);
  8026d5:	83 7d d4 00          	cmpl   $0x0,-0x2c(%ebp)
  8026d9:	75 17                	jne    8026f2 <free_block+0x19a>
  8026db:	83 ec 04             	sub    $0x4,%esp
  8026de:	68 61 36 80 00       	push   $0x803661
  8026e3:	68 f8 00 00 00       	push   $0xf8
  8026e8:	68 a3 35 80 00       	push   $0x8035a3
  8026ed:	e8 90 dd ff ff       	call   800482 <_panic>
  8026f2:	8b 45 d4             	mov    -0x2c(%ebp),%eax
  8026f5:	8b 00                	mov    (%eax),%eax
  8026f7:	85 c0                	test   %eax,%eax
  8026f9:	74 10                	je     80270b <free_block+0x1b3>
  ...
  802709:	eb 14                	jmp    80271f <free_block+0x1c7>
  ...
  802717:	81 c2 84 c0 81 00    	add    $0x81c084,%edx
  80271d:	89 02                	mov    %eax,(%edx)
  80271f:	8b 45 d4             	mov    -0x2c(%ebp),%eax
  802722:	8b 40 04             	mov    0x4(%eax),%eax
  802725:	85 c0                	test   %eax,%eax
  802727:	74 0f                	je     802738 <free_block+0x1e0>
  802729:	8b 45 d4             	mov    -0x2c(%ebp),%eax
  80272c:	8b 40 04             	mov    0x4(%eax),%eax
  80272f:	8b 55 d4             	mov    -0x2c(%ebp),%edx
  802732:	8b 12                	mov    (%edx),%edx
  802734:	89 10                	mov    %edx,(%eax)
  802736:	eb 13                	jmp    80274b <free_block+0x1f3>
  802738:	8b 45 d4             	mov    -0x2c(%ebp),%eax
  80273b:	8b 00                	mov    (%eax),%eax
  80273d:	8b 55 f4             	mov    -0xc(%ebp),%edx
  802740:	c1 e2 04             	shl    $0x4,%edx
  802743:	81 c2 80 c0 81 00    	add    $0x81c080,%edx
  802749:	89 02                	mov    %eax,(%edx)
  ...
  802761:	c1 e0 04             	shl    $0x4,%eax
  802764:	05 8c c0 81 00       	add    $0x81c08c,%eax
  802769:	8b 00                	mov    (%eax),%eax
  80276b:	8d 50 ff             	lea    -0x1(%eax),%edx
  80276e:	8b 45 f4             	mov    -0xc(%ebp),%eax
  802771:	c1 e0 04             	shl    $0x4,%eax
  802774:	05 8c c0 81 00       	add    $0x81c08c,%eax
  ...
  80277e:	01 45 ec             	add    %eax,-0x14(%ebp)
  802781:	81 7d ec ff 0f 00 00 	cmpl   $0xfff,-0x14(%ebp)
  802788:	0f 86 3c ff ff ff    	jbe    8026ca <free_block+0x172>
			struct BlockElement *blk = (struct BlockElement*)(page_va + off);
			LIST_REMOVE(&freeBlockLists[idx], blk);
		}
		// reset page info.
  ...
  802791:	66 c7 40 08 00 00    	movw   $0x0,0x8(%eax)
		pageInfo->num_of_free_blocks = 0;
  802797:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  80279a:	66 c7 40 0a 00 00    	movw   $0x0,0xa(%eax)
		// add it to the available pages.
		LIST_INSERT_TAIL(&freePagesList, pageInfo);
  8027a0:	83 7d e4 00          	cmpl   $0x0,-0x1c(%ebp)
  8027a4:	75 17                	jne    8027bd <free_block+0x265>
  8027a6:	83 ec 04             	sub    $0x4,%esp
  8027a9:	68 1c 36 80 00       	push   $0x80361c
  8027ae:	68 fe 00 00 00       	push   $0xfe
  8027b3:	68 a3 35 80 00       	push   $0x8035a3
  8027b8:	e8 c5 dc ff ff       	call   800482 <_panic>
  8027bd:	8b 15 4c 40 80 00    	mov    0x80404c,%edx
...
void *realloc_block(void* va, uint32 new_size)
{
  ...
  802829:	68 c8 36 80 00       	push   $0x8036c8
  80282e:	68 11 01 00 00       	push   $0x111
  802833:	68 a3 35 80 00       	push   $0x8035a3
  802838:	e8 45 dc ff ff       	call   800482 <_panic>
...
00802840 <__udivdi3>:
  ...
  802892:	77 28                	ja     8028bc <__udivdi3+0x7c>
  802894:	0f bd fe             	bsr    %esi,%edi
  802897:	83 f7 1f             	xor    $0x1f,%edi
  80289a:	75 40                	jne    8028dc <__udivdi3+0x9c>
  80289c:	39 ce                	cmp    %ecx,%esi
  80289e:	72 0a                	jb     8028aa <__udivdi3+0x6a>
  8028a0:	3b 44 24 08          	cmp    0x8(%esp),%eax
  8028a4:	0f 87 9e 00 00 00    	ja     802948 <__udivdi3+0x108>
  ...
  8028da:	5d                   	pop    %ebp
  8028db:	c3                   	ret    
  8028dc:	bd 20 00 00 00       	mov    $0x20,%ebp
  8028e1:	89 eb                	mov    %ebp,%ebx
  8028e3:	29 fb                	sub    %edi,%ebx
  8028e5:	89 f9                	mov    %edi,%ecx
  8028e7:	d3 e6                	shl    %cl,%esi
  8028e9:	89 c5                	mov    %eax,%ebp
  8028eb:	88 d9                	mov    %bl,%cl
  8028ed:	d3 ed                	shr    %cl,%ebp
  8028ef:	89 e9                	mov    %ebp,%ecx
  8028f1:	09 f1                	or     %esi,%ecx
  8028f3:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
  8028f7:	89 f9                	mov    %edi,%ecx
  8028f9:	d3 e0                	shl    %cl,%eax
  8028fb:	89 c5                	mov    %eax,%ebp
  8028fd:	89 d6                	mov    %edx,%esi
  8028ff:	88 d9                	mov    %bl,%cl
  802901:	d3 ee                	shr    %cl,%esi
  802903:	89 f9                	mov    %edi,%ecx
  802905:	d3 e2                	shl    %cl,%edx
  802907:	8b 44 24 08          	mov    0x8(%esp),%eax
  80290b:	88 d9                	mov    %bl,%cl
  80290d:	d3 e8                	shr    %cl,%eax
  80290f:	09 c2                	or     %eax,%edx
  802911:	89 d0                	mov    %edx,%eax
  802913:	89 f2                	mov    %esi,%edx
  802915:	f7 74 24 0c          	divl   0xc(%esp)
  802919:	89 d6                	mov    %edx,%esi
  80291b:	89 c3                	mov    %eax,%ebx
  80291d:	f7 e5                	mul    %ebp
  80291f:	39 d6                	cmp    %edx,%esi
  802921:	72 19                	jb     80293c <__udivdi3+0xfc>
  802923:	74 0b                	je     802930 <__udivdi3+0xf0>
  802925:	89 d8                	mov    %ebx,%eax
  802927:	31 ff                	xor    %edi,%edi
  802929:	e9 58 ff ff ff       	jmp    802886 <__udivdi3+0x46>
  80292e:	66 90                	xchg   %ax,%ax
  802930:	8b 54 24 08          	mov    0x8(%esp),%edx
  802934:	89 f9                	mov    %edi,%ecx
  802936:	d3 e2                	shl    %cl,%edx
  802938:	39 c2                	cmp    %eax,%edx
  80293a:	73 e9                	jae    802925 <__udivdi3+0xe5>
  80293c:	8d 43 ff             	lea    -0x1(%ebx),%eax
  80293f:	31 ff                	xor    %edi,%edi
  802941:	e9 40 ff ff ff       	jmp    802886 <__udivdi3+0x46>
  802946:	66 90                	xchg   %ax,%ax
  802948:	31 c0                	xor    %eax,%eax
  80294a:	e9 37 ff ff ff       	jmp    802886 <__udivdi3+0x46>
  80294f:	90                   	nop
...
00802950 <__umoddi3>:
  ...
  802957:	8b 4c 24 30          	mov    0x30(%esp),%ecx
  80295b:	8b 74 24 34          	mov    0x34(%esp),%esi
  80295f:	8b 7c 24 38          	mov    0x38(%esp),%edi
  802963:	8b 44 24 3c          	mov    0x3c(%esp),%eax
  802967:	89 44 24 0c          	mov    %eax,0xc(%esp)
  80296b:	89 4c 24 08          	mov    %ecx,0x8(%esp)
  80296f:	89 f3                	mov    %esi,%ebx
  802971:	89 fa                	mov    %edi,%edx
  802973:	89 4c 24 04          	mov    %ecx,0x4(%esp)
  802977:	89 34 24             	mov    %esi,(%esp)
  80297a:	85 c0                	test   %eax,%eax
  80297c:	75 1a                	jne    802998 <__umoddi3+0x48>
  80297e:	39 f7                	cmp    %esi,%edi
  802980:	0f 86 a2 00 00 00    	jbe    802a28 <__umoddi3+0xd8>
  802986:	89 c8                	mov    %ecx,%eax
  802988:	89 f2                	mov    %esi,%edx
  80298a:	f7 f7                	div    %edi
  ...
  802996:	5d                   	pop    %ebp
  802997:	c3                   	ret    
  802998:	39 f0                	cmp    %esi,%eax
  80299a:	0f 87 ac 00 00 00    	ja     802a4c <__umoddi3+0xfc>
  8029a0:	0f bd e8             	bsr    %eax,%ebp
  8029a3:	83 f5 1f             	xor    $0x1f,%ebp
  8029a6:	0f 84 ac 00 00 00    	je     802a58 <__umoddi3+0x108>
  8029ac:	bf 20 00 00 00       	mov    $0x20,%edi
  8029b1:	29 ef                	sub    %ebp,%edi
  8029b3:	89 fe                	mov    %edi,%esi
  8029b5:	89 7c 24 0c          	mov    %edi,0xc(%esp)
  8029b9:	89 e9                	mov    %ebp,%ecx
  8029bb:	d3 e0                	shl    %cl,%eax
  8029bd:	89 d7                	mov    %edx,%edi
  8029bf:	89 f1                	mov    %esi,%ecx
  8029c1:	d3 ef                	shr    %cl,%edi
  8029c3:	09 c7                	or     %eax,%edi
  8029c5:	89 e9                	mov    %ebp,%ecx
  8029c7:	d3 e2                	shl    %cl,%edx
  8029c9:	89 14 24             	mov    %edx,(%esp)
  8029cc:	89 d8                	mov    %ebx,%eax
  8029ce:	d3 e0                	shl    %cl,%eax
  8029d0:	89 c2                	mov    %eax,%edx
  8029d2:	8b 44 24 08          	mov    0x8(%esp),%eax
  8029d6:	d3 e0                	shl    %cl,%eax
  8029d8:	89 44 24 04          	mov    %eax,0x4(%esp)
  8029dc:	8b 44 24 08          	mov    0x8(%esp),%eax
  8029e0:	89 f1                	mov    %esi,%ecx
  8029e2:	d3 e8                	shr    %cl,%eax
  8029e4:	09 d0                	or     %edx,%eax
  8029e6:	d3 eb                	shr    %cl,%ebx
  8029e8:	89 da                	mov    %ebx,%edx
  8029ea:	f7 f7                	div    %edi
  8029ec:	89 d3                	mov    %edx,%ebx
  8029ee:	f7 24 24             	mull   (%esp)
  8029f1:	89 c6                	mov    %eax,%esi
  8029f3:	89 d1                	mov    %edx,%ecx
  8029f5:	39 d3                	cmp    %edx,%ebx
  8029f7:	0f 82 87 00 00 00    	jb     802a84 <__umoddi3+0x134>
  8029fd:	0f 84 91 00 00 00    	je     802a94 <__umoddi3+0x144>
  802a03:	8b 54 24 04          	mov    0x4(%esp),%edx
  802a07:	29 f2                	sub    %esi,%edx
  802a09:	19 cb                	sbb    %ecx,%ebx
  802a0b:	89 d8                	mov    %ebx,%eax
  802a0d:	8a 4c 24 0c          	mov    0xc(%esp),%cl
  802a11:	d3 e0                	shl    %cl,%eax
  802a13:	89 e9                	mov    %ebp,%ecx
  802a15:	d3 ea                	shr    %cl,%edx
  802a17:	09 d0                	or     %edx,%eax
  802a19:	89 e9                	mov    %ebp,%ecx
  802a1b:	d3 eb                	shr    %cl,%ebx
  802a1d:	89 da                	mov    %ebx,%edx
  802a1f:	83 c4 1c             	add    $0x1c,%esp
  802a22:	5b                   	pop    %ebx
  802a23:	5e                   	pop    %esi
  802a24:	5f                   	pop    %edi
  802a25:	5d                   	pop    %ebp
  ...
  802a3f:	89 c8                	mov    %ecx,%eax
  802a41:	f7 f5                	div    %ebp
  802a43:	89 d0                	mov    %edx,%eax
  802a45:	e9 44 ff ff ff       	jmp    80298e <__umoddi3+0x3e>
  802a4a:	66 90                	xchg   %ax,%ax
  802a4c:	89 c8                	mov    %ecx,%eax
  802a4e:	89 f2                	mov    %esi,%edx
  ...
  802a56:	5d                   	pop    %ebp
  802a57:	c3                   	ret    
  802a58:	3b 04 24             	cmp    (%esp),%eax
  802a5b:	72 06                	jb     802a63 <__umoddi3+0x113>
  802a5d:	3b 7c 24 04          	cmp    0x4(%esp),%edi
  802a61:	77 0f                	ja     802a72 <__umoddi3+0x122>
  802a63:	89 f2                	mov    %esi,%edx
  802a65:	29 f9                	sub    %edi,%ecx
  802a67:	1b 54 24 0c          	sbb    0xc(%esp),%edx
  802a6b:	89 14 24             	mov    %edx,(%esp)
  802a6e:	89 4c 24 04          	mov    %ecx,0x4(%esp)
  802a72:	8b 44 24 04          	mov    0x4(%esp),%eax
  802a76:	8b 14 24             	mov    (%esp),%edx
  ...
  802a84:	2b 04 24             	sub    (%esp),%eax
  802a87:	19 fa                	sbb    %edi,%edx
  802a89:	89 d1                	mov    %edx,%ecx
  802a8b:	89 c6                	mov    %eax,%esi
  802a8d:	e9 71 ff ff ff       	jmp    802a03 <__umoddi3+0xb3>
  802a92:	66 90                	xchg   %ax,%ax
  802a94:	39 44 24 04          	cmp    %eax,0x4(%esp)
  802a98:	72 ea                	jb     802a84 <__umoddi3+0x134>
  802a9a:	89 d9                	mov    %ebx,%ecx
  802a9c:	e9 62 ff ff ff       	jmp    802a03 <__umoddi3+0xb3>
