...
_main(void)
{
  ...
  80006e:	e8 6f 05 00 00       	call   8005e2 <atomic_cprintf>
  ...
  800091:	e8 0c 02 00 00       	call   8002a2 <_panic>

	//To indicate that it's completed successfully
	inctst();
  800096:	e8 e0 17 00 00       	call   80187b <inctst>
...
libmain(int argc, char **argv)
{
  ...
  8000e6:	e8 52 16 00 00       	call   80173d <sys_getenvindex>
  8000eb:	89 45 e4             	mov    %eax,-0x1c(%ebp)

	myEnv = &(envs[envIndex]);
  8000ee:	8b 55 e4             	mov    -0x1c(%ebp),%edx
  8000f1:	89 d0                	mov    %edx,%eax
  8000f3:	c1 e0 06             	shl    $0x6,%eax
  8000f6:	29 d0                	sub    %edx,%eax
  ...
  800114:	8d 04 95 00 00 00 00 	lea    0x0(,%edx,4),%eax
  80011b:	89 c2                	mov    %eax,%edx
  80011d:	8d 82 00 00 c0 ee    	lea    -0x11400000(%edx),%eax
  ...
  800132:	74 0d                	je     800141 <libmain+0x64>
  ...
  800145:	7e 0a                	jle    800151 <libmain+0x74>
		binaryname = argv[0];
  ...
  800169:	0f 84 01 01 00 00    	je     800270 <libmain+0x193>
	{
		char isOPTReplCmd[100] = "__IsOPTRepl__" ;
  80016f:	8d 85 7c ff ff ff    	lea    -0x84(%ebp),%eax
  800175:	bb bc 1d 80 00       	mov    $0x801dbc,%ebx
  ...
  800244:	8b 80 68 da 01 00    	mov    0x1da68(%eax),%eax
  80024a:	83 ec 08             	sub    $0x8,%esp
  80024d:	50                   	push   %eax
  80024e:	68 a8 1d 80 00       	push   $0x801da8
  800253:	e8 18 03 00 00       	call   800570 <cprintf>
  800258:	83 c4 10             	add    $0x10,%esp
			cprintf("**************************************\n");
  80025b:	83 ec 0c             	sub    $0xc,%esp
  80025e:	68 dc 1c 80 00       	push   $0x801cdc
...
_panic(const char *file, int line, const char *fmt,...)
{
  ...
  8002c2:	50                   	push   %eax
  8002c3:	68 20 1e 80 00       	push   $0x801e20
  ...
  8002de:	50                   	push   %eax
  8002df:	68 28 1e 80 00       	push   $0x801e28
  ...
  800305:	68 50 1e 80 00       	push   $0x801e50
...
void CheckWSArrayWithoutLastIndex(uint32 *expectedPages, int arraySize)
{
  ...
  800334:	68 54 1e 80 00       	push   $0x801e54
  800339:	6a 26                	push   $0x26
  80033b:	68 a0 1e 80 00       	push   $0x801ea0
  ...
  80038a:	8b 88 38 da 01 00    	mov    0x1da38(%eax),%ecx
  ...
  80043e:	8b 88 38 da 01 00    	mov    0x1da38(%eax),%ecx
  ...
  80047c:	68 00 1f 80 00       	push   $0x801f00
  800481:	6a 44                	push   $0x44
  800483:	68 a0 1e 80 00       	push   $0x801ea0
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8006aa:	05 74 21 80 00       	add    $0x802174,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8007fd:	8b 04 85 98 21 80 00 	mov    0x802198(,%eax,4),%eax
  ...
  8008de:	8b 34 9d e0 1f 80 00 	mov    0x801fe0(,%ebx,4),%esi
  8008e5:	85 f6                	test   %esi,%esi
  8008e7:	75 19                	jne    800902 <vprintfmt+0x173>
				printfmt(putch, putdat, "error %d", err);
  8008e9:	53                   	push   %ebx
  8008ea:	68 85 21 80 00       	push   $0x802185
  ...
  8008fd:	e9 5b 02 00 00       	jmp    800b5d <vprintfmt+0x3ce>
			...
			if (err > MAXERROR || (p = error_string[err]) == NULL)
				...
				printfmt(putch, putdat, "%s", p);
  800902:	56                   	push   %esi
  800903:	68 8e 21 80 00       	push   $0x80218e
  ...
  80092e:	75 05                	jne    800935 <vprintfmt+0x1a6>
				p = "(null)";
  800930:	be 91 21 80 00       	mov    $0x802191,%esi
			if (width > 0 && padc != '-')
...
void sys_env_set_priority(int32 envID, int priority)
{
  ...
  8019eb:	68 08 23 80 00       	push   $0x802308
  8019f0:	68 25 01 00 00       	push   $0x125
  8019f5:	68 3b 23 80 00       	push   $0x80233b
