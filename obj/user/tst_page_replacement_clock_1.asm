...
libmain(int argc, char **argv)
{
  ...
  800098:	a3 a0 30 80 00       	mov    %eax,0x8030a0

	//SET THE PROGRAM NAME
	if (myEnv->prog_name[0] != '\0')
  80009d:	a1 a0 30 80 00       	mov    0x8030a0,%eax
  8000a2:	8a 40 20             	mov    0x20(%eax),%al
  8000a5:	84 c0                	test   %al,%al
  8000a7:	74 0d                	je     8000b6 <libmain+0x64>
		binaryname = myEnv->prog_name;
  8000a9:	a1 a0 30 80 00       	mov    0x8030a0,%eax
  8000ae:	83 c0 20             	add    $0x20,%eax
  8000b1:	a3 90 30 80 00       	mov    %eax,0x803090
  ...
  8000c1:	a3 90 30 80 00       	mov    %eax,0x803090
  ...
  8000d4:	83 c4 10             	add    $0x10,%esp
	...
	if (printStats)
  8000d7:	a1 8c 30 80 00       	mov    0x80308c,%eax
  ...
  80015b:	a1 a0 30 80 00       	mov    0x8030a0,%eax
  800160:	8b 90 50 da 01 00    	mov    0x1da50(%eax),%edx
  800166:	a1 a0 30 80 00       	mov    0x8030a0,%eax
  ...
  800183:	a1 a0 30 80 00       	mov    0x8030a0,%eax
  ...
  800199:	a1 a0 30 80 00       	mov    0x8030a0,%eax
  ...
  8001b4:	a1 a0 30 80 00       	mov    0x8030a0,%eax
...
_panic(const char *file, int line, const char *fmt,...)
{
  ...
  800223:	89 45 f4             	mov    %eax,-0xc(%ebp)
	...
	if (argv0)
  800226:	a1 b8 71 82 00       	mov    0x8271b8,%eax
  80022b:	85 c0                	test   %eax,%eax
  80022d:	74 16                	je     800245 <_panic+0x2e>
		cprintf("%s: ", argv0);
  80022f:	a1 b8 71 82 00       	mov    0x8271b8,%eax
  ...
  800245:	a1 90 30 80 00       	mov    0x803090,%eax
...
void CheckWSArrayWithoutLastIndex(uint32 *expectedPages, int arraySize)
{
  ...
  800294:	a1 a0 30 80 00       	mov    0x8030a0,%eax
  ...
  8002fa:	a1 a0 30 80 00       	mov    0x8030a0,%eax
  ...
  80031a:	a1 a0 30 80 00       	mov    0x8030a0,%eax
  ...
  800363:	a1 a0 30 80 00       	mov    0x8030a0,%eax
  ...
  8003ae:	a1 a0 30 80 00       	mov    0x8030a0,%eax
...
static void putch(int ch, struct printbuf *b) {
  ...
  800431:	8b 15 bc 71 82 00    	mov    0x8271bc,%edx
  800437:	a0 c4 30 80 00       	mov    0x8030c4,%al
...
int vcprintf(const char *fmt, va_list ap) {
  ...
  8004aa:	83 c4 10             	add    $0x10,%esp
	sys_cputs(b.buf, b.idx, printProgName, curTextClr);
  8004ad:	8b 15 bc 71 82 00    	mov    0x8271bc,%edx
  8004b3:	a0 c4 30 80 00       	mov    0x8030c4,%al
  ...
  8004d3:	83 c4 10             	add    $0x10,%esp
	...
	printProgName = 0;
  8004d6:	c6 05 c4 30 80 00 00 	movb   $0x0,0x8030c4
	return b.cnt;
...
int cprintf(const char *fmt, ...) {
  ...
  8004e8:	83 ec 18             	sub    $0x18,%esp
	...
	int cnt;
	printProgName = 1 ;
  8004eb:	c6 05 c4 30 80 00 01 	movb   $0x1,0x8030c4
	va_start(ap, fmt);
...
int cprintf_colored(int textClr, const char *fmt, ...) {
  ...
  800515:	83 ec 18             	sub    $0x18,%esp
	...
	int cnt;
	printProgName = 1 ;
  800518:	c6 05 c4 30 80 00 01 	movb   $0x1,0x8030c4
	curTextClr = (textClr << 8) ; //set text color by the given value
  80051f:	8b 45 08             	mov    0x8(%ebp),%eax
  800522:	c1 e0 08             	shl    $0x8,%eax
  800525:	a3 bc 71 82 00       	mov    %eax,0x8271bc
	va_start(ap, fmt);
  ...
  800548:	c7 05 bc 71 82 00 00 	movl   $0x700,0x8271bc
  80054f:	07 00 00 
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800a9b:	eb 35                	jmp    800ad2 <vprintfmt+0x3ce>
		...
		case '~':
			printProgName = 0;
  800a9d:	c6 05 c4 30 80 00 00 	movb   $0x0,0x8030c4
			break;
  800aa4:	eb 2c                	jmp    800ad2 <vprintfmt+0x3ce>
		// Print Program Name & UD
		case '@':
			printProgName = 1;
  800aa6:	c6 05 c4 30 80 00 01 	movb   $0x1,0x8030c4
			break;
...
uint32 sys_get_uheap_strategy()
{
  ...
  80183a:	a3 00 71 82 00       	mov    %eax,0x827100
	return uheapPlaceStrategy ;
  80183f:	a1 00 71 82 00       	mov    0x827100,%eax
}
  801844:	c9                   	leave  
  801845:	c3                   	ret    
...
void sys_set_uheap_strategy(uint32 heapStrategy)
{
  ...
  80184c:	a3 00 71 82 00       	mov    %eax,0x827100
