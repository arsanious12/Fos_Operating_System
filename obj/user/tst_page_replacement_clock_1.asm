...
void _main(void)
{
  ...
  8000c3:	68 f8 1d 80 00       	push   $0x801df8
  ...
  8000e1:	68 11 1e 80 00       	push   $0x801e11
  ...
  800101:	68 11 1e 80 00       	push   $0x801e11
  ...
  800115:	68 20 1e 80 00       	push   $0x801e20
  ...
  800146:	68 48 1e 80 00       	push   $0x801e48
  ...
  80015a:	68 90 1e 80 00       	push   $0x801e90
  ...
  8001b1:	68 b8 1e 80 00       	push   $0x801eb8
  ...
  8001c5:	68 f0 1e 80 00       	push   $0x801ef0
...
libmain(int argc, char **argv)
{
  ...
  80025a:	bb 40 20 80 00       	mov    $0x802040,%ebx
  ...
  80029f:	68 60 1f 80 00       	push   $0x801f60
  ...
  8002bb:	50                   	push   %eax
  8002bc:	68 88 1f 80 00       	push   $0x801f88
  ...
  8002e4:	52                   	push   %edx
  8002e5:	50                   	push   %eax
  8002e6:	68 ac 1f 80 00       	push   $0x801fac
  ...
  800315:	52                   	push   %edx
  800316:	50                   	push   %eax
  800317:	68 d4 1f 80 00       	push   $0x801fd4
  ...
  800332:	50                   	push   %eax
  800333:	68 2c 20 80 00       	push   $0x80202c
  800338:	e8 18 03 00 00       	call   800655 <cprintf>
  80033d:	83 c4 10             	add    $0x10,%esp
			cprintf("**************************************\n");
  800340:	83 ec 0c             	sub    $0xc,%esp
  800343:	68 60 1f 80 00       	push   $0x801f60
...
_panic(const char *file, int line, const char *fmt,...)
{
  ...
  8003a7:	50                   	push   %eax
  8003a8:	68 a4 20 80 00       	push   $0x8020a4
  ...
  8003c3:	50                   	push   %eax
  8003c4:	68 ac 20 80 00       	push   $0x8020ac
  ...
  8003ea:	68 d4 20 80 00       	push   $0x8020d4
...
void CheckWSArrayWithoutLastIndex(uint32 *expectedPages, int arraySize)
{
  ...
  800419:	68 d8 20 80 00       	push   $0x8020d8
  80041e:	6a 26                	push   $0x26
  800420:	68 24 21 80 00       	push   $0x802124
  ...
  8004ee:	68 30 21 80 00       	push   $0x802130
  8004f3:	6a 3a                	push   $0x3a
  8004f5:	68 24 21 80 00       	push   $0x802124
  ...
  800561:	68 84 21 80 00       	push   $0x802184
  800566:	6a 44                	push   $0x44
  800568:	68 24 21 80 00       	push   $0x802124
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80078f:	05 f4 23 80 00       	add    $0x8023f4,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8008e2:	8b 04 85 18 24 80 00 	mov    0x802418(,%eax,4),%eax
  ...
  8009c3:	8b 34 9d 60 22 80 00 	mov    0x802260(,%ebx,4),%esi
  8009ca:	85 f6                	test   %esi,%esi
  8009cc:	75 19                	jne    8009e7 <vprintfmt+0x173>
				printfmt(putch, putdat, "error %d", err);
  8009ce:	53                   	push   %ebx
  8009cf:	68 05 24 80 00       	push   $0x802405
  ...
  8009e2:	e9 5b 02 00 00       	jmp    800c42 <vprintfmt+0x3ce>
			...
			if (err > MAXERROR || (p = error_string[err]) == NULL)
				...
				printfmt(putch, putdat, "%s", p);
  8009e7:	56                   	push   %esi
  8009e8:	68 0e 24 80 00       	push   $0x80240e
  ...
  800a13:	75 05                	jne    800a1a <vprintfmt+0x1a6>
				p = "(null)";
  800a15:	be 11 24 80 00       	mov    $0x802411,%esi
			if (width > 0 && padc != '-')
...
void sys_env_set_priority(int32 envID, int priority)
{
  ...
  801ad0:	68 88 25 80 00       	push   $0x802588
  801ad5:	68 25 01 00 00       	push   $0x125
  801ada:	68 bb 25 80 00       	push   $0x8025bb
