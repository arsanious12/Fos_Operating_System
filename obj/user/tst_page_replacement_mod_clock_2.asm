...
libmain(int argc, char **argv)
{
  ...
  8000ea:	bb 34 1d 80 00       	mov    $0x801d34,%ebx
  ...
  80012f:	68 54 1c 80 00       	push   $0x801c54
  ...
  80014b:	50                   	push   %eax
  80014c:	68 7c 1c 80 00       	push   $0x801c7c
  ...
  800174:	52                   	push   %edx
  800175:	50                   	push   %eax
  800176:	68 a0 1c 80 00       	push   $0x801ca0
  ...
  8001a5:	52                   	push   %edx
  8001a6:	50                   	push   %eax
  8001a7:	68 c8 1c 80 00       	push   $0x801cc8
  ...
  8001c2:	50                   	push   %eax
  8001c3:	68 20 1d 80 00       	push   $0x801d20
  8001c8:	e8 18 03 00 00       	call   8004e5 <cprintf>
  8001cd:	83 c4 10             	add    $0x10,%esp
			cprintf("**************************************\n");
  8001d0:	83 ec 0c             	sub    $0xc,%esp
  8001d3:	68 54 1c 80 00       	push   $0x801c54
...
_panic(const char *file, int line, const char *fmt,...)
{
  ...
  800237:	50                   	push   %eax
  800238:	68 98 1d 80 00       	push   $0x801d98
  ...
  800253:	50                   	push   %eax
  800254:	68 a0 1d 80 00       	push   $0x801da0
  ...
  80027a:	68 c8 1d 80 00       	push   $0x801dc8
...
void CheckWSArrayWithoutLastIndex(uint32 *expectedPages, int arraySize)
{
  ...
  80037e:	68 24 1e 80 00       	push   $0x801e24
  800383:	6a 3a                	push   $0x3a
  800385:	68 18 1e 80 00       	push   $0x801e18
  ...
  8003f1:	68 78 1e 80 00       	push   $0x801e78
  8003f6:	6a 44                	push   $0x44
  8003f8:	68 18 1e 80 00       	push   $0x801e18
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80061f:	05 f4 20 80 00       	add    $0x8020f4,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800772:	8b 04 85 18 21 80 00 	mov    0x802118(,%eax,4),%eax
  ...
  800853:	8b 34 9d 60 1f 80 00 	mov    0x801f60(,%ebx,4),%esi
  80085a:	85 f6                	test   %esi,%esi
  80085c:	75 19                	jne    800877 <vprintfmt+0x173>
				printfmt(putch, putdat, "error %d", err);
  80085e:	53                   	push   %ebx
  80085f:	68 05 21 80 00       	push   $0x802105
  ...
  800872:	e9 5b 02 00 00       	jmp    800ad2 <vprintfmt+0x3ce>
			...
			if (err > MAXERROR || (p = error_string[err]) == NULL)
				...
				printfmt(putch, putdat, "%s", p);
  800877:	56                   	push   %esi
  800878:	68 0e 21 80 00       	push   $0x80210e
  ...
  8008a3:	75 05                	jne    8008aa <vprintfmt+0x1a6>
				p = "(null)";
  8008a5:	be 11 21 80 00       	mov    $0x802111,%esi
			if (width > 0 && padc != '-')
...
void sys_env_set_priority(int32 envID, int priority)
{
  ...
  801960:	68 88 22 80 00       	push   $0x802288
  801965:	68 25 01 00 00       	push   $0x125
  80196a:	68 bb 22 80 00       	push   $0x8022bb
