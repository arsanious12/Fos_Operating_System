...
_main(void)
{
  ...
  800065:	68 00 29 80 00       	push   $0x802900
  80006a:	6a 0e                	push   $0xe
  80006c:	68 1c 29 80 00       	push   $0x80291c
...
sys_lock_cons();
  ...
  80008a:	68 3a 29 80 00       	push   $0x80293a
  80008f:	50                   	push   %eax
  ...
  8000a6:	68 3c 29 80 00       	push   $0x80293c
  ...
  8000c4:	68 60 29 80 00       	push   $0x802960
...
sys_unlock_cons();
  ...
  8000f9:	68 78 29 80 00       	push   $0x802978
  8000fe:	6a 25                	push   $0x25
  800100:	68 1c 29 80 00       	push   $0x80291c
...
libmain(int argc, char **argv)
{
  ...
  800143:	a3 20 40 80 00       	mov    %eax,0x804020

	//SET THE PROGRAM NAME
	if (myEnv->prog_name[0] != '\0')
  800148:	a1 20 40 80 00       	mov    0x804020,%eax
  80014d:	8a 40 20             	mov    0x20(%eax),%al
  800150:	84 c0                	test   %al,%al
  800152:	74 0d                	je     800161 <libmain+0x4f>
		binaryname = myEnv->prog_name;
  800154:	a1 20 40 80 00       	mov    0x804020,%eax
  800159:	83 c0 20             	add    $0x20,%eax
  80015c:	a3 04 40 80 00       	mov    %eax,0x804004
  ...
  80016c:	a3 04 40 80 00       	mov    %eax,0x804004
  ...
  80017f:	83 c4 10             	add    $0x10,%esp
	...
	if (printStats)
  800182:	a1 00 40 80 00       	mov    0x804000,%eax
  ...
  800195:	bb fc 2a 80 00       	mov    $0x802afc,%ebx
  ...
  8001da:	68 1c 2a 80 00       	push   $0x802a1c
  ...
  8001f6:	50                   	push   %eax
  8001f7:	68 44 2a 80 00       	push   $0x802a44
  ...
  80021f:	52                   	push   %edx
  800220:	50                   	push   %eax
  800221:	68 68 2a 80 00       	push   $0x802a68
  ...
  800250:	52                   	push   %edx
  800251:	50                   	push   %eax
  800252:	68 90 2a 80 00       	push   $0x802a90
...
_panic(const char *file, int line, const char *fmt,...)
{
  ...
  800325:	68 90 2b 80 00       	push   $0x802b90
...
void CheckWSArrayWithoutLastIndex(uint32 *expectedPages, int arraySize)
{
  ...
  80033f:	a1 20 40 80 00       	mov    0x804020,%eax
  ...
  800354:	68 94 2b 80 00       	push   $0x802b94
  800359:	6a 26                	push   $0x26
  80035b:	68 e0 2b 80 00       	push   $0x802be0
  ...
  8003a5:	a1 20 40 80 00       	mov    0x804020,%eax
  ...
  800429:	68 ec 2b 80 00       	push   $0x802bec
  80042e:	6a 3a                	push   $0x3a
  800430:	68 e0 2b 80 00       	push   $0x802be0
  ...
  80049c:	68 40 2c 80 00       	push   $0x802c40
  8004a1:	6a 44                	push   $0x44
  8004a3:	68 e0 2b 80 00       	push   $0x802be0
...
static void putch(int ch, struct printbuf *b) {
  ...
  8004dc:	8b 15 1c c1 81 00    	mov    0x81c11c,%edx
  8004e2:	a0 44 40 80 00       	mov    0x804044,%al
...
int vcprintf(const char *fmt, va_list ap) {
  ...
  800555:	83 c4 10             	add    $0x10,%esp
	sys_cputs(b.buf, b.idx, printProgName, curTextClr);
  800558:	8b 15 1c c1 81 00    	mov    0x81c11c,%edx
  80055e:	a0 44 40 80 00       	mov    0x804044,%al
  ...
  80057e:	83 c4 10             	add    $0x10,%esp
	...
	printProgName = 0;
  800581:	c6 05 44 40 80 00 00 	movb   $0x0,0x804044
	return b.cnt;
...
int cprintf(const char *fmt, ...) {
  ...
  800593:	83 ec 18             	sub    $0x18,%esp
	...
	int cnt;
	printProgName = 1 ;
  800596:	c6 05 44 40 80 00 01 	movb   $0x1,0x804044
	va_start(ap, fmt);
...
int cprintf_colored(int textClr, const char *fmt, ...) {
  ...
  8005c0:	83 ec 18             	sub    $0x18,%esp
	...
	int cnt;
	printProgName = 1 ;
  8005c3:	c6 05 44 40 80 00 01 	movb   $0x1,0x804044
	curTextClr = (textClr << 8) ; //set text color by the given value
  8005ca:	8b 45 08             	mov    0x8(%ebp),%eax
  8005cd:	c1 e0 08             	shl    $0x8,%eax
  8005d0:	a3 1c c1 81 00       	mov    %eax,0x81c11c
	va_start(ap, fmt);
  ...
  8005f3:	c7 05 1c c1 81 00 00 	movl   $0x700,0x81c11c
  8005fa:	07 00 00 
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800672:	e8 09 20 00 00       	call   802680 <__udivdi3>
  ...
  8006c0:	52                   	push   %edx
  8006c1:	50                   	push   %eax
  8006c2:	e8 c9 20 00 00       	call   802790 <__umoddi3>
  8006c7:	83 c4 10             	add    $0x10,%esp
  8006ca:	05 b4 2e 80 00       	add    $0x802eb4,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80081d:	8b 04 85 d8 2e 80 00 	mov    0x802ed8(,%eax,4),%eax
  ...
  8008fe:	8b 34 9d 20 2d 80 00 	mov    0x802d20(,%ebx,4),%esi
  800905:	85 f6                	test   %esi,%esi
  800907:	75 19                	jne    800922 <vprintfmt+0x173>
				printfmt(putch, putdat, "error %d", err);
  800909:	53                   	push   %ebx
  80090a:	68 c5 2e 80 00       	push   $0x802ec5
  ...
  80091d:	e9 5b 02 00 00       	jmp    800b7d <vprintfmt+0x3ce>
			...
			if (err > MAXERROR || (p = error_string[err]) == NULL)
				...
				printfmt(putch, putdat, "%s", p);
  800922:	56                   	push   %esi
  800923:	68 ce 2e 80 00       	push   $0x802ece
  ...
  80094e:	75 05                	jne    800955 <vprintfmt+0x1a6>
				p = "(null)";
  800950:	be d1 2e 80 00       	mov    $0x802ed1,%esi
			if (width > 0 && padc != '-')
  ...
  800b46:	eb 35                	jmp    800b7d <vprintfmt+0x3ce>
		...
		case '~':
			printProgName = 0;
  800b48:	c6 05 44 40 80 00 00 	movb   $0x0,0x804044
			break;
  800b4f:	eb 2c                	jmp    800b7d <vprintfmt+0x3ce>
		// Print Program Name & UD
		case '@':
			printProgName = 1;
  800b51:	c6 05 44 40 80 00 01 	movb   $0x1,0x804044
			break;
...
void uheap_init()
{
  ...
  80149e:	a3 60 c0 81 00       	mov    %eax,0x81c060
		uheapPageAllocStart = dynAllocEnd + PAGE_SIZE;
  8014a3:	a1 40 40 80 00       	mov    0x804040,%eax
  8014a8:	05 00 10 00 00       	add    $0x1000,%eax
  8014ad:	a3 10 c1 81 00       	mov    %eax,0x81c110
		uheapPageAllocBreak = uheapPageAllocStart;
  8014b2:	a1 10 c1 81 00       	mov    0x81c110,%eax
  8014b7:	a3 68 c0 81 00       	mov    %eax,0x81c068

		__firstTimeFlag = 0;
  8014bc:	c7 05 08 40 80 00 00 	movl   $0x0,0x804008
  8014c3:	00 00 00 
	}
}
  8014c6:	90                   	nop
...
int get_page(void* va)
{
  ...
  8014fa:	68 48 30 80 00       	push   $0x803048
  8014ff:	6a 1f                	push   $0x1f
  801501:	68 84 30 80 00       	push   $0x803084
...
void return_page(void* va)
{
  ...
  80153e:	68 90 30 80 00       	push   $0x803090
  801543:	6a 2a                	push   $0x2a
  801545:	68 84 30 80 00       	push   $0x803084
...
void* malloc(uint32 size)
{
  ...
  80156d:	68 d0 30 80 00       	push   $0x8030d0
  801572:	6a 3e                	push   $0x3e
  801574:	68 84 30 80 00       	push   $0x803084
...
void free(void* virtual_address)
{
  ...
  801589:	68 f8 30 80 00       	push   $0x8030f8
  80158e:	6a 49                	push   $0x49
  801590:	68 84 30 80 00       	push   $0x803084
...
void* smalloc(char *sharedVarName, uint32 size, uint8 isWritable)
{
  ...
  8015bb:	68 1c 31 80 00       	push   $0x80311c
  8015c0:	6a 5a                	push   $0x5a
  8015c2:	68 84 30 80 00       	push   $0x803084
...
void* sget(int32 ownerEnvID, char *sharedVarName)
{
  ...
  8015dc:	68 44 31 80 00       	push   $0x803144
  8015e1:	6a 6a                	push   $0x6a
  8015e3:	68 84 30 80 00       	push   $0x803084
...
void *realloc(void *virtual_address, uint32 new_size)
{
  ...
  8015fb:	68 68 31 80 00       	push   $0x803168
  801600:	68 88 00 00 00       	push   $0x88
  801605:	68 84 30 80 00       	push   $0x803084
...
void sfree(void* virtual_address)
{
  ...
  801618:	68 90 31 80 00       	push   $0x803190
  80161d:	68 9b 00 00 00       	push   $0x9b
  801622:	68 84 30 80 00       	push   $0x803084
...
uint32 sys_get_uheap_strategy()
{
  ...
  801a9c:	a3 60 c0 81 00       	mov    %eax,0x81c060
	return uheapPlaceStrategy ;
  801aa1:	a1 60 c0 81 00       	mov    0x81c060,%eax
}
  801aa6:	c9                   	leave  
  801aa7:	c3                   	ret    
...
void sys_env_set_priority(int32 envID, int priority)
{
  ...
  801bc2:	68 b4 31 80 00       	push   $0x8031b4
  801bc7:	68 25 01 00 00       	push   $0x125
  801bcc:	68 e7 31 80 00       	push   $0x8031e7
...
__inline__ uint32 to_page_va(struct PageInfoElement *ptrPageInfo)
{
  ...
  801c3f:	a1 64 c0 81 00       	mov    0x81c064,%eax
...
__inline__ struct PageInfoElement * to_page_info(uint32 va)
{
  ...
  801c4e:	a1 64 c0 81 00       	mov    0x81c064,%eax
  ...
  801c72:	68 3c 32 80 00       	push   $0x80323c
  801c77:	6a 22                	push   $0x22
  801c79:	68 23 32 80 00       	push   $0x803223
  ...
  801c8f:	05 60 40 80 00       	add    $0x804060,%eax
}
  801c94:	c9                   	leave  
  801c95:	c3                   	ret    
...
void initialize_dynamic_allocator(uint32 daStart, uint32 daEnd)
{
  ...
  801ca9:	68 60 32 80 00       	push   $0x803260
  801cae:	68 86 32 80 00       	push   $0x803286
  801cb3:	6a 34                	push   $0x34
  801cb5:	68 23 32 80 00       	push   $0x803223
  801cba:	e8 03 e6 ff ff       	call   8002c2 <_panic>
		is_initialized = 1;
  801cbf:	c7 05 24 40 80 00 01 	movl   $0x1,0x804024
  801cc6:	00 00 00 
	//==================================================================================
	//==================================================================================
  ...
  801ccc:	a3 64 c0 81 00       	mov    %eax,0x81c064
	dynAllocEnd = daEnd;
  801cd1:	8b 45 0c             	mov    0xc(%ebp),%eax
  801cd4:	a3 40 40 80 00       	mov    %eax,0x804040
	// init the list that keep track of all free pageBlockInfoArr instances.
	LIST_INIT(&freePagesList);
  801cd9:	c7 05 48 40 80 00 00 	movl   $0x0,0x804048
  801ce0:	00 00 00 
  801ce3:	c7 05 4c 40 80 00 00 	movl   $0x0,0x80404c
  801cea:	00 00 00 
  801ced:	c7 05 54 40 80 00 00 	movl   $0x0,0x804054
  801cf4:	00 00 00 

	// no.of pages in the dynamic allocator.
	int pCount = (daEnd - daStart) / PAGE_SIZE;
  801cf7:	8b 45 0c             	mov    0xc(%ebp),%eax
  801cfa:	2b 45 08             	sub    0x8(%ebp),%eax
  801cfd:	c1 e8 0c             	shr    $0xc,%eax
  801d00:	89 45 ec             	mov    %eax,-0x14(%ebp)
	// iterate over each page and init its data in pageBlockInfoArr and reset it.
	for (int i = 0; i < pCount; ++i) {
  801d03:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  801d0a:	e9 c8 00 00 00       	jmp    801dd7 <initialize_dynamic_allocator+0x141>
  ...
  801d1b:	05 68 40 80 00       	add    $0x804068,%eax
  801d20:	66 c7 00 00 00       	movw   $0x0,(%eax)
  ...
  801d31:	05 6a 40 80 00       	add    $0x80406a,%eax
  801d36:	66 c7 00 00 00       	movw   $0x0,(%eax)
	    LIST_INSERT_TAIL(&freePagesList, &pageBlockInfoArr[i]);
  801d3b:	8b 15 4c 40 80 00    	mov    0x80404c,%edx
  801d41:	8b 4d f4             	mov    -0xc(%ebp),%ecx
  801d44:	89 c8                	mov    %ecx,%eax
  801d46:	01 c0                	add    %eax,%eax
  801d48:	01 c8                	add    %ecx,%eax
  801d4a:	c1 e0 02             	shl    $0x2,%eax
  801d4d:	05 64 40 80 00       	add    $0x804064,%eax
  ...
  801d60:	05 64 40 80 00       	add    $0x804064,%eax
  801d65:	8b 00                	mov    (%eax),%eax
  801d67:	85 c0                	test   %eax,%eax
  801d69:	74 1b                	je     801d86 <initialize_dynamic_allocator+0xf0>
  ...
  801d7d:	05 60 40 80 00       	add    $0x804060,%eax
  801d82:	89 02                	mov    %eax,(%edx)
  801d84:	eb 16                	jmp    801d9c <initialize_dynamic_allocator+0x106>
  ...
  801d92:	05 60 40 80 00       	add    $0x804060,%eax
  801d97:	a3 48 40 80 00       	mov    %eax,0x804048
  ...
  801da8:	05 60 40 80 00       	add    $0x804060,%eax
  801dad:	a3 4c 40 80 00       	mov    %eax,0x80404c
  ...
  801dbe:	05 60 40 80 00       	add    $0x804060,%eax
  801dc3:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  801dc9:	a1 54 40 80 00       	mov    0x804054,%eax
  801dce:	40                   	inc    %eax
  801dcf:	a3 54 40 80 00       	mov    %eax,0x804054
	LIST_INIT(&freePagesList);
	...
	// iterate over each page and init its data in pageBlockInfoArr and reset it.
	for (int i = 0; i < pCount; ++i) {
  801dd4:	ff 45 f4             	incl   -0xc(%ebp)
  801dd7:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801dda:	3b 45 ec             	cmp    -0x14(%ebp),%eax
  801ddd:	0f 8c 2c ff ff ff    	jl     801d0f <initialize_dynamic_allocator+0x79>
	    LIST_INSERT_TAIL(&freePagesList, &pageBlockInfoArr[i]);
	}
  ...
  801dea:	eb 36                	jmp    801e22 <initialize_dynamic_allocator+0x18c>
		LIST_INIT(&freeBlockLists[i]);
  801dec:	8b 45 f0             	mov    -0x10(%ebp),%eax
  801def:	c1 e0 04             	shl    $0x4,%eax
  801df2:	05 80 c0 81 00       	add    $0x81c080,%eax
  801df7:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  801dfd:	8b 45 f0             	mov    -0x10(%ebp),%eax
  801e00:	c1 e0 04             	shl    $0x4,%eax
  801e03:	05 84 c0 81 00       	add    $0x81c084,%eax
  801e08:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  801e0e:	8b 45 f0             	mov    -0x10(%ebp),%eax
  801e11:	c1 e0 04             	shl    $0x4,%eax
  801e14:	05 8c c0 81 00       	add    $0x81c08c,%eax
  801e19:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
	    LIST_INSERT_TAIL(&freePagesList, &pageBlockInfoArr[i]);
	}
	// init the array of lists of each size..
	// 8 16 32 64 128 256 512 1024 2056
	// 0 1  2  3   4  5    6   7    8
	for (int i = 0; i <= (LOG2_MAX_SIZE - LOG2_MIN_SIZE); ++i){
  801e1f:	ff 45 f0             	incl   -0x10(%ebp)
  801e22:	83 7d f0 08          	cmpl   $0x8,-0x10(%ebp)
  801e26:	7e c4                	jle    801dec <initialize_dynamic_allocator+0x156>
		LIST_INIT(&freeBlockLists[i]);
	}
	//Comment the following line
...
__inline__ uint32 get_block_size(void *va)
{
  ...
  801e37:	50                   	push   %eax
  801e38:	e8 0b fe ff ff       	call   801c48 <to_page_info>
...
//and putem in suitable freeblockList index according to size.
 void split_page_to_blocks(uint32 blk_size, struct PageInfoElement *pageInfo) {
  ...
  801e5a:	e8 77 fd ff ff       	call   801bd6 <to_page_va>
  801e5f:	83 c4 10             	add    $0x10,%esp
  801e62:	89 45 e8             	mov    %eax,-0x18(%ebp)
	 // no. of blks to save in freeblockList.
	 int blk_count = PAGE_SIZE / blk_size;
  801e65:	b8 00 10 00 00       	mov    $0x1000,%eax
  801e6a:	ba 00 00 00 00       	mov    $0x0,%edx
  801e6f:	f7 75 08             	divl   0x8(%ebp)
  ...
  801e7b:	50                   	push   %eax
  801e7c:	e8 48 f6 ff ff       	call   8014c9 <get_page>
  801e81:	83 c4 10             	add    $0x10,%esp
	 // assigning the pageInfo data block size, free block which is whole block count.
	 pageInfo->num_of_free_blocks = blk_count;
  801e84:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  801e87:	8b 55 0c             	mov    0xc(%ebp),%edx
  801e8a:	66 89 42 0a          	mov    %ax,0xa(%edx)
	 pageInfo->block_size = blk_size;
  801e8e:	8b 45 08             	mov    0x8(%ebp),%eax
  801e91:	8b 55 0c             	mov    0xc(%ebp),%edx
  801e94:	66 89 42 08          	mov    %ax,0x8(%edx)
	 // get index by size block in freeblocklist.
	 int idx = 0;
  801e98:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
	 for (int i = LOG2_MIN_SIZE; i <= LOG2_MAX_SIZE; i++) {
  801e9f:	c7 45 f0 03 00 00 00 	movl   $0x3,-0x10(%ebp)
  801ea6:	eb 19                	jmp    801ec1 <split_page_to_blocks+0x73>
	     if ((1 << i) == blk_size)
  801ea8:	8b 45 f0             	mov    -0x10(%ebp),%eax
  801eab:	ba 01 00 00 00       	mov    $0x1,%edx
  801eb0:	88 c1                	mov    %al,%cl
  801eb2:	d3 e2                	shl    %cl,%edx
  801eb4:	89 d0                	mov    %edx,%eax
  801eb6:	3b 45 08             	cmp    0x8(%ebp),%eax
  801eb9:	74 0e                	je     801ec9 <split_page_to_blocks+0x7b>
	         break;
	     idx++;
  801ebb:	ff 45 f4             	incl   -0xc(%ebp)
	 ...
	 int idx = 0;
	 for (int i = LOG2_MIN_SIZE; i <= LOG2_MAX_SIZE; i++) {
  801ebe:	ff 45 f0             	incl   -0x10(%ebp)
  801ec1:	83 7d f0 0b          	cmpl   $0xb,-0x10(%ebp)
  801ec5:	7e e1                	jle    801ea8 <split_page_to_blocks+0x5a>
  801ec7:	eb 01                	jmp    801eca <split_page_to_blocks+0x7c>
	     if ((1 << i) == blk_size)
	         break;
  801ec9:	90                   	nop
	     idx++;
  ...
  801ed1:	e9 a7 00 00 00       	jmp    801f7d <split_page_to_blocks+0x12f>
	     struct BlockElement *blk =(struct BlockElement*)(page_va + i * blk_size);
  801ed6:	8b 45 ec             	mov    -0x14(%ebp),%eax
  801ed9:	0f af 45 08          	imul   0x8(%ebp),%eax
  801edd:	89 c2                	mov    %eax,%edx
  801edf:	8b 45 e8             	mov    -0x18(%ebp),%eax
  801ee2:	01 d0                	add    %edx,%eax
  801ee4:	89 45 e0             	mov    %eax,-0x20(%ebp)
	     LIST_INSERT_TAIL(&freeBlockLists[idx],blk);
  801ee7:	83 7d e0 00          	cmpl   $0x0,-0x20(%ebp)
  801eeb:	75 14                	jne    801f01 <split_page_to_blocks+0xb3>
  801eed:	83 ec 04             	sub    $0x4,%esp
  801ef0:	68 9c 32 80 00       	push   $0x80329c
  801ef5:	6a 7c                	push   $0x7c
  801ef7:	68 23 32 80 00       	push   $0x803223
  801efc:	e8 c1 e3 ff ff       	call   8002c2 <_panic>
  801f01:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801f04:	c1 e0 04             	shl    $0x4,%eax
  801f07:	05 84 c0 81 00       	add    $0x81c084,%eax
  801f0c:	8b 10                	mov    (%eax),%edx
  801f0e:	8b 45 e0             	mov    -0x20(%ebp),%eax
  801f11:	89 50 04             	mov    %edx,0x4(%eax)
  801f14:	8b 45 e0             	mov    -0x20(%ebp),%eax
  801f17:	8b 40 04             	mov    0x4(%eax),%eax
  801f1a:	85 c0                	test   %eax,%eax
  801f1c:	74 14                	je     801f32 <split_page_to_blocks+0xe4>
  801f1e:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801f21:	c1 e0 04             	shl    $0x4,%eax
  801f24:	05 84 c0 81 00       	add    $0x81c084,%eax
  801f29:	8b 00                	mov    (%eax),%eax
  801f2b:	8b 55 e0             	mov    -0x20(%ebp),%edx
  801f2e:	89 10                	mov    %edx,(%eax)
  801f30:	eb 11                	jmp    801f43 <split_page_to_blocks+0xf5>
  801f32:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801f35:	c1 e0 04             	shl    $0x4,%eax
  801f38:	8d 90 80 c0 81 00    	lea    0x81c080(%eax),%edx
  801f3e:	8b 45 e0             	mov    -0x20(%ebp),%eax
  801f41:	89 02                	mov    %eax,(%edx)
  801f43:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801f46:	c1 e0 04             	shl    $0x4,%eax
  801f49:	8d 90 84 c0 81 00    	lea    0x81c084(%eax),%edx
  ...
  801f60:	c1 e0 04             	shl    $0x4,%eax
  801f63:	05 8c c0 81 00       	add    $0x81c08c,%eax
  801f68:	8b 00                	mov    (%eax),%eax
  801f6a:	8d 50 01             	lea    0x1(%eax),%edx
  801f6d:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801f70:	c1 e0 04             	shl    $0x4,%eax
  801f73:	05 8c c0 81 00       	add    $0x81c08c,%eax
  801f78:	89 10                	mov    %edx,(%eax)
	         break;
	     idx++;
	 }
	 // iterate over each blk and make and element of it by passing its address in blockElement pointer and save those in the list.
	 // starting from the page_va.
	 for (uint32 i = 0; i < blk_count; ++i) {
  801f7a:	ff 45 ec             	incl   -0x14(%ebp)
  801f7d:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  801f80:	39 45 ec             	cmp    %eax,-0x14(%ebp)
  801f83:	0f 82 4d ff ff ff    	jb     801ed6 <split_page_to_blocks+0x88>
	     struct BlockElement *blk =(struct BlockElement*)(page_va + i * blk_size);
	     LIST_INSERT_TAIL(&freeBlockLists[idx],blk);
	 }
 }
...
void *alloc_block(uint32 size)
{
  ...
  801f8f:	83 ec 38             	sub    $0x38,%esp
	//==================================================================================
	//DON'T CHANGE THESE LINES==========================================================
	//==================================================================================
	{
		assert(size <= DYN_ALLOC_MAX_BLOCK_SIZE);
  801f92:	81 7d 08 00 08 00 00 	cmpl   $0x800,0x8(%ebp)
  801f99:	76 19                	jbe    801fb4 <alloc_block+0x28>
  801f9b:	68 c0 32 80 00       	push   $0x8032c0
  801fa0:	68 86 32 80 00       	push   $0x803286
  801fa5:	68 8a 00 00 00       	push   $0x8a
  801faa:	68 23 32 80 00       	push   $0x803223
  801faf:	e8 0e e3 ff ff       	call   8002c2 <_panic>
	//==================================================================================
	...
	uint32 idx = 0;
  801fb4:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
	for (int i = LOG2_MIN_SIZE; i <= LOG2_MAX_SIZE; ++i){
  801fbb:	c7 45 f0 03 00 00 00 	movl   $0x3,-0x10(%ebp)
  801fc2:	eb 19                	jmp    801fdd <alloc_block+0x51>
		if((1 << i) >= size) break;
  801fc4:	8b 45 f0             	mov    -0x10(%ebp),%eax
  801fc7:	ba 01 00 00 00       	mov    $0x1,%edx
  801fcc:	88 c1                	mov    %al,%cl
  801fce:	d3 e2                	shl    %cl,%edx
  801fd0:	89 d0                	mov    %edx,%eax
  801fd2:	3b 45 08             	cmp    0x8(%ebp),%eax
  801fd5:	73 0e                	jae    801fe5 <alloc_block+0x59>
		idx++;
  801fd7:	ff 45 f4             	incl   -0xc(%ebp)
	//TODO: [PROJECT'25.GM#1] DYNAMIC ALLOCATOR - #3 alloc_block
	//Your code is here
	//Comment the following line
	// get index in freeBlockList by size.
	uint32 idx = 0;
	for (int i = LOG2_MIN_SIZE; i <= LOG2_MAX_SIZE; ++i){
  801fda:	ff 45 f0             	incl   -0x10(%ebp)
  801fdd:	83 7d f0 0b          	cmpl   $0xb,-0x10(%ebp)
  801fe1:	7e e1                	jle    801fc4 <alloc_block+0x38>
  801fe3:	eb 01                	jmp    801fe6 <alloc_block+0x5a>
		if((1 << i) >= size) break;
  801fe5:	90                   	nop
		idx++;
	}
  ...
  801fec:	05 8c c0 81 00       	add    $0x81c08c,%eax
  801ff1:	8b 00                	mov    (%eax),%eax
  801ff3:	85 c0                	test   %eax,%eax
  801ff5:	0f 84 df 00 00 00    	je     8020da <alloc_block+0x14e>
  ...
  80209a:	05 8c c0 81 00       	add    $0x81c08c,%eax
  80209f:	8b 00                	mov    (%eax),%eax
  8020a1:	8d 50 ff             	lea    -0x1(%eax),%edx
  8020a4:	8b 45 f4             	mov    -0xc(%ebp),%eax
  8020a7:	c1 e0 04             	shl    $0x4,%eax
  8020aa:	05 8c c0 81 00       	add    $0x81c08c,%eax
  ...
  802166:	a1 54 40 80 00       	mov    0x804054,%eax
  80216b:	48                   	dec    %eax
  80216c:	a3 54 40 80 00       	mov    %eax,0x804054
			// from page to freeblockList by the pageInfo and the block size.
			split_page_to_blocks(1 << (idx + LOG2_MIN_SIZE), ptr_new_page);
  802171:	8b 45 f4             	mov    -0xc(%ebp),%eax
  802174:	83 c0 03             	add    $0x3,%eax
  802177:	ba 01 00 00 00       	mov    $0x1,%edx
  80217c:	88 c1                	mov    %al,%cl
  80217e:	d3 e2                	shl    %cl,%edx
  802180:	89 d0                	mov    %edx,%eax
  802182:	83 ec 08             	sub    $0x8,%esp
  802185:	ff 75 e4             	pushl  -0x1c(%ebp)
  802188:	50                   	push   %eax
  802189:	e8 c0 fc ff ff       	call   801e4e <split_page_to_blocks>
  ...
  802197:	05 80 c0 81 00       	add    $0x81c080,%eax
  80219c:	8b 00                	mov    (%eax),%eax
  80219e:	89 45 e0             	mov    %eax,-0x20(%ebp)
		    LIST_REMOVE(&freeBlockLists[idx], blk);
  8021a1:	83 7d e0 00          	cmpl   $0x0,-0x20(%ebp)
  8021a5:	75 17                	jne    8021be <alloc_block+0x232>
  8021a7:	83 ec 04             	sub    $0x4,%esp
  8021aa:	68 e1 32 80 00       	push   $0x8032e1
  8021af:	68 b0 00 00 00       	push   $0xb0
  8021b4:	68 23 32 80 00       	push   $0x803223
  8021b9:	e8 04 e1 ff ff       	call   8002c2 <_panic>
  8021be:	8b 45 e0             	mov    -0x20(%ebp),%eax
  8021c1:	8b 00                	mov    (%eax),%eax
  8021c3:	85 c0                	test   %eax,%eax
  8021c5:	74 10                	je     8021d7 <alloc_block+0x24b>
  8021c7:	8b 45 e0             	mov    -0x20(%ebp),%eax
  8021ca:	8b 00                	mov    (%eax),%eax
  8021cc:	8b 55 e0             	mov    -0x20(%ebp),%edx
  8021cf:	8b 52 04             	mov    0x4(%edx),%edx
  8021d2:	89 50 04             	mov    %edx,0x4(%eax)
  8021d5:	eb 14                	jmp    8021eb <alloc_block+0x25f>
  8021d7:	8b 45 e0             	mov    -0x20(%ebp),%eax
  8021da:	8b 40 04             	mov    0x4(%eax),%eax
  8021dd:	8b 55 f4             	mov    -0xc(%ebp),%edx
  8021e0:	c1 e2 04             	shl    $0x4,%edx
  8021e3:	81 c2 84 c0 81 00    	add    $0x81c084,%edx
  8021e9:	89 02                	mov    %eax,(%edx)
  8021eb:	8b 45 e0             	mov    -0x20(%ebp),%eax
  8021ee:	8b 40 04             	mov    0x4(%eax),%eax
  8021f1:	85 c0                	test   %eax,%eax
  8021f3:	74 0f                	je     802204 <alloc_block+0x278>
  8021f5:	8b 45 e0             	mov    -0x20(%ebp),%eax
  8021f8:	8b 40 04             	mov    0x4(%eax),%eax
  8021fb:	8b 55 e0             	mov    -0x20(%ebp),%edx
  8021fe:	8b 12                	mov    (%edx),%edx
  802200:	89 10                	mov    %edx,(%eax)
  802202:	eb 13                	jmp    802217 <alloc_block+0x28b>
  802204:	8b 45 e0             	mov    -0x20(%ebp),%eax
  802207:	8b 00                	mov    (%eax),%eax
  802209:	8b 55 f4             	mov    -0xc(%ebp),%edx
  80220c:	c1 e2 04             	shl    $0x4,%edx
  80220f:	81 c2 80 c0 81 00    	add    $0x81c080,%edx
  ...
  802230:	05 8c c0 81 00       	add    $0x81c08c,%eax
  802235:	8b 00                	mov    (%eax),%eax
  802237:	8d 50 ff             	lea    -0x1(%eax),%edx
  80223a:	8b 45 f4             	mov    -0xc(%ebp),%eax
  80223d:	c1 e0 04             	shl    $0x4,%eax
  802240:	05 8c c0 81 00       	add    $0x81c08c,%eax
  ...
  80224d:	50                   	push   %eax
  80224e:	e8 f5 f9 ff ff       	call   801c48 <to_page_info>
  802253:	83 c4 10             	add    $0x10,%esp
  802256:	89 45 dc             	mov    %eax,-0x24(%ebp)
		    pageInfo->num_of_free_blocks--;
  802259:	8b 45 dc             	mov    -0x24(%ebp),%eax
  80225c:	66 8b 40 0a          	mov    0xa(%eax),%ax
  802260:	48                   	dec    %eax
  802261:	8b 55 dc             	mov    -0x24(%ebp),%edx
  802264:	66 89 42 0a          	mov    %ax,0xa(%edx)
		    return blk;
  802268:	8b 45 e0             	mov    -0x20(%ebp),%eax
  80226b:	e9 26 01 00 00       	jmp    802396 <alloc_block+0x40a>
  ...
  802276:	c1 e0 04             	shl    $0x4,%eax
  802279:	05 8c c0 81 00       	add    $0x81c08c,%eax
  80227e:	8b 00                	mov    (%eax),%eax
  802280:	85 c0                	test   %eax,%eax
  802282:	0f 84 dc 00 00 00    	je     802364 <alloc_block+0x3d8>
					// remove from the list and updat the pageInfoArr free blocks.
					// pop from the freeBlockList.
					struct BlockElement *blk = LIST_FIRST(&freeBlockLists[idx]);
  802288:	8b 45 f4             	mov    -0xc(%ebp),%eax
  80228b:	c1 e0 04             	shl    $0x4,%eax
  80228e:	05 80 c0 81 00       	add    $0x81c080,%eax
  802293:	8b 00                	mov    (%eax),%eax
  802295:	89 45 d8             	mov    %eax,-0x28(%ebp)
				    LIST_REMOVE(&freeBlockLists[idx], blk);
  802298:	83 7d d8 00          	cmpl   $0x0,-0x28(%ebp)
  80229c:	75 17                	jne    8022b5 <alloc_block+0x329>
  80229e:	83 ec 04             	sub    $0x4,%esp
  8022a1:	68 e1 32 80 00       	push   $0x8032e1
  8022a6:	68 be 00 00 00       	push   $0xbe
  8022ab:	68 23 32 80 00       	push   $0x803223
  8022b0:	e8 0d e0 ff ff       	call   8002c2 <_panic>
  8022b5:	8b 45 d8             	mov    -0x28(%ebp),%eax
  8022b8:	8b 00                	mov    (%eax),%eax
  8022ba:	85 c0                	test   %eax,%eax
  8022bc:	74 10                	je     8022ce <alloc_block+0x342>
  8022be:	8b 45 d8             	mov    -0x28(%ebp),%eax
  8022c1:	8b 00                	mov    (%eax),%eax
  8022c3:	8b 55 d8             	mov    -0x28(%ebp),%edx
  8022c6:	8b 52 04             	mov    0x4(%edx),%edx
  8022c9:	89 50 04             	mov    %edx,0x4(%eax)
  8022cc:	eb 14                	jmp    8022e2 <alloc_block+0x356>
  8022ce:	8b 45 d8             	mov    -0x28(%ebp),%eax
  8022d1:	8b 40 04             	mov    0x4(%eax),%eax
  8022d4:	8b 55 f4             	mov    -0xc(%ebp),%edx
  8022d7:	c1 e2 04             	shl    $0x4,%edx
  8022da:	81 c2 84 c0 81 00    	add    $0x81c084,%edx
  8022e0:	89 02                	mov    %eax,(%edx)
  8022e2:	8b 45 d8             	mov    -0x28(%ebp),%eax
  8022e5:	8b 40 04             	mov    0x4(%eax),%eax
  8022e8:	85 c0                	test   %eax,%eax
  8022ea:	74 0f                	je     8022fb <alloc_block+0x36f>
  8022ec:	8b 45 d8             	mov    -0x28(%ebp),%eax
  8022ef:	8b 40 04             	mov    0x4(%eax),%eax
  8022f2:	8b 55 d8             	mov    -0x28(%ebp),%edx
  8022f5:	8b 12                	mov    (%edx),%edx
  8022f7:	89 10                	mov    %edx,(%eax)
  8022f9:	eb 13                	jmp    80230e <alloc_block+0x382>
  8022fb:	8b 45 d8             	mov    -0x28(%ebp),%eax
  8022fe:	8b 00                	mov    (%eax),%eax
  802300:	8b 55 f4             	mov    -0xc(%ebp),%edx
  802303:	c1 e2 04             	shl    $0x4,%edx
  802306:	81 c2 80 c0 81 00    	add    $0x81c080,%edx
  80230c:	89 02                	mov    %eax,(%edx)
  80230e:	8b 45 d8             	mov    -0x28(%ebp),%eax
  802311:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  802317:	8b 45 d8             	mov    -0x28(%ebp),%eax
  ...
  80232e:	8d 50 ff             	lea    -0x1(%eax),%edx
  802331:	8b 45 f4             	mov    -0xc(%ebp),%eax
  802334:	c1 e0 04             	shl    $0x4,%eax
  802337:	05 8c c0 81 00       	add    $0x81c08c,%eax
  ...
  802344:	50                   	push   %eax
  802345:	e8 fe f8 ff ff       	call   801c48 <to_page_info>
  80234a:	83 c4 10             	add    $0x10,%esp
  80234d:	89 45 d4             	mov    %eax,-0x2c(%ebp)
				    pageInfo->num_of_free_blocks--;
  802350:	8b 45 d4             	mov    -0x2c(%ebp),%eax
  802353:	66 8b 40 0a          	mov    0xa(%eax),%ax
  802357:	48                   	dec    %eax
  802358:	8b 55 d4             	mov    -0x2c(%ebp),%edx
  80235b:	66 89 42 0a          	mov    %ax,0xa(%edx)
				    return blk;
  80235f:	8b 45 d8             	mov    -0x28(%ebp),%eax
  802362:	eb 32                	jmp    802396 <alloc_block+0x40a>
		    struct PageInfoElement *pageInfo = to_page_info((uint32)blk);
		    pageInfo->num_of_free_blocks--;
		    return blk;
		}else{//case 3: no free block and no free page so iterate and try to find bigger size.
			// iterate over the list until finding available block
			while (idx <= (LOG2_MAX_SIZE - LOG2_MIN_SIZE) && freeBlockLists[idx].size == 0) {
  802364:	83 7d f4 08          	cmpl   $0x8,-0xc(%ebp)
  802368:	77 15                	ja     80237f <alloc_block+0x3f3>
  80236a:	8b 45 f4             	mov    -0xc(%ebp),%eax
  80236d:	c1 e0 04             	shl    $0x4,%eax
  802370:	05 8c c0 81 00       	add    $0x81c08c,%eax
  802375:	8b 00                	mov    (%eax),%eax
  802377:	85 c0                	test   %eax,%eax
  802379:	0f 84 f1 fe ff ff    	je     802270 <alloc_block+0x2e4>
				}
			}
		}
	}
  ...
  802382:	68 ff 32 80 00       	push   $0x8032ff
  802387:	68 c8 00 00 00       	push   $0xc8
  80238c:	68 23 32 80 00       	push   $0x803223
  802391:	e8 2c df ff ff       	call   8002c2 <_panic>
...
void free_block(void *va)
{
  ...
  8023a1:	a1 64 c0 81 00       	mov    0x81c064,%eax
  8023a6:	39 c2                	cmp    %eax,%edx
  8023a8:	72 0c                	jb     8023b6 <free_block+0x1e>
  8023aa:	8b 55 08             	mov    0x8(%ebp),%edx
  8023ad:	a1 40 40 80 00       	mov    0x804040,%eax
  8023b2:	39 c2                	cmp    %eax,%edx
  8023b4:	72 19                	jb     8023cf <free_block+0x37>
  8023b6:	68 10 33 80 00       	push   $0x803310
  8023bb:	68 86 32 80 00       	push   $0x803286
  8023c0:	68 d7 00 00 00       	push   $0xd7
  8023c5:	68 23 32 80 00       	push   $0x803223
  8023ca:	e8 f3 de ff ff       	call   8002c2 <_panic>
  ...
  8023db:	50                   	push   %eax
  8023dc:	e8 67 f8 ff ff       	call   801c48 <to_page_info>
  8023e1:	83 c4 10             	add    $0x10,%esp
  8023e4:	89 45 e4             	mov    %eax,-0x1c(%ebp)
	uint32 blk_size = pageInfo->block_size;
  8023e7:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  8023ea:	8b 40 08             	mov    0x8(%eax),%eax
  8023ed:	0f b7 c0             	movzwl %ax,%eax
  8023f0:	89 45 e0             	mov    %eax,-0x20(%ebp)

	// its index in the freeBlocklist.
	int idx = 0;
  8023f3:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
	for (int i = LOG2_MIN_SIZE; i <= LOG2_MAX_SIZE; i++) {
  8023fa:	c7 45 f0 03 00 00 00 	movl   $0x3,-0x10(%ebp)
  802401:	eb 19                	jmp    80241c <free_block+0x84>
	    if ((1 << i) == blk_size)
  802403:	8b 45 f0             	mov    -0x10(%ebp),%eax
  802406:	ba 01 00 00 00       	mov    $0x1,%edx
  80240b:	88 c1                	mov    %al,%cl
  80240d:	d3 e2                	shl    %cl,%edx
  80240f:	89 d0                	mov    %edx,%eax
  802411:	3b 45 e0             	cmp    -0x20(%ebp),%eax
  802414:	74 0e                	je     802424 <free_block+0x8c>
	        break;
	    idx++;
  802416:	ff 45 f4             	incl   -0xc(%ebp)
	...
	int idx = 0;
	for (int i = LOG2_MIN_SIZE; i <= LOG2_MAX_SIZE; i++) {
  802419:	ff 45 f0             	incl   -0x10(%ebp)
  80241c:	83 7d f0 0b          	cmpl   $0xb,-0x10(%ebp)
  802420:	7e e1                	jle    802403 <free_block+0x6b>
  802422:	eb 01                	jmp    802425 <free_block+0x8d>
	    if ((1 << i) == blk_size)
	        break;
  802424:	90                   	nop
	    idx++;
  ...
  802428:	66 8b 40 0a          	mov    0xa(%eax),%ax
  80242c:	40                   	inc    %eax
  80242d:	8b 55 e4             	mov    -0x1c(%ebp),%edx
  802430:	66 89 42 0a          	mov    %ax,0xa(%edx)
	LIST_INSERT_TAIL(&freeBlockLists[idx], blk_to_free);
  802434:	83 7d e8 00          	cmpl   $0x0,-0x18(%ebp)
  802438:	75 17                	jne    802451 <free_block+0xb9>
  80243a:	83 ec 04             	sub    $0x4,%esp
  80243d:	68 9c 32 80 00       	push   $0x80329c
  802442:	68 ee 00 00 00       	push   $0xee
  802447:	68 23 32 80 00       	push   $0x803223
  80244c:	e8 71 de ff ff       	call   8002c2 <_panic>
  802451:	8b 45 f4             	mov    -0xc(%ebp),%eax
  802454:	c1 e0 04             	shl    $0x4,%eax
  802457:	05 84 c0 81 00       	add    $0x81c084,%eax
  80245c:	8b 10                	mov    (%eax),%edx
  ...
  80246c:	74 14                	je     802482 <free_block+0xea>
  80246e:	8b 45 f4             	mov    -0xc(%ebp),%eax
  802471:	c1 e0 04             	shl    $0x4,%eax
  802474:	05 84 c0 81 00       	add    $0x81c084,%eax
  802479:	8b 00                	mov    (%eax),%eax
  80247b:	8b 55 e8             	mov    -0x18(%ebp),%edx
  80247e:	89 10                	mov    %edx,(%eax)
  802480:	eb 11                	jmp    802493 <free_block+0xfb>
  802482:	8b 45 f4             	mov    -0xc(%ebp),%eax
  802485:	c1 e0 04             	shl    $0x4,%eax
  802488:	8d 90 80 c0 81 00    	lea    0x81c080(%eax),%edx
  80248e:	8b 45 e8             	mov    -0x18(%ebp),%eax
  802491:	89 02                	mov    %eax,(%edx)
  802493:	8b 45 f4             	mov    -0xc(%ebp),%eax
  802496:	c1 e0 04             	shl    $0x4,%eax
  802499:	8d 90 84 c0 81 00    	lea    0x81c084(%eax),%edx
  80249f:	8b 45 e8             	mov    -0x18(%ebp),%eax
  8024a2:	89 02                	mov    %eax,(%edx)
  ...
  8024c0:	c1 e0 04             	shl    $0x4,%eax
  8024c3:	05 8c c0 81 00       	add    $0x81c08c,%eax
  8024c8:	89 10                	mov    %edx,(%eax)

	// now, case 1: the page all blocks are freed so you free the page.
	int blk_count = PAGE_SIZE / blk_size;
  8024ca:	b8 00 10 00 00       	mov    $0x1000,%eax
  8024cf:	ba 00 00 00 00       	mov    $0x0,%edx
  8024d4:	f7 75 e0             	divl   -0x20(%ebp)
  8024d7:	89 45 dc             	mov    %eax,-0x24(%ebp)
	// the blk count in the page is same as number fo free blocks free up the page.
	if (pageInfo->num_of_free_blocks == blk_count) {
  8024da:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  8024dd:	66 8b 40 0a          	mov    0xa(%eax),%ax
  8024e1:	0f b7 c0             	movzwl %ax,%eax
  8024e4:	3b 45 dc             	cmp    -0x24(%ebp),%eax
  8024e7:	0f 85 70 01 00 00    	jne    80265d <free_block+0x2c5>
		uint32 page_va = to_page_va(pageInfo);
  8024ed:	83 ec 0c             	sub    $0xc,%esp
  8024f0:	ff 75 e4             	pushl  -0x1c(%ebp)
  8024f3:	e8 de f6 ff ff       	call   801bd6 <to_page_va>
  8024f8:	83 c4 10             	add    $0x10,%esp
  8024fb:	89 45 d8             	mov    %eax,-0x28(%ebp)
		// remove all blk in the freeBlockList.
		for (uint32 off = 0; off < PAGE_SIZE; off += blk_size) {
  8024fe:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  802505:	e9 b7 00 00 00       	jmp    8025c1 <free_block+0x229>
			struct BlockElement *blk = (struct BlockElement*)(page_va + off);
  80250a:	8b 55 d8             	mov    -0x28(%ebp),%edx
  80250d:	8b 45 ec             	mov    -0x14(%ebp),%eax
  802510:	01 d0                	add    %edx,%eax
  802512:	89 45 d4             	mov    %eax,-0x2c(%ebp)
			LIST_REMOVE(&freeBlockLists[idx], blk);
  802515:	83 7d d4 00          	cmpl   $0x0,-0x2c(%ebp)
  802519:	75 17                	jne    802532 <free_block+0x19a>
  80251b:	83 ec 04             	sub    $0x4,%esp
  80251e:	68 e1 32 80 00       	push   $0x8032e1
  802523:	68 f8 00 00 00       	push   $0xf8
  802528:	68 23 32 80 00       	push   $0x803223
  80252d:	e8 90 dd ff ff       	call   8002c2 <_panic>
  802532:	8b 45 d4             	mov    -0x2c(%ebp),%eax
  802535:	8b 00                	mov    (%eax),%eax
  802537:	85 c0                	test   %eax,%eax
  802539:	74 10                	je     80254b <free_block+0x1b3>
  80253b:	8b 45 d4             	mov    -0x2c(%ebp),%eax
  80253e:	8b 00                	mov    (%eax),%eax
  802540:	8b 55 d4             	mov    -0x2c(%ebp),%edx
  802543:	8b 52 04             	mov    0x4(%edx),%edx
  802546:	89 50 04             	mov    %edx,0x4(%eax)
  802549:	eb 14                	jmp    80255f <free_block+0x1c7>
  ...
  802557:	81 c2 84 c0 81 00    	add    $0x81c084,%edx
  80255d:	89 02                	mov    %eax,(%edx)
  80255f:	8b 45 d4             	mov    -0x2c(%ebp),%eax
  802562:	8b 40 04             	mov    0x4(%eax),%eax
  802565:	85 c0                	test   %eax,%eax
  802567:	74 0f                	je     802578 <free_block+0x1e0>
  802569:	8b 45 d4             	mov    -0x2c(%ebp),%eax
  80256c:	8b 40 04             	mov    0x4(%eax),%eax
  80256f:	8b 55 d4             	mov    -0x2c(%ebp),%edx
  802572:	8b 12                	mov    (%edx),%edx
  802574:	89 10                	mov    %edx,(%eax)
  802576:	eb 13                	jmp    80258b <free_block+0x1f3>
  802578:	8b 45 d4             	mov    -0x2c(%ebp),%eax
  80257b:	8b 00                	mov    (%eax),%eax
  80257d:	8b 55 f4             	mov    -0xc(%ebp),%edx
  802580:	c1 e2 04             	shl    $0x4,%edx
  802583:	81 c2 80 c0 81 00    	add    $0x81c080,%edx
  802589:	89 02                	mov    %eax,(%edx)
  80258b:	8b 45 d4             	mov    -0x2c(%ebp),%eax
  80258e:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  802594:	8b 45 d4             	mov    -0x2c(%ebp),%eax
  802597:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
  80259e:	8b 45 f4             	mov    -0xc(%ebp),%eax
  8025a1:	c1 e0 04             	shl    $0x4,%eax
  8025a4:	05 8c c0 81 00       	add    $0x81c08c,%eax
  8025a9:	8b 00                	mov    (%eax),%eax
  8025ab:	8d 50 ff             	lea    -0x1(%eax),%edx
  8025ae:	8b 45 f4             	mov    -0xc(%ebp),%eax
  8025b1:	c1 e0 04             	shl    $0x4,%eax
  8025b4:	05 8c c0 81 00       	add    $0x81c08c,%eax
  ...
  8025be:	01 45 ec             	add    %eax,-0x14(%ebp)
  8025c1:	81 7d ec ff 0f 00 00 	cmpl   $0xfff,-0x14(%ebp)
  8025c8:	0f 86 3c ff ff ff    	jbe    80250a <free_block+0x172>
			struct BlockElement *blk = (struct BlockElement*)(page_va + off);
			LIST_REMOVE(&freeBlockLists[idx], blk);
		}
		// reset page info.
  ...
  8025d1:	66 c7 40 08 00 00    	movw   $0x0,0x8(%eax)
		pageInfo->num_of_free_blocks = 0;
  8025d7:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  8025da:	66 c7 40 0a 00 00    	movw   $0x0,0xa(%eax)
		// add it to the available pages.
		LIST_INSERT_TAIL(&freePagesList, pageInfo);
  8025e0:	83 7d e4 00          	cmpl   $0x0,-0x1c(%ebp)
  8025e4:	75 17                	jne    8025fd <free_block+0x265>
  8025e6:	83 ec 04             	sub    $0x4,%esp
  8025e9:	68 9c 32 80 00       	push   $0x80329c
  8025ee:	68 fe 00 00 00       	push   $0xfe
  8025f3:	68 23 32 80 00       	push   $0x803223
  8025f8:	e8 c5 dc ff ff       	call   8002c2 <_panic>
  8025fd:	8b 15 4c 40 80 00    	mov    0x80404c,%edx
  ...
  802611:	74 0c                	je     80261f <free_block+0x287>
  802613:	a1 4c 40 80 00       	mov    0x80404c,%eax
  802618:	8b 55 e4             	mov    -0x1c(%ebp),%edx
  80261b:	89 10                	mov    %edx,(%eax)
  80261d:	eb 08                	jmp    802627 <free_block+0x28f>
  80261f:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  802622:	a3 48 40 80 00       	mov    %eax,0x804048
  802627:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  80262a:	a3 4c 40 80 00       	mov    %eax,0x80404c
  80262f:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  802632:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  802638:	a1 54 40 80 00       	mov    0x804054,%eax
  80263d:	40                   	inc    %eax
  80263e:	a3 54 40 80 00       	mov    %eax,0x804054
		// make it available in memory.
		return_page((uint32 *)to_page_va(pageInfo));
  802643:	83 ec 0c             	sub    $0xc,%esp
  802646:	ff 75 e4             	pushl  -0x1c(%ebp)
  802649:	e8 88 f5 ff ff       	call   801bd6 <to_page_va>
  80264e:	83 c4 10             	add    $0x10,%esp
  802651:	83 ec 0c             	sub    $0xc,%esp
  802654:	50                   	push   %eax
  802655:	e8 b8 ee ff ff       	call   801512 <return_page>
...
void *realloc_block(void* va, uint32 new_size)
{
  ...
  802669:	68 48 33 80 00       	push   $0x803348
  80266e:	68 11 01 00 00       	push   $0x111
  802673:	68 23 32 80 00       	push   $0x803223
  802678:	e8 45 dc ff ff       	call   8002c2 <_panic>
...
00802680 <__udivdi3>:
  ...
  8026d2:	77 28                	ja     8026fc <__udivdi3+0x7c>
  8026d4:	0f bd fe             	bsr    %esi,%edi
  8026d7:	83 f7 1f             	xor    $0x1f,%edi
  8026da:	75 40                	jne    80271c <__udivdi3+0x9c>
  8026dc:	39 ce                	cmp    %ecx,%esi
  8026de:	72 0a                	jb     8026ea <__udivdi3+0x6a>
  8026e0:	3b 44 24 08          	cmp    0x8(%esp),%eax
  8026e4:	0f 87 9e 00 00 00    	ja     802788 <__udivdi3+0x108>
  ...
  80271a:	5d                   	pop    %ebp
  80271b:	c3                   	ret    
  80271c:	bd 20 00 00 00       	mov    $0x20,%ebp
  802721:	89 eb                	mov    %ebp,%ebx
  802723:	29 fb                	sub    %edi,%ebx
  802725:	89 f9                	mov    %edi,%ecx
  802727:	d3 e6                	shl    %cl,%esi
  802729:	89 c5                	mov    %eax,%ebp
  80272b:	88 d9                	mov    %bl,%cl
  80272d:	d3 ed                	shr    %cl,%ebp
  80272f:	89 e9                	mov    %ebp,%ecx
  802731:	09 f1                	or     %esi,%ecx
  802733:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
  802737:	89 f9                	mov    %edi,%ecx
  802739:	d3 e0                	shl    %cl,%eax
  80273b:	89 c5                	mov    %eax,%ebp
  80273d:	89 d6                	mov    %edx,%esi
  80273f:	88 d9                	mov    %bl,%cl
  802741:	d3 ee                	shr    %cl,%esi
  802743:	89 f9                	mov    %edi,%ecx
  802745:	d3 e2                	shl    %cl,%edx
  802747:	8b 44 24 08          	mov    0x8(%esp),%eax
  80274b:	88 d9                	mov    %bl,%cl
  80274d:	d3 e8                	shr    %cl,%eax
  80274f:	09 c2                	or     %eax,%edx
  802751:	89 d0                	mov    %edx,%eax
  802753:	89 f2                	mov    %esi,%edx
  802755:	f7 74 24 0c          	divl   0xc(%esp)
  802759:	89 d6                	mov    %edx,%esi
  80275b:	89 c3                	mov    %eax,%ebx
  80275d:	f7 e5                	mul    %ebp
  80275f:	39 d6                	cmp    %edx,%esi
  802761:	72 19                	jb     80277c <__udivdi3+0xfc>
  802763:	74 0b                	je     802770 <__udivdi3+0xf0>
  802765:	89 d8                	mov    %ebx,%eax
  802767:	31 ff                	xor    %edi,%edi
  802769:	e9 58 ff ff ff       	jmp    8026c6 <__udivdi3+0x46>
  80276e:	66 90                	xchg   %ax,%ax
  802770:	8b 54 24 08          	mov    0x8(%esp),%edx
  802774:	89 f9                	mov    %edi,%ecx
  802776:	d3 e2                	shl    %cl,%edx
  802778:	39 c2                	cmp    %eax,%edx
  80277a:	73 e9                	jae    802765 <__udivdi3+0xe5>
  80277c:	8d 43 ff             	lea    -0x1(%ebx),%eax
  80277f:	31 ff                	xor    %edi,%edi
  802781:	e9 40 ff ff ff       	jmp    8026c6 <__udivdi3+0x46>
  802786:	66 90                	xchg   %ax,%ax
  802788:	31 c0                	xor    %eax,%eax
  80278a:	e9 37 ff ff ff       	jmp    8026c6 <__udivdi3+0x46>
  80278f:	90                   	nop
...
00802790 <__umoddi3>:
  ...
  802797:	8b 4c 24 30          	mov    0x30(%esp),%ecx
  80279b:	8b 74 24 34          	mov    0x34(%esp),%esi
  80279f:	8b 7c 24 38          	mov    0x38(%esp),%edi
  8027a3:	8b 44 24 3c          	mov    0x3c(%esp),%eax
  8027a7:	89 44 24 0c          	mov    %eax,0xc(%esp)
  8027ab:	89 4c 24 08          	mov    %ecx,0x8(%esp)
  8027af:	89 f3                	mov    %esi,%ebx
  8027b1:	89 fa                	mov    %edi,%edx
  8027b3:	89 4c 24 04          	mov    %ecx,0x4(%esp)
  8027b7:	89 34 24             	mov    %esi,(%esp)
  8027ba:	85 c0                	test   %eax,%eax
  8027bc:	75 1a                	jne    8027d8 <__umoddi3+0x48>
  8027be:	39 f7                	cmp    %esi,%edi
  8027c0:	0f 86 a2 00 00 00    	jbe    802868 <__umoddi3+0xd8>
  ...
  8027d6:	5d                   	pop    %ebp
  8027d7:	c3                   	ret    
  8027d8:	39 f0                	cmp    %esi,%eax
  8027da:	0f 87 ac 00 00 00    	ja     80288c <__umoddi3+0xfc>
  8027e0:	0f bd e8             	bsr    %eax,%ebp
  8027e3:	83 f5 1f             	xor    $0x1f,%ebp
  8027e6:	0f 84 ac 00 00 00    	je     802898 <__umoddi3+0x108>
  8027ec:	bf 20 00 00 00       	mov    $0x20,%edi
  8027f1:	29 ef                	sub    %ebp,%edi
  8027f3:	89 fe                	mov    %edi,%esi
  8027f5:	89 7c 24 0c          	mov    %edi,0xc(%esp)
  8027f9:	89 e9                	mov    %ebp,%ecx
  8027fb:	d3 e0                	shl    %cl,%eax
  8027fd:	89 d7                	mov    %edx,%edi
  8027ff:	89 f1                	mov    %esi,%ecx
  802801:	d3 ef                	shr    %cl,%edi
  802803:	09 c7                	or     %eax,%edi
  802805:	89 e9                	mov    %ebp,%ecx
  802807:	d3 e2                	shl    %cl,%edx
  802809:	89 14 24             	mov    %edx,(%esp)
  80280c:	89 d8                	mov    %ebx,%eax
  80280e:	d3 e0                	shl    %cl,%eax
  802810:	89 c2                	mov    %eax,%edx
  802812:	8b 44 24 08          	mov    0x8(%esp),%eax
  802816:	d3 e0                	shl    %cl,%eax
  802818:	89 44 24 04          	mov    %eax,0x4(%esp)
  80281c:	8b 44 24 08          	mov    0x8(%esp),%eax
  802820:	89 f1                	mov    %esi,%ecx
  802822:	d3 e8                	shr    %cl,%eax
  802824:	09 d0                	or     %edx,%eax
  802826:	d3 eb                	shr    %cl,%ebx
  802828:	89 da                	mov    %ebx,%edx
  80282a:	f7 f7                	div    %edi
  80282c:	89 d3                	mov    %edx,%ebx
  80282e:	f7 24 24             	mull   (%esp)
  802831:	89 c6                	mov    %eax,%esi
  802833:	89 d1                	mov    %edx,%ecx
  802835:	39 d3                	cmp    %edx,%ebx
  802837:	0f 82 87 00 00 00    	jb     8028c4 <__umoddi3+0x134>
  80283d:	0f 84 91 00 00 00    	je     8028d4 <__umoddi3+0x144>
  802843:	8b 54 24 04          	mov    0x4(%esp),%edx
  802847:	29 f2                	sub    %esi,%edx
  802849:	19 cb                	sbb    %ecx,%ebx
  80284b:	89 d8                	mov    %ebx,%eax
  80284d:	8a 4c 24 0c          	mov    0xc(%esp),%cl
  802851:	d3 e0                	shl    %cl,%eax
  802853:	89 e9                	mov    %ebp,%ecx
  802855:	d3 ea                	shr    %cl,%edx
  802857:	09 d0                	or     %edx,%eax
  802859:	89 e9                	mov    %ebp,%ecx
  80285b:	d3 eb                	shr    %cl,%ebx
  80285d:	89 da                	mov    %ebx,%edx
  ...
  80286c:	75 0b                	jne    802879 <__umoddi3+0xe9>
  ...
  80287f:	89 c8                	mov    %ecx,%eax
  802881:	f7 f5                	div    %ebp
  802883:	89 d0                	mov    %edx,%eax
  802885:	e9 44 ff ff ff       	jmp    8027ce <__umoddi3+0x3e>
  80288a:	66 90                	xchg   %ax,%ax
  80288c:	89 c8                	mov    %ecx,%eax
  80288e:	89 f2                	mov    %esi,%edx
  ...
  802896:	5d                   	pop    %ebp
  802897:	c3                   	ret    
  802898:	3b 04 24             	cmp    (%esp),%eax
  80289b:	72 06                	jb     8028a3 <__umoddi3+0x113>
  80289d:	3b 7c 24 04          	cmp    0x4(%esp),%edi
  8028a1:	77 0f                	ja     8028b2 <__umoddi3+0x122>
  8028a3:	89 f2                	mov    %esi,%edx
  8028a5:	29 f9                	sub    %edi,%ecx
  8028a7:	1b 54 24 0c          	sbb    0xc(%esp),%edx
  8028ab:	89 14 24             	mov    %edx,(%esp)
  8028ae:	89 4c 24 04          	mov    %ecx,0x4(%esp)
  8028b2:	8b 44 24 04          	mov    0x4(%esp),%eax
  8028b6:	8b 14 24             	mov    (%esp),%edx
  ...
  8028c4:	2b 04 24             	sub    (%esp),%eax
  8028c7:	19 fa                	sbb    %edi,%edx
  8028c9:	89 d1                	mov    %edx,%ecx
  8028cb:	89 c6                	mov    %eax,%esi
  8028cd:	e9 71 ff ff ff       	jmp    802843 <__umoddi3+0xb3>
  8028d2:	66 90                	xchg   %ax,%ax
  8028d4:	39 44 24 04          	cmp    %eax,0x4(%esp)
  8028d8:	72 ea                	jb     8028c4 <__umoddi3+0x134>
  8028da:	89 d9                	mov    %ebx,%ecx
  8028dc:	e9 62 ff ff ff       	jmp    802843 <__umoddi3+0xb3>
