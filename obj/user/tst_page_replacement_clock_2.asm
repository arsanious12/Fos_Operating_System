...
void _main(void)
{
  ...
  800046:	6a 25                	push   $0x25
  800048:	68 14 1c 80 00       	push   $0x801c14
  80004d:	e8 c5 01 00 00       	call   800217 <_panic>
...
libmain(int argc, char **argv)
{
  ...
  80005b:	e8 52 16 00 00       	call   8016b2 <sys_getenvindex>
  ...
  800098:	a3 e0 30 80 00       	mov    %eax,0x8030e0

	//SET THE PROGRAM NAME
	if (myEnv->prog_name[0] != '\0')
  80009d:	a1 e0 30 80 00       	mov    0x8030e0,%eax
  8000a2:	8a 40 20             	mov    0x20(%eax),%al
  8000a5:	84 c0                	test   %al,%al
  8000a7:	74 0d                	je     8000b6 <libmain+0x64>
		binaryname = myEnv->prog_name;
  8000a9:	a1 e0 30 80 00       	mov    0x8030e0,%eax
  8000ae:	83 c0 20             	add    $0x20,%eax
  8000b1:	a3 d0 30 80 00       	mov    %eax,0x8030d0
  ...
  8000ba:	7e 0a                	jle    8000c6 <libmain+0x74>
		binaryname = argv[0];
  8000bc:	8b 45 0c             	mov    0xc(%ebp),%eax
  8000bf:	8b 00                	mov    (%eax),%eax
  8000c1:	a3 d0 30 80 00       	mov    %eax,0x8030d0
  ...
  8000d4:	83 c4 10             	add    $0x10,%esp
	...
	if (printStats)
  8000d7:	a1 cc 30 80 00       	mov    0x8030cc,%eax
  8000dc:	85 c0                	test   %eax,%eax
  8000de:	0f 84 01 01 00 00    	je     8001e5 <libmain+0x193>
	{
		char isOPTReplCmd[100] = "__IsOPTRepl__" ;
  8000e4:	8d 85 7c ff ff ff    	lea    -0x84(%ebp),%eax
  8000ea:	bb 30 1d 80 00       	mov    $0x801d30,%ebx
  ...
  80012f:	68 50 1c 80 00       	push   $0x801c50
  800134:	e8 ac 03 00 00       	call   8004e5 <cprintf>
  800139:	83 c4 10             	add    $0x10,%esp
			if (isOPTRepl)
  80013c:	8b 45 e0             	mov    -0x20(%ebp),%eax
  80013f:	85 c0                	test   %eax,%eax
  800141:	74 18                	je     80015b <libmain+0x109>
			{
				cprintf("OPTIMAL number of page faults = %d\n", sys_get_optimal_num_faults());
  800143:	e8 be 17 00 00       	call   801906 <sys_get_optimal_num_faults>
  800148:	83 ec 08             	sub    $0x8,%esp
  80014b:	50                   	push   %eax
  80014c:	68 78 1c 80 00       	push   $0x801c78
  800151:	e8 8f 03 00 00       	call   8004e5 <cprintf>
  800156:	83 c4 10             	add    $0x10,%esp
  800159:	eb 59                	jmp    8001b4 <libmain+0x162>
			}
			else
			{
				cprintf("Num of PAGE faults = %d, modif = %d\n", myEnv->pageFaultsCounter, myEnv->nModifiedPages);
  80015b:	a1 e0 30 80 00       	mov    0x8030e0,%eax
  800160:	8b 90 50 da 01 00    	mov    0x1da50(%eax),%edx
  800166:	a1 e0 30 80 00       	mov    0x8030e0,%eax
  80016b:	8b 80 40 da 01 00    	mov    0x1da40(%eax),%eax
  800171:	83 ec 04             	sub    $0x4,%esp
  800174:	52                   	push   %edx
  800175:	50                   	push   %eax
  800176:	68 9c 1c 80 00       	push   $0x801c9c
  80017b:	e8 65 03 00 00       	call   8004e5 <cprintf>
  800180:	83 c4 10             	add    $0x10,%esp
				cprintf("# PAGE IN (from disk) = %d, # PAGE OUT (on disk) = %d, # NEW PAGE ADDED (on disk) = %d\n", myEnv->nPageIn, myEnv->nPageOut,myEnv->nNewPageAdded);
  800183:	a1 e0 30 80 00       	mov    0x8030e0,%eax
  800188:	8b 88 64 da 01 00    	mov    0x1da64(%eax),%ecx
  80018e:	a1 e0 30 80 00       	mov    0x8030e0,%eax
  800193:	8b 90 60 da 01 00    	mov    0x1da60(%eax),%edx
  800199:	a1 e0 30 80 00       	mov    0x8030e0,%eax
  80019e:	8b 80 5c da 01 00    	mov    0x1da5c(%eax),%eax
  8001a4:	51                   	push   %ecx
  8001a5:	52                   	push   %edx
  8001a6:	50                   	push   %eax
  8001a7:	68 c4 1c 80 00       	push   $0x801cc4
  8001ac:	e8 34 03 00 00       	call   8004e5 <cprintf>
  8001b1:	83 c4 10             	add    $0x10,%esp
			}
			//cprintf("Num of freeing scarce memory = %d, freeing full working set = %d\n", myEnv->freeingScarceMemCounter, myEnv->freeingFullWSCounter);
			cprintf("Num of clocks = %d\n", myEnv->nClocks);
  8001b4:	a1 e0 30 80 00       	mov    0x8030e0,%eax
  8001b9:	8b 80 68 da 01 00    	mov    0x1da68(%eax),%eax
  8001bf:	83 ec 08             	sub    $0x8,%esp
  8001c2:	50                   	push   %eax
  8001c3:	68 1c 1d 80 00       	push   $0x801d1c
  8001c8:	e8 18 03 00 00       	call   8004e5 <cprintf>
  8001cd:	83 c4 10             	add    $0x10,%esp
			cprintf("**************************************\n");
  8001d0:	83 ec 0c             	sub    $0xc,%esp
  8001d3:	68 50 1c 80 00       	push   $0x801c50
...
_panic(const char *file, int line, const char *fmt,...)
{
  ...
  80027a:	68 c4 1d 80 00       	push   $0x801dc4
...
void CheckWSArrayWithoutLastIndex(uint32 *expectedPages, int arraySize)
{
  ...
  800294:	a1 e0 30 80 00       	mov    0x8030e0,%eax
  ...
  8002a9:	68 c8 1d 80 00       	push   $0x801dc8
  8002ae:	6a 26                	push   $0x26
  8002b0:	68 14 1e 80 00       	push   $0x801e14
  ...
  8002fa:	a1 e0 30 80 00       	mov    0x8030e0,%eax
  8002ff:	8b 88 38 da 01 00    	mov    0x1da38(%eax),%ecx
  ...
  80031a:	a1 e0 30 80 00       	mov    0x8030e0,%eax
  80031f:	8b 88 38 da 01 00    	mov    0x1da38(%eax),%ecx
  ...
  800363:	a1 e0 30 80 00       	mov    0x8030e0,%eax
  ...
  80037e:	68 20 1e 80 00       	push   $0x801e20
  800383:	6a 3a                	push   $0x3a
  800385:	68 14 1e 80 00       	push   $0x801e14
  ...
  8003ae:	a1 e0 30 80 00       	mov    0x8030e0,%eax
  8003b3:	8b 88 38 da 01 00    	mov    0x1da38(%eax),%ecx
  ...
  8003d4:	a1 e0 30 80 00       	mov    0x8030e0,%eax
  ...
  8003f1:	68 74 1e 80 00       	push   $0x801e74
  8003f6:	6a 44                	push   $0x44
  8003f8:	68 14 1e 80 00       	push   $0x801e14
...
static void putch(int ch, struct printbuf *b) {
  ...
  800431:	8b 15 fc 71 82 00    	mov    0x8271fc,%edx
  800437:	a0 04 31 80 00       	mov    0x803104,%al
...
int vcprintf(const char *fmt, va_list ap) {
  ...
  8004aa:	83 c4 10             	add    $0x10,%esp
	sys_cputs(b.buf, b.idx, printProgName, curTextClr);
  8004ad:	8b 15 fc 71 82 00    	mov    0x8271fc,%edx
  8004b3:	a0 04 31 80 00       	mov    0x803104,%al
  ...
  8004d3:	83 c4 10             	add    $0x10,%esp
	...
	printProgName = 0;
  8004d6:	c6 05 04 31 80 00 00 	movb   $0x0,0x803104
	return b.cnt;
...
int cprintf(const char *fmt, ...) {
  ...
  8004e8:	83 ec 18             	sub    $0x18,%esp
	...
	int cnt;
	printProgName = 1 ;
  8004eb:	c6 05 04 31 80 00 01 	movb   $0x1,0x803104
	va_start(ap, fmt);
...
int cprintf_colored(int textClr, const char *fmt, ...) {
  ...
  800515:	83 ec 18             	sub    $0x18,%esp
	...
	int cnt;
	printProgName = 1 ;
  800518:	c6 05 04 31 80 00 01 	movb   $0x1,0x803104
	curTextClr = (textClr << 8) ; //set text color by the given value
  80051f:	8b 45 08             	mov    0x8(%ebp),%eax
  800522:	c1 e0 08             	shl    $0x8,%eax
  800525:	a3 fc 71 82 00       	mov    %eax,0x8271fc
	va_start(ap, fmt);
  ...
  800548:	c7 05 fc 71 82 00 00 	movl   $0x700,0x8271fc
  80054f:	07 00 00 
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80061f:	05 d4 20 80 00       	add    $0x8020d4,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800772:	8b 04 85 f8 20 80 00 	mov    0x8020f8(,%eax,4),%eax
  ...
  800853:	8b 34 9d 40 1f 80 00 	mov    0x801f40(,%ebx,4),%esi
  80085a:	85 f6                	test   %esi,%esi
  80085c:	75 19                	jne    800877 <vprintfmt+0x173>
				printfmt(putch, putdat, "error %d", err);
  80085e:	53                   	push   %ebx
  80085f:	68 e5 20 80 00       	push   $0x8020e5
  ...
  800872:	e9 5b 02 00 00       	jmp    800ad2 <vprintfmt+0x3ce>
			...
			if (err > MAXERROR || (p = error_string[err]) == NULL)
				...
				printfmt(putch, putdat, "%s", p);
  800877:	56                   	push   %esi
  800878:	68 ee 20 80 00       	push   $0x8020ee
  ...
  8008a3:	75 05                	jne    8008aa <vprintfmt+0x1a6>
				p = "(null)";
  8008a5:	be f1 20 80 00       	mov    $0x8020f1,%esi
			if (width > 0 && padc != '-')
  ...
  800a9b:	eb 35                	jmp    800ad2 <vprintfmt+0x3ce>
		...
		case '~':
			printProgName = 0;
  800a9d:	c6 05 04 31 80 00 00 	movb   $0x0,0x803104
			break;
  800aa4:	eb 2c                	jmp    800ad2 <vprintfmt+0x3ce>
		// Print Program Name & UD
		case '@':
			printProgName = 1;
  800aa6:	c6 05 04 31 80 00 01 	movb   $0x1,0x803104
			break;
...
uint32 sys_get_uheap_strategy()
{
  ...
  80183a:	a3 40 71 82 00       	mov    %eax,0x827140
	return uheapPlaceStrategy ;
  80183f:	a1 40 71 82 00       	mov    0x827140,%eax
}
  801844:	c9                   	leave  
  801845:	c3                   	ret    
...
void sys_set_uheap_strategy(uint32 heapStrategy)
{
  ...
  80184c:	a3 40 71 82 00       	mov    %eax,0x827140
...
void sys_env_set_priority(int32 envID, int priority)
{
  ...
  801960:	68 68 22 80 00       	push   $0x802268
  801965:	68 25 01 00 00       	push   $0x125
  80196a:	68 9b 22 80 00       	push   $0x80229b
