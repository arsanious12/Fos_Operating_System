...
void _main(void)
{
  ...
  800087:	bb 6b 22 80 00       	mov    $0x80226b,%ebx
  ...
  8000aa:	68 78 1f 80 00       	push   $0x801f78
  ...
  800121:	68 a0 1f 80 00       	push   $0x801fa0
  ...
  800152:	68 ec 1f 80 00       	push   $0x801fec
  ...
  800166:	68 34 20 80 00       	push   $0x802034
  ...
  80024c:	68 7a 20 80 00       	push   $0x80207a
  ...
  80026a:	68 93 20 80 00       	push   $0x802093
  ...
  80028a:	68 93 20 80 00       	push   $0x802093
  ...
  80029e:	68 a0 20 80 00       	push   $0x8020a0
  ...
  8002e3:	68 f8 20 80 00       	push   $0x8020f8
  ...
  8002ff:	68 28 21 80 00       	push   $0x802128
  ...
  800335:	68 94 21 80 00       	push   $0x802194
  ...
  800349:	68 14 22 80 00       	push   $0x802214
...
libmain(int argc, char **argv)
{
  ...
  8003e4:	bb 78 23 80 00       	mov    $0x802378,%ebx
  ...
  800429:	68 98 22 80 00       	push   $0x802298
  ...
  800445:	50                   	push   %eax
  800446:	68 c0 22 80 00       	push   $0x8022c0
  ...
  80046e:	52                   	push   %edx
  80046f:	50                   	push   %eax
  800470:	68 e4 22 80 00       	push   $0x8022e4
  ...
  80049f:	52                   	push   %edx
  8004a0:	50                   	push   %eax
  8004a1:	68 0c 23 80 00       	push   $0x80230c
  ...
  8004bc:	50                   	push   %eax
  8004bd:	68 64 23 80 00       	push   $0x802364
...
_panic(const char *file, int line, const char *fmt,...)
{
  ...
  800531:	50                   	push   %eax
  800532:	68 dc 23 80 00       	push   $0x8023dc
  ...
  80054d:	50                   	push   %eax
  80054e:	68 e4 23 80 00       	push   $0x8023e4
  ...
  800574:	68 0c 24 80 00       	push   $0x80240c
...
void CheckWSArrayWithoutLastIndex(uint32 *expectedPages, int arraySize)
{
  ...
  8005a3:	68 10 24 80 00       	push   $0x802410
  8005a8:	6a 26                	push   $0x26
  8005aa:	68 5c 24 80 00       	push   $0x80245c
  ...
  800678:	68 68 24 80 00       	push   $0x802468
  80067d:	6a 3a                	push   $0x3a
  80067f:	68 5c 24 80 00       	push   $0x80245c
  ...
  8006eb:	68 bc 24 80 00       	push   $0x8024bc
  8006f0:	6a 44                	push   $0x44
  8006f2:	68 5c 24 80 00       	push   $0x80245c
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800919:	05 34 27 80 00       	add    $0x802734,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800a6c:	8b 04 85 58 27 80 00 	mov    0x802758(,%eax,4),%eax
  ...
  800b4d:	8b 34 9d a0 25 80 00 	mov    0x8025a0(,%ebx,4),%esi
  800b54:	85 f6                	test   %esi,%esi
  800b56:	75 19                	jne    800b71 <vprintfmt+0x173>
				printfmt(putch, putdat, "error %d", err);
  800b58:	53                   	push   %ebx
  800b59:	68 45 27 80 00       	push   $0x802745
  ...
  800b6c:	e9 5b 02 00 00       	jmp    800dcc <vprintfmt+0x3ce>
			...
			if (err > MAXERROR || (p = error_string[err]) == NULL)
				...
				printfmt(putch, putdat, "%s", p);
  800b71:	56                   	push   %esi
  800b72:	68 4e 27 80 00       	push   $0x80274e
  ...
  800b9d:	75 05                	jne    800ba4 <vprintfmt+0x1a6>
				p = "(null)";
  800b9f:	be 51 27 80 00       	mov    $0x802751,%esi
			if (width > 0 && padc != '-')
...
void sys_env_set_priority(int32 envID, int priority)
{
  ...
  801c5a:	68 c8 28 80 00       	push   $0x8028c8
  801c5f:	68 25 01 00 00       	push   $0x125
  801c64:	68 fb 28 80 00       	push   $0x8028fb
