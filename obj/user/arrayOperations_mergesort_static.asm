...
void _main(void)
{
  ...
  800054:	50                   	push   %eax
  800055:	e8 04 28 00 00       	call   80285e <get_semaphore>
  ...
  80006b:	50                   	push   %eax
  80006c:	e8 ed 27 00 00       	call   80285e <get_semaphore>
  ...
  80007a:	e8 f9 27 00 00       	call   802878 <wait_semaphore>
  ...
  8000a8:	52                   	push   %edx
  8000a9:	50                   	push   %eax
  8000aa:	e8 af 27 00 00       	call   80285e <get_semaphore>
...
//	Right = smalloc("mergesortRightArr", sizeof(int) * (*numOfElements), 1) ;
  ...
  80015e:	e8 15 27 00 00       	call   802878 <wait_semaphore>
  ...
  80019c:	e8 f1 26 00 00       	call   802892 <signal_semaphore>
  ...
  8001aa:	e8 e3 26 00 00       	call   802892 <signal_semaphore>
...
libmain(int argc, char **argv)
{
  ...
  8004f8:	a3 20 40 80 00       	mov    %eax,0x804020

	//SET THE PROGRAM NAME
	if (myEnv->prog_name[0] != '\0')
  8004fd:	a1 20 40 80 00       	mov    0x804020,%eax
  ...
  800511:	a3 04 40 80 00       	mov    %eax,0x804004
  ...
  800521:	a3 04 40 80 00       	mov    %eax,0x804004
  ...
  800534:	83 c4 10             	add    $0x10,%esp
	...
	if (printStats)
  800537:	a1 00 40 80 00       	mov    0x804000,%eax
  ...
  80054a:	bb c8 2e 80 00       	mov    $0x802ec8,%ebx
  ...
  80058f:	68 e8 2d 80 00       	push   $0x802de8
  ...
  8005ab:	50                   	push   %eax
  8005ac:	68 10 2e 80 00       	push   $0x802e10
  ...
  8005bb:	a1 20 40 80 00       	mov    0x804020,%eax
  ...
  8005d4:	52                   	push   %edx
  8005d5:	50                   	push   %eax
  8005d6:	68 34 2e 80 00       	push   $0x802e34
  ...
  8005ee:	a1 20 40 80 00       	mov    0x804020,%eax
  ...
  800605:	52                   	push   %edx
  800606:	50                   	push   %eax
  800607:	68 5c 2e 80 00       	push   $0x802e5c
...
static void putch(int ch, struct printbuf *b) {
  ...
  8006a3:	8b 15 44 f6 8d 00    	mov    0x8df644,%edx
  8006a9:	a0 e0 5a 86 00       	mov    0x865ae0,%al
...
int vcprintf(const char *fmt, va_list ap) {
  ...
  80071c:	83 c4 10             	add    $0x10,%esp
	sys_cputs(b.buf, b.idx, printProgName, curTextClr);
  80071f:	8b 15 44 f6 8d 00    	mov    0x8df644,%edx
  800725:	a0 e0 5a 86 00       	mov    0x865ae0,%al
  ...
  800745:	83 c4 10             	add    $0x10,%esp
	...
	printProgName = 0;
  800748:	c6 05 e0 5a 86 00 00 	movb   $0x0,0x865ae0
	return b.cnt;
...
int cprintf(const char *fmt, ...) {
  ...
  80075a:	83 ec 18             	sub    $0x18,%esp
	...
	int cnt;
	printProgName = 1 ;
  80075d:	c6 05 e0 5a 86 00 01 	movb   $0x1,0x865ae0
	va_start(ap, fmt);
...
int cprintf_colored(int textClr, const char *fmt, ...) {
  ...
  800787:	83 ec 18             	sub    $0x18,%esp
	...
	int cnt;
	printProgName = 1 ;
  80078a:	c6 05 e0 5a 86 00 01 	movb   $0x1,0x865ae0
	curTextClr = (textClr << 8) ; //set text color by the given value
  800791:	8b 45 08             	mov    0x8(%ebp),%eax
  800794:	c1 e0 08             	shl    $0x8,%eax
  800797:	a3 44 f6 8d 00       	mov    %eax,0x8df644
	va_start(ap, fmt);
  ...
  8007ba:	c7 05 44 f6 8d 00 00 	movl   $0x700,0x8df644
  8007c1:	07 00 00 
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800839:	e8 6a 22 00 00       	call   802aa8 <__udivdi3>
  ...
  800887:	52                   	push   %edx
  800888:	50                   	push   %eax
  800889:	e8 2a 23 00 00       	call   802bb8 <__umoddi3>
  80088e:	83 c4 10             	add    $0x10,%esp
  800891:	05 54 31 80 00       	add    $0x803154,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8009e4:	8b 04 85 78 31 80 00 	mov    0x803178(,%eax,4),%eax
  ...
  800ac5:	8b 34 9d c0 2f 80 00 	mov    0x802fc0(,%ebx,4),%esi
  800acc:	85 f6                	test   %esi,%esi
  800ace:	75 19                	jne    800ae9 <vprintfmt+0x173>
				printfmt(putch, putdat, "error %d", err);
  800ad0:	53                   	push   %ebx
  800ad1:	68 65 31 80 00       	push   $0x803165
  ...
  800ae4:	e9 5b 02 00 00       	jmp    800d44 <vprintfmt+0x3ce>
			...
			if (err > MAXERROR || (p = error_string[err]) == NULL)
				...
				printfmt(putch, putdat, "%s", p);
  800ae9:	56                   	push   %esi
  800aea:	68 6e 31 80 00       	push   $0x80316e
  ...
  800b15:	75 05                	jne    800b1c <vprintfmt+0x1a6>
				p = "(null)";
  800b17:	be 71 31 80 00       	mov    $0x803171,%esi
			if (width > 0 && padc != '-')
  ...
  800d0d:	eb 35                	jmp    800d44 <vprintfmt+0x3ce>
		...
		case '~':
			printProgName = 0;
  800d0f:	c6 05 e0 5a 86 00 00 	movb   $0x0,0x865ae0
			break;
  800d16:	eb 2c                	jmp    800d44 <vprintfmt+0x3ce>
		// Print Program Name & UD
		case '@':
			printProgName = 1;
  800d18:	c6 05 e0 5a 86 00 01 	movb   $0x1,0x865ae0
			break;
...
void uheap_init()
{
  ...
  801665:	a3 00 db 87 00       	mov    %eax,0x87db00
		uheapPageAllocStart = dynAllocEnd + PAGE_SIZE;
  80166a:	a1 40 40 80 00       	mov    0x804040,%eax
  80166f:	05 00 10 00 00       	add    $0x1000,%eax
  801674:	a3 b0 db 87 00       	mov    %eax,0x87dbb0
		uheapPageAllocBreak = uheapPageAllocStart;
  801679:	a1 b0 db 87 00       	mov    0x87dbb0,%eax
  80167e:	a3 08 db 87 00       	mov    %eax,0x87db08

		__firstTimeFlag = 0;
  801683:	c7 05 08 40 80 00 00 	movl   $0x0,0x804008
  80168a:	00 00 00 
	}
}
  80168d:	90                   	nop
...
int get_page(void* va)
{
  ...
  8016c1:	68 e8 32 80 00       	push   $0x8032e8
  8016c6:	6a 1f                	push   $0x1f
  8016c8:	68 24 33 80 00       	push   $0x803324
  8016cd:	e8 e5 11 00 00       	call   8028b7 <_panic>
	return 0;
...
void return_page(void* va)
{
  ...
  801705:	68 30 33 80 00       	push   $0x803330
  80170a:	6a 2a                	push   $0x2a
  80170c:	68 24 33 80 00       	push   $0x803324
  801711:	e8 a1 11 00 00       	call   8028b7 <_panic>
}
  801716:	90                   	nop
  801717:	c9                   	leave  
  801718:	c3                   	ret    
...
void* malloc(uint32 size)
{
  ...
  801734:	68 70 33 80 00       	push   $0x803370
  801739:	6a 3e                	push   $0x3e
  80173b:	68 24 33 80 00       	push   $0x803324
  801740:	e8 72 11 00 00       	call   8028b7 <_panic>
}
  801745:	c9                   	leave  
  801746:	c3                   	ret    
...
void free(void* virtual_address)
{
  ...
  801750:	68 98 33 80 00       	push   $0x803398
  801755:	6a 49                	push   $0x49
  801757:	68 24 33 80 00       	push   $0x803324
  80175c:	e8 56 11 00 00       	call   8028b7 <_panic>
...
void* smalloc(char *sharedVarName, uint32 size, uint8 isWritable)
{
  ...
  801782:	68 bc 33 80 00       	push   $0x8033bc
  801787:	6a 5a                	push   $0x5a
  801789:	68 24 33 80 00       	push   $0x803324
  80178e:	e8 24 11 00 00       	call   8028b7 <_panic>
}
  801793:	c9                   	leave  
  801794:	c3                   	ret    
...
void* sget(int32 ownerEnvID, char *sharedVarName)
{
  ...
  8017a3:	68 e4 33 80 00       	push   $0x8033e4
  8017a8:	6a 6a                	push   $0x6a
  8017aa:	68 24 33 80 00       	push   $0x803324
  8017af:	e8 03 11 00 00       	call   8028b7 <_panic>
...
void *realloc(void *virtual_address, uint32 new_size)
{
  ...
  8017c2:	68 08 34 80 00       	push   $0x803408
  8017c7:	68 88 00 00 00       	push   $0x88
  8017cc:	68 24 33 80 00       	push   $0x803324
  8017d1:	e8 e1 10 00 00       	call   8028b7 <_panic>
...
void sfree(void* virtual_address)
{
  ...
  8017df:	68 30 34 80 00       	push   $0x803430
  8017e4:	68 9b 00 00 00       	push   $0x9b
  8017e9:	68 24 33 80 00       	push   $0x803324
  8017ee:	e8 c4 10 00 00       	call   8028b7 <_panic>
...
uint32 sys_get_uheap_strategy()
{
  ...
  801c63:	a3 00 db 87 00       	mov    %eax,0x87db00
	return uheapPlaceStrategy ;
  801c68:	a1 00 db 87 00       	mov    0x87db00,%eax
}
  801c6d:	c9                   	leave  
  801c6e:	c3                   	ret    
...
void sys_set_uheap_strategy(uint32 heapStrategy)
{
  ...
  801c75:	a3 00 db 87 00       	mov    %eax,0x87db00
...
void sys_env_set_priority(int32 envID, int priority)
{
  ...
  801d89:	68 54 34 80 00       	push   $0x803454
  801d8e:	68 25 01 00 00       	push   $0x125
  801d93:	68 87 34 80 00       	push   $0x803487
  801d98:	e8 1a 0b 00 00       	call   8028b7 <_panic>
...
__inline__ uint32 to_page_va(struct PageInfoElement *ptrPageInfo)
{
  ...
  801da3:	81 7d 08 00 5b 86 00 	cmpl   $0x865b00,0x8(%ebp)
  801daa:	72 09                	jb     801db5 <to_page_va+0x18>
  801dac:	81 7d 08 00 db 87 00 	cmpl   $0x87db00,0x8(%ebp)
  801db3:	72 14                	jb     801dc9 <to_page_va+0x2c>
			panic("to_page_va called with invalid pageInfoPtr");
  801db5:	83 ec 04             	sub    $0x4,%esp
  801db8:	68 98 34 80 00       	push   $0x803498
  801dbd:	6a 15                	push   $0x15
  801dbf:	68 c3 34 80 00       	push   $0x8034c3
  801dc4:	e8 ee 0a 00 00       	call   8028b7 <_panic>
	//Get start VA of the page from the corresponding Page Info pointer
	int idxInPageInfoArr = (ptrPageInfo - pageBlockInfoArr);
  801dc9:	8b 45 08             	mov    0x8(%ebp),%eax
  801dcc:	ba 00 5b 86 00       	mov    $0x865b00,%edx
  ...
  801e06:	a1 04 db 87 00       	mov    0x87db04,%eax
...
__inline__ struct PageInfoElement * to_page_info(uint32 va)
{
  ...
  801e15:	a1 04 db 87 00       	mov    0x87db04,%eax
  ...
  801e39:	68 dc 34 80 00       	push   $0x8034dc
  801e3e:	6a 22                	push   $0x22
  801e40:	68 c3 34 80 00       	push   $0x8034c3
  801e45:	e8 6d 0a 00 00       	call   8028b7 <_panic>
  ...
  801e56:	05 00 5b 86 00       	add    $0x865b00,%eax
}
  801e5b:	c9                   	leave  
  801e5c:	c3                   	ret    
...
void initialize_dynamic_allocator(uint32 daStart, uint32 daEnd)
{
  ...
  801e70:	68 00 35 80 00       	push   $0x803500
  801e75:	68 26 35 80 00       	push   $0x803526
  801e7a:	6a 34                	push   $0x34
  801e7c:	68 c3 34 80 00       	push   $0x8034c3
  801e81:	e8 31 0a 00 00       	call   8028b7 <_panic>
		is_initialized = 1;
  801e86:	c7 05 24 40 80 00 01 	movl   $0x1,0x804024
  801e8d:	00 00 00 
	//==================================================================================
	//==================================================================================
  ...
  801e93:	a3 04 db 87 00       	mov    %eax,0x87db04
	dynAllocEnd = daEnd;
  801e98:	8b 45 0c             	mov    0xc(%ebp),%eax
  801e9b:	a3 40 40 80 00       	mov    %eax,0x804040
	// init the list that keep track of all free pageBlockInfoArr instances.
	LIST_INIT(&freePagesList);
  801ea0:	c7 05 e4 5a 86 00 00 	movl   $0x0,0x865ae4
  801ea7:	00 00 00 
  801eaa:	c7 05 e8 5a 86 00 00 	movl   $0x0,0x865ae8
  801eb1:	00 00 00 
  801eb4:	c7 05 f0 5a 86 00 00 	movl   $0x0,0x865af0
  801ebb:	00 00 00 

	// no.of pages in the dynamic allocator.
	int pCount = (daEnd - daStart) / PAGE_SIZE;
  801ebe:	8b 45 0c             	mov    0xc(%ebp),%eax
  801ec1:	2b 45 08             	sub    0x8(%ebp),%eax
  801ec4:	c1 e8 0c             	shr    $0xc,%eax
  801ec7:	89 45 ec             	mov    %eax,-0x14(%ebp)
	// iterate over each page and init its data in pageBlockInfoArr and reset it.
	for (int i = 0; i < pCount; ++i) {
  801eca:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  801ed1:	e9 c8 00 00 00       	jmp    801f9e <initialize_dynamic_allocator+0x141>
  ...
  801ee2:	05 08 5b 86 00       	add    $0x865b08,%eax
  801ee7:	66 c7 00 00 00       	movw   $0x0,(%eax)
  ...
  801ef8:	05 0a 5b 86 00       	add    $0x865b0a,%eax
  801efd:	66 c7 00 00 00       	movw   $0x0,(%eax)
	    LIST_INSERT_TAIL(&freePagesList, &pageBlockInfoArr[i]);
  801f02:	8b 15 e8 5a 86 00    	mov    0x865ae8,%edx
  801f08:	8b 4d f4             	mov    -0xc(%ebp),%ecx
  801f0b:	89 c8                	mov    %ecx,%eax
  801f0d:	01 c0                	add    %eax,%eax
  801f0f:	01 c8                	add    %ecx,%eax
  801f11:	c1 e0 02             	shl    $0x2,%eax
  801f14:	05 04 5b 86 00       	add    $0x865b04,%eax
  ...
  801f27:	05 04 5b 86 00       	add    $0x865b04,%eax
  801f2c:	8b 00                	mov    (%eax),%eax
  801f2e:	85 c0                	test   %eax,%eax
  801f30:	74 1b                	je     801f4d <initialize_dynamic_allocator+0xf0>
  801f32:	8b 15 e8 5a 86 00    	mov    0x865ae8,%edx
  801f38:	8b 4d f4             	mov    -0xc(%ebp),%ecx
  801f3b:	89 c8                	mov    %ecx,%eax
  801f3d:	01 c0                	add    %eax,%eax
  801f3f:	01 c8                	add    %ecx,%eax
  801f41:	c1 e0 02             	shl    $0x2,%eax
  801f44:	05 00 5b 86 00       	add    $0x865b00,%eax
  801f49:	89 02                	mov    %eax,(%edx)
  801f4b:	eb 16                	jmp    801f63 <initialize_dynamic_allocator+0x106>
  ...
  801f5e:	a3 e4 5a 86 00       	mov    %eax,0x865ae4
  ...
  801f6f:	05 00 5b 86 00       	add    $0x865b00,%eax
  801f74:	a3 e8 5a 86 00       	mov    %eax,0x865ae8
  ...
  801f85:	05 00 5b 86 00       	add    $0x865b00,%eax
  801f8a:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  801f90:	a1 f0 5a 86 00       	mov    0x865af0,%eax
  801f95:	40                   	inc    %eax
  801f96:	a3 f0 5a 86 00       	mov    %eax,0x865af0
	LIST_INIT(&freePagesList);
  ...
  801fa1:	3b 45 ec             	cmp    -0x14(%ebp),%eax
  801fa4:	0f 8c 2c ff ff ff    	jl     801ed6 <initialize_dynamic_allocator+0x79>
	    LIST_INSERT_TAIL(&freePagesList, &pageBlockInfoArr[i]);
	}
  ...
  801fb1:	eb 36                	jmp    801fe9 <initialize_dynamic_allocator+0x18c>
		LIST_INIT(&freeBlockLists[i]);
  801fb3:	8b 45 f0             	mov    -0x10(%ebp),%eax
  801fb6:	c1 e0 04             	shl    $0x4,%eax
  801fb9:	05 20 db 87 00       	add    $0x87db20,%eax
  801fbe:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  801fc4:	8b 45 f0             	mov    -0x10(%ebp),%eax
  801fc7:	c1 e0 04             	shl    $0x4,%eax
  801fca:	05 24 db 87 00       	add    $0x87db24,%eax
  801fcf:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  801fd5:	8b 45 f0             	mov    -0x10(%ebp),%eax
  801fd8:	c1 e0 04             	shl    $0x4,%eax
  801fdb:	05 2c db 87 00       	add    $0x87db2c,%eax
  801fe0:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
	...
	// 0 1  2  3   4  5    6   7    8
	for (int i = 0; i <= (LOG2_MAX_SIZE - LOG2_MIN_SIZE); ++i){
  801fe6:	ff 45 f0             	incl   -0x10(%ebp)
  801fe9:	83 7d f0 08          	cmpl   $0x8,-0x10(%ebp)
  801fed:	7e c4                	jle    801fb3 <initialize_dynamic_allocator+0x156>
		LIST_INIT(&freeBlockLists[i]);
	}
	//Comment the following line
...
__inline__ uint32 get_block_size(void *va)
{
  ...
  801ffe:	50                   	push   %eax
  801fff:	e8 0b fe ff ff       	call   801e0f <to_page_info>
...
//and putem in suitable freeblockList index according to size.
 void split_page_to_blocks(uint32 blk_size, struct PageInfoElement *pageInfo) {
  ...
  802021:	e8 77 fd ff ff       	call   801d9d <to_page_va>
  802026:	83 c4 10             	add    $0x10,%esp
  802029:	89 45 e8             	mov    %eax,-0x18(%ebp)
	 // no. of blks to save in freeblockList.
	 int blk_count = PAGE_SIZE / blk_size;
  80202c:	b8 00 10 00 00       	mov    $0x1000,%eax
  802031:	ba 00 00 00 00       	mov    $0x0,%edx
  802036:	f7 75 08             	divl   0x8(%ebp)
  ...
  802088:	83 7d f0 0b          	cmpl   $0xb,-0x10(%ebp)
  80208c:	7e e1                	jle    80206f <split_page_to_blocks+0x5a>
  80208e:	eb 01                	jmp    802091 <split_page_to_blocks+0x7c>
	     if ((1 << i) == blk_size)
	         break;
  802090:	90                   	nop
	     idx++;
  ...
  802091:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  802098:	e9 a7 00 00 00       	jmp    802144 <split_page_to_blocks+0x12f>
	     struct BlockElement *blk =(struct BlockElement*)(page_va + i * blk_size);
  80209d:	8b 45 ec             	mov    -0x14(%ebp),%eax
  8020a0:	0f af 45 08          	imul   0x8(%ebp),%eax
  8020a4:	89 c2                	mov    %eax,%edx
  8020a6:	8b 45 e8             	mov    -0x18(%ebp),%eax
  8020a9:	01 d0                	add    %edx,%eax
  8020ab:	89 45 e0             	mov    %eax,-0x20(%ebp)
	     LIST_INSERT_TAIL(&freeBlockLists[idx],blk);
  8020ae:	83 7d e0 00          	cmpl   $0x0,-0x20(%ebp)
  8020b2:	75 14                	jne    8020c8 <split_page_to_blocks+0xb3>
  8020b4:	83 ec 04             	sub    $0x4,%esp
  8020b7:	68 3c 35 80 00       	push   $0x80353c
  8020bc:	6a 7c                	push   $0x7c
  8020be:	68 c3 34 80 00       	push   $0x8034c3
  8020c3:	e8 ef 07 00 00       	call   8028b7 <_panic>
  8020c8:	8b 45 f4             	mov    -0xc(%ebp),%eax
  8020cb:	c1 e0 04             	shl    $0x4,%eax
  8020ce:	05 24 db 87 00       	add    $0x87db24,%eax
  8020d3:	8b 10                	mov    (%eax),%edx
  8020d5:	8b 45 e0             	mov    -0x20(%ebp),%eax
  8020d8:	89 50 04             	mov    %edx,0x4(%eax)
  8020db:	8b 45 e0             	mov    -0x20(%ebp),%eax
  8020de:	8b 40 04             	mov    0x4(%eax),%eax
  8020e1:	85 c0                	test   %eax,%eax
  8020e3:	74 14                	je     8020f9 <split_page_to_blocks+0xe4>
  8020e5:	8b 45 f4             	mov    -0xc(%ebp),%eax
  8020e8:	c1 e0 04             	shl    $0x4,%eax
  8020eb:	05 24 db 87 00       	add    $0x87db24,%eax
  8020f0:	8b 00                	mov    (%eax),%eax
  8020f2:	8b 55 e0             	mov    -0x20(%ebp),%edx
  8020f5:	89 10                	mov    %edx,(%eax)
  8020f7:	eb 11                	jmp    80210a <split_page_to_blocks+0xf5>
  8020f9:	8b 45 f4             	mov    -0xc(%ebp),%eax
  8020fc:	c1 e0 04             	shl    $0x4,%eax
  8020ff:	8d 90 20 db 87 00    	lea    0x87db20(%eax),%edx
  802105:	8b 45 e0             	mov    -0x20(%ebp),%eax
  802108:	89 02                	mov    %eax,(%edx)
  80210a:	8b 45 f4             	mov    -0xc(%ebp),%eax
  80210d:	c1 e0 04             	shl    $0x4,%eax
  802110:	8d 90 24 db 87 00    	lea    0x87db24(%eax),%edx
  802116:	8b 45 e0             	mov    -0x20(%ebp),%eax
  802119:	89 02                	mov    %eax,(%edx)
  80211b:	8b 45 e0             	mov    -0x20(%ebp),%eax
  80211e:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  802124:	8b 45 f4             	mov    -0xc(%ebp),%eax
  802127:	c1 e0 04             	shl    $0x4,%eax
  80212a:	05 2c db 87 00       	add    $0x87db2c,%eax
  80212f:	8b 00                	mov    (%eax),%eax
  802131:	8d 50 01             	lea    0x1(%eax),%edx
  802134:	8b 45 f4             	mov    -0xc(%ebp),%eax
  802137:	c1 e0 04             	shl    $0x4,%eax
  80213a:	05 2c db 87 00       	add    $0x87db2c,%eax
  80213f:	89 10                	mov    %edx,(%eax)
	 ...
	 // starting from the page_va.
	 for (uint32 i = 0; i < blk_count; ++i) {
  802141:	ff 45 ec             	incl   -0x14(%ebp)
  802144:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  802147:	39 45 ec             	cmp    %eax,-0x14(%ebp)
  80214a:	0f 82 4d ff ff ff    	jb     80209d <split_page_to_blocks+0x88>
	     struct BlockElement *blk =(struct BlockElement*)(page_va + i * blk_size);
	     LIST_INSERT_TAIL(&freeBlockLists[idx],blk);
	 }
 }
...
void *alloc_block(uint32 size)
{
  ...
  802156:	83 ec 38             	sub    $0x38,%esp
	//==================================================================================
	//DON'T CHANGE THESE LINES==========================================================
	//==================================================================================
	{
		assert(size <= DYN_ALLOC_MAX_BLOCK_SIZE);
  802159:	81 7d 08 00 08 00 00 	cmpl   $0x800,0x8(%ebp)
  802160:	76 19                	jbe    80217b <alloc_block+0x28>
  802162:	68 60 35 80 00       	push   $0x803560
  802167:	68 26 35 80 00       	push   $0x803526
  80216c:	68 8a 00 00 00       	push   $0x8a
  802171:	68 c3 34 80 00       	push   $0x8034c3
  802176:	e8 3c 07 00 00       	call   8028b7 <_panic>
	//==================================================================================
	...
	uint32 idx = 0;
  80217b:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
	for (int i = LOG2_MIN_SIZE; i <= LOG2_MAX_SIZE; ++i){
  802182:	c7 45 f0 03 00 00 00 	movl   $0x3,-0x10(%ebp)
  802189:	eb 19                	jmp    8021a4 <alloc_block+0x51>
		if((1 << i) >= size) break;
  80218b:	8b 45 f0             	mov    -0x10(%ebp),%eax
  80218e:	ba 01 00 00 00       	mov    $0x1,%edx
  802193:	88 c1                	mov    %al,%cl
  802195:	d3 e2                	shl    %cl,%edx
  802197:	89 d0                	mov    %edx,%eax
  802199:	3b 45 08             	cmp    0x8(%ebp),%eax
  80219c:	73 0e                	jae    8021ac <alloc_block+0x59>
		idx++;
  80219e:	ff 45 f4             	incl   -0xc(%ebp)
	//TODO: [PROJECT'25.GM#1] DYNAMIC ALLOCATOR - #3 alloc_block
	//Your code is here
	//Comment the following line
	// get index in freeBlockList by size.
  ...
  8021a4:	83 7d f0 0b          	cmpl   $0xb,-0x10(%ebp)
  8021a8:	7e e1                	jle    80218b <alloc_block+0x38>
  8021aa:	eb 01                	jmp    8021ad <alloc_block+0x5a>
		if((1 << i) >= size) break;
  8021ac:	90                   	nop
		idx++;
	}
  ...
  8021b3:	05 2c db 87 00       	add    $0x87db2c,%eax
  8021b8:	8b 00                	mov    (%eax),%eax
  8021ba:	85 c0                	test   %eax,%eax
  8021bc:	0f 84 df 00 00 00    	je     8022a1 <alloc_block+0x14e>
  ...
  8021c8:	05 20 db 87 00       	add    $0x87db20,%eax
  8021cd:	8b 00                	mov    (%eax),%eax
  8021cf:	89 45 ec             	mov    %eax,-0x14(%ebp)
	    LIST_REMOVE(&freeBlockLists[idx], blk);
  8021d2:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
  8021d6:	75 17                	jne    8021ef <alloc_block+0x9c>
  8021d8:	83 ec 04             	sub    $0x4,%esp
  8021db:	68 81 35 80 00       	push   $0x803581
  8021e0:	68 9e 00 00 00       	push   $0x9e
  8021e5:	68 c3 34 80 00       	push   $0x8034c3
  8021ea:	e8 c8 06 00 00       	call   8028b7 <_panic>
  8021ef:	8b 45 ec             	mov    -0x14(%ebp),%eax
  8021f2:	8b 00                	mov    (%eax),%eax
  8021f4:	85 c0                	test   %eax,%eax
  8021f6:	74 10                	je     802208 <alloc_block+0xb5>
  8021f8:	8b 45 ec             	mov    -0x14(%ebp),%eax
  8021fb:	8b 00                	mov    (%eax),%eax
  8021fd:	8b 55 ec             	mov    -0x14(%ebp),%edx
  802200:	8b 52 04             	mov    0x4(%edx),%edx
  802203:	89 50 04             	mov    %edx,0x4(%eax)
  802206:	eb 14                	jmp    80221c <alloc_block+0xc9>
  ...
  80227e:	50                   	push   %eax
  80227f:	e8 8b fb ff ff       	call   801e0f <to_page_info>
  802284:	83 c4 10             	add    $0x10,%esp
  802287:	89 45 e8             	mov    %eax,-0x18(%ebp)
	    pageInfo->num_of_free_blocks--;
  80228a:	8b 45 e8             	mov    -0x18(%ebp),%eax
  80228d:	66 8b 40 0a          	mov    0xa(%eax),%ax
  802291:	48                   	dec    %eax
  802292:	8b 55 e8             	mov    -0x18(%ebp),%edx
  802295:	66 89 42 0a          	mov    %ax,0xa(%edx)
	    return blk;
  802299:	8b 45 ec             	mov    -0x14(%ebp),%eax
  80229c:	e9 bc 02 00 00       	jmp    80255d <alloc_block+0x40a>
	}else{ //case(2, 3): 2. no free blocks available in the freeblocklist but there is free pages.
				//3. no free blocks and no available freepages so search in higher block sizes.
		// case 2:
		if(freePagesList.size > 0){ //have free pages.
  8022a1:	a1 f0 5a 86 00       	mov    0x865af0,%eax
  8022a6:	85 c0                	test   %eax,%eax
  8022a8:	0f 84 7d 02 00 00    	je     80252b <alloc_block+0x3d8>
			// get page to split and use from freepagesList.
			struct PageInfoElement *ptr_new_page = LIST_FIRST(&freePagesList);
  8022ae:	a1 e4 5a 86 00       	mov    0x865ae4,%eax
  8022b3:	89 45 e4             	mov    %eax,-0x1c(%ebp)
			LIST_REMOVE(&freePagesList, ptr_new_page);
  8022b6:	83 7d e4 00          	cmpl   $0x0,-0x1c(%ebp)
  8022ba:	75 17                	jne    8022d3 <alloc_block+0x180>
  8022bc:	83 ec 04             	sub    $0x4,%esp
  8022bf:	68 81 35 80 00       	push   $0x803581
  8022c4:	68 a9 00 00 00       	push   $0xa9
  8022c9:	68 c3 34 80 00       	push   $0x8034c3
  8022ce:	e8 e4 05 00 00       	call   8028b7 <_panic>
  8022d3:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  8022d6:	8b 00                	mov    (%eax),%eax
  8022d8:	85 c0                	test   %eax,%eax
  8022da:	74 10                	je     8022ec <alloc_block+0x199>
  8022dc:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  8022df:	8b 00                	mov    (%eax),%eax
  8022e1:	8b 55 e4             	mov    -0x1c(%ebp),%edx
  8022e4:	8b 52 04             	mov    0x4(%edx),%edx
  8022e7:	89 50 04             	mov    %edx,0x4(%eax)
  8022ea:	eb 0b                	jmp    8022f7 <alloc_block+0x1a4>
  8022ec:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  8022ef:	8b 40 04             	mov    0x4(%eax),%eax
  8022f2:	a3 e8 5a 86 00       	mov    %eax,0x865ae8
  8022f7:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  8022fa:	8b 40 04             	mov    0x4(%eax),%eax
  8022fd:	85 c0                	test   %eax,%eax
  8022ff:	74 0f                	je     802310 <alloc_block+0x1bd>
  ...
  80230e:	eb 0a                	jmp    80231a <alloc_block+0x1c7>
  802310:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  802313:	8b 00                	mov    (%eax),%eax
  802315:	a3 e4 5a 86 00       	mov    %eax,0x865ae4
  ...
  80232d:	a1 f0 5a 86 00       	mov    0x865af0,%eax
  802332:	48                   	dec    %eax
  802333:	a3 f0 5a 86 00       	mov    %eax,0x865af0
			// from page to freeblockList by the pageInfo and the block size.
			split_page_to_blocks(1 << (idx + LOG2_MIN_SIZE), ptr_new_page);
  802338:	8b 45 f4             	mov    -0xc(%ebp),%eax
  80233b:	83 c0 03             	add    $0x3,%eax
  80233e:	ba 01 00 00 00       	mov    $0x1,%edx
  ...
  80234f:	50                   	push   %eax
  802350:	e8 c0 fc ff ff       	call   802015 <split_page_to_blocks>
  ...
  80235e:	05 20 db 87 00       	add    $0x87db20,%eax
  802363:	8b 00                	mov    (%eax),%eax
  802365:	89 45 e0             	mov    %eax,-0x20(%ebp)
		    LIST_REMOVE(&freeBlockLists[idx], blk);
  802368:	83 7d e0 00          	cmpl   $0x0,-0x20(%ebp)
  80236c:	75 17                	jne    802385 <alloc_block+0x232>
  80236e:	83 ec 04             	sub    $0x4,%esp
  802371:	68 81 35 80 00       	push   $0x803581
  802376:	68 b0 00 00 00       	push   $0xb0
  80237b:	68 c3 34 80 00       	push   $0x8034c3
  802380:	e8 32 05 00 00       	call   8028b7 <_panic>
  802385:	8b 45 e0             	mov    -0x20(%ebp),%eax
  802388:	8b 00                	mov    (%eax),%eax
  80238a:	85 c0                	test   %eax,%eax
  80238c:	74 10                	je     80239e <alloc_block+0x24b>
  ...
  80239c:	eb 14                	jmp    8023b2 <alloc_block+0x25f>
  80239e:	8b 45 e0             	mov    -0x20(%ebp),%eax
  8023a1:	8b 40 04             	mov    0x4(%eax),%eax
  8023a4:	8b 55 f4             	mov    -0xc(%ebp),%edx
  8023a7:	c1 e2 04             	shl    $0x4,%edx
  8023aa:	81 c2 24 db 87 00    	add    $0x87db24,%edx
  8023b0:	89 02                	mov    %eax,(%edx)
  8023b2:	8b 45 e0             	mov    -0x20(%ebp),%eax
  8023b5:	8b 40 04             	mov    0x4(%eax),%eax
  8023b8:	85 c0                	test   %eax,%eax
  8023ba:	74 0f                	je     8023cb <alloc_block+0x278>
  ...
  8023c9:	eb 13                	jmp    8023de <alloc_block+0x28b>
  8023cb:	8b 45 e0             	mov    -0x20(%ebp),%eax
  8023ce:	8b 00                	mov    (%eax),%eax
  8023d0:	8b 55 f4             	mov    -0xc(%ebp),%edx
  8023d3:	c1 e2 04             	shl    $0x4,%edx
  8023d6:	81 c2 20 db 87 00    	add    $0x87db20,%edx
  8023dc:	89 02                	mov    %eax,(%edx)
  8023de:	8b 45 e0             	mov    -0x20(%ebp),%eax
  8023e1:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  8023e7:	8b 45 e0             	mov    -0x20(%ebp),%eax
  8023ea:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
  8023f1:	8b 45 f4             	mov    -0xc(%ebp),%eax
  8023f4:	c1 e0 04             	shl    $0x4,%eax
  8023f7:	05 2c db 87 00       	add    $0x87db2c,%eax
  8023fc:	8b 00                	mov    (%eax),%eax
  8023fe:	8d 50 ff             	lea    -0x1(%eax),%edx
  802401:	8b 45 f4             	mov    -0xc(%ebp),%eax
  802404:	c1 e0 04             	shl    $0x4,%eax
  802407:	05 2c db 87 00       	add    $0x87db2c,%eax
  80240c:	89 10                	mov    %edx,(%eax)
		    // update pageBlockInfoArr
		    struct PageInfoElement *pageInfo = to_page_info((uint32)blk);
  80240e:	8b 45 e0             	mov    -0x20(%ebp),%eax
  802411:	83 ec 0c             	sub    $0xc,%esp
  802414:	50                   	push   %eax
  802415:	e8 f5 f9 ff ff       	call   801e0f <to_page_info>
  80241a:	83 c4 10             	add    $0x10,%esp
  80241d:	89 45 dc             	mov    %eax,-0x24(%ebp)
		    pageInfo->num_of_free_blocks--;
  802420:	8b 45 dc             	mov    -0x24(%ebp),%eax
  802423:	66 8b 40 0a          	mov    0xa(%eax),%ax
  802427:	48                   	dec    %eax
  802428:	8b 55 dc             	mov    -0x24(%ebp),%edx
  80242b:	66 89 42 0a          	mov    %ax,0xa(%edx)
		    return blk;
  80242f:	8b 45 e0             	mov    -0x20(%ebp),%eax
  802432:	e9 26 01 00 00       	jmp    80255d <alloc_block+0x40a>
		}else{//case 3: no free block and no free page so iterate and try to find bigger size.
			// iterate over the list until finding available block
			while (idx <= (LOG2_MAX_SIZE - LOG2_MIN_SIZE) && freeBlockLists[idx].size == 0) {
				idx++;
  802437:	ff 45 f4             	incl   -0xc(%ebp)
				// found free block
				if(freeBlockLists[idx].size > 0){
  80243a:	8b 45 f4             	mov    -0xc(%ebp),%eax
  80243d:	c1 e0 04             	shl    $0x4,%eax
  802440:	05 2c db 87 00       	add    $0x87db2c,%eax
  802445:	8b 00                	mov    (%eax),%eax
  802447:	85 c0                	test   %eax,%eax
  802449:	0f 84 dc 00 00 00    	je     80252b <alloc_block+0x3d8>
					// remove from the list and updat the pageInfoArr free blocks.
					// pop from the freeBlockList.
					struct BlockElement *blk = LIST_FIRST(&freeBlockLists[idx]);
  80244f:	8b 45 f4             	mov    -0xc(%ebp),%eax
  802452:	c1 e0 04             	shl    $0x4,%eax
  802455:	05 20 db 87 00       	add    $0x87db20,%eax
  80245a:	8b 00                	mov    (%eax),%eax
  80245c:	89 45 d8             	mov    %eax,-0x28(%ebp)
				    LIST_REMOVE(&freeBlockLists[idx], blk);
  80245f:	83 7d d8 00          	cmpl   $0x0,-0x28(%ebp)
  802463:	75 17                	jne    80247c <alloc_block+0x329>
  802465:	83 ec 04             	sub    $0x4,%esp
  802468:	68 81 35 80 00       	push   $0x803581
  80246d:	68 be 00 00 00       	push   $0xbe
  802472:	68 c3 34 80 00       	push   $0x8034c3
  802477:	e8 3b 04 00 00       	call   8028b7 <_panic>
  80247c:	8b 45 d8             	mov    -0x28(%ebp),%eax
  80247f:	8b 00                	mov    (%eax),%eax
  802481:	85 c0                	test   %eax,%eax
  802483:	74 10                	je     802495 <alloc_block+0x342>
  ...
  802493:	eb 14                	jmp    8024a9 <alloc_block+0x356>
  802495:	8b 45 d8             	mov    -0x28(%ebp),%eax
  802498:	8b 40 04             	mov    0x4(%eax),%eax
  80249b:	8b 55 f4             	mov    -0xc(%ebp),%edx
  80249e:	c1 e2 04             	shl    $0x4,%edx
  8024a1:	81 c2 24 db 87 00    	add    $0x87db24,%edx
  8024a7:	89 02                	mov    %eax,(%edx)
  8024a9:	8b 45 d8             	mov    -0x28(%ebp),%eax
  8024ac:	8b 40 04             	mov    0x4(%eax),%eax
  8024af:	85 c0                	test   %eax,%eax
  8024b1:	74 0f                	je     8024c2 <alloc_block+0x36f>
  8024b3:	8b 45 d8             	mov    -0x28(%ebp),%eax
  8024b6:	8b 40 04             	mov    0x4(%eax),%eax
  8024b9:	8b 55 d8             	mov    -0x28(%ebp),%edx
  8024bc:	8b 12                	mov    (%edx),%edx
  8024be:	89 10                	mov    %edx,(%eax)
  8024c0:	eb 13                	jmp    8024d5 <alloc_block+0x382>
  8024c2:	8b 45 d8             	mov    -0x28(%ebp),%eax
  8024c5:	8b 00                	mov    (%eax),%eax
  8024c7:	8b 55 f4             	mov    -0xc(%ebp),%edx
  8024ca:	c1 e2 04             	shl    $0x4,%edx
  8024cd:	81 c2 20 db 87 00    	add    $0x87db20,%edx
  ...
  8024ee:	05 2c db 87 00       	add    $0x87db2c,%eax
  8024f3:	8b 00                	mov    (%eax),%eax
  8024f5:	8d 50 ff             	lea    -0x1(%eax),%edx
  8024f8:	8b 45 f4             	mov    -0xc(%ebp),%eax
  8024fb:	c1 e0 04             	shl    $0x4,%eax
  8024fe:	05 2c db 87 00       	add    $0x87db2c,%eax
  802503:	89 10                	mov    %edx,(%eax)
				    // update pageBlockInfoArr
				    struct PageInfoElement *pageInfo = to_page_info((uint32)blk);
  802505:	8b 45 d8             	mov    -0x28(%ebp),%eax
  802508:	83 ec 0c             	sub    $0xc,%esp
  80250b:	50                   	push   %eax
  80250c:	e8 fe f8 ff ff       	call   801e0f <to_page_info>
  802511:	83 c4 10             	add    $0x10,%esp
  802514:	89 45 d4             	mov    %eax,-0x2c(%ebp)
				    pageInfo->num_of_free_blocks--;
  802517:	8b 45 d4             	mov    -0x2c(%ebp),%eax
  80251a:	66 8b 40 0a          	mov    0xa(%eax),%ax
  80251e:	48                   	dec    %eax
  80251f:	8b 55 d4             	mov    -0x2c(%ebp),%edx
  802522:	66 89 42 0a          	mov    %ax,0xa(%edx)
				    return blk;
  802526:	8b 45 d8             	mov    -0x28(%ebp),%eax
  802529:	eb 32                	jmp    80255d <alloc_block+0x40a>
		    struct PageInfoElement *pageInfo = to_page_info((uint32)blk);
		    pageInfo->num_of_free_blocks--;
		    return blk;
		}else{//case 3: no free block and no free page so iterate and try to find bigger size.
			// iterate over the list until finding available block
			while (idx <= (LOG2_MAX_SIZE - LOG2_MIN_SIZE) && freeBlockLists[idx].size == 0) {
  80252b:	83 7d f4 08          	cmpl   $0x8,-0xc(%ebp)
  80252f:	77 15                	ja     802546 <alloc_block+0x3f3>
  802531:	8b 45 f4             	mov    -0xc(%ebp),%eax
  802534:	c1 e0 04             	shl    $0x4,%eax
  802537:	05 2c db 87 00       	add    $0x87db2c,%eax
  80253c:	8b 00                	mov    (%eax),%eax
  80253e:	85 c0                	test   %eax,%eax
  802540:	0f 84 f1 fe ff ff    	je     802437 <alloc_block+0x2e4>
				}
			}
		}
	}
  ...
  802549:	68 9f 35 80 00       	push   $0x80359f
  80254e:	68 c8 00 00 00       	push   $0xc8
  802553:	68 c3 34 80 00       	push   $0x8034c3
  802558:	e8 5a 03 00 00       	call   8028b7 <_panic>
...
void free_block(void *va)
{
  ...
  802568:	a1 04 db 87 00       	mov    0x87db04,%eax
  80256d:	39 c2                	cmp    %eax,%edx
  80256f:	72 0c                	jb     80257d <free_block+0x1e>
  802571:	8b 55 08             	mov    0x8(%ebp),%edx
  802574:	a1 40 40 80 00       	mov    0x804040,%eax
  802579:	39 c2                	cmp    %eax,%edx
  80257b:	72 19                	jb     802596 <free_block+0x37>
  80257d:	68 b0 35 80 00       	push   $0x8035b0
  802582:	68 26 35 80 00       	push   $0x803526
  802587:	68 d7 00 00 00       	push   $0xd7
  80258c:	68 c3 34 80 00       	push   $0x8034c3
  802591:	e8 21 03 00 00       	call   8028b7 <_panic>
  ...
  802599:	89 45 e8             	mov    %eax,-0x18(%ebp)
	struct PageInfoElement *pageInfo = to_page_info((uint32)va);
  80259c:	8b 45 08             	mov    0x8(%ebp),%eax
  80259f:	83 ec 0c             	sub    $0xc,%esp
  8025a2:	50                   	push   %eax
  8025a3:	e8 67 f8 ff ff       	call   801e0f <to_page_info>
  ...
  8025b4:	0f b7 c0             	movzwl %ax,%eax
  8025b7:	89 45 e0             	mov    %eax,-0x20(%ebp)

	// its index in the freeBlocklist.
	int idx = 0;
  8025ba:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
	for (int i = LOG2_MIN_SIZE; i <= LOG2_MAX_SIZE; i++) {
  8025c1:	c7 45 f0 03 00 00 00 	movl   $0x3,-0x10(%ebp)
  8025c8:	eb 19                	jmp    8025e3 <free_block+0x84>
	    if ((1 << i) == blk_size)
  8025ca:	8b 45 f0             	mov    -0x10(%ebp),%eax
  8025cd:	ba 01 00 00 00       	mov    $0x1,%edx
  8025d2:	88 c1                	mov    %al,%cl
  8025d4:	d3 e2                	shl    %cl,%edx
  8025d6:	89 d0                	mov    %edx,%eax
  8025d8:	3b 45 e0             	cmp    -0x20(%ebp),%eax
  8025db:	74 0e                	je     8025eb <free_block+0x8c>
	        break;
	    idx++;
  8025dd:	ff 45 f4             	incl   -0xc(%ebp)
	struct PageInfoElement *pageInfo = to_page_info((uint32)va);
	uint32 blk_size = pageInfo->block_size;
  ...
  8025e3:	83 7d f0 0b          	cmpl   $0xb,-0x10(%ebp)
  8025e7:	7e e1                	jle    8025ca <free_block+0x6b>
  8025e9:	eb 01                	jmp    8025ec <free_block+0x8d>
	    if ((1 << i) == blk_size)
	        break;
  8025eb:	90                   	nop
	    idx++;
  ...
  8025ef:	66 8b 40 0a          	mov    0xa(%eax),%ax
  8025f3:	40                   	inc    %eax
  8025f4:	8b 55 e4             	mov    -0x1c(%ebp),%edx
  8025f7:	66 89 42 0a          	mov    %ax,0xa(%edx)
	LIST_INSERT_TAIL(&freeBlockLists[idx], blk_to_free);
  8025fb:	83 7d e8 00          	cmpl   $0x0,-0x18(%ebp)
  8025ff:	75 17                	jne    802618 <free_block+0xb9>
  802601:	83 ec 04             	sub    $0x4,%esp
  802604:	68 3c 35 80 00       	push   $0x80353c
  802609:	68 ee 00 00 00       	push   $0xee
  80260e:	68 c3 34 80 00       	push   $0x8034c3
  802613:	e8 9f 02 00 00       	call   8028b7 <_panic>
  802618:	8b 45 f4             	mov    -0xc(%ebp),%eax
  80261b:	c1 e0 04             	shl    $0x4,%eax
  80261e:	05 24 db 87 00       	add    $0x87db24,%eax
  ...
  80267a:	05 2c db 87 00       	add    $0x87db2c,%eax
  80267f:	8b 00                	mov    (%eax),%eax
  802681:	8d 50 01             	lea    0x1(%eax),%edx
  802684:	8b 45 f4             	mov    -0xc(%ebp),%eax
  802687:	c1 e0 04             	shl    $0x4,%eax
  80268a:	05 2c db 87 00       	add    $0x87db2c,%eax
  80268f:	89 10                	mov    %edx,(%eax)

	// now, case 1: the page all blocks are freed so you free the page.
	int blk_count = PAGE_SIZE / blk_size;
  802691:	b8 00 10 00 00       	mov    $0x1000,%eax
  802696:	ba 00 00 00 00       	mov    $0x0,%edx
  80269b:	f7 75 e0             	divl   -0x20(%ebp)
  80269e:	89 45 dc             	mov    %eax,-0x24(%ebp)
	// the blk count in the page is same as number fo free blocks free up the page.
	if (pageInfo->num_of_free_blocks == blk_count) {
  8026a1:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  8026a4:	66 8b 40 0a          	mov    0xa(%eax),%ax
  8026a8:	0f b7 c0             	movzwl %ax,%eax
  8026ab:	3b 45 dc             	cmp    -0x24(%ebp),%eax
  8026ae:	0f 85 70 01 00 00    	jne    802824 <free_block+0x2c5>
		uint32 page_va = to_page_va(pageInfo);
  8026b4:	83 ec 0c             	sub    $0xc,%esp
  8026b7:	ff 75 e4             	pushl  -0x1c(%ebp)
  8026ba:	e8 de f6 ff ff       	call   801d9d <to_page_va>
  8026bf:	83 c4 10             	add    $0x10,%esp
  8026c2:	89 45 d8             	mov    %eax,-0x28(%ebp)
		// remove all blk in the freeBlockList.
		for (uint32 off = 0; off < PAGE_SIZE; off += blk_size) {
  8026c5:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  8026cc:	e9 b7 00 00 00       	jmp    802788 <free_block+0x229>
			struct BlockElement *blk = (struct BlockElement*)(page_va + off);
  8026d1:	8b 55 d8             	mov    -0x28(%ebp),%edx
  8026d4:	8b 45 ec             	mov    -0x14(%ebp),%eax
  8026d7:	01 d0                	add    %edx,%eax
  8026d9:	89 45 d4             	mov    %eax,-0x2c(%ebp)
			LIST_REMOVE(&freeBlockLists[idx], blk);
  8026dc:	83 7d d4 00          	cmpl   $0x0,-0x2c(%ebp)
  8026e0:	75 17                	jne    8026f9 <free_block+0x19a>
  8026e2:	83 ec 04             	sub    $0x4,%esp
  8026e5:	68 81 35 80 00       	push   $0x803581
  8026ea:	68 f8 00 00 00       	push   $0xf8
  8026ef:	68 c3 34 80 00       	push   $0x8034c3
  8026f4:	e8 be 01 00 00       	call   8028b7 <_panic>
  8026f9:	8b 45 d4             	mov    -0x2c(%ebp),%eax
  8026fc:	8b 00                	mov    (%eax),%eax
  8026fe:	85 c0                	test   %eax,%eax
  802700:	74 10                	je     802712 <free_block+0x1b3>
  802702:	8b 45 d4             	mov    -0x2c(%ebp),%eax
  802705:	8b 00                	mov    (%eax),%eax
  802707:	8b 55 d4             	mov    -0x2c(%ebp),%edx
  80270a:	8b 52 04             	mov    0x4(%edx),%edx
  80270d:	89 50 04             	mov    %edx,0x4(%eax)
  802710:	eb 14                	jmp    802726 <free_block+0x1c7>
  802712:	8b 45 d4             	mov    -0x2c(%ebp),%eax
  802715:	8b 40 04             	mov    0x4(%eax),%eax
  802718:	8b 55 f4             	mov    -0xc(%ebp),%edx
  80271b:	c1 e2 04             	shl    $0x4,%edx
  80271e:	81 c2 24 db 87 00    	add    $0x87db24,%edx
  802724:	89 02                	mov    %eax,(%edx)
  802726:	8b 45 d4             	mov    -0x2c(%ebp),%eax
  802729:	8b 40 04             	mov    0x4(%eax),%eax
  80272c:	85 c0                	test   %eax,%eax
  80272e:	74 0f                	je     80273f <free_block+0x1e0>
  802730:	8b 45 d4             	mov    -0x2c(%ebp),%eax
  802733:	8b 40 04             	mov    0x4(%eax),%eax
  802736:	8b 55 d4             	mov    -0x2c(%ebp),%edx
  802739:	8b 12                	mov    (%edx),%edx
  80273b:	89 10                	mov    %edx,(%eax)
  80273d:	eb 13                	jmp    802752 <free_block+0x1f3>
  80273f:	8b 45 d4             	mov    -0x2c(%ebp),%eax
  802742:	8b 00                	mov    (%eax),%eax
  802744:	8b 55 f4             	mov    -0xc(%ebp),%edx
  802747:	c1 e2 04             	shl    $0x4,%edx
  80274a:	81 c2 20 db 87 00    	add    $0x87db20,%edx
  802750:	89 02                	mov    %eax,(%edx)
  ...
  802768:	c1 e0 04             	shl    $0x4,%eax
  80276b:	05 2c db 87 00       	add    $0x87db2c,%eax
  802770:	8b 00                	mov    (%eax),%eax
  802772:	8d 50 ff             	lea    -0x1(%eax),%edx
  802775:	8b 45 f4             	mov    -0xc(%ebp),%eax
  802778:	c1 e0 04             	shl    $0x4,%eax
  80277b:	05 2c db 87 00       	add    $0x87db2c,%eax
  ...
  802785:	01 45 ec             	add    %eax,-0x14(%ebp)
  802788:	81 7d ec ff 0f 00 00 	cmpl   $0xfff,-0x14(%ebp)
  80278f:	0f 86 3c ff ff ff    	jbe    8026d1 <free_block+0x172>
			struct BlockElement *blk = (struct BlockElement*)(page_va + off);
			LIST_REMOVE(&freeBlockLists[idx], blk);
		}
		// reset page info.
  ...
  802798:	66 c7 40 08 00 00    	movw   $0x0,0x8(%eax)
		pageInfo->num_of_free_blocks = 0;
  80279e:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  8027a1:	66 c7 40 0a 00 00    	movw   $0x0,0xa(%eax)
		// add it to the available pages.
		LIST_INSERT_TAIL(&freePagesList, pageInfo);
  8027a7:	83 7d e4 00          	cmpl   $0x0,-0x1c(%ebp)
  8027ab:	75 17                	jne    8027c4 <free_block+0x265>
  8027ad:	83 ec 04             	sub    $0x4,%esp
  8027b0:	68 3c 35 80 00       	push   $0x80353c
  8027b5:	68 fe 00 00 00       	push   $0xfe
  8027ba:	68 c3 34 80 00       	push   $0x8034c3
  8027bf:	e8 f3 00 00 00       	call   8028b7 <_panic>
  8027c4:	8b 15 e8 5a 86 00    	mov    0x865ae8,%edx
  ...
  8027d8:	74 0c                	je     8027e6 <free_block+0x287>
  8027da:	a1 e8 5a 86 00       	mov    0x865ae8,%eax
  8027df:	8b 55 e4             	mov    -0x1c(%ebp),%edx
  8027e2:	89 10                	mov    %edx,(%eax)
  8027e4:	eb 08                	jmp    8027ee <free_block+0x28f>
  8027e6:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  8027e9:	a3 e4 5a 86 00       	mov    %eax,0x865ae4
  8027ee:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  8027f1:	a3 e8 5a 86 00       	mov    %eax,0x865ae8
  8027f6:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  8027f9:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  8027ff:	a1 f0 5a 86 00       	mov    0x865af0,%eax
  802804:	40                   	inc    %eax
  802805:	a3 f0 5a 86 00       	mov    %eax,0x865af0
		// make it available in memory.
		return_page((uint32 *)to_page_va(pageInfo));
  80280a:	83 ec 0c             	sub    $0xc,%esp
  80280d:	ff 75 e4             	pushl  -0x1c(%ebp)
  802810:	e8 88 f5 ff ff       	call   801d9d <to_page_va>
  802815:	83 c4 10             	add    $0x10,%esp
  802818:	83 ec 0c             	sub    $0xc,%esp
  80281b:	50                   	push   %eax
  80281c:	e8 b8 ee ff ff       	call   8016d9 <return_page>
...
void *realloc_block(void* va, uint32 new_size)
{
  ...
  802830:	68 e8 35 80 00       	push   $0x8035e8
  802835:	68 11 01 00 00       	push   $0x111
  80283a:	68 c3 34 80 00       	push   $0x8034c3
  80283f:	e8 73 00 00 00       	call   8028b7 <_panic>

00802844 <create_semaphore>:
...
struct semaphore create_semaphore(char *semaphoreName, uint32 value)
{
  ...
  80284d:	68 0c 36 80 00       	push   $0x80360c
  802852:	6a 07                	push   $0x7
  802854:	68 3b 36 80 00       	push   $0x80363b
  802859:	e8 59 00 00 00       	call   8028b7 <_panic>

0080285e <get_semaphore>:
}
struct semaphore get_semaphore(int32 ownerEnvID, char* semaphoreName)
{
  ...
  802867:	68 4c 36 80 00       	push   $0x80364c
  80286c:	6a 0b                	push   $0xb
  80286e:	68 3b 36 80 00       	push   $0x80363b
  802873:	e8 3f 00 00 00       	call   8028b7 <_panic>

00802878 <wait_semaphore>:
}
...
void wait_semaphore(struct semaphore sem)
{
  ...
  802881:	68 78 36 80 00       	push   $0x803678
  802886:	6a 10                	push   $0x10
  802888:	68 3b 36 80 00       	push   $0x80363b
  80288d:	e8 25 00 00 00       	call   8028b7 <_panic>

00802892 <signal_semaphore>:
}
...
void signal_semaphore(struct semaphore sem)
{
  ...
  80289b:	68 a8 36 80 00       	push   $0x8036a8
  8028a0:	6a 15                	push   $0x15
  8028a2:	68 3b 36 80 00       	push   $0x80363b
  8028a7:	e8 0b 00 00 00       	call   8028b7 <_panic>

008028ac <semaphore_count>:
}
...
int semaphore_count(struct semaphore sem)
{
  ...
  8028b2:	8b 40 10             	mov    0x10(%eax),%eax
}
  8028b5:	5d                   	pop    %ebp
  8028b6:	c3                   	ret    
...
_panic(const char *file, int line, const char *fmt,...)
{
  ...
  8028ba:	83 ec 18             	sub    $0x18,%esp
	va_list ap;
	va_start(ap, fmt);
  8028bd:	8d 45 10             	lea    0x10(%ebp),%eax
  8028c0:	83 c0 04             	add    $0x4,%eax
  8028c3:	89 45 f4             	mov    %eax,-0xc(%ebp)
	// Print the panic message
	if (argv0)
  8028c6:	a1 48 f6 8d 00       	mov    0x8df648,%eax
  8028cb:	85 c0                	test   %eax,%eax
  8028cd:	74 16                	je     8028e5 <_panic+0x2e>
		cprintf("%s: ", argv0);
  8028cf:	a1 48 f6 8d 00       	mov    0x8df648,%eax
  8028d4:	83 ec 08             	sub    $0x8,%esp
  8028d7:	50                   	push   %eax
  8028d8:	68 d8 36 80 00       	push   $0x8036d8
  8028dd:	e8 75 de ff ff       	call   800757 <cprintf>
  8028e2:	83 c4 10             	add    $0x10,%esp
	cprintf_colored(TEXT_PANIC_CLR, "user [EVAL_FINAL]panic in %s at %s:%d: ", binaryname, file, line);
  8028e5:	a1 04 40 80 00       	mov    0x804004,%eax
  8028ea:	83 ec 0c             	sub    $0xc,%esp
  8028ed:	ff 75 0c             	pushl  0xc(%ebp)
  8028f0:	ff 75 08             	pushl  0x8(%ebp)
  8028f3:	50                   	push   %eax
  8028f4:	68 e0 36 80 00       	push   $0x8036e0
  8028f9:	6a 74                	push   $0x74
  8028fb:	e8 84 de ff ff       	call   800784 <cprintf_colored>
  ...
  80290c:	50                   	push   %eax
  80290d:	e8 d6 dd ff ff       	call   8006e8 <vcprintf>
  802912:	83 c4 10             	add    $0x10,%esp
	vcprintf("\n", NULL);
  802915:	83 ec 08             	sub    $0x8,%esp
  802918:	6a 00                	push   $0x0
  80291a:	68 08 37 80 00       	push   $0x803708
  80291f:	e8 c4 dd ff ff       	call   8006e8 <vcprintf>
...
//		asm volatile("int3");
	...
	exit() ;
  802927:	e8 3d dd ff ff       	call   800669 <exit>

	// should not return here
	while (1) ;
  80292c:	eb fe                	jmp    80292c <_panic+0x75>

0080292e <CheckWSArrayWithoutLastIndex>:
}
...
void CheckWSArrayWithoutLastIndex(uint32 *expectedPages, int arraySize)
{
  ...
  802931:	83 ec 28             	sub    $0x28,%esp
	if (arraySize != myEnv->page_WS_max_size)
  802934:	a1 20 40 80 00       	mov    0x804020,%eax
  802939:	8b 90 84 00 00 00    	mov    0x84(%eax),%edx
  80293f:	8b 45 0c             	mov    0xc(%ebp),%eax
  802942:	39 c2                	cmp    %eax,%edx
  802944:	74 14                	je     80295a <CheckWSArrayWithoutLastIndex+0x2c>
	{
		panic("number of expected pages SHOULD BE EQUAL to max WS size... review your TA!!");
  802946:	83 ec 04             	sub    $0x4,%esp
  802949:	68 0c 37 80 00       	push   $0x80370c
  80294e:	6a 26                	push   $0x26
  802950:	68 58 37 80 00       	push   $0x803758
  802955:	e8 5d ff ff ff       	call   8028b7 <_panic>
	}
	int expectedNumOfEmptyLocs = 0;
  80295a:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
	for (int e = 0; e < arraySize; e++) {
  802961:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  802968:	e9 c5 00 00 00       	jmp    802a32 <CheckWSArrayWithoutLastIndex+0x104>
		if (expectedPages[e] == 0) {
  80296d:	8b 45 f0             	mov    -0x10(%ebp),%eax
  802970:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
  802977:	8b 45 08             	mov    0x8(%ebp),%eax
  80297a:	01 d0                	add    %edx,%eax
  80297c:	8b 00                	mov    (%eax),%eax
  80297e:	85 c0                	test   %eax,%eax
  802980:	75 08                	jne    80298a <CheckWSArrayWithoutLastIndex+0x5c>
			expectedNumOfEmptyLocs++;
  802982:	ff 45 f4             	incl   -0xc(%ebp)
			continue;
  802985:	e9 a5 00 00 00       	jmp    802a2f <CheckWSArrayWithoutLastIndex+0x101>
		}
		int found = 0;
  80298a:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
		for (int w = 0; w < myEnv->page_WS_max_size; w++) {
  802991:	c7 45 e8 00 00 00 00 	movl   $0x0,-0x18(%ebp)
  802998:	eb 69                	jmp    802a03 <CheckWSArrayWithoutLastIndex+0xd5>
			if (myEnv->__uptr_pws[w].empty == 0) {
  80299a:	a1 20 40 80 00       	mov    0x804020,%eax
  80299f:	8b 88 90 05 00 00    	mov    0x590(%eax),%ecx
  8029a5:	8b 55 e8             	mov    -0x18(%ebp),%edx
  8029a8:	89 d0                	mov    %edx,%eax
  8029aa:	01 c0                	add    %eax,%eax
  8029ac:	01 d0                	add    %edx,%eax
  8029ae:	c1 e0 03             	shl    $0x3,%eax
  8029b1:	01 c8                	add    %ecx,%eax
  8029b3:	8a 40 04             	mov    0x4(%eax),%al
  8029b6:	84 c0                	test   %al,%al
  8029b8:	75 46                	jne    802a00 <CheckWSArrayWithoutLastIndex+0xd2>
				if (ROUNDDOWN(myEnv->__uptr_pws[w].virtual_address, PAGE_SIZE)
  8029ba:	a1 20 40 80 00       	mov    0x804020,%eax
  8029bf:	8b 88 90 05 00 00    	mov    0x590(%eax),%ecx
  8029c5:	8b 55 e8             	mov    -0x18(%ebp),%edx
  8029c8:	89 d0                	mov    %edx,%eax
  8029ca:	01 c0                	add    %eax,%eax
  8029cc:	01 d0                	add    %edx,%eax
  8029ce:	c1 e0 03             	shl    $0x3,%eax
  8029d1:	01 c8                	add    %ecx,%eax
  8029d3:	8b 00                	mov    (%eax),%eax
  8029d5:	89 45 dc             	mov    %eax,-0x24(%ebp)
  8029d8:	8b 45 dc             	mov    -0x24(%ebp),%eax
  8029db:	25 00 f0 ff ff       	and    $0xfffff000,%eax
  8029e0:	89 c2                	mov    %eax,%edx
						== expectedPages[e]) {
  8029e2:	8b 45 f0             	mov    -0x10(%ebp),%eax
  8029e5:	8d 0c 85 00 00 00 00 	lea    0x0(,%eax,4),%ecx
  8029ec:	8b 45 08             	mov    0x8(%ebp),%eax
  8029ef:	01 c8                	add    %ecx,%eax
  ...
  8029f5:	75 09                	jne    802a00 <CheckWSArrayWithoutLastIndex+0xd2>
						== expectedPages[e]) {
					found = 1;
  8029f7:	c7 45 ec 01 00 00 00 	movl   $0x1,-0x14(%ebp)
					break;
  8029fe:	eb 15                	jmp    802a15 <CheckWSArrayWithoutLastIndex+0xe7>
		if (expectedPages[e] == 0) {
			expectedNumOfEmptyLocs++;
			continue;
		}
		int found = 0;
		for (int w = 0; w < myEnv->page_WS_max_size; w++) {
  802a00:	ff 45 e8             	incl   -0x18(%ebp)
  802a03:	a1 20 40 80 00       	mov    0x804020,%eax
  802a08:	8b 90 84 00 00 00    	mov    0x84(%eax),%edx
  802a0e:	8b 45 e8             	mov    -0x18(%ebp),%eax
  802a11:	39 c2                	cmp    %eax,%edx
  802a13:	77 85                	ja     80299a <CheckWSArrayWithoutLastIndex+0x6c>
					found = 1;
					break;
				}
			}
  ...
  802a19:	75 14                	jne    802a2f <CheckWSArrayWithoutLastIndex+0x101>
			panic(
  802a1b:	83 ec 04             	sub    $0x4,%esp
  802a1e:	68 64 37 80 00       	push   $0x803764
  802a23:	6a 3a                	push   $0x3a
  802a25:	68 58 37 80 00       	push   $0x803758
  802a2a:	e8 88 fe ff ff       	call   8028b7 <_panic>
	if (arraySize != myEnv->page_WS_max_size)
	{
		panic("number of expected pages SHOULD BE EQUAL to max WS size... review your TA!!");
	}
	int expectedNumOfEmptyLocs = 0;
	for (int e = 0; e < arraySize; e++) {
  802a2f:	ff 45 f0             	incl   -0x10(%ebp)
  802a32:	8b 45 f0             	mov    -0x10(%ebp),%eax
  802a35:	3b 45 0c             	cmp    0xc(%ebp),%eax
  802a38:	0f 8c 2f ff ff ff    	jl     80296d <CheckWSArrayWithoutLastIndex+0x3f>
		}
		if (!found)
			panic(
  ...
  802a3e:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
	for (int w = 0; w < myEnv->page_WS_max_size; w++) {
  802a45:	c7 45 e0 00 00 00 00 	movl   $0x0,-0x20(%ebp)
  802a4c:	eb 26                	jmp    802a74 <CheckWSArrayWithoutLastIndex+0x146>
		if (myEnv->__uptr_pws[w].empty == 1) {
  802a4e:	a1 20 40 80 00       	mov    0x804020,%eax
  802a53:	8b 88 90 05 00 00    	mov    0x590(%eax),%ecx
  802a59:	8b 55 e0             	mov    -0x20(%ebp),%edx
  802a5c:	89 d0                	mov    %edx,%eax
  802a5e:	01 c0                	add    %eax,%eax
  802a60:	01 d0                	add    %edx,%eax
  802a62:	c1 e0 03             	shl    $0x3,%eax
  802a65:	01 c8                	add    %ecx,%eax
  802a67:	8a 40 04             	mov    0x4(%eax),%al
  802a6a:	3c 01                	cmp    $0x1,%al
  802a6c:	75 03                	jne    802a71 <CheckWSArrayWithoutLastIndex+0x143>
			actualNumOfEmptyLocs++;
  802a6e:	ff 45 e4             	incl   -0x1c(%ebp)
		if (!found)
			panic(
					"PAGE WS entry checking failed... trace it by printing page WS before & after fault");
	}
	int actualNumOfEmptyLocs = 0;
	for (int w = 0; w < myEnv->page_WS_max_size; w++) {
  802a71:	ff 45 e0             	incl   -0x20(%ebp)
  802a74:	a1 20 40 80 00       	mov    0x804020,%eax
  802a79:	8b 90 84 00 00 00    	mov    0x84(%eax),%edx
  802a7f:	8b 45 e0             	mov    -0x20(%ebp),%eax
  802a82:	39 c2                	cmp    %eax,%edx
  802a84:	77 c8                	ja     802a4e <CheckWSArrayWithoutLastIndex+0x120>
		if (myEnv->__uptr_pws[w].empty == 1) {
			actualNumOfEmptyLocs++;
		}
	}
  ...
  802a89:	3b 45 e4             	cmp    -0x1c(%ebp),%eax
  802a8c:	74 14                	je     802aa2 <CheckWSArrayWithoutLastIndex+0x174>
		panic(
  802a8e:	83 ec 04             	sub    $0x4,%esp
  802a91:	68 b8 37 80 00       	push   $0x8037b8
  802a96:	6a 44                	push   $0x44
  802a98:	68 58 37 80 00       	push   $0x803758
  802a9d:	e8 15 fe ff ff       	call   8028b7 <_panic>
...
00802aa8 <__udivdi3>:
  ...
  802aaf:	8b 5c 24 30          	mov    0x30(%esp),%ebx
  802ab3:	8b 4c 24 34          	mov    0x34(%esp),%ecx
  802ab7:	8b 7c 24 38          	mov    0x38(%esp),%edi
  802abb:	89 5c 24 08          	mov    %ebx,0x8(%esp)
  802abf:	89 ca                	mov    %ecx,%edx
  802ac1:	89 f8                	mov    %edi,%eax
  802ac3:	8b 74 24 3c          	mov    0x3c(%esp),%esi
  802ac7:	85 f6                	test   %esi,%esi
  802ac9:	75 2d                	jne    802af8 <__udivdi3+0x50>
  802acb:	39 cf                	cmp    %ecx,%edi
  802acd:	77 65                	ja     802b34 <__udivdi3+0x8c>
  802acf:	89 fd                	mov    %edi,%ebp
  802ad1:	85 ff                	test   %edi,%edi
  802ad3:	75 0b                	jne    802ae0 <__udivdi3+0x38>
  802ad5:	b8 01 00 00 00       	mov    $0x1,%eax
  802ada:	31 d2                	xor    %edx,%edx
  802adc:	f7 f7                	div    %edi
  802ade:	89 c5                	mov    %eax,%ebp
  802ae0:	31 d2                	xor    %edx,%edx
  802ae2:	89 c8                	mov    %ecx,%eax
  802ae4:	f7 f5                	div    %ebp
  802ae6:	89 c1                	mov    %eax,%ecx
  802ae8:	89 d8                	mov    %ebx,%eax
  802aea:	f7 f5                	div    %ebp
  802aec:	89 cf                	mov    %ecx,%edi
  ...
  802afa:	77 28                	ja     802b24 <__udivdi3+0x7c>
  802afc:	0f bd fe             	bsr    %esi,%edi
  802aff:	83 f7 1f             	xor    $0x1f,%edi
  802b02:	75 40                	jne    802b44 <__udivdi3+0x9c>
  802b04:	39 ce                	cmp    %ecx,%esi
  802b06:	72 0a                	jb     802b12 <__udivdi3+0x6a>
  802b08:	3b 44 24 08          	cmp    0x8(%esp),%eax
  802b0c:	0f 87 9e 00 00 00    	ja     802bb0 <__udivdi3+0x108>
  ...
  802b1f:	5d                   	pop    %ebp
  802b20:	c3                   	ret    
  802b21:	8d 76 00             	lea    0x0(%esi),%esi
  802b24:	31 ff                	xor    %edi,%edi
  802b26:	31 c0                	xor    %eax,%eax
  ...
  802b42:	5d                   	pop    %ebp
  802b43:	c3                   	ret    
  802b44:	bd 20 00 00 00       	mov    $0x20,%ebp
  802b49:	89 eb                	mov    %ebp,%ebx
  802b4b:	29 fb                	sub    %edi,%ebx
  802b4d:	89 f9                	mov    %edi,%ecx
  802b4f:	d3 e6                	shl    %cl,%esi
  802b51:	89 c5                	mov    %eax,%ebp
  802b53:	88 d9                	mov    %bl,%cl
  802b55:	d3 ed                	shr    %cl,%ebp
  802b57:	89 e9                	mov    %ebp,%ecx
  802b59:	09 f1                	or     %esi,%ecx
  802b5b:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
  802b5f:	89 f9                	mov    %edi,%ecx
  802b61:	d3 e0                	shl    %cl,%eax
  802b63:	89 c5                	mov    %eax,%ebp
  802b65:	89 d6                	mov    %edx,%esi
  802b67:	88 d9                	mov    %bl,%cl
  802b69:	d3 ee                	shr    %cl,%esi
  802b6b:	89 f9                	mov    %edi,%ecx
  802b6d:	d3 e2                	shl    %cl,%edx
  802b6f:	8b 44 24 08          	mov    0x8(%esp),%eax
  802b73:	88 d9                	mov    %bl,%cl
  802b75:	d3 e8                	shr    %cl,%eax
  802b77:	09 c2                	or     %eax,%edx
  802b79:	89 d0                	mov    %edx,%eax
  802b7b:	89 f2                	mov    %esi,%edx
  802b7d:	f7 74 24 0c          	divl   0xc(%esp)
  802b81:	89 d6                	mov    %edx,%esi
  802b83:	89 c3                	mov    %eax,%ebx
  802b85:	f7 e5                	mul    %ebp
  802b87:	39 d6                	cmp    %edx,%esi
  802b89:	72 19                	jb     802ba4 <__udivdi3+0xfc>
  802b8b:	74 0b                	je     802b98 <__udivdi3+0xf0>
  802b8d:	89 d8                	mov    %ebx,%eax
  802b8f:	31 ff                	xor    %edi,%edi
  802b91:	e9 58 ff ff ff       	jmp    802aee <__udivdi3+0x46>
  802b96:	66 90                	xchg   %ax,%ax
  802b98:	8b 54 24 08          	mov    0x8(%esp),%edx
  802b9c:	89 f9                	mov    %edi,%ecx
  802b9e:	d3 e2                	shl    %cl,%edx
  802ba0:	39 c2                	cmp    %eax,%edx
  802ba2:	73 e9                	jae    802b8d <__udivdi3+0xe5>
  802ba4:	8d 43 ff             	lea    -0x1(%ebx),%eax
  802ba7:	31 ff                	xor    %edi,%edi
  802ba9:	e9 40 ff ff ff       	jmp    802aee <__udivdi3+0x46>
  802bae:	66 90                	xchg   %ax,%ax
  802bb0:	31 c0                	xor    %eax,%eax
  802bb2:	e9 37 ff ff ff       	jmp    802aee <__udivdi3+0x46>
  802bb7:	90                   	nop
...
00802bb8 <__umoddi3>:
  ...
  802bba:	56                   	push   %esi
  802bbb:	53                   	push   %ebx
  802bbc:	83 ec 1c             	sub    $0x1c,%esp
  802bbf:	8b 4c 24 30          	mov    0x30(%esp),%ecx
  802bc3:	8b 74 24 34          	mov    0x34(%esp),%esi
  802bc7:	8b 7c 24 38          	mov    0x38(%esp),%edi
  802bcb:	8b 44 24 3c          	mov    0x3c(%esp),%eax
  802bcf:	89 44 24 0c          	mov    %eax,0xc(%esp)
  802bd3:	89 4c 24 08          	mov    %ecx,0x8(%esp)
  802bd7:	89 f3                	mov    %esi,%ebx
  802bd9:	89 fa                	mov    %edi,%edx
  802bdb:	89 4c 24 04          	mov    %ecx,0x4(%esp)
  802bdf:	89 34 24             	mov    %esi,(%esp)
  802be2:	85 c0                	test   %eax,%eax
  802be4:	75 1a                	jne    802c00 <__umoddi3+0x48>
  802be6:	39 f7                	cmp    %esi,%edi
  802be8:	0f 86 a2 00 00 00    	jbe    802c90 <__umoddi3+0xd8>
  802bee:	89 c8                	mov    %ecx,%eax
  802bf0:	89 f2                	mov    %esi,%edx
  802bf2:	f7 f7                	div    %edi
  802bf4:	89 d0                	mov    %edx,%eax
  802bf6:	31 d2                	xor    %edx,%edx
  ...
  802bfe:	5d                   	pop    %ebp
  802bff:	c3                   	ret    
  802c00:	39 f0                	cmp    %esi,%eax
  802c02:	0f 87 ac 00 00 00    	ja     802cb4 <__umoddi3+0xfc>
  802c08:	0f bd e8             	bsr    %eax,%ebp
  802c0b:	83 f5 1f             	xor    $0x1f,%ebp
  802c0e:	0f 84 ac 00 00 00    	je     802cc0 <__umoddi3+0x108>
  802c14:	bf 20 00 00 00       	mov    $0x20,%edi
  802c19:	29 ef                	sub    %ebp,%edi
  802c1b:	89 fe                	mov    %edi,%esi
  802c1d:	89 7c 24 0c          	mov    %edi,0xc(%esp)
  802c21:	89 e9                	mov    %ebp,%ecx
  802c23:	d3 e0                	shl    %cl,%eax
  802c25:	89 d7                	mov    %edx,%edi
  802c27:	89 f1                	mov    %esi,%ecx
  802c29:	d3 ef                	shr    %cl,%edi
  802c2b:	09 c7                	or     %eax,%edi
  802c2d:	89 e9                	mov    %ebp,%ecx
  802c2f:	d3 e2                	shl    %cl,%edx
  802c31:	89 14 24             	mov    %edx,(%esp)
  802c34:	89 d8                	mov    %ebx,%eax
  802c36:	d3 e0                	shl    %cl,%eax
  802c38:	89 c2                	mov    %eax,%edx
  802c3a:	8b 44 24 08          	mov    0x8(%esp),%eax
  802c3e:	d3 e0                	shl    %cl,%eax
  802c40:	89 44 24 04          	mov    %eax,0x4(%esp)
  802c44:	8b 44 24 08          	mov    0x8(%esp),%eax
  802c48:	89 f1                	mov    %esi,%ecx
  802c4a:	d3 e8                	shr    %cl,%eax
  802c4c:	09 d0                	or     %edx,%eax
  802c4e:	d3 eb                	shr    %cl,%ebx
  802c50:	89 da                	mov    %ebx,%edx
  802c52:	f7 f7                	div    %edi
  802c54:	89 d3                	mov    %edx,%ebx
  802c56:	f7 24 24             	mull   (%esp)
  802c59:	89 c6                	mov    %eax,%esi
  802c5b:	89 d1                	mov    %edx,%ecx
  802c5d:	39 d3                	cmp    %edx,%ebx
  802c5f:	0f 82 87 00 00 00    	jb     802cec <__umoddi3+0x134>
  802c65:	0f 84 91 00 00 00    	je     802cfc <__umoddi3+0x144>
  802c6b:	8b 54 24 04          	mov    0x4(%esp),%edx
  802c6f:	29 f2                	sub    %esi,%edx
  802c71:	19 cb                	sbb    %ecx,%ebx
  802c73:	89 d8                	mov    %ebx,%eax
  802c75:	8a 4c 24 0c          	mov    0xc(%esp),%cl
  802c79:	d3 e0                	shl    %cl,%eax
  802c7b:	89 e9                	mov    %ebp,%ecx
  802c7d:	d3 ea                	shr    %cl,%edx
  802c7f:	09 d0                	or     %edx,%eax
  802c81:	89 e9                	mov    %ebp,%ecx
  802c83:	d3 eb                	shr    %cl,%ebx
  802c85:	89 da                	mov    %ebx,%edx
  802c87:	83 c4 1c             	add    $0x1c,%esp
  802c8a:	5b                   	pop    %ebx
  802c8b:	5e                   	pop    %esi
  802c8c:	5f                   	pop    %edi
  802c8d:	5d                   	pop    %ebp
  802c8e:	c3                   	ret    
  802c8f:	90                   	nop
  802c90:	89 fd                	mov    %edi,%ebp
  802c92:	85 ff                	test   %edi,%edi
  802c94:	75 0b                	jne    802ca1 <__umoddi3+0xe9>
  ...
  802cad:	e9 44 ff ff ff       	jmp    802bf6 <__umoddi3+0x3e>
  802cb2:	66 90                	xchg   %ax,%ax
  802cb4:	89 c8                	mov    %ecx,%eax
  802cb6:	89 f2                	mov    %esi,%edx
  ...
  802cbe:	5d                   	pop    %ebp
  802cbf:	c3                   	ret    
  802cc0:	3b 04 24             	cmp    (%esp),%eax
  802cc3:	72 06                	jb     802ccb <__umoddi3+0x113>
  802cc5:	3b 7c 24 04          	cmp    0x4(%esp),%edi
  802cc9:	77 0f                	ja     802cda <__umoddi3+0x122>
  802ccb:	89 f2                	mov    %esi,%edx
  802ccd:	29 f9                	sub    %edi,%ecx
  802ccf:	1b 54 24 0c          	sbb    0xc(%esp),%edx
  802cd3:	89 14 24             	mov    %edx,(%esp)
  802cd6:	89 4c 24 04          	mov    %ecx,0x4(%esp)
  802cda:	8b 44 24 04          	mov    0x4(%esp),%eax
  802cde:	8b 14 24             	mov    (%esp),%edx
  ...
  802ce7:	5d                   	pop    %ebp
  802ce8:	c3                   	ret    
  802ce9:	8d 76 00             	lea    0x0(%esi),%esi
  802cec:	2b 04 24             	sub    (%esp),%eax
  802cef:	19 fa                	sbb    %edi,%edx
  802cf1:	89 d1                	mov    %edx,%ecx
  802cf3:	89 c6                	mov    %eax,%esi
  802cf5:	e9 71 ff ff ff       	jmp    802c6b <__umoddi3+0xb3>
  802cfa:	66 90                	xchg   %ax,%ax
  802cfc:	39 44 24 04          	cmp    %eax,0x4(%esp)
  802d00:	72 ea                	jb     802cec <__umoddi3+0x134>
  802d02:	89 d9                	mov    %ebx,%ecx
  802d04:	e9 62 ff ff ff       	jmp    802c6b <__umoddi3+0xb3>
