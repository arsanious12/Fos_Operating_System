...
void _main(void)
{
  ...
  80004b:	68 40 2b 80 00       	push   $0x802b40
  ...
  80006a:	bb 43 2d 80 00       	mov    $0x802d43,%ebx
  ...
  8000bf:	68 50 2b 80 00       	push   $0x802b50
  ...
  8000d5:	68 83 2b 80 00       	push   $0x802b83
  ...
  8000ee:	68 8c 2b 80 00       	push   $0x802b8c
  ...
  800114:	e8 03 27 00 00       	call   80281c <env_sleep>
  ...
  80013d:	50                   	push   %eax
  80013e:	68 98 2b 80 00       	push   $0x802b98
  ...
  80016a:	bb a7 2d 80 00       	mov    $0x802da7,%ebx
  ...
  80023f:	68 ca 2b 80 00       	push   $0x802bca
  ...
  800264:	68 dc 2b 80 00       	push   $0x802bdc
  ...
  800274:	68 4c 2c 80 00       	push   $0x802c4c
  800279:	6a 36                	push   $0x36
  80027b:	68 82 2c 80 00       	push   $0x802c82
...
libmain(int argc, char **argv)
{
  ...
  8002e2:	a3 20 40 80 00       	mov    %eax,0x804020
  ...
  8002f3:	a1 20 40 80 00       	mov    0x804020,%eax
  ...
  80031e:	83 c4 10             	add    $0x10,%esp
	...
	if (printStats)
  800321:	a1 00 40 80 00       	mov    0x804000,%eax
  ...
  800334:	bb 04 2f 80 00       	mov    $0x802f04,%ebx
  ...
  800379:	68 24 2e 80 00       	push   $0x802e24
  ...
  800395:	50                   	push   %eax
  800396:	68 4c 2e 80 00       	push   $0x802e4c
  ...
  8003be:	52                   	push   %edx
  8003bf:	50                   	push   %eax
  8003c0:	68 70 2e 80 00       	push   $0x802e70
  8003c5:	e8 65 03 00 00       	call   80072f <cprintf>
  8003ca:	83 c4 10             	add    $0x10,%esp
				cprintf("# PAGE IN (from disk) = %d, # PAGE OUT (on disk) = %d, # NEW PAGE ADDED (on disk) = %d\n", myEnv->nPageIn, myEnv->nPageOut,myEnv->nNewPageAdded);
  8003cd:	a1 20 40 80 00       	mov    0x804020,%eax
  8003d2:	8b 88 bc 05 00 00    	mov    0x5bc(%eax),%ecx
  8003d8:	a1 20 40 80 00       	mov    0x804020,%eax
  ...
  8003ef:	52                   	push   %edx
  8003f0:	50                   	push   %eax
  8003f1:	68 98 2e 80 00       	push   $0x802e98
...
_panic(const char *file, int line, const char *fmt,...)
{
  ...
  8004c4:	68 98 2f 80 00       	push   $0x802f98
...
void CheckWSArrayWithoutLastIndex(uint32 *expectedPages, int arraySize)
{
  ...
  8004de:	a1 20 40 80 00       	mov    0x804020,%eax
  ...
  8004f3:	68 9c 2f 80 00       	push   $0x802f9c
  8004f8:	6a 26                	push   $0x26
  8004fa:	68 e8 2f 80 00       	push   $0x802fe8
  ...
  800564:	a1 20 40 80 00       	mov    0x804020,%eax
  ...
  8005c8:	68 f4 2f 80 00       	push   $0x802ff4
  8005cd:	6a 3a                	push   $0x3a
  8005cf:	68 e8 2f 80 00       	push   $0x802fe8
  ...
  80063b:	68 48 30 80 00       	push   $0x803048
  800640:	6a 44                	push   $0x44
  800642:	68 e8 2f 80 00       	push   $0x802fe8
...
static void putch(int ch, struct printbuf *b) {
  ...
  80067b:	8b 15 1c c1 81 00    	mov    0x81c11c,%edx
  800681:	a0 44 40 80 00       	mov    0x804044,%al
...
int vcprintf(const char *fmt, va_list ap) {
  ...
  8006f4:	83 c4 10             	add    $0x10,%esp
	sys_cputs(b.buf, b.idx, printProgName, curTextClr);
  8006f7:	8b 15 1c c1 81 00    	mov    0x81c11c,%edx
  8006fd:	a0 44 40 80 00       	mov    0x804044,%al
  ...
  80071d:	83 c4 10             	add    $0x10,%esp
	...
	printProgName = 0;
  800720:	c6 05 44 40 80 00 00 	movb   $0x0,0x804044
	return b.cnt;
...
int cprintf(const char *fmt, ...) {
  ...
  800732:	83 ec 18             	sub    $0x18,%esp
	...
	int cnt;
	printProgName = 1 ;
  800735:	c6 05 44 40 80 00 01 	movb   $0x1,0x804044
	va_start(ap, fmt);
...
int cprintf_colored(int textClr, const char *fmt, ...) {
  ...
  80075f:	83 ec 18             	sub    $0x18,%esp
	...
	int cnt;
	printProgName = 1 ;
  800762:	c6 05 44 40 80 00 01 	movb   $0x1,0x804044
	curTextClr = (textClr << 8) ; //set text color by the given value
  800769:	8b 45 08             	mov    0x8(%ebp),%eax
  80076c:	c1 e0 08             	shl    $0x8,%eax
  80076f:	a3 1c c1 81 00       	mov    %eax,0x81c11c
	va_start(ap, fmt);
  ...
  800792:	c7 05 1c c1 81 00 00 	movl   $0x700,0x81c11c
  800799:	07 00 00 
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800811:	e8 c6 20 00 00       	call   8028dc <__udivdi3>
  ...
  80085f:	52                   	push   %edx
  800860:	50                   	push   %eax
  800861:	e8 86 21 00 00       	call   8029ec <__umoddi3>
  800866:	83 c4 10             	add    $0x10,%esp
  800869:	05 b4 32 80 00       	add    $0x8032b4,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8009bc:	8b 04 85 d8 32 80 00 	mov    0x8032d8(,%eax,4),%eax
  ...
  800a9d:	8b 34 9d 20 31 80 00 	mov    0x803120(,%ebx,4),%esi
  800aa4:	85 f6                	test   %esi,%esi
  800aa6:	75 19                	jne    800ac1 <vprintfmt+0x173>
				printfmt(putch, putdat, "error %d", err);
  800aa8:	53                   	push   %ebx
  800aa9:	68 c5 32 80 00       	push   $0x8032c5
  ...
  800abc:	e9 5b 02 00 00       	jmp    800d1c <vprintfmt+0x3ce>
			...
			if (err > MAXERROR || (p = error_string[err]) == NULL)
				...
				printfmt(putch, putdat, "%s", p);
  800ac1:	56                   	push   %esi
  800ac2:	68 ce 32 80 00       	push   $0x8032ce
  ...
  800aed:	75 05                	jne    800af4 <vprintfmt+0x1a6>
				p = "(null)";
  800aef:	be d1 32 80 00       	mov    $0x8032d1,%esi
			if (width > 0 && padc != '-')
  ...
  800ce5:	eb 35                	jmp    800d1c <vprintfmt+0x3ce>
		...
		case '~':
			printProgName = 0;
  800ce7:	c6 05 44 40 80 00 00 	movb   $0x0,0x804044
			break;
  800cee:	eb 2c                	jmp    800d1c <vprintfmt+0x3ce>
		// Print Program Name & UD
		case '@':
			printProgName = 1;
  800cf0:	c6 05 44 40 80 00 01 	movb   $0x1,0x804044
			break;
...
void uheap_init()
{
  ...
  801617:	83 ec 08             	sub    $0x8,%esp
	if(__firstTimeFlag)
  80161a:	a1 08 40 80 00       	mov    0x804008,%eax
  ...
  80163d:	a3 60 c0 81 00       	mov    %eax,0x81c060
		uheapPageAllocStart = dynAllocEnd + PAGE_SIZE;
  801642:	a1 40 40 80 00       	mov    0x804040,%eax
  801647:	05 00 10 00 00       	add    $0x1000,%eax
  80164c:	a3 10 c1 81 00       	mov    %eax,0x81c110
		uheapPageAllocBreak = uheapPageAllocStart;
  801651:	a1 10 c1 81 00       	mov    0x81c110,%eax
  801656:	a3 68 c0 81 00       	mov    %eax,0x81c068

		__firstTimeFlag = 0;
  80165b:	c7 05 08 40 80 00 00 	movl   $0x0,0x804008
  801662:	00 00 00 
	}
}
  801665:	90                   	nop
...
int get_page(void* va)
{
  ...
  801699:	68 48 34 80 00       	push   $0x803448
  80169e:	6a 1f                	push   $0x1f
  8016a0:	68 84 34 80 00       	push   $0x803484
...
void return_page(void* va)
{
  ...
  8016dd:	68 90 34 80 00       	push   $0x803490
  8016e2:	6a 2a                	push   $0x2a
  8016e4:	68 84 34 80 00       	push   $0x803484
...
void* malloc(uint32 size)
{
  ...
  80170c:	68 d0 34 80 00       	push   $0x8034d0
  801711:	6a 3e                	push   $0x3e
  801713:	68 84 34 80 00       	push   $0x803484
...
void free(void* virtual_address)
{
  ...
  801728:	68 f8 34 80 00       	push   $0x8034f8
  80172d:	6a 49                	push   $0x49
  80172f:	68 84 34 80 00       	push   $0x803484
...
void* smalloc(char *sharedVarName, uint32 size, uint8 isWritable)
{
  ...
  80175a:	68 1c 35 80 00       	push   $0x80351c
  80175f:	6a 5a                	push   $0x5a
  801761:	68 84 34 80 00       	push   $0x803484
...
void* sget(int32 ownerEnvID, char *sharedVarName)
{
  ...
  80177b:	68 44 35 80 00       	push   $0x803544
  801780:	6a 6a                	push   $0x6a
  801782:	68 84 34 80 00       	push   $0x803484
...
void *realloc(void *virtual_address, uint32 new_size)
{
  ...
  80179a:	68 68 35 80 00       	push   $0x803568
  80179f:	68 88 00 00 00       	push   $0x88
  8017a4:	68 84 34 80 00       	push   $0x803484
...
void sfree(void* virtual_address)
{
  ...
  8017b7:	68 90 35 80 00       	push   $0x803590
  8017bc:	68 9b 00 00 00       	push   $0x9b
  8017c1:	68 84 34 80 00       	push   $0x803484
...
uint32 sys_get_uheap_strategy()
{
  ...
  801c3b:	a3 60 c0 81 00       	mov    %eax,0x81c060
	return uheapPlaceStrategy ;
  801c40:	a1 60 c0 81 00       	mov    0x81c060,%eax
}
  801c45:	c9                   	leave  
  801c46:	c3                   	ret    
...
void sys_set_uheap_strategy(uint32 heapStrategy)
{
  ...
  801c4d:	a3 60 c0 81 00       	mov    %eax,0x81c060
...
void sys_env_set_priority(int32 envID, int priority)
{
  ...
  801d61:	68 b4 35 80 00       	push   $0x8035b4
  801d66:	68 25 01 00 00       	push   $0x125
  801d6b:	68 e7 35 80 00       	push   $0x8035e7
...
__inline__ uint32 to_page_va(struct PageInfoElement *ptrPageInfo)
{
  ...
  801dde:	a1 64 c0 81 00       	mov    0x81c064,%eax
...
__inline__ struct PageInfoElement * to_page_info(uint32 va)
{
  ...
  801ded:	a1 64 c0 81 00       	mov    0x81c064,%eax
  ...
  801e11:	68 3c 36 80 00       	push   $0x80363c
  801e16:	6a 22                	push   $0x22
  801e18:	68 23 36 80 00       	push   $0x803623
  ...
  801e2e:	05 60 40 80 00       	add    $0x804060,%eax
}
  801e33:	c9                   	leave  
  801e34:	c3                   	ret    
...
void initialize_dynamic_allocator(uint32 daStart, uint32 daEnd)
{
  ...
  801e48:	68 60 36 80 00       	push   $0x803660
  801e4d:	68 86 36 80 00       	push   $0x803686
  801e52:	6a 34                	push   $0x34
  801e54:	68 23 36 80 00       	push   $0x803623
  801e59:	e8 03 e6 ff ff       	call   800461 <_panic>
		is_initialized = 1;
  801e5e:	c7 05 24 40 80 00 01 	movl   $0x1,0x804024
  801e65:	00 00 00 
	//==================================================================================
	//==================================================================================
  ...
  801e6b:	a3 64 c0 81 00       	mov    %eax,0x81c064
	dynAllocEnd = daEnd;
  801e70:	8b 45 0c             	mov    0xc(%ebp),%eax
  801e73:	a3 40 40 80 00       	mov    %eax,0x804040
	// init the list that keep track of all free pageBlockInfoArr instances.
	LIST_INIT(&freePagesList);
  801e78:	c7 05 48 40 80 00 00 	movl   $0x0,0x804048
  801e7f:	00 00 00 
  801e82:	c7 05 4c 40 80 00 00 	movl   $0x0,0x80404c
  801e89:	00 00 00 
  801e8c:	c7 05 54 40 80 00 00 	movl   $0x0,0x804054
  801e93:	00 00 00 

	// no.of pages in the dynamic allocator.
	int pCount = (daEnd - daStart) / PAGE_SIZE;
  801e96:	8b 45 0c             	mov    0xc(%ebp),%eax
  801e99:	2b 45 08             	sub    0x8(%ebp),%eax
  801e9c:	c1 e8 0c             	shr    $0xc,%eax
  801e9f:	89 45 ec             	mov    %eax,-0x14(%ebp)
	// iterate over each page and init its data in pageBlockInfoArr and reset it.
	for (int i = 0; i < pCount; ++i) {
  801ea2:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  801ea9:	e9 c8 00 00 00       	jmp    801f76 <initialize_dynamic_allocator+0x141>
  ...
  801eba:	05 68 40 80 00       	add    $0x804068,%eax
  801ebf:	66 c7 00 00 00       	movw   $0x0,(%eax)
  ...
  801ed0:	05 6a 40 80 00       	add    $0x80406a,%eax
  801ed5:	66 c7 00 00 00       	movw   $0x0,(%eax)
	    LIST_INSERT_TAIL(&freePagesList, &pageBlockInfoArr[i]);
  801eda:	8b 15 4c 40 80 00    	mov    0x80404c,%edx
  801ee0:	8b 4d f4             	mov    -0xc(%ebp),%ecx
  801ee3:	89 c8                	mov    %ecx,%eax
  801ee5:	01 c0                	add    %eax,%eax
  801ee7:	01 c8                	add    %ecx,%eax
  801ee9:	c1 e0 02             	shl    $0x2,%eax
  801eec:	05 64 40 80 00       	add    $0x804064,%eax
  ...
  801eff:	05 64 40 80 00       	add    $0x804064,%eax
  801f04:	8b 00                	mov    (%eax),%eax
  801f06:	85 c0                	test   %eax,%eax
  801f08:	74 1b                	je     801f25 <initialize_dynamic_allocator+0xf0>
  801f0a:	8b 15 4c 40 80 00    	mov    0x80404c,%edx
  801f10:	8b 4d f4             	mov    -0xc(%ebp),%ecx
  801f13:	89 c8                	mov    %ecx,%eax
  801f15:	01 c0                	add    %eax,%eax
  801f17:	01 c8                	add    %ecx,%eax
  801f19:	c1 e0 02             	shl    $0x2,%eax
  801f1c:	05 60 40 80 00       	add    $0x804060,%eax
  801f21:	89 02                	mov    %eax,(%edx)
  801f23:	eb 16                	jmp    801f3b <initialize_dynamic_allocator+0x106>
  ...
  801f36:	a3 48 40 80 00       	mov    %eax,0x804048
  ...
  801f47:	05 60 40 80 00       	add    $0x804060,%eax
  ...
  801f5d:	05 60 40 80 00       	add    $0x804060,%eax
  801f62:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  801f68:	a1 54 40 80 00       	mov    0x804054,%eax
  801f6d:	40                   	inc    %eax
  801f6e:	a3 54 40 80 00       	mov    %eax,0x804054
	LIST_INIT(&freePagesList);
  ...
  801f79:	3b 45 ec             	cmp    -0x14(%ebp),%eax
  801f7c:	0f 8c 2c ff ff ff    	jl     801eae <initialize_dynamic_allocator+0x79>
	    LIST_INSERT_TAIL(&freePagesList, &pageBlockInfoArr[i]);
	}
  ...
  801fb8:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
	...
	// 0 1  2  3   4  5    6   7    8
	for (int i = 0; i <= (LOG2_MAX_SIZE - LOG2_MIN_SIZE); ++i){
  801fbe:	ff 45 f0             	incl   -0x10(%ebp)
  801fc1:	83 7d f0 08          	cmpl   $0x8,-0x10(%ebp)
  801fc5:	7e c4                	jle    801f8b <initialize_dynamic_allocator+0x156>
		LIST_INIT(&freeBlockLists[i]);
	}
	//Comment the following line
...
__inline__ uint32 get_block_size(void *va)
{
  ...
  801fd6:	50                   	push   %eax
  801fd7:	e8 0b fe ff ff       	call   801de7 <to_page_info>
...
//and putem in suitable freeblockList index according to size.
 void split_page_to_blocks(uint32 blk_size, struct PageInfoElement *pageInfo) {
  ...
  80205a:	ff 45 f4             	incl   -0xc(%ebp)
	 ...
	 int idx = 0;
	 for (int i = LOG2_MIN_SIZE; i <= LOG2_MAX_SIZE; i++) {
  80205d:	ff 45 f0             	incl   -0x10(%ebp)
  802060:	83 7d f0 0b          	cmpl   $0xb,-0x10(%ebp)
  802064:	7e e1                	jle    802047 <split_page_to_blocks+0x5a>
  802066:	eb 01                	jmp    802069 <split_page_to_blocks+0x7c>
	     if ((1 << i) == blk_size)
	         break;
  802068:	90                   	nop
	     idx++;
  ...
  802070:	e9 a7 00 00 00       	jmp    80211c <split_page_to_blocks+0x12f>
	     struct BlockElement *blk =(struct BlockElement*)(page_va + i * blk_size);
  802075:	8b 45 ec             	mov    -0x14(%ebp),%eax
  802078:	0f af 45 08          	imul   0x8(%ebp),%eax
  80207c:	89 c2                	mov    %eax,%edx
  80207e:	8b 45 e8             	mov    -0x18(%ebp),%eax
  802081:	01 d0                	add    %edx,%eax
  802083:	89 45 e0             	mov    %eax,-0x20(%ebp)
	     LIST_INSERT_TAIL(&freeBlockLists[idx],blk);
  802086:	83 7d e0 00          	cmpl   $0x0,-0x20(%ebp)
  80208a:	75 14                	jne    8020a0 <split_page_to_blocks+0xb3>
  80208c:	83 ec 04             	sub    $0x4,%esp
  80208f:	68 9c 36 80 00       	push   $0x80369c
  802094:	6a 7c                	push   $0x7c
  802096:	68 23 36 80 00       	push   $0x803623
  80209b:	e8 c1 e3 ff ff       	call   800461 <_panic>
  8020a0:	8b 45 f4             	mov    -0xc(%ebp),%eax
  8020a3:	c1 e0 04             	shl    $0x4,%eax
  8020a6:	05 84 c0 81 00       	add    $0x81c084,%eax
  8020ab:	8b 10                	mov    (%eax),%edx
  ...
  8020bb:	74 14                	je     8020d1 <split_page_to_blocks+0xe4>
  8020bd:	8b 45 f4             	mov    -0xc(%ebp),%eax
  8020c0:	c1 e0 04             	shl    $0x4,%eax
  8020c3:	05 84 c0 81 00       	add    $0x81c084,%eax
  8020c8:	8b 00                	mov    (%eax),%eax
  8020ca:	8b 55 e0             	mov    -0x20(%ebp),%edx
  8020cd:	89 10                	mov    %edx,(%eax)
  8020cf:	eb 11                	jmp    8020e2 <split_page_to_blocks+0xf5>
  8020d1:	8b 45 f4             	mov    -0xc(%ebp),%eax
  8020d4:	c1 e0 04             	shl    $0x4,%eax
  8020d7:	8d 90 80 c0 81 00    	lea    0x81c080(%eax),%edx
  8020dd:	8b 45 e0             	mov    -0x20(%ebp),%eax
  8020e0:	89 02                	mov    %eax,(%edx)
  8020e2:	8b 45 f4             	mov    -0xc(%ebp),%eax
  8020e5:	c1 e0 04             	shl    $0x4,%eax
  8020e8:	8d 90 84 c0 81 00    	lea    0x81c084(%eax),%edx
  8020ee:	8b 45 e0             	mov    -0x20(%ebp),%eax
  8020f1:	89 02                	mov    %eax,(%edx)
  8020f3:	8b 45 e0             	mov    -0x20(%ebp),%eax
  8020f6:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  8020fc:	8b 45 f4             	mov    -0xc(%ebp),%eax
  8020ff:	c1 e0 04             	shl    $0x4,%eax
  802102:	05 8c c0 81 00       	add    $0x81c08c,%eax
  ...
  802117:	89 10                	mov    %edx,(%eax)
	 ...
	 // starting from the page_va.
	 for (uint32 i = 0; i < blk_count; ++i) {
  802119:	ff 45 ec             	incl   -0x14(%ebp)
  80211c:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  80211f:	39 45 ec             	cmp    %eax,-0x14(%ebp)
  802122:	0f 82 4d ff ff ff    	jb     802075 <split_page_to_blocks+0x88>
	     struct BlockElement *blk =(struct BlockElement*)(page_va + i * blk_size);
	     LIST_INSERT_TAIL(&freeBlockLists[idx],blk);
	 }
 }
...
void *alloc_block(uint32 size)
{
  ...
  80212e:	83 ec 38             	sub    $0x38,%esp
	//==================================================================================
	//DON'T CHANGE THESE LINES==========================================================
	//==================================================================================
	{
		assert(size <= DYN_ALLOC_MAX_BLOCK_SIZE);
  802131:	81 7d 08 00 08 00 00 	cmpl   $0x800,0x8(%ebp)
  802138:	76 19                	jbe    802153 <alloc_block+0x28>
  80213a:	68 c0 36 80 00       	push   $0x8036c0
  80213f:	68 86 36 80 00       	push   $0x803686
  802144:	68 8a 00 00 00       	push   $0x8a
  802149:	68 23 36 80 00       	push   $0x803623
  80214e:	e8 0e e3 ff ff       	call   800461 <_panic>
	//==================================================================================
  ...
  802153:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
	for (int i = LOG2_MIN_SIZE; i <= LOG2_MAX_SIZE; ++i){
  80215a:	c7 45 f0 03 00 00 00 	movl   $0x3,-0x10(%ebp)
  802161:	eb 19                	jmp    80217c <alloc_block+0x51>
		if((1 << i) >= size) break;
  802163:	8b 45 f0             	mov    -0x10(%ebp),%eax
  802166:	ba 01 00 00 00       	mov    $0x1,%edx
  80216b:	88 c1                	mov    %al,%cl
  80216d:	d3 e2                	shl    %cl,%edx
  80216f:	89 d0                	mov    %edx,%eax
  802171:	3b 45 08             	cmp    0x8(%ebp),%eax
  802174:	73 0e                	jae    802184 <alloc_block+0x59>
		idx++;
  802176:	ff 45 f4             	incl   -0xc(%ebp)
	//TODO: [PROJECT'25.GM#1] DYNAMIC ALLOCATOR - #3 alloc_block
	//Your code is here
	//Comment the following line
	// get index in freeBlockList by size.
	uint32 idx = 0;
	for (int i = LOG2_MIN_SIZE; i <= LOG2_MAX_SIZE; ++i){
  802179:	ff 45 f0             	incl   -0x10(%ebp)
  80217c:	83 7d f0 0b          	cmpl   $0xb,-0x10(%ebp)
  802180:	7e e1                	jle    802163 <alloc_block+0x38>
  802182:	eb 01                	jmp    802185 <alloc_block+0x5a>
		if((1 << i) >= size) break;
  802184:	90                   	nop
		idx++;
	}
  ...
  80218b:	05 8c c0 81 00       	add    $0x81c08c,%eax
  802190:	8b 00                	mov    (%eax),%eax
  802192:	85 c0                	test   %eax,%eax
  802194:	0f 84 df 00 00 00    	je     802279 <alloc_block+0x14e>
  ...
  8021a0:	05 80 c0 81 00       	add    $0x81c080,%eax
  8021a5:	8b 00                	mov    (%eax),%eax
  8021a7:	89 45 ec             	mov    %eax,-0x14(%ebp)
	    LIST_REMOVE(&freeBlockLists[idx], blk);
  8021aa:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
  8021ae:	75 17                	jne    8021c7 <alloc_block+0x9c>
  8021b0:	83 ec 04             	sub    $0x4,%esp
  8021b3:	68 e1 36 80 00       	push   $0x8036e1
  8021b8:	68 9e 00 00 00       	push   $0x9e
  8021bd:	68 23 36 80 00       	push   $0x803623
  8021c2:	e8 9a e2 ff ff       	call   800461 <_panic>
  8021c7:	8b 45 ec             	mov    -0x14(%ebp),%eax
  8021ca:	8b 00                	mov    (%eax),%eax
  8021cc:	85 c0                	test   %eax,%eax
  8021ce:	74 10                	je     8021e0 <alloc_block+0xb5>
  8021d0:	8b 45 ec             	mov    -0x14(%ebp),%eax
  8021d3:	8b 00                	mov    (%eax),%eax
  8021d5:	8b 55 ec             	mov    -0x14(%ebp),%edx
  8021d8:	8b 52 04             	mov    0x4(%edx),%edx
  8021db:	89 50 04             	mov    %edx,0x4(%eax)
  8021de:	eb 14                	jmp    8021f4 <alloc_block+0xc9>
  ...
  80222c:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
  802233:	8b 45 f4             	mov    -0xc(%ebp),%eax
  802236:	c1 e0 04             	shl    $0x4,%eax
  802239:	05 8c c0 81 00       	add    $0x81c08c,%eax
  80223e:	8b 00                	mov    (%eax),%eax
  802240:	8d 50 ff             	lea    -0x1(%eax),%edx
  ...
  802256:	50                   	push   %eax
  802257:	e8 8b fb ff ff       	call   801de7 <to_page_info>
  80225c:	83 c4 10             	add    $0x10,%esp
  80225f:	89 45 e8             	mov    %eax,-0x18(%ebp)
	    pageInfo->num_of_free_blocks--;
  802262:	8b 45 e8             	mov    -0x18(%ebp),%eax
  802265:	66 8b 40 0a          	mov    0xa(%eax),%ax
  802269:	48                   	dec    %eax
  80226a:	8b 55 e8             	mov    -0x18(%ebp),%edx
  80226d:	66 89 42 0a          	mov    %ax,0xa(%edx)
	    return blk;
  802271:	8b 45 ec             	mov    -0x14(%ebp),%eax
  802274:	e9 bc 02 00 00       	jmp    802535 <alloc_block+0x40a>
	}else{ //case(2, 3): 2. no free blocks available in the freeblocklist but there is free pages.
				//3. no free blocks and no available freepages so search in higher block sizes.
		// case 2:
		if(freePagesList.size > 0){ //have free pages.
  802279:	a1 54 40 80 00       	mov    0x804054,%eax
  80227e:	85 c0                	test   %eax,%eax
  802280:	0f 84 7d 02 00 00    	je     802503 <alloc_block+0x3d8>
			// get page to split and use from freepagesList.
			struct PageInfoElement *ptr_new_page = LIST_FIRST(&freePagesList);
  802286:	a1 48 40 80 00       	mov    0x804048,%eax
  80228b:	89 45 e4             	mov    %eax,-0x1c(%ebp)
			LIST_REMOVE(&freePagesList, ptr_new_page);
  80228e:	83 7d e4 00          	cmpl   $0x0,-0x1c(%ebp)
  802292:	75 17                	jne    8022ab <alloc_block+0x180>
  802294:	83 ec 04             	sub    $0x4,%esp
  802297:	68 e1 36 80 00       	push   $0x8036e1
  80229c:	68 a9 00 00 00       	push   $0xa9
  8022a1:	68 23 36 80 00       	push   $0x803623
  8022a6:	e8 b6 e1 ff ff       	call   800461 <_panic>
  8022ab:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  8022ae:	8b 00                	mov    (%eax),%eax
  8022b0:	85 c0                	test   %eax,%eax
  8022b2:	74 10                	je     8022c4 <alloc_block+0x199>
  8022b4:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  8022b7:	8b 00                	mov    (%eax),%eax
  8022b9:	8b 55 e4             	mov    -0x1c(%ebp),%edx
  8022bc:	8b 52 04             	mov    0x4(%edx),%edx
  8022bf:	89 50 04             	mov    %edx,0x4(%eax)
  8022c2:	eb 0b                	jmp    8022cf <alloc_block+0x1a4>
  8022c4:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  8022c7:	8b 40 04             	mov    0x4(%eax),%eax
  8022ca:	a3 4c 40 80 00       	mov    %eax,0x80404c
  8022cf:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  8022d2:	8b 40 04             	mov    0x4(%eax),%eax
  8022d5:	85 c0                	test   %eax,%eax
  8022d7:	74 0f                	je     8022e8 <alloc_block+0x1bd>
  ...
  8022e6:	eb 0a                	jmp    8022f2 <alloc_block+0x1c7>
  8022e8:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  8022eb:	8b 00                	mov    (%eax),%eax
  8022ed:	a3 48 40 80 00       	mov    %eax,0x804048
  ...
  802305:	a1 54 40 80 00       	mov    0x804054,%eax
  80230a:	48                   	dec    %eax
  80230b:	a3 54 40 80 00       	mov    %eax,0x804054
			// from page to freeblockList by the pageInfo and the block size.
			split_page_to_blocks(1 << (idx + LOG2_MIN_SIZE), ptr_new_page);
  802310:	8b 45 f4             	mov    -0xc(%ebp),%eax
  802313:	83 c0 03             	add    $0x3,%eax
  802316:	ba 01 00 00 00       	mov    $0x1,%edx
  80231b:	88 c1                	mov    %al,%cl
  80231d:	d3 e2                	shl    %cl,%edx
  80231f:	89 d0                	mov    %edx,%eax
  802321:	83 ec 08             	sub    $0x8,%esp
  802324:	ff 75 e4             	pushl  -0x1c(%ebp)
  802327:	50                   	push   %eax
  802328:	e8 c0 fc ff ff       	call   801fed <split_page_to_blocks>
  ...
  802336:	05 80 c0 81 00       	add    $0x81c080,%eax
  80233b:	8b 00                	mov    (%eax),%eax
  80233d:	89 45 e0             	mov    %eax,-0x20(%ebp)
		    LIST_REMOVE(&freeBlockLists[idx], blk);
  802340:	83 7d e0 00          	cmpl   $0x0,-0x20(%ebp)
  802344:	75 17                	jne    80235d <alloc_block+0x232>
  802346:	83 ec 04             	sub    $0x4,%esp
  802349:	68 e1 36 80 00       	push   $0x8036e1
  80234e:	68 b0 00 00 00       	push   $0xb0
  802353:	68 23 36 80 00       	push   $0x803623
  802358:	e8 04 e1 ff ff       	call   800461 <_panic>
  80235d:	8b 45 e0             	mov    -0x20(%ebp),%eax
  802360:	8b 00                	mov    (%eax),%eax
  802362:	85 c0                	test   %eax,%eax
  802364:	74 10                	je     802376 <alloc_block+0x24b>
  802366:	8b 45 e0             	mov    -0x20(%ebp),%eax
  802369:	8b 00                	mov    (%eax),%eax
  80236b:	8b 55 e0             	mov    -0x20(%ebp),%edx
  80236e:	8b 52 04             	mov    0x4(%edx),%edx
  802371:	89 50 04             	mov    %edx,0x4(%eax)
  802374:	eb 14                	jmp    80238a <alloc_block+0x25f>
  802376:	8b 45 e0             	mov    -0x20(%ebp),%eax
  802379:	8b 40 04             	mov    0x4(%eax),%eax
  80237c:	8b 55 f4             	mov    -0xc(%ebp),%edx
  80237f:	c1 e2 04             	shl    $0x4,%edx
  802382:	81 c2 84 c0 81 00    	add    $0x81c084,%edx
  802388:	89 02                	mov    %eax,(%edx)
  80238a:	8b 45 e0             	mov    -0x20(%ebp),%eax
  80238d:	8b 40 04             	mov    0x4(%eax),%eax
  802390:	85 c0                	test   %eax,%eax
  802392:	74 0f                	je     8023a3 <alloc_block+0x278>
  802394:	8b 45 e0             	mov    -0x20(%ebp),%eax
  802397:	8b 40 04             	mov    0x4(%eax),%eax
  80239a:	8b 55 e0             	mov    -0x20(%ebp),%edx
  80239d:	8b 12                	mov    (%edx),%edx
  80239f:	89 10                	mov    %edx,(%eax)
  8023a1:	eb 13                	jmp    8023b6 <alloc_block+0x28b>
  8023a3:	8b 45 e0             	mov    -0x20(%ebp),%eax
  8023a6:	8b 00                	mov    (%eax),%eax
  8023a8:	8b 55 f4             	mov    -0xc(%ebp),%edx
  8023ab:	c1 e2 04             	shl    $0x4,%edx
  8023ae:	81 c2 80 c0 81 00    	add    $0x81c080,%edx
  8023b4:	89 02                	mov    %eax,(%edx)
  8023b6:	8b 45 e0             	mov    -0x20(%ebp),%eax
  8023b9:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  8023bf:	8b 45 e0             	mov    -0x20(%ebp),%eax
  8023c2:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
  8023c9:	8b 45 f4             	mov    -0xc(%ebp),%eax
  8023cc:	c1 e0 04             	shl    $0x4,%eax
  8023cf:	05 8c c0 81 00       	add    $0x81c08c,%eax
  ...
  8023ec:	50                   	push   %eax
  8023ed:	e8 f5 f9 ff ff       	call   801de7 <to_page_info>
  8023f2:	83 c4 10             	add    $0x10,%esp
  8023f5:	89 45 dc             	mov    %eax,-0x24(%ebp)
		    pageInfo->num_of_free_blocks--;
  8023f8:	8b 45 dc             	mov    -0x24(%ebp),%eax
  8023fb:	66 8b 40 0a          	mov    0xa(%eax),%ax
  8023ff:	48                   	dec    %eax
  802400:	8b 55 dc             	mov    -0x24(%ebp),%edx
  802403:	66 89 42 0a          	mov    %ax,0xa(%edx)
		    return blk;
  802407:	8b 45 e0             	mov    -0x20(%ebp),%eax
  80240a:	e9 26 01 00 00       	jmp    802535 <alloc_block+0x40a>
  ...
  802415:	c1 e0 04             	shl    $0x4,%eax
  802418:	05 8c c0 81 00       	add    $0x81c08c,%eax
  80241d:	8b 00                	mov    (%eax),%eax
  80241f:	85 c0                	test   %eax,%eax
  802421:	0f 84 dc 00 00 00    	je     802503 <alloc_block+0x3d8>
					// remove from the list and updat the pageInfoArr free blocks.
					// pop from the freeBlockList.
					struct BlockElement *blk = LIST_FIRST(&freeBlockLists[idx]);
  802427:	8b 45 f4             	mov    -0xc(%ebp),%eax
  80242a:	c1 e0 04             	shl    $0x4,%eax
  80242d:	05 80 c0 81 00       	add    $0x81c080,%eax
  802432:	8b 00                	mov    (%eax),%eax
  802434:	89 45 d8             	mov    %eax,-0x28(%ebp)
				    LIST_REMOVE(&freeBlockLists[idx], blk);
  802437:	83 7d d8 00          	cmpl   $0x0,-0x28(%ebp)
  80243b:	75 17                	jne    802454 <alloc_block+0x329>
  80243d:	83 ec 04             	sub    $0x4,%esp
  802440:	68 e1 36 80 00       	push   $0x8036e1
  802445:	68 be 00 00 00       	push   $0xbe
  80244a:	68 23 36 80 00       	push   $0x803623
  80244f:	e8 0d e0 ff ff       	call   800461 <_panic>
  802454:	8b 45 d8             	mov    -0x28(%ebp),%eax
  802457:	8b 00                	mov    (%eax),%eax
  802459:	85 c0                	test   %eax,%eax
  80245b:	74 10                	je     80246d <alloc_block+0x342>
  80245d:	8b 45 d8             	mov    -0x28(%ebp),%eax
  802460:	8b 00                	mov    (%eax),%eax
  802462:	8b 55 d8             	mov    -0x28(%ebp),%edx
  802465:	8b 52 04             	mov    0x4(%edx),%edx
  802468:	89 50 04             	mov    %edx,0x4(%eax)
  80246b:	eb 14                	jmp    802481 <alloc_block+0x356>
  ...
  802479:	81 c2 84 c0 81 00    	add    $0x81c084,%edx
  80247f:	89 02                	mov    %eax,(%edx)
  802481:	8b 45 d8             	mov    -0x28(%ebp),%eax
  802484:	8b 40 04             	mov    0x4(%eax),%eax
  802487:	85 c0                	test   %eax,%eax
  802489:	74 0f                	je     80249a <alloc_block+0x36f>
  80248b:	8b 45 d8             	mov    -0x28(%ebp),%eax
  80248e:	8b 40 04             	mov    0x4(%eax),%eax
  802491:	8b 55 d8             	mov    -0x28(%ebp),%edx
  802494:	8b 12                	mov    (%edx),%edx
  802496:	89 10                	mov    %edx,(%eax)
  802498:	eb 13                	jmp    8024ad <alloc_block+0x382>
  80249a:	8b 45 d8             	mov    -0x28(%ebp),%eax
  80249d:	8b 00                	mov    (%eax),%eax
  80249f:	8b 55 f4             	mov    -0xc(%ebp),%edx
  8024a2:	c1 e2 04             	shl    $0x4,%edx
  8024a5:	81 c2 80 c0 81 00    	add    $0x81c080,%edx
  8024ab:	89 02                	mov    %eax,(%edx)
  8024ad:	8b 45 d8             	mov    -0x28(%ebp),%eax
  8024b0:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  8024b6:	8b 45 d8             	mov    -0x28(%ebp),%eax
  8024b9:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
  8024c0:	8b 45 f4             	mov    -0xc(%ebp),%eax
  8024c3:	c1 e0 04             	shl    $0x4,%eax
  8024c6:	05 8c c0 81 00       	add    $0x81c08c,%eax
  ...
  8024e3:	50                   	push   %eax
  8024e4:	e8 fe f8 ff ff       	call   801de7 <to_page_info>
  8024e9:	83 c4 10             	add    $0x10,%esp
  8024ec:	89 45 d4             	mov    %eax,-0x2c(%ebp)
				    pageInfo->num_of_free_blocks--;
  8024ef:	8b 45 d4             	mov    -0x2c(%ebp),%eax
  8024f2:	66 8b 40 0a          	mov    0xa(%eax),%ax
  8024f6:	48                   	dec    %eax
  8024f7:	8b 55 d4             	mov    -0x2c(%ebp),%edx
  8024fa:	66 89 42 0a          	mov    %ax,0xa(%edx)
				    return blk;
  8024fe:	8b 45 d8             	mov    -0x28(%ebp),%eax
  802501:	eb 32                	jmp    802535 <alloc_block+0x40a>
		    struct PageInfoElement *pageInfo = to_page_info((uint32)blk);
		    pageInfo->num_of_free_blocks--;
		    return blk;
		}else{//case 3: no free block and no free page so iterate and try to find bigger size.
			// iterate over the list until finding available block
			while (idx <= (LOG2_MAX_SIZE - LOG2_MIN_SIZE) && freeBlockLists[idx].size == 0) {
  802503:	83 7d f4 08          	cmpl   $0x8,-0xc(%ebp)
  802507:	77 15                	ja     80251e <alloc_block+0x3f3>
  802509:	8b 45 f4             	mov    -0xc(%ebp),%eax
  80250c:	c1 e0 04             	shl    $0x4,%eax
  80250f:	05 8c c0 81 00       	add    $0x81c08c,%eax
  802514:	8b 00                	mov    (%eax),%eax
  802516:	85 c0                	test   %eax,%eax
  802518:	0f 84 f1 fe ff ff    	je     80240f <alloc_block+0x2e4>
				}
			}
		}
	}
  ...
  802521:	68 ff 36 80 00       	push   $0x8036ff
  802526:	68 c8 00 00 00       	push   $0xc8
  80252b:	68 23 36 80 00       	push   $0x803623
  802530:	e8 2c df ff ff       	call   800461 <_panic>
...
void free_block(void *va)
{
  ...
  802540:	a1 64 c0 81 00       	mov    0x81c064,%eax
  802545:	39 c2                	cmp    %eax,%edx
  802547:	72 0c                	jb     802555 <free_block+0x1e>
  802549:	8b 55 08             	mov    0x8(%ebp),%edx
  80254c:	a1 40 40 80 00       	mov    0x804040,%eax
  802551:	39 c2                	cmp    %eax,%edx
  802553:	72 19                	jb     80256e <free_block+0x37>
  802555:	68 10 37 80 00       	push   $0x803710
  80255a:	68 86 36 80 00       	push   $0x803686
  80255f:	68 d7 00 00 00       	push   $0xd7
  802564:	68 23 36 80 00       	push   $0x803623
  802569:	e8 f3 de ff ff       	call   800461 <_panic>
  ...
  802571:	89 45 e8             	mov    %eax,-0x18(%ebp)
	struct PageInfoElement *pageInfo = to_page_info((uint32)va);
  802574:	8b 45 08             	mov    0x8(%ebp),%eax
  802577:	83 ec 0c             	sub    $0xc,%esp
  80257a:	50                   	push   %eax
  80257b:	e8 67 f8 ff ff       	call   801de7 <to_page_info>
  ...
  80258f:	89 45 e0             	mov    %eax,-0x20(%ebp)
	...
	int idx = 0;
  802592:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
	for (int i = LOG2_MIN_SIZE; i <= LOG2_MAX_SIZE; i++) {
  802599:	c7 45 f0 03 00 00 00 	movl   $0x3,-0x10(%ebp)
  8025a0:	eb 19                	jmp    8025bb <free_block+0x84>
	    if ((1 << i) == blk_size)
  8025a2:	8b 45 f0             	mov    -0x10(%ebp),%eax
  8025a5:	ba 01 00 00 00       	mov    $0x1,%edx
  8025aa:	88 c1                	mov    %al,%cl
  8025ac:	d3 e2                	shl    %cl,%edx
  8025ae:	89 d0                	mov    %edx,%eax
  8025b0:	3b 45 e0             	cmp    -0x20(%ebp),%eax
  8025b3:	74 0e                	je     8025c3 <free_block+0x8c>
	        break;
	    idx++;
  8025b5:	ff 45 f4             	incl   -0xc(%ebp)
	struct PageInfoElement *pageInfo = to_page_info((uint32)va);
	uint32 blk_size = pageInfo->block_size;
	...
	int idx = 0;
	for (int i = LOG2_MIN_SIZE; i <= LOG2_MAX_SIZE; i++) {
  8025b8:	ff 45 f0             	incl   -0x10(%ebp)
  8025bb:	83 7d f0 0b          	cmpl   $0xb,-0x10(%ebp)
  8025bf:	7e e1                	jle    8025a2 <free_block+0x6b>
  8025c1:	eb 01                	jmp    8025c4 <free_block+0x8d>
	    if ((1 << i) == blk_size)
	        break;
  8025c3:	90                   	nop
	    idx++;
  ...
  8025c7:	66 8b 40 0a          	mov    0xa(%eax),%ax
  8025cb:	40                   	inc    %eax
  8025cc:	8b 55 e4             	mov    -0x1c(%ebp),%edx
  8025cf:	66 89 42 0a          	mov    %ax,0xa(%edx)
	LIST_INSERT_TAIL(&freeBlockLists[idx], blk_to_free);
  8025d3:	83 7d e8 00          	cmpl   $0x0,-0x18(%ebp)
  8025d7:	75 17                	jne    8025f0 <free_block+0xb9>
  8025d9:	83 ec 04             	sub    $0x4,%esp
  8025dc:	68 9c 36 80 00       	push   $0x80369c
  8025e1:	68 ee 00 00 00       	push   $0xee
  8025e6:	68 23 36 80 00       	push   $0x803623
  8025eb:	e8 71 de ff ff       	call   800461 <_panic>
  8025f0:	8b 45 f4             	mov    -0xc(%ebp),%eax
  8025f3:	c1 e0 04             	shl    $0x4,%eax
  8025f6:	05 84 c0 81 00       	add    $0x81c084,%eax
  8025fb:	8b 10                	mov    (%eax),%edx
  ...
  80260b:	74 14                	je     802621 <free_block+0xea>
  80260d:	8b 45 f4             	mov    -0xc(%ebp),%eax
  802610:	c1 e0 04             	shl    $0x4,%eax
  802613:	05 84 c0 81 00       	add    $0x81c084,%eax
  802618:	8b 00                	mov    (%eax),%eax
  80261a:	8b 55 e8             	mov    -0x18(%ebp),%edx
  80261d:	89 10                	mov    %edx,(%eax)
  80261f:	eb 11                	jmp    802632 <free_block+0xfb>
  802621:	8b 45 f4             	mov    -0xc(%ebp),%eax
  802624:	c1 e0 04             	shl    $0x4,%eax
  802627:	8d 90 80 c0 81 00    	lea    0x81c080(%eax),%edx
  80262d:	8b 45 e8             	mov    -0x18(%ebp),%eax
  802630:	89 02                	mov    %eax,(%edx)
  802632:	8b 45 f4             	mov    -0xc(%ebp),%eax
  802635:	c1 e0 04             	shl    $0x4,%eax
  802638:	8d 90 84 c0 81 00    	lea    0x81c084(%eax),%edx
  80263e:	8b 45 e8             	mov    -0x18(%ebp),%eax
  802641:	89 02                	mov    %eax,(%edx)
  ...
  802652:	05 8c c0 81 00       	add    $0x81c08c,%eax
  802657:	8b 00                	mov    (%eax),%eax
  802659:	8d 50 01             	lea    0x1(%eax),%edx
  ...
  802667:	89 10                	mov    %edx,(%eax)
	...
	int blk_count = PAGE_SIZE / blk_size;
  802669:	b8 00 10 00 00       	mov    $0x1000,%eax
  ...
  80267c:	66 8b 40 0a          	mov    0xa(%eax),%ax
  802680:	0f b7 c0             	movzwl %ax,%eax
  802683:	3b 45 dc             	cmp    -0x24(%ebp),%eax
  802686:	0f 85 70 01 00 00    	jne    8027fc <free_block+0x2c5>
		uint32 page_va = to_page_va(pageInfo);
  80268c:	83 ec 0c             	sub    $0xc,%esp
  80268f:	ff 75 e4             	pushl  -0x1c(%ebp)
  802692:	e8 de f6 ff ff       	call   801d75 <to_page_va>
  802697:	83 c4 10             	add    $0x10,%esp
  80269a:	89 45 d8             	mov    %eax,-0x28(%ebp)
		// remove all blk in the freeBlockList.
		for (uint32 off = 0; off < PAGE_SIZE; off += blk_size) {
  80269d:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  8026a4:	e9 b7 00 00 00       	jmp    802760 <free_block+0x229>
			struct BlockElement *blk = (struct BlockElement*)(page_va + off);
  8026a9:	8b 55 d8             	mov    -0x28(%ebp),%edx
  8026ac:	8b 45 ec             	mov    -0x14(%ebp),%eax
  8026af:	01 d0                	add    %edx,%eax
  8026b1:	89 45 d4             	mov    %eax,-0x2c(%ebp)
			LIST_REMOVE(&freeBlockLists[idx], blk);
  8026b4:	83 7d d4 00          	cmpl   $0x0,-0x2c(%ebp)
  8026b8:	75 17                	jne    8026d1 <free_block+0x19a>
  8026ba:	83 ec 04             	sub    $0x4,%esp
  8026bd:	68 e1 36 80 00       	push   $0x8036e1
  8026c2:	68 f8 00 00 00       	push   $0xf8
  8026c7:	68 23 36 80 00       	push   $0x803623
  8026cc:	e8 90 dd ff ff       	call   800461 <_panic>
  8026d1:	8b 45 d4             	mov    -0x2c(%ebp),%eax
  8026d4:	8b 00                	mov    (%eax),%eax
  8026d6:	85 c0                	test   %eax,%eax
  8026d8:	74 10                	je     8026ea <free_block+0x1b3>
  ...
  8026e8:	eb 14                	jmp    8026fe <free_block+0x1c7>
  8026ea:	8b 45 d4             	mov    -0x2c(%ebp),%eax
  8026ed:	8b 40 04             	mov    0x4(%eax),%eax
  8026f0:	8b 55 f4             	mov    -0xc(%ebp),%edx
  8026f3:	c1 e2 04             	shl    $0x4,%edx
  8026f6:	81 c2 84 c0 81 00    	add    $0x81c084,%edx
  8026fc:	89 02                	mov    %eax,(%edx)
  8026fe:	8b 45 d4             	mov    -0x2c(%ebp),%eax
  802701:	8b 40 04             	mov    0x4(%eax),%eax
  802704:	85 c0                	test   %eax,%eax
  802706:	74 0f                	je     802717 <free_block+0x1e0>
  802708:	8b 45 d4             	mov    -0x2c(%ebp),%eax
  80270b:	8b 40 04             	mov    0x4(%eax),%eax
  80270e:	8b 55 d4             	mov    -0x2c(%ebp),%edx
  802711:	8b 12                	mov    (%edx),%edx
  802713:	89 10                	mov    %edx,(%eax)
  802715:	eb 13                	jmp    80272a <free_block+0x1f3>
  802717:	8b 45 d4             	mov    -0x2c(%ebp),%eax
  80271a:	8b 00                	mov    (%eax),%eax
  80271c:	8b 55 f4             	mov    -0xc(%ebp),%edx
  80271f:	c1 e2 04             	shl    $0x4,%edx
  802722:	81 c2 80 c0 81 00    	add    $0x81c080,%edx
  ...
  802740:	c1 e0 04             	shl    $0x4,%eax
  802743:	05 8c c0 81 00       	add    $0x81c08c,%eax
  802748:	8b 00                	mov    (%eax),%eax
  80274a:	8d 50 ff             	lea    -0x1(%eax),%edx
  ...
  802758:	89 10                	mov    %edx,(%eax)
	...
	if (pageInfo->num_of_free_blocks == blk_count) {
		...
		// remove all blk in the freeBlockList.
		for (uint32 off = 0; off < PAGE_SIZE; off += blk_size) {
  80275a:	8b 45 e0             	mov    -0x20(%ebp),%eax
  80275d:	01 45 ec             	add    %eax,-0x14(%ebp)
  802760:	81 7d ec ff 0f 00 00 	cmpl   $0xfff,-0x14(%ebp)
  802767:	0f 86 3c ff ff ff    	jbe    8026a9 <free_block+0x172>
			struct BlockElement *blk = (struct BlockElement*)(page_va + off);
			LIST_REMOVE(&freeBlockLists[idx], blk);
		}
		// reset page info.
  ...
  802770:	66 c7 40 08 00 00    	movw   $0x0,0x8(%eax)
		pageInfo->num_of_free_blocks = 0;
  802776:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  802779:	66 c7 40 0a 00 00    	movw   $0x0,0xa(%eax)
		// add it to the available pages.
		LIST_INSERT_TAIL(&freePagesList, pageInfo);
  80277f:	83 7d e4 00          	cmpl   $0x0,-0x1c(%ebp)
  802783:	75 17                	jne    80279c <free_block+0x265>
  802785:	83 ec 04             	sub    $0x4,%esp
  802788:	68 9c 36 80 00       	push   $0x80369c
  80278d:	68 fe 00 00 00       	push   $0xfe
  802792:	68 23 36 80 00       	push   $0x803623
  802797:	e8 c5 dc ff ff       	call   800461 <_panic>
  80279c:	8b 15 4c 40 80 00    	mov    0x80404c,%edx
  ...
  8027b0:	74 0c                	je     8027be <free_block+0x287>
  8027b2:	a1 4c 40 80 00       	mov    0x80404c,%eax
  8027b7:	8b 55 e4             	mov    -0x1c(%ebp),%edx
  8027ba:	89 10                	mov    %edx,(%eax)
  8027bc:	eb 08                	jmp    8027c6 <free_block+0x28f>
  8027be:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  8027c1:	a3 48 40 80 00       	mov    %eax,0x804048
  ...
  8027d7:	a1 54 40 80 00       	mov    0x804054,%eax
  8027dc:	40                   	inc    %eax
  8027dd:	a3 54 40 80 00       	mov    %eax,0x804054
		// make it available in memory.
		return_page((uint32 *)to_page_va(pageInfo));
  8027e2:	83 ec 0c             	sub    $0xc,%esp
  8027e5:	ff 75 e4             	pushl  -0x1c(%ebp)
  8027e8:	e8 88 f5 ff ff       	call   801d75 <to_page_va>
  8027ed:	83 c4 10             	add    $0x10,%esp
  8027f0:	83 ec 0c             	sub    $0xc,%esp
  8027f3:	50                   	push   %eax
  8027f4:	e8 b8 ee ff ff       	call   8016b1 <return_page>
...
void *realloc_block(void* va, uint32 new_size)
{
  ...
  802808:	68 48 37 80 00       	push   $0x803748
  80280d:	68 11 01 00 00       	push   $0x111
  802812:	68 23 36 80 00       	push   $0x803623
  802817:	e8 45 dc ff ff       	call   800461 <_panic>
...
//	cprintf("%s go to sleep...\n", myEnv->prog_name);
  ...
  80282c:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
  802833:	01 d0                	add    %edx,%eax
  802835:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
  80283c:	01 d0                	add    %edx,%eax
  80283e:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
  802845:	01 d0                	add    %edx,%eax
  802847:	c1 e0 04             	shl    $0x4,%eax
  80284a:	89 45 f8             	mov    %eax,-0x8(%ebp)
	uint32 cycles_counter =0;
  80284d:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%ebp)
...
static inline __attribute__((always_inline)) struct uint64 get_virtual_time_user()
{
  ...
  802854:	0f 31                	rdtsc  
  802856:	89 45 e8             	mov    %eax,-0x18(%ebp)
  802859:	89 55 ec             	mov    %edx,-0x14(%ebp)
	: "=a" (result.low), "=d" (result.hi)
	);

	return result;
  80285c:	8b 45 e8             	mov    -0x18(%ebp),%eax
  80285f:	8b 55 ec             	mov    -0x14(%ebp),%edx
  802862:	89 45 f0             	mov    %eax,-0x10(%ebp)
  802865:	89 55 f4             	mov    %edx,-0xc(%ebp)

	/*2024*/ //USE A USER-SIDE VERSION OF THIS FUNCTION TO AVOID SLOW-DOWN THE PERFORMANCE DUE SYS_CALL (el7 :))
	//struct uint64 baseTime = sys_get_virtual_time() ;
	struct uint64 baseTime = get_virtual_time_user() ;
	while(cycles_counter<time_in_cycles)
  802868:	eb 46                	jmp    8028b0 <env_sleep+0x94>
...
static inline __attribute__((always_inline)) struct uint64 get_virtual_time_user()
{
  ...
  80286f:	89 55 d4             	mov    %edx,-0x2c(%ebp)
	: "=a" (result.low), "=d" (result.hi)
	);

	return result;
  802872:	8b 45 d0             	mov    -0x30(%ebp),%eax
  802875:	8b 55 d4             	mov    -0x2c(%ebp),%edx
  802878:	89 45 e0             	mov    %eax,-0x20(%ebp)
  80287b:	89 55 e4             	mov    %edx,-0x1c(%ebp)
  ...
  802884:	29 c2                	sub    %eax,%edx
  802886:	89 d0                	mov    %edx,%eax
  802888:	89 45 d8             	mov    %eax,-0x28(%ebp)
		res.hi = (currentTime.hi - baseTime.hi - (res.low > currentTime.low)) & M32;
  80288b:	8b 55 e4             	mov    -0x1c(%ebp),%edx
  80288e:	8b 45 f4             	mov    -0xc(%ebp),%eax
  802891:	89 d1                	mov    %edx,%ecx
  802893:	29 c1                	sub    %eax,%ecx
  802895:	8b 55 d8             	mov    -0x28(%ebp),%edx
  802898:	8b 45 e0             	mov    -0x20(%ebp),%eax
  80289b:	39 c2                	cmp    %eax,%edx
  80289d:	0f 97 c0             	seta   %al
  8028a0:	0f b6 c0             	movzbl %al,%eax
  8028a3:	29 c1                	sub    %eax,%ecx
  8028a5:	89 c8                	mov    %ecx,%eax
  8028a7:	89 45 dc             	mov    %eax,-0x24(%ebp)

		//update cycles_count with result
		cycles_counter = res.low;
  8028aa:	8b 45 d8             	mov    -0x28(%ebp),%eax
  8028ad:	89 45 fc             	mov    %eax,-0x4(%ebp)
	uint32 cycles_counter =0;
	...
	struct uint64 baseTime = get_virtual_time_user() ;
	while(cycles_counter<time_in_cycles)
  8028b0:	8b 45 fc             	mov    -0x4(%ebp),%eax
  8028b3:	3b 45 f8             	cmp    -0x8(%ebp),%eax
  8028b6:	72 b2                	jb     80286a <env_sleep+0x4e>
//				,cycles_counter
//				);
	}
...
uint32 busy_wait(uint32 loopMax)
{
  ...
  8028be:	83 ec 10             	sub    $0x10,%esp
	uint32 i = 0 ;
  8028c1:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%ebp)
	while (i < loopMax) i++;
  8028c8:	eb 03                	jmp    8028cd <busy_wait+0x12>
  8028ca:	ff 45 fc             	incl   -0x4(%ebp)
  8028cd:	8b 45 fc             	mov    -0x4(%ebp),%eax
  8028d0:	3b 45 08             	cmp    0x8(%ebp),%eax
  8028d3:	72 f5                	jb     8028ca <busy_wait+0xf>
	return i;
  8028d5:	8b 45 fc             	mov    -0x4(%ebp),%eax
}
  8028d8:	c9                   	leave  
  8028d9:	c3                   	ret    
