...
void _main(void)
{
  ...
  8000c9:	68 cc 1c 80 00       	push   $0x801ccc
  8000ce:	6a 28                	push   $0x28
  8000d0:	68 fd 1c 80 00       	push   $0x801cfd
...
libmain(int argc, char **argv)
{
  ...
  800172:	bb 0c 1e 80 00       	mov    $0x801e0c,%ebx
  ...
  8001b7:	68 2c 1d 80 00       	push   $0x801d2c
  ...
  8001d3:	50                   	push   %eax
  8001d4:	68 54 1d 80 00       	push   $0x801d54
  ...
  8001fc:	52                   	push   %edx
  8001fd:	50                   	push   %eax
  8001fe:	68 78 1d 80 00       	push   $0x801d78
  ...
  80022d:	52                   	push   %edx
  80022e:	50                   	push   %eax
  80022f:	68 a0 1d 80 00       	push   $0x801da0
...
_panic(const char *file, int line, const char *fmt,...)
{
  ...
  8002bf:	50                   	push   %eax
  8002c0:	68 70 1e 80 00       	push   $0x801e70
  ...
  8002db:	50                   	push   %eax
  8002dc:	68 78 1e 80 00       	push   $0x801e78
  ...
  800302:	68 a0 1e 80 00       	push   $0x801ea0
...
void CheckWSArrayWithoutLastIndex(uint32 *expectedPages, int arraySize)
{
  ...
  800331:	68 a4 1e 80 00       	push   $0x801ea4
  800336:	6a 26                	push   $0x26
  800338:	68 f0 1e 80 00       	push   $0x801ef0
  ...
  800406:	68 fc 1e 80 00       	push   $0x801efc
  80040b:	6a 3a                	push   $0x3a
  80040d:	68 f0 1e 80 00       	push   $0x801ef0
  ...
  800479:	68 50 1f 80 00       	push   $0x801f50
  80047e:	6a 44                	push   $0x44
  800480:	68 f0 1e 80 00       	push   $0x801ef0
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8006a7:	05 b4 21 80 00       	add    $0x8021b4,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8007fa:	8b 04 85 d8 21 80 00 	mov    0x8021d8(,%eax,4),%eax
  ...
  8008db:	8b 34 9d 20 20 80 00 	mov    0x802020(,%ebx,4),%esi
  8008e2:	85 f6                	test   %esi,%esi
  8008e4:	75 19                	jne    8008ff <vprintfmt+0x173>
				printfmt(putch, putdat, "error %d", err);
  8008e6:	53                   	push   %ebx
  8008e7:	68 c5 21 80 00       	push   $0x8021c5
  ...
  8008fa:	e9 5b 02 00 00       	jmp    800b5a <vprintfmt+0x3ce>
			...
			if (err > MAXERROR || (p = error_string[err]) == NULL)
				...
				printfmt(putch, putdat, "%s", p);
  8008ff:	56                   	push   %esi
  800900:	68 ce 21 80 00       	push   $0x8021ce
  ...
  80092b:	75 05                	jne    800932 <vprintfmt+0x1a6>
				p = "(null)";
  80092d:	be d1 21 80 00       	mov    $0x8021d1,%esi
			if (width > 0 && padc != '-')
...
void sys_env_set_priority(int32 envID, int priority)
{
  ...
  8019e8:	68 48 23 80 00       	push   $0x802348
  8019ed:	68 25 01 00 00       	push   $0x125
  8019f2:	68 7b 23 80 00       	push   $0x80237b
