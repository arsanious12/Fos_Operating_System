...
void _main(void)
{
  ...
  800046:	6a 17                	push   $0x17
  800048:	68 ed 1b 80 00       	push   $0x801bed
...
libmain(int argc, char **argv)
{
  ...
  8000ea:	bb 00 1d 80 00       	mov    $0x801d00,%ebx
  ...
  80012f:	68 20 1c 80 00       	push   $0x801c20
  ...
  80014b:	50                   	push   %eax
  80014c:	68 48 1c 80 00       	push   $0x801c48
  ...
  800174:	52                   	push   %edx
  800175:	50                   	push   %eax
  800176:	68 6c 1c 80 00       	push   $0x801c6c
  ...
  8001a5:	52                   	push   %edx
  8001a6:	50                   	push   %eax
  8001a7:	68 94 1c 80 00       	push   $0x801c94
  ...
  8001c2:	50                   	push   %eax
  8001c3:	68 ec 1c 80 00       	push   $0x801cec
  8001c8:	e8 18 03 00 00       	call   8004e5 <cprintf>
  8001cd:	83 c4 10             	add    $0x10,%esp
			cprintf("**************************************\n");
  8001d0:	83 ec 0c             	sub    $0xc,%esp
  8001d3:	68 20 1c 80 00       	push   $0x801c20
...
_panic(const char *file, int line, const char *fmt,...)
{
  ...
  800237:	50                   	push   %eax
  800238:	68 64 1d 80 00       	push   $0x801d64
  ...
  800253:	50                   	push   %eax
  800254:	68 6c 1d 80 00       	push   $0x801d6c
  ...
  80027a:	68 94 1d 80 00       	push   $0x801d94
...
void CheckWSArrayWithoutLastIndex(uint32 *expectedPages, int arraySize)
{
  ...
  8002a9:	68 98 1d 80 00       	push   $0x801d98
  8002ae:	6a 26                	push   $0x26
  8002b0:	68 e4 1d 80 00       	push   $0x801de4
  ...
  80037e:	68 f0 1d 80 00       	push   $0x801df0
  800383:	6a 3a                	push   $0x3a
  800385:	68 e4 1d 80 00       	push   $0x801de4
  ...
  8003f1:	68 44 1e 80 00       	push   $0x801e44
  8003f6:	6a 44                	push   $0x44
  8003f8:	68 e4 1d 80 00       	push   $0x801de4
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80061f:	05 b4 20 80 00       	add    $0x8020b4,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800772:	8b 04 85 d8 20 80 00 	mov    0x8020d8(,%eax,4),%eax
  ...
  800853:	8b 34 9d 20 1f 80 00 	mov    0x801f20(,%ebx,4),%esi
  80085a:	85 f6                	test   %esi,%esi
  80085c:	75 19                	jne    800877 <vprintfmt+0x173>
				printfmt(putch, putdat, "error %d", err);
  80085e:	53                   	push   %ebx
  80085f:	68 c5 20 80 00       	push   $0x8020c5
  ...
  800872:	e9 5b 02 00 00       	jmp    800ad2 <vprintfmt+0x3ce>
			...
			if (err > MAXERROR || (p = error_string[err]) == NULL)
				...
				printfmt(putch, putdat, "%s", p);
  800877:	56                   	push   %esi
  800878:	68 ce 20 80 00       	push   $0x8020ce
  ...
  8008a3:	75 05                	jne    8008aa <vprintfmt+0x1a6>
				p = "(null)";
  8008a5:	be d1 20 80 00       	mov    $0x8020d1,%esi
			if (width > 0 && padc != '-')
...
void sys_env_set_priority(int32 envID, int priority)
{
  ...
  801960:	68 48 22 80 00       	push   $0x802248
  801965:	68 25 01 00 00       	push   $0x125
  80196a:	68 7b 22 80 00       	push   $0x80227b
