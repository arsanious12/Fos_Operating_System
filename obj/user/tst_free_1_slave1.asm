...
void _main(void)
{
  ...
  8002dc:	68 a0 2c 80 00       	push   $0x802ca0
  8002e1:	6a 5e                	push   $0x5e
  8002e3:	68 dc 2a 80 00       	push   $0x802adc
...
libmain(int argc, char **argv)
{
  ...
  80031e:	a3 20 40 80 00       	mov    %eax,0x804020
  ...
  800337:	a3 04 40 80 00       	mov    %eax,0x804004
  ...
  80035a:	83 c4 10             	add    $0x10,%esp
	...
	if (printStats)
  80035d:	a1 00 40 80 00       	mov    0x804000,%eax
  ...
  800370:	bb e4 2d 80 00       	mov    $0x802de4,%ebx
  ...
  8003b5:	68 04 2d 80 00       	push   $0x802d04
  ...
  8003d1:	50                   	push   %eax
  8003d2:	68 2c 2d 80 00       	push   $0x802d2c
  ...
  8003ec:	a1 20 40 80 00       	mov    0x804020,%eax
  8003f1:	8b 80 98 05 00 00    	mov    0x598(%eax),%eax
  8003f7:	83 ec 04             	sub    $0x4,%esp
  8003fa:	52                   	push   %edx
  8003fb:	50                   	push   %eax
  8003fc:	68 50 2d 80 00       	push   $0x802d50
  ...
  800414:	a1 20 40 80 00       	mov    0x804020,%eax
...
_panic(const char *file, int line, const char *fmt,...)
{
  ...
  800500:	68 78 2e 80 00       	push   $0x802e78
...
void CheckWSArrayWithoutLastIndex(uint32 *expectedPages, int arraySize)
{
  ...
  80052f:	68 7c 2e 80 00       	push   $0x802e7c
  800534:	6a 26                	push   $0x26
  800536:	68 c8 2e 80 00       	push   $0x802ec8
  ...
  8005a0:	a1 20 40 80 00       	mov    0x804020,%eax
  ...
  8005e9:	a1 20 40 80 00       	mov    0x804020,%eax
  ...
  800604:	68 d4 2e 80 00       	push   $0x802ed4
  800609:	6a 3a                	push   $0x3a
  80060b:	68 c8 2e 80 00       	push   $0x802ec8
  ...
  800634:	a1 20 40 80 00       	mov    0x804020,%eax
  ...
  80065a:	a1 20 40 80 00       	mov    0x804020,%eax
  ...
  800677:	68 28 2f 80 00       	push   $0x802f28
  80067c:	6a 44                	push   $0x44
  80067e:	68 c8 2e 80 00       	push   $0x802ec8
...
static void putch(int ch, struct printbuf *b) {
  ...
  8006b7:	8b 15 1c c1 81 00    	mov    0x81c11c,%edx
  8006bd:	a0 44 40 80 00       	mov    0x804044,%al
...
int vcprintf(const char *fmt, va_list ap) {
  ...
  800730:	83 c4 10             	add    $0x10,%esp
	sys_cputs(b.buf, b.idx, printProgName, curTextClr);
  800733:	8b 15 1c c1 81 00    	mov    0x81c11c,%edx
  800739:	a0 44 40 80 00       	mov    0x804044,%al
  ...
  800759:	83 c4 10             	add    $0x10,%esp
	...
	printProgName = 0;
  80075c:	c6 05 44 40 80 00 00 	movb   $0x0,0x804044
	return b.cnt;
...
int cprintf(const char *fmt, ...) {
  ...
  80076e:	83 ec 18             	sub    $0x18,%esp
	...
	int cnt;
	printProgName = 1 ;
  800771:	c6 05 44 40 80 00 01 	movb   $0x1,0x804044
	va_start(ap, fmt);
...
int cprintf_colored(int textClr, const char *fmt, ...) {
  ...
  80079b:	83 ec 18             	sub    $0x18,%esp
	...
	int cnt;
	printProgName = 1 ;
  80079e:	c6 05 44 40 80 00 01 	movb   $0x1,0x804044
	curTextClr = (textClr << 8) ; //set text color by the given value
  8007a5:	8b 45 08             	mov    0x8(%ebp),%eax
  8007a8:	c1 e0 08             	shl    $0x8,%eax
  8007ab:	a3 1c c1 81 00       	mov    %eax,0x81c11c
	va_start(ap, fmt);
  ...
  8007ce:	c7 05 1c c1 81 00 00 	movl   $0x700,0x81c11c
  8007d5:	07 00 00 
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80084d:	e8 06 20 00 00       	call   802858 <__udivdi3>
  ...
  80089b:	52                   	push   %edx
  80089c:	50                   	push   %eax
  80089d:	e8 c6 20 00 00       	call   802968 <__umoddi3>
  8008a2:	83 c4 10             	add    $0x10,%esp
  8008a5:	05 94 31 80 00       	add    $0x803194,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8009f8:	8b 04 85 b8 31 80 00 	mov    0x8031b8(,%eax,4),%eax
  ...
  800ad9:	8b 34 9d 00 30 80 00 	mov    0x803000(,%ebx,4),%esi
  800ae0:	85 f6                	test   %esi,%esi
  800ae2:	75 19                	jne    800afd <vprintfmt+0x173>
				printfmt(putch, putdat, "error %d", err);
  800ae4:	53                   	push   %ebx
  800ae5:	68 a5 31 80 00       	push   $0x8031a5
  ...
  800af8:	e9 5b 02 00 00       	jmp    800d58 <vprintfmt+0x3ce>
			...
			if (err > MAXERROR || (p = error_string[err]) == NULL)
				...
				printfmt(putch, putdat, "%s", p);
  800afd:	56                   	push   %esi
  800afe:	68 ae 31 80 00       	push   $0x8031ae
  ...
  800b29:	75 05                	jne    800b30 <vprintfmt+0x1a6>
				p = "(null)";
  800b2b:	be b1 31 80 00       	mov    $0x8031b1,%esi
			if (width > 0 && padc != '-')
  ...
  800d21:	eb 35                	jmp    800d58 <vprintfmt+0x3ce>
		...
		case '~':
			printProgName = 0;
  800d23:	c6 05 44 40 80 00 00 	movb   $0x0,0x804044
			break;
  800d2a:	eb 2c                	jmp    800d58 <vprintfmt+0x3ce>
		// Print Program Name & UD
		case '@':
			printProgName = 1;
  800d2c:	c6 05 44 40 80 00 01 	movb   $0x1,0x804044
			break;
...
void uheap_init()
{
  ...
  801653:	83 ec 08             	sub    $0x8,%esp
	if(__firstTimeFlag)
  801656:	a1 08 40 80 00       	mov    0x804008,%eax
  ...
  801679:	a3 60 c0 81 00       	mov    %eax,0x81c060
		uheapPageAllocStart = dynAllocEnd + PAGE_SIZE;
  80167e:	a1 40 40 80 00       	mov    0x804040,%eax
  801683:	05 00 10 00 00       	add    $0x1000,%eax
  801688:	a3 10 c1 81 00       	mov    %eax,0x81c110
		uheapPageAllocBreak = uheapPageAllocStart;
  80168d:	a1 10 c1 81 00       	mov    0x81c110,%eax
  801692:	a3 68 c0 81 00       	mov    %eax,0x81c068

		__firstTimeFlag = 0;
  801697:	c7 05 08 40 80 00 00 	movl   $0x0,0x804008
  80169e:	00 00 00 
	}
}
  8016a1:	90                   	nop
...
int get_page(void* va)
{
  ...
  8016d5:	68 28 33 80 00       	push   $0x803328
  8016da:	6a 1f                	push   $0x1f
  8016dc:	68 64 33 80 00       	push   $0x803364
...
void return_page(void* va)
{
  ...
  801719:	68 70 33 80 00       	push   $0x803370
  80171e:	6a 2a                	push   $0x2a
  801720:	68 64 33 80 00       	push   $0x803364
...
void* malloc(uint32 size)
{
  ...
  801748:	68 b0 33 80 00       	push   $0x8033b0
  80174d:	6a 3e                	push   $0x3e
  80174f:	68 64 33 80 00       	push   $0x803364
...
void free(void* virtual_address)
{
  ...
  801764:	68 d8 33 80 00       	push   $0x8033d8
  801769:	6a 49                	push   $0x49
  80176b:	68 64 33 80 00       	push   $0x803364
...
void* smalloc(char *sharedVarName, uint32 size, uint8 isWritable)
{
  ...
  801796:	68 fc 33 80 00       	push   $0x8033fc
  80179b:	6a 5a                	push   $0x5a
  80179d:	68 64 33 80 00       	push   $0x803364
...
void* sget(int32 ownerEnvID, char *sharedVarName)
{
  ...
  8017b7:	68 24 34 80 00       	push   $0x803424
  8017bc:	6a 6a                	push   $0x6a
  8017be:	68 64 33 80 00       	push   $0x803364
...
void *realloc(void *virtual_address, uint32 new_size)
{
  ...
  8017d6:	68 48 34 80 00       	push   $0x803448
...
void sfree(void* virtual_address)
{
  ...
  8017f3:	68 70 34 80 00       	push   $0x803470
...
uint32 sys_get_uheap_strategy()
{
  ...
  801c77:	a3 60 c0 81 00       	mov    %eax,0x81c060
	return uheapPlaceStrategy ;
  801c7c:	a1 60 c0 81 00       	mov    0x81c060,%eax
}
  801c81:	c9                   	leave  
  801c82:	c3                   	ret    
...
void sys_set_uheap_strategy(uint32 heapStrategy)
{
  ...
  801c89:	a3 60 c0 81 00       	mov    %eax,0x81c060
...
void sys_env_set_priority(int32 envID, int priority)
{
  ...
  801d9d:	68 94 34 80 00       	push   $0x803494
  801da2:	68 25 01 00 00       	push   $0x125
  801da7:	68 c7 34 80 00       	push   $0x8034c7
...
__inline__ uint32 to_page_va(struct PageInfoElement *ptrPageInfo)
{
  ...
  801e1a:	a1 64 c0 81 00       	mov    0x81c064,%eax
...
__inline__ struct PageInfoElement * to_page_info(uint32 va)
{
  ...
  801e29:	a1 64 c0 81 00       	mov    0x81c064,%eax
  ...
  801e4d:	68 1c 35 80 00       	push   $0x80351c
  801e52:	6a 22                	push   $0x22
  801e54:	68 03 35 80 00       	push   $0x803503
  ...
  801e6a:	05 60 40 80 00       	add    $0x804060,%eax
}
  801e6f:	c9                   	leave  
  801e70:	c3                   	ret    
...
void initialize_dynamic_allocator(uint32 daStart, uint32 daEnd)
{
  ...
  801e84:	68 40 35 80 00       	push   $0x803540
  801e89:	68 66 35 80 00       	push   $0x803566
  801e8e:	6a 34                	push   $0x34
  801e90:	68 03 35 80 00       	push   $0x803503
  801e95:	e8 03 e6 ff ff       	call   80049d <_panic>
		is_initialized = 1;
  801e9a:	c7 05 24 40 80 00 01 	movl   $0x1,0x804024
  801ea1:	00 00 00 
	//==================================================================================
	//==================================================================================
  ...
  801ea7:	a3 64 c0 81 00       	mov    %eax,0x81c064
	dynAllocEnd = daEnd;
  801eac:	8b 45 0c             	mov    0xc(%ebp),%eax
  801eaf:	a3 40 40 80 00       	mov    %eax,0x804040
	// init the list that keep track of all free pageBlockInfoArr instances.
	LIST_INIT(&freePagesList);
  801eb4:	c7 05 48 40 80 00 00 	movl   $0x0,0x804048
  801ebb:	00 00 00 
  801ebe:	c7 05 4c 40 80 00 00 	movl   $0x0,0x80404c
  801ec5:	00 00 00 
  801ec8:	c7 05 54 40 80 00 00 	movl   $0x0,0x804054
  801ecf:	00 00 00 

	// no.of pages in the dynamic allocator.
	int pCount = (daEnd - daStart) / PAGE_SIZE;
  801ed2:	8b 45 0c             	mov    0xc(%ebp),%eax
  801ed5:	2b 45 08             	sub    0x8(%ebp),%eax
  ...
  801ee5:	e9 c8 00 00 00       	jmp    801fb2 <initialize_dynamic_allocator+0x141>
  ...
  801ef6:	05 68 40 80 00       	add    $0x804068,%eax
  ...
  801f0c:	05 6a 40 80 00       	add    $0x80406a,%eax
  801f11:	66 c7 00 00 00       	movw   $0x0,(%eax)
	    LIST_INSERT_TAIL(&freePagesList, &pageBlockInfoArr[i]);
  801f16:	8b 15 4c 40 80 00    	mov    0x80404c,%edx
  801f1c:	8b 4d f4             	mov    -0xc(%ebp),%ecx
  801f1f:	89 c8                	mov    %ecx,%eax
  801f21:	01 c0                	add    %eax,%eax
  801f23:	01 c8                	add    %ecx,%eax
  801f25:	c1 e0 02             	shl    $0x2,%eax
  801f28:	05 64 40 80 00       	add    $0x804064,%eax
  ...
  801f3b:	05 64 40 80 00       	add    $0x804064,%eax
  801f40:	8b 00                	mov    (%eax),%eax
  801f42:	85 c0                	test   %eax,%eax
  801f44:	74 1b                	je     801f61 <initialize_dynamic_allocator+0xf0>
  801f46:	8b 15 4c 40 80 00    	mov    0x80404c,%edx
  801f4c:	8b 4d f4             	mov    -0xc(%ebp),%ecx
  801f4f:	89 c8                	mov    %ecx,%eax
  801f51:	01 c0                	add    %eax,%eax
  801f53:	01 c8                	add    %ecx,%eax
  801f55:	c1 e0 02             	shl    $0x2,%eax
  801f58:	05 60 40 80 00       	add    $0x804060,%eax
  801f5d:	89 02                	mov    %eax,(%edx)
  801f5f:	eb 16                	jmp    801f77 <initialize_dynamic_allocator+0x106>
  ...
  801f72:	a3 48 40 80 00       	mov    %eax,0x804048
  ...
  801f88:	a3 4c 40 80 00       	mov    %eax,0x80404c
  ...
  801f99:	05 60 40 80 00       	add    $0x804060,%eax
  801f9e:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  801fa4:	a1 54 40 80 00       	mov    0x804054,%eax
  801fa9:	40                   	inc    %eax
  801faa:	a3 54 40 80 00       	mov    %eax,0x804054
	LIST_INIT(&freePagesList);
	...
	// iterate over each page and init its data in pageBlockInfoArr and reset it.
	for (int i = 0; i < pCount; ++i) {
  801faf:	ff 45 f4             	incl   -0xc(%ebp)
  801fb2:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801fb5:	3b 45 ec             	cmp    -0x14(%ebp),%eax
  801fb8:	0f 8c 2c ff ff ff    	jl     801eea <initialize_dynamic_allocator+0x79>
	    LIST_INSERT_TAIL(&freePagesList, &pageBlockInfoArr[i]);
	}
  ...
  801fc5:	eb 36                	jmp    801ffd <initialize_dynamic_allocator+0x18c>
		LIST_INIT(&freeBlockLists[i]);
  801fc7:	8b 45 f0             	mov    -0x10(%ebp),%eax
  801fca:	c1 e0 04             	shl    $0x4,%eax
  801fcd:	05 80 c0 81 00       	add    $0x81c080,%eax
  801fd2:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  801fd8:	8b 45 f0             	mov    -0x10(%ebp),%eax
  801fdb:	c1 e0 04             	shl    $0x4,%eax
  801fde:	05 84 c0 81 00       	add    $0x81c084,%eax
  801fe3:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  801fe9:	8b 45 f0             	mov    -0x10(%ebp),%eax
  801fec:	c1 e0 04             	shl    $0x4,%eax
  801fef:	05 8c c0 81 00       	add    $0x81c08c,%eax
  801ff4:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
	    LIST_INSERT_TAIL(&freePagesList, &pageBlockInfoArr[i]);
	}
	// init the array of lists of each size..
	// 8 16 32 64 128 256 512 1024 2056
  ...
  801ffd:	83 7d f0 08          	cmpl   $0x8,-0x10(%ebp)
  802001:	7e c4                	jle    801fc7 <initialize_dynamic_allocator+0x156>
		LIST_INIT(&freeBlockLists[i]);
	}
	//Comment the following line
...
__inline__ uint32 get_block_size(void *va)
{
  ...
  802012:	50                   	push   %eax
  802013:	e8 0b fe ff ff       	call   801e23 <to_page_info>
...
//and putem in suitable freeblockList index according to size.
 void split_page_to_blocks(uint32 blk_size, struct PageInfoElement *pageInfo) {
  ...
  802035:	e8 77 fd ff ff       	call   801db1 <to_page_va>
  80203a:	83 c4 10             	add    $0x10,%esp
  80203d:	89 45 e8             	mov    %eax,-0x18(%ebp)
	 // no. of blks to save in freeblockList.
	 int blk_count = PAGE_SIZE / blk_size;
  802040:	b8 00 10 00 00       	mov    $0x1000,%eax
  802045:	ba 00 00 00 00       	mov    $0x0,%edx
  80204a:	f7 75 08             	divl   0x8(%ebp)
  ...
  802096:	ff 45 f4             	incl   -0xc(%ebp)
	 ...
	 int idx = 0;
	 for (int i = LOG2_MIN_SIZE; i <= LOG2_MAX_SIZE; i++) {
  802099:	ff 45 f0             	incl   -0x10(%ebp)
  80209c:	83 7d f0 0b          	cmpl   $0xb,-0x10(%ebp)
  8020a0:	7e e1                	jle    802083 <split_page_to_blocks+0x5a>
  8020a2:	eb 01                	jmp    8020a5 <split_page_to_blocks+0x7c>
	     if ((1 << i) == blk_size)
	         break;
  8020a4:	90                   	nop
	     idx++;
  ...
  8020a5:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  8020ac:	e9 a7 00 00 00       	jmp    802158 <split_page_to_blocks+0x12f>
	     struct BlockElement *blk =(struct BlockElement*)(page_va + i * blk_size);
  8020b1:	8b 45 ec             	mov    -0x14(%ebp),%eax
  8020b4:	0f af 45 08          	imul   0x8(%ebp),%eax
  8020b8:	89 c2                	mov    %eax,%edx
  8020ba:	8b 45 e8             	mov    -0x18(%ebp),%eax
  8020bd:	01 d0                	add    %edx,%eax
  8020bf:	89 45 e0             	mov    %eax,-0x20(%ebp)
	     LIST_INSERT_TAIL(&freeBlockLists[idx],blk);
  8020c2:	83 7d e0 00          	cmpl   $0x0,-0x20(%ebp)
  8020c6:	75 14                	jne    8020dc <split_page_to_blocks+0xb3>
  8020c8:	83 ec 04             	sub    $0x4,%esp
  8020cb:	68 7c 35 80 00       	push   $0x80357c
  8020d0:	6a 7c                	push   $0x7c
  8020d2:	68 03 35 80 00       	push   $0x803503
  8020d7:	e8 c1 e3 ff ff       	call   80049d <_panic>
  8020dc:	8b 45 f4             	mov    -0xc(%ebp),%eax
  8020df:	c1 e0 04             	shl    $0x4,%eax
  8020e2:	05 84 c0 81 00       	add    $0x81c084,%eax
  ...
  8020f7:	74 14                	je     80210d <split_page_to_blocks+0xe4>
  8020f9:	8b 45 f4             	mov    -0xc(%ebp),%eax
  8020fc:	c1 e0 04             	shl    $0x4,%eax
  8020ff:	05 84 c0 81 00       	add    $0x81c084,%eax
  802104:	8b 00                	mov    (%eax),%eax
  802106:	8b 55 e0             	mov    -0x20(%ebp),%edx
  802109:	89 10                	mov    %edx,(%eax)
  80210b:	eb 11                	jmp    80211e <split_page_to_blocks+0xf5>
  80210d:	8b 45 f4             	mov    -0xc(%ebp),%eax
  802110:	c1 e0 04             	shl    $0x4,%eax
  802113:	8d 90 80 c0 81 00    	lea    0x81c080(%eax),%edx
  802119:	8b 45 e0             	mov    -0x20(%ebp),%eax
  80211c:	89 02                	mov    %eax,(%edx)
  80211e:	8b 45 f4             	mov    -0xc(%ebp),%eax
  802121:	c1 e0 04             	shl    $0x4,%eax
  802124:	8d 90 84 c0 81 00    	lea    0x81c084(%eax),%edx
  80212a:	8b 45 e0             	mov    -0x20(%ebp),%eax
  80212d:	89 02                	mov    %eax,(%edx)
  80212f:	8b 45 e0             	mov    -0x20(%ebp),%eax
  ...
  80214e:	05 8c c0 81 00       	add    $0x81c08c,%eax
  802153:	89 10                	mov    %edx,(%eax)
	 ...
	 // starting from the page_va.
	 for (uint32 i = 0; i < blk_count; ++i) {
  802155:	ff 45 ec             	incl   -0x14(%ebp)
  802158:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  80215b:	39 45 ec             	cmp    %eax,-0x14(%ebp)
  80215e:	0f 82 4d ff ff ff    	jb     8020b1 <split_page_to_blocks+0x88>
	     struct BlockElement *blk =(struct BlockElement*)(page_va + i * blk_size);
	     LIST_INSERT_TAIL(&freeBlockLists[idx],blk);
	 }
 }
...
void *alloc_block(uint32 size)
{
  ...
  80216a:	83 ec 38             	sub    $0x38,%esp
	//==================================================================================
	//DON'T CHANGE THESE LINES==========================================================
	//==================================================================================
	{
		assert(size <= DYN_ALLOC_MAX_BLOCK_SIZE);
  80216d:	81 7d 08 00 08 00 00 	cmpl   $0x800,0x8(%ebp)
  802174:	76 19                	jbe    80218f <alloc_block+0x28>
  802176:	68 a0 35 80 00       	push   $0x8035a0
  80217b:	68 66 35 80 00       	push   $0x803566
  802180:	68 8a 00 00 00       	push   $0x8a
  802185:	68 03 35 80 00       	push   $0x803503
  80218a:	e8 0e e3 ff ff       	call   80049d <_panic>
	//==================================================================================
	...
	uint32 idx = 0;
  80218f:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
	for (int i = LOG2_MIN_SIZE; i <= LOG2_MAX_SIZE; ++i){
  802196:	c7 45 f0 03 00 00 00 	movl   $0x3,-0x10(%ebp)
  80219d:	eb 19                	jmp    8021b8 <alloc_block+0x51>
		if((1 << i) >= size) break;
  80219f:	8b 45 f0             	mov    -0x10(%ebp),%eax
  8021a2:	ba 01 00 00 00       	mov    $0x1,%edx
  8021a7:	88 c1                	mov    %al,%cl
  8021a9:	d3 e2                	shl    %cl,%edx
  8021ab:	89 d0                	mov    %edx,%eax
  8021ad:	3b 45 08             	cmp    0x8(%ebp),%eax
  8021b0:	73 0e                	jae    8021c0 <alloc_block+0x59>
		idx++;
  8021b2:	ff 45 f4             	incl   -0xc(%ebp)
	...
	uint32 idx = 0;
	for (int i = LOG2_MIN_SIZE; i <= LOG2_MAX_SIZE; ++i){
  8021b5:	ff 45 f0             	incl   -0x10(%ebp)
  8021b8:	83 7d f0 0b          	cmpl   $0xb,-0x10(%ebp)
  8021bc:	7e e1                	jle    80219f <alloc_block+0x38>
  8021be:	eb 01                	jmp    8021c1 <alloc_block+0x5a>
		if((1 << i) >= size) break;
  8021c0:	90                   	nop
		idx++;
	}
  ...
  8021c7:	05 8c c0 81 00       	add    $0x81c08c,%eax
  8021cc:	8b 00                	mov    (%eax),%eax
  8021ce:	85 c0                	test   %eax,%eax
  8021d0:	0f 84 df 00 00 00    	je     8022b5 <alloc_block+0x14e>

		// remove from the list and updat the pageInfoArr free blocks.
		// pop from the freeBlockList.
		struct BlockElement *blk = LIST_FIRST(&freeBlockLists[idx]);
  8021d6:	8b 45 f4             	mov    -0xc(%ebp),%eax
  8021d9:	c1 e0 04             	shl    $0x4,%eax
  8021dc:	05 80 c0 81 00       	add    $0x81c080,%eax
  8021e1:	8b 00                	mov    (%eax),%eax
  8021e3:	89 45 ec             	mov    %eax,-0x14(%ebp)
	    LIST_REMOVE(&freeBlockLists[idx], blk);
  8021e6:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
  8021ea:	75 17                	jne    802203 <alloc_block+0x9c>
  8021ec:	83 ec 04             	sub    $0x4,%esp
  8021ef:	68 c1 35 80 00       	push   $0x8035c1
  8021f4:	68 9e 00 00 00       	push   $0x9e
  8021f9:	68 03 35 80 00       	push   $0x803503
  8021fe:	e8 9a e2 ff ff       	call   80049d <_panic>
  802203:	8b 45 ec             	mov    -0x14(%ebp),%eax
  802206:	8b 00                	mov    (%eax),%eax
  802208:	85 c0                	test   %eax,%eax
  80220a:	74 10                	je     80221c <alloc_block+0xb5>
  80220c:	8b 45 ec             	mov    -0x14(%ebp),%eax
  80220f:	8b 00                	mov    (%eax),%eax
  802211:	8b 55 ec             	mov    -0x14(%ebp),%edx
  802214:	8b 52 04             	mov    0x4(%edx),%edx
  802217:	89 50 04             	mov    %edx,0x4(%eax)
  80221a:	eb 14                	jmp    802230 <alloc_block+0xc9>
  ...
  802247:	eb 13                	jmp    80225c <alloc_block+0xf5>
  802249:	8b 45 ec             	mov    -0x14(%ebp),%eax
  80224c:	8b 00                	mov    (%eax),%eax
  80224e:	8b 55 f4             	mov    -0xc(%ebp),%edx
  802251:	c1 e2 04             	shl    $0x4,%edx
  802254:	81 c2 80 c0 81 00    	add    $0x81c080,%edx
  80225a:	89 02                	mov    %eax,(%edx)
  80225c:	8b 45 ec             	mov    -0x14(%ebp),%eax
  80225f:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  802265:	8b 45 ec             	mov    -0x14(%ebp),%eax
  802268:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
  80226f:	8b 45 f4             	mov    -0xc(%ebp),%eax
  802272:	c1 e0 04             	shl    $0x4,%eax
  802275:	05 8c c0 81 00       	add    $0x81c08c,%eax
  80227a:	8b 00                	mov    (%eax),%eax
  80227c:	8d 50 ff             	lea    -0x1(%eax),%edx
  80227f:	8b 45 f4             	mov    -0xc(%ebp),%eax
  802282:	c1 e0 04             	shl    $0x4,%eax
  802285:	05 8c c0 81 00       	add    $0x81c08c,%eax
  ...
  802292:	50                   	push   %eax
  802293:	e8 8b fb ff ff       	call   801e23 <to_page_info>
  802298:	83 c4 10             	add    $0x10,%esp
  80229b:	89 45 e8             	mov    %eax,-0x18(%ebp)
	    pageInfo->num_of_free_blocks--;
  80229e:	8b 45 e8             	mov    -0x18(%ebp),%eax
  8022a1:	66 8b 40 0a          	mov    0xa(%eax),%ax
  8022a5:	48                   	dec    %eax
  8022a6:	8b 55 e8             	mov    -0x18(%ebp),%edx
  8022a9:	66 89 42 0a          	mov    %ax,0xa(%edx)
	    return blk;
  8022ad:	8b 45 ec             	mov    -0x14(%ebp),%eax
  8022b0:	e9 bc 02 00 00       	jmp    802571 <alloc_block+0x40a>
	}else{ //case(2, 3): 2. no free blocks available in the freeblocklist but there is free pages.
				//3. no free blocks and no available freepages so search in higher block sizes.
		// case 2:
		if(freePagesList.size > 0){ //have free pages.
  8022b5:	a1 54 40 80 00       	mov    0x804054,%eax
  8022ba:	85 c0                	test   %eax,%eax
  8022bc:	0f 84 7d 02 00 00    	je     80253f <alloc_block+0x3d8>
			// get page to split and use from freepagesList.
			struct PageInfoElement *ptr_new_page = LIST_FIRST(&freePagesList);
  8022c2:	a1 48 40 80 00       	mov    0x804048,%eax
  8022c7:	89 45 e4             	mov    %eax,-0x1c(%ebp)
			LIST_REMOVE(&freePagesList, ptr_new_page);
  8022ca:	83 7d e4 00          	cmpl   $0x0,-0x1c(%ebp)
  8022ce:	75 17                	jne    8022e7 <alloc_block+0x180>
  8022d0:	83 ec 04             	sub    $0x4,%esp
  8022d3:	68 c1 35 80 00       	push   $0x8035c1
  8022d8:	68 a9 00 00 00       	push   $0xa9
  8022dd:	68 03 35 80 00       	push   $0x803503
  8022e2:	e8 b6 e1 ff ff       	call   80049d <_panic>
  8022e7:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  8022ea:	8b 00                	mov    (%eax),%eax
  8022ec:	85 c0                	test   %eax,%eax
  8022ee:	74 10                	je     802300 <alloc_block+0x199>
  ...
  80236f:	c1 e0 04             	shl    $0x4,%eax
  802372:	05 80 c0 81 00       	add    $0x81c080,%eax
  802377:	8b 00                	mov    (%eax),%eax
  802379:	89 45 e0             	mov    %eax,-0x20(%ebp)
		    LIST_REMOVE(&freeBlockLists[idx], blk);
  80237c:	83 7d e0 00          	cmpl   $0x0,-0x20(%ebp)
  802380:	75 17                	jne    802399 <alloc_block+0x232>
  802382:	83 ec 04             	sub    $0x4,%esp
  802385:	68 c1 35 80 00       	push   $0x8035c1
  80238a:	68 b0 00 00 00       	push   $0xb0
  80238f:	68 03 35 80 00       	push   $0x803503
  802394:	e8 04 e1 ff ff       	call   80049d <_panic>
  802399:	8b 45 e0             	mov    -0x20(%ebp),%eax
  80239c:	8b 00                	mov    (%eax),%eax
  80239e:	85 c0                	test   %eax,%eax
  8023a0:	74 10                	je     8023b2 <alloc_block+0x24b>
  8023a2:	8b 45 e0             	mov    -0x20(%ebp),%eax
  8023a5:	8b 00                	mov    (%eax),%eax
  8023a7:	8b 55 e0             	mov    -0x20(%ebp),%edx
  8023aa:	8b 52 04             	mov    0x4(%edx),%edx
  8023ad:	89 50 04             	mov    %edx,0x4(%eax)
  8023b0:	eb 14                	jmp    8023c6 <alloc_block+0x25f>
  ...
  802428:	50                   	push   %eax
  802429:	e8 f5 f9 ff ff       	call   801e23 <to_page_info>
  80242e:	83 c4 10             	add    $0x10,%esp
  802431:	89 45 dc             	mov    %eax,-0x24(%ebp)
		    pageInfo->num_of_free_blocks--;
  802434:	8b 45 dc             	mov    -0x24(%ebp),%eax
  802437:	66 8b 40 0a          	mov    0xa(%eax),%ax
  80243b:	48                   	dec    %eax
  80243c:	8b 55 dc             	mov    -0x24(%ebp),%edx
  80243f:	66 89 42 0a          	mov    %ax,0xa(%edx)
		    return blk;
  802443:	8b 45 e0             	mov    -0x20(%ebp),%eax
  802446:	e9 26 01 00 00       	jmp    802571 <alloc_block+0x40a>
		}else{//case 3: no free block and no free page so iterate and try to find bigger size.
			// iterate over the list until finding available block
			while (idx <= (LOG2_MAX_SIZE - LOG2_MIN_SIZE) && freeBlockLists[idx].size == 0) {
				idx++;
  80244b:	ff 45 f4             	incl   -0xc(%ebp)
				// found free block
				if(freeBlockLists[idx].size > 0){
  ...
  80245d:	0f 84 dc 00 00 00    	je     80253f <alloc_block+0x3d8>
					// remove from the list and updat the pageInfoArr free blocks.
					// pop from the freeBlockList.
					struct BlockElement *blk = LIST_FIRST(&freeBlockLists[idx]);
  802463:	8b 45 f4             	mov    -0xc(%ebp),%eax
  802466:	c1 e0 04             	shl    $0x4,%eax
  802469:	05 80 c0 81 00       	add    $0x81c080,%eax
  80246e:	8b 00                	mov    (%eax),%eax
  802470:	89 45 d8             	mov    %eax,-0x28(%ebp)
				    LIST_REMOVE(&freeBlockLists[idx], blk);
  802473:	83 7d d8 00          	cmpl   $0x0,-0x28(%ebp)
  802477:	75 17                	jne    802490 <alloc_block+0x329>
  802479:	83 ec 04             	sub    $0x4,%esp
  80247c:	68 c1 35 80 00       	push   $0x8035c1
  802481:	68 be 00 00 00       	push   $0xbe
  802486:	68 03 35 80 00       	push   $0x803503
  80248b:	e8 0d e0 ff ff       	call   80049d <_panic>
  802490:	8b 45 d8             	mov    -0x28(%ebp),%eax
  802493:	8b 00                	mov    (%eax),%eax
  802495:	85 c0                	test   %eax,%eax
  802497:	74 10                	je     8024a9 <alloc_block+0x342>
  802499:	8b 45 d8             	mov    -0x28(%ebp),%eax
  80249c:	8b 00                	mov    (%eax),%eax
  80249e:	8b 55 d8             	mov    -0x28(%ebp),%edx
  8024a1:	8b 52 04             	mov    0x4(%edx),%edx
  8024a4:	89 50 04             	mov    %edx,0x4(%eax)
  8024a7:	eb 14                	jmp    8024bd <alloc_block+0x356>
  ...
  8024b5:	81 c2 84 c0 81 00    	add    $0x81c084,%edx
  8024bb:	89 02                	mov    %eax,(%edx)
  8024bd:	8b 45 d8             	mov    -0x28(%ebp),%eax
  8024c0:	8b 40 04             	mov    0x4(%eax),%eax
  8024c3:	85 c0                	test   %eax,%eax
  8024c5:	74 0f                	je     8024d6 <alloc_block+0x36f>
  8024c7:	8b 45 d8             	mov    -0x28(%ebp),%eax
  8024ca:	8b 40 04             	mov    0x4(%eax),%eax
  8024cd:	8b 55 d8             	mov    -0x28(%ebp),%edx
  8024d0:	8b 12                	mov    (%edx),%edx
  8024d2:	89 10                	mov    %edx,(%eax)
  8024d4:	eb 13                	jmp    8024e9 <alloc_block+0x382>
  8024d6:	8b 45 d8             	mov    -0x28(%ebp),%eax
  8024d9:	8b 00                	mov    (%eax),%eax
  8024db:	8b 55 f4             	mov    -0xc(%ebp),%edx
  8024de:	c1 e2 04             	shl    $0x4,%edx
  8024e1:	81 c2 80 c0 81 00    	add    $0x81c080,%edx
  8024e7:	89 02                	mov    %eax,(%edx)
  8024e9:	8b 45 d8             	mov    -0x28(%ebp),%eax
  ...
  8024ff:	c1 e0 04             	shl    $0x4,%eax
  802502:	05 8c c0 81 00       	add    $0x81c08c,%eax
  802507:	8b 00                	mov    (%eax),%eax
  802509:	8d 50 ff             	lea    -0x1(%eax),%edx
  80250c:	8b 45 f4             	mov    -0xc(%ebp),%eax
  80250f:	c1 e0 04             	shl    $0x4,%eax
  802512:	05 8c c0 81 00       	add    $0x81c08c,%eax
  ...
  80251f:	50                   	push   %eax
  802520:	e8 fe f8 ff ff       	call   801e23 <to_page_info>
  802525:	83 c4 10             	add    $0x10,%esp
  802528:	89 45 d4             	mov    %eax,-0x2c(%ebp)
				    pageInfo->num_of_free_blocks--;
  80252b:	8b 45 d4             	mov    -0x2c(%ebp),%eax
  80252e:	66 8b 40 0a          	mov    0xa(%eax),%ax
  802532:	48                   	dec    %eax
  802533:	8b 55 d4             	mov    -0x2c(%ebp),%edx
  802536:	66 89 42 0a          	mov    %ax,0xa(%edx)
				    return blk;
  80253a:	8b 45 d8             	mov    -0x28(%ebp),%eax
  80253d:	eb 32                	jmp    802571 <alloc_block+0x40a>
		    struct PageInfoElement *pageInfo = to_page_info((uint32)blk);
		    pageInfo->num_of_free_blocks--;
		    return blk;
		}else{//case 3: no free block and no free page so iterate and try to find bigger size.
			// iterate over the list until finding available block
			while (idx <= (LOG2_MAX_SIZE - LOG2_MIN_SIZE) && freeBlockLists[idx].size == 0) {
  80253f:	83 7d f4 08          	cmpl   $0x8,-0xc(%ebp)
  802543:	77 15                	ja     80255a <alloc_block+0x3f3>
  ...
  802554:	0f 84 f1 fe ff ff    	je     80244b <alloc_block+0x2e4>
				}
			}
		}
	}
  ...
  80255d:	68 df 35 80 00       	push   $0x8035df
  802562:	68 c8 00 00 00       	push   $0xc8
  802567:	68 03 35 80 00       	push   $0x803503
  80256c:	e8 2c df ff ff       	call   80049d <_panic>
...
void free_block(void *va)
{
  ...
  80257c:	a1 64 c0 81 00       	mov    0x81c064,%eax
  802581:	39 c2                	cmp    %eax,%edx
  802583:	72 0c                	jb     802591 <free_block+0x1e>
  802585:	8b 55 08             	mov    0x8(%ebp),%edx
  802588:	a1 40 40 80 00       	mov    0x804040,%eax
  80258d:	39 c2                	cmp    %eax,%edx
  80258f:	72 19                	jb     8025aa <free_block+0x37>
  802591:	68 f0 35 80 00       	push   $0x8035f0
  802596:	68 66 35 80 00       	push   $0x803566
  80259b:	68 d7 00 00 00       	push   $0xd7
  8025a0:	68 03 35 80 00       	push   $0x803503
  8025a5:	e8 f3 de ff ff       	call   80049d <_panic>
  ...
  8025ad:	89 45 e8             	mov    %eax,-0x18(%ebp)
	struct PageInfoElement *pageInfo = to_page_info((uint32)va);
  8025b0:	8b 45 08             	mov    0x8(%ebp),%eax
  8025b3:	83 ec 0c             	sub    $0xc,%esp
  8025b6:	50                   	push   %eax
  8025b7:	e8 67 f8 ff ff       	call   801e23 <to_page_info>
  8025bc:	83 c4 10             	add    $0x10,%esp
  8025bf:	89 45 e4             	mov    %eax,-0x1c(%ebp)
	uint32 blk_size = pageInfo->block_size;
  8025c2:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  8025c5:	8b 40 08             	mov    0x8(%eax),%eax
  8025c8:	0f b7 c0             	movzwl %ax,%eax
  8025cb:	89 45 e0             	mov    %eax,-0x20(%ebp)

	// its index in the freeBlocklist.
	int idx = 0;
  8025ce:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
	for (int i = LOG2_MIN_SIZE; i <= LOG2_MAX_SIZE; i++) {
  8025d5:	c7 45 f0 03 00 00 00 	movl   $0x3,-0x10(%ebp)
  8025dc:	eb 19                	jmp    8025f7 <free_block+0x84>
	    if ((1 << i) == blk_size)
  8025de:	8b 45 f0             	mov    -0x10(%ebp),%eax
  8025e1:	ba 01 00 00 00       	mov    $0x1,%edx
  8025e6:	88 c1                	mov    %al,%cl
  8025e8:	d3 e2                	shl    %cl,%edx
  8025ea:	89 d0                	mov    %edx,%eax
  8025ec:	3b 45 e0             	cmp    -0x20(%ebp),%eax
  8025ef:	74 0e                	je     8025ff <free_block+0x8c>
	        break;
	    idx++;
  8025f1:	ff 45 f4             	incl   -0xc(%ebp)
	...
	int idx = 0;
	for (int i = LOG2_MIN_SIZE; i <= LOG2_MAX_SIZE; i++) {
  8025f4:	ff 45 f0             	incl   -0x10(%ebp)
  8025f7:	83 7d f0 0b          	cmpl   $0xb,-0x10(%ebp)
  8025fb:	7e e1                	jle    8025de <free_block+0x6b>
  8025fd:	eb 01                	jmp    802600 <free_block+0x8d>
	    if ((1 << i) == blk_size)
	        break;
  8025ff:	90                   	nop
	    idx++;
  ...
  802603:	66 8b 40 0a          	mov    0xa(%eax),%ax
  802607:	40                   	inc    %eax
  802608:	8b 55 e4             	mov    -0x1c(%ebp),%edx
  80260b:	66 89 42 0a          	mov    %ax,0xa(%edx)
	LIST_INSERT_TAIL(&freeBlockLists[idx], blk_to_free);
  80260f:	83 7d e8 00          	cmpl   $0x0,-0x18(%ebp)
  802613:	75 17                	jne    80262c <free_block+0xb9>
  802615:	83 ec 04             	sub    $0x4,%esp
  802618:	68 7c 35 80 00       	push   $0x80357c
  80261d:	68 ee 00 00 00       	push   $0xee
  802622:	68 03 35 80 00       	push   $0x803503
  802627:	e8 71 de ff ff       	call   80049d <_panic>
  80262c:	8b 45 f4             	mov    -0xc(%ebp),%eax
  80262f:	c1 e0 04             	shl    $0x4,%eax
  802632:	05 84 c0 81 00       	add    $0x81c084,%eax
  ...
  802647:	74 14                	je     80265d <free_block+0xea>
  802649:	8b 45 f4             	mov    -0xc(%ebp),%eax
  80264c:	c1 e0 04             	shl    $0x4,%eax
  80264f:	05 84 c0 81 00       	add    $0x81c084,%eax
  802654:	8b 00                	mov    (%eax),%eax
  802656:	8b 55 e8             	mov    -0x18(%ebp),%edx
  802659:	89 10                	mov    %edx,(%eax)
  80265b:	eb 11                	jmp    80266e <free_block+0xfb>
  80265d:	8b 45 f4             	mov    -0xc(%ebp),%eax
  802660:	c1 e0 04             	shl    $0x4,%eax
  802663:	8d 90 80 c0 81 00    	lea    0x81c080(%eax),%edx
  802669:	8b 45 e8             	mov    -0x18(%ebp),%eax
  80266c:	89 02                	mov    %eax,(%edx)
  80266e:	8b 45 f4             	mov    -0xc(%ebp),%eax
  802671:	c1 e0 04             	shl    $0x4,%eax
  802674:	8d 90 84 c0 81 00    	lea    0x81c084(%eax),%edx
  ...
  802695:	8d 50 01             	lea    0x1(%eax),%edx
  ...
  8026a3:	89 10                	mov    %edx,(%eax)
	...
	int blk_count = PAGE_SIZE / blk_size;
  8026a5:	b8 00 10 00 00       	mov    $0x1000,%eax
  8026aa:	ba 00 00 00 00       	mov    $0x0,%edx
  8026af:	f7 75 e0             	divl   -0x20(%ebp)
  8026b2:	89 45 dc             	mov    %eax,-0x24(%ebp)
	// the blk count in the page is same as number fo free blocks free up the page.
	if (pageInfo->num_of_free_blocks == blk_count) {
  8026b5:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  8026b8:	66 8b 40 0a          	mov    0xa(%eax),%ax
  8026bc:	0f b7 c0             	movzwl %ax,%eax
  8026bf:	3b 45 dc             	cmp    -0x24(%ebp),%eax
  8026c2:	0f 85 70 01 00 00    	jne    802838 <free_block+0x2c5>
		uint32 page_va = to_page_va(pageInfo);
  8026c8:	83 ec 0c             	sub    $0xc,%esp
  8026cb:	ff 75 e4             	pushl  -0x1c(%ebp)
  8026ce:	e8 de f6 ff ff       	call   801db1 <to_page_va>
  8026d3:	83 c4 10             	add    $0x10,%esp
  8026d6:	89 45 d8             	mov    %eax,-0x28(%ebp)
		// remove all blk in the freeBlockList.
		for (uint32 off = 0; off < PAGE_SIZE; off += blk_size) {
  8026d9:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  8026e0:	e9 b7 00 00 00       	jmp    80279c <free_block+0x229>
			struct BlockElement *blk = (struct BlockElement*)(page_va + off);
  8026e5:	8b 55 d8             	mov    -0x28(%ebp),%edx
  8026e8:	8b 45 ec             	mov    -0x14(%ebp),%eax
  8026eb:	01 d0                	add    %edx,%eax
  8026ed:	89 45 d4             	mov    %eax,-0x2c(%ebp)
			LIST_REMOVE(&freeBlockLists[idx], blk);
  8026f0:	83 7d d4 00          	cmpl   $0x0,-0x2c(%ebp)
  8026f4:	75 17                	jne    80270d <free_block+0x19a>
  8026f6:	83 ec 04             	sub    $0x4,%esp
  8026f9:	68 c1 35 80 00       	push   $0x8035c1
  8026fe:	68 f8 00 00 00       	push   $0xf8
  802703:	68 03 35 80 00       	push   $0x803503
  802708:	e8 90 dd ff ff       	call   80049d <_panic>
  80270d:	8b 45 d4             	mov    -0x2c(%ebp),%eax
  802710:	8b 00                	mov    (%eax),%eax
  802712:	85 c0                	test   %eax,%eax
  802714:	74 10                	je     802726 <free_block+0x1b3>
  802716:	8b 45 d4             	mov    -0x2c(%ebp),%eax
  802719:	8b 00                	mov    (%eax),%eax
  80271b:	8b 55 d4             	mov    -0x2c(%ebp),%edx
  80271e:	8b 52 04             	mov    0x4(%edx),%edx
  802721:	89 50 04             	mov    %edx,0x4(%eax)
  802724:	eb 14                	jmp    80273a <free_block+0x1c7>
  ...
  80277c:	c1 e0 04             	shl    $0x4,%eax
  80277f:	05 8c c0 81 00       	add    $0x81c08c,%eax
  802784:	8b 00                	mov    (%eax),%eax
  802786:	8d 50 ff             	lea    -0x1(%eax),%edx
  802789:	8b 45 f4             	mov    -0xc(%ebp),%eax
  80278c:	c1 e0 04             	shl    $0x4,%eax
  80278f:	05 8c c0 81 00       	add    $0x81c08c,%eax
  ...
  802799:	01 45 ec             	add    %eax,-0x14(%ebp)
  80279c:	81 7d ec ff 0f 00 00 	cmpl   $0xfff,-0x14(%ebp)
  8027a3:	0f 86 3c ff ff ff    	jbe    8026e5 <free_block+0x172>
			struct BlockElement *blk = (struct BlockElement*)(page_va + off);
			LIST_REMOVE(&freeBlockLists[idx], blk);
		}
		// reset page info.
  ...
  8027ac:	66 c7 40 08 00 00    	movw   $0x0,0x8(%eax)
		pageInfo->num_of_free_blocks = 0;
  8027b2:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  8027b5:	66 c7 40 0a 00 00    	movw   $0x0,0xa(%eax)
		// add it to the available pages.
		LIST_INSERT_TAIL(&freePagesList, pageInfo);
  8027bb:	83 7d e4 00          	cmpl   $0x0,-0x1c(%ebp)
  8027bf:	75 17                	jne    8027d8 <free_block+0x265>
  8027c1:	83 ec 04             	sub    $0x4,%esp
  8027c4:	68 7c 35 80 00       	push   $0x80357c
  8027c9:	68 fe 00 00 00       	push   $0xfe
  8027ce:	68 03 35 80 00       	push   $0x803503
  8027d3:	e8 c5 dc ff ff       	call   80049d <_panic>
  8027d8:	8b 15 4c 40 80 00    	mov    0x80404c,%edx
  ...
  8027ec:	74 0c                	je     8027fa <free_block+0x287>
  8027ee:	a1 4c 40 80 00       	mov    0x80404c,%eax
  8027f3:	8b 55 e4             	mov    -0x1c(%ebp),%edx
  8027f6:	89 10                	mov    %edx,(%eax)
  8027f8:	eb 08                	jmp    802802 <free_block+0x28f>
  8027fa:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  8027fd:	a3 48 40 80 00       	mov    %eax,0x804048
  802802:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  802805:	a3 4c 40 80 00       	mov    %eax,0x80404c
  80280a:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  80280d:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  802813:	a1 54 40 80 00       	mov    0x804054,%eax
  802818:	40                   	inc    %eax
  802819:	a3 54 40 80 00       	mov    %eax,0x804054
		// make it available in memory.
		return_page((uint32 *)to_page_va(pageInfo));
  80281e:	83 ec 0c             	sub    $0xc,%esp
  802821:	ff 75 e4             	pushl  -0x1c(%ebp)
  802824:	e8 88 f5 ff ff       	call   801db1 <to_page_va>
  802829:	83 c4 10             	add    $0x10,%esp
  80282c:	83 ec 0c             	sub    $0xc,%esp
  80282f:	50                   	push   %eax
  802830:	e8 b8 ee ff ff       	call   8016ed <return_page>
...
void *realloc_block(void* va, uint32 new_size)
{
  ...
  802844:	68 28 36 80 00       	push   $0x803628
  802849:	68 11 01 00 00       	push   $0x111
  80284e:	68 03 35 80 00       	push   $0x803503
  802853:	e8 45 dc ff ff       	call   80049d <_panic>
...
00802858 <__udivdi3>:
  ...
  80285f:	8b 5c 24 30          	mov    0x30(%esp),%ebx
  802863:	8b 4c 24 34          	mov    0x34(%esp),%ecx
  802867:	8b 7c 24 38          	mov    0x38(%esp),%edi
  80286b:	89 5c 24 08          	mov    %ebx,0x8(%esp)
  80286f:	89 ca                	mov    %ecx,%edx
  802871:	89 f8                	mov    %edi,%eax
  802873:	8b 74 24 3c          	mov    0x3c(%esp),%esi
  802877:	85 f6                	test   %esi,%esi
  802879:	75 2d                	jne    8028a8 <__udivdi3+0x50>
  80287b:	39 cf                	cmp    %ecx,%edi
  80287d:	77 65                	ja     8028e4 <__udivdi3+0x8c>
  80287f:	89 fd                	mov    %edi,%ebp
  802881:	85 ff                	test   %edi,%edi
  802883:	75 0b                	jne    802890 <__udivdi3+0x38>
  802885:	b8 01 00 00 00       	mov    $0x1,%eax
  80288a:	31 d2                	xor    %edx,%edx
  80288c:	f7 f7                	div    %edi
  80288e:	89 c5                	mov    %eax,%ebp
  802890:	31 d2                	xor    %edx,%edx
  802892:	89 c8                	mov    %ecx,%eax
  802894:	f7 f5                	div    %ebp
  802896:	89 c1                	mov    %eax,%ecx
  802898:	89 d8                	mov    %ebx,%eax
  80289a:	f7 f5                	div    %ebp
  80289c:	89 cf                	mov    %ecx,%edi
  ...
  8028aa:	77 28                	ja     8028d4 <__udivdi3+0x7c>
  8028ac:	0f bd fe             	bsr    %esi,%edi
  8028af:	83 f7 1f             	xor    $0x1f,%edi
  8028b2:	75 40                	jne    8028f4 <__udivdi3+0x9c>
  8028b4:	39 ce                	cmp    %ecx,%esi
  8028b6:	72 0a                	jb     8028c2 <__udivdi3+0x6a>
  8028b8:	3b 44 24 08          	cmp    0x8(%esp),%eax
  8028bc:	0f 87 9e 00 00 00    	ja     802960 <__udivdi3+0x108>
  ...
  8028f2:	5d                   	pop    %ebp
  8028f3:	c3                   	ret    
  8028f4:	bd 20 00 00 00       	mov    $0x20,%ebp
  8028f9:	89 eb                	mov    %ebp,%ebx
  8028fb:	29 fb                	sub    %edi,%ebx
  8028fd:	89 f9                	mov    %edi,%ecx
  8028ff:	d3 e6                	shl    %cl,%esi
  802901:	89 c5                	mov    %eax,%ebp
  802903:	88 d9                	mov    %bl,%cl
  802905:	d3 ed                	shr    %cl,%ebp
  802907:	89 e9                	mov    %ebp,%ecx
  802909:	09 f1                	or     %esi,%ecx
  80290b:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
  80290f:	89 f9                	mov    %edi,%ecx
  802911:	d3 e0                	shl    %cl,%eax
  802913:	89 c5                	mov    %eax,%ebp
  802915:	89 d6                	mov    %edx,%esi
  802917:	88 d9                	mov    %bl,%cl
  802919:	d3 ee                	shr    %cl,%esi
  80291b:	89 f9                	mov    %edi,%ecx
  80291d:	d3 e2                	shl    %cl,%edx
  80291f:	8b 44 24 08          	mov    0x8(%esp),%eax
  802923:	88 d9                	mov    %bl,%cl
  802925:	d3 e8                	shr    %cl,%eax
  802927:	09 c2                	or     %eax,%edx
  802929:	89 d0                	mov    %edx,%eax
  80292b:	89 f2                	mov    %esi,%edx
  80292d:	f7 74 24 0c          	divl   0xc(%esp)
  802931:	89 d6                	mov    %edx,%esi
  802933:	89 c3                	mov    %eax,%ebx
  802935:	f7 e5                	mul    %ebp
  802937:	39 d6                	cmp    %edx,%esi
  802939:	72 19                	jb     802954 <__udivdi3+0xfc>
  80293b:	74 0b                	je     802948 <__udivdi3+0xf0>
  80293d:	89 d8                	mov    %ebx,%eax
  80293f:	31 ff                	xor    %edi,%edi
  802941:	e9 58 ff ff ff       	jmp    80289e <__udivdi3+0x46>
  802946:	66 90                	xchg   %ax,%ax
  802948:	8b 54 24 08          	mov    0x8(%esp),%edx
  80294c:	89 f9                	mov    %edi,%ecx
  80294e:	d3 e2                	shl    %cl,%edx
  802950:	39 c2                	cmp    %eax,%edx
  802952:	73 e9                	jae    80293d <__udivdi3+0xe5>
  802954:	8d 43 ff             	lea    -0x1(%ebx),%eax
  802957:	31 ff                	xor    %edi,%edi
  802959:	e9 40 ff ff ff       	jmp    80289e <__udivdi3+0x46>
  80295e:	66 90                	xchg   %ax,%ax
  802960:	31 c0                	xor    %eax,%eax
  802962:	e9 37 ff ff ff       	jmp    80289e <__udivdi3+0x46>
  802967:	90                   	nop
...
00802968 <__umoddi3>:
  ...
  80296a:	56                   	push   %esi
  80296b:	53                   	push   %ebx
  80296c:	83 ec 1c             	sub    $0x1c,%esp
  80296f:	8b 4c 24 30          	mov    0x30(%esp),%ecx
  802973:	8b 74 24 34          	mov    0x34(%esp),%esi
  802977:	8b 7c 24 38          	mov    0x38(%esp),%edi
  80297b:	8b 44 24 3c          	mov    0x3c(%esp),%eax
  80297f:	89 44 24 0c          	mov    %eax,0xc(%esp)
  802983:	89 4c 24 08          	mov    %ecx,0x8(%esp)
  802987:	89 f3                	mov    %esi,%ebx
  802989:	89 fa                	mov    %edi,%edx
  80298b:	89 4c 24 04          	mov    %ecx,0x4(%esp)
  80298f:	89 34 24             	mov    %esi,(%esp)
  802992:	85 c0                	test   %eax,%eax
  802994:	75 1a                	jne    8029b0 <__umoddi3+0x48>
  802996:	39 f7                	cmp    %esi,%edi
  802998:	0f 86 a2 00 00 00    	jbe    802a40 <__umoddi3+0xd8>
  ...
  8029ae:	5d                   	pop    %ebp
  8029af:	c3                   	ret    
  8029b0:	39 f0                	cmp    %esi,%eax
  8029b2:	0f 87 ac 00 00 00    	ja     802a64 <__umoddi3+0xfc>
  8029b8:	0f bd e8             	bsr    %eax,%ebp
  8029bb:	83 f5 1f             	xor    $0x1f,%ebp
  8029be:	0f 84 ac 00 00 00    	je     802a70 <__umoddi3+0x108>
  8029c4:	bf 20 00 00 00       	mov    $0x20,%edi
  8029c9:	29 ef                	sub    %ebp,%edi
  8029cb:	89 fe                	mov    %edi,%esi
  8029cd:	89 7c 24 0c          	mov    %edi,0xc(%esp)
  8029d1:	89 e9                	mov    %ebp,%ecx
  8029d3:	d3 e0                	shl    %cl,%eax
  8029d5:	89 d7                	mov    %edx,%edi
  8029d7:	89 f1                	mov    %esi,%ecx
  8029d9:	d3 ef                	shr    %cl,%edi
  8029db:	09 c7                	or     %eax,%edi
  8029dd:	89 e9                	mov    %ebp,%ecx
  8029df:	d3 e2                	shl    %cl,%edx
  8029e1:	89 14 24             	mov    %edx,(%esp)
  8029e4:	89 d8                	mov    %ebx,%eax
  8029e6:	d3 e0                	shl    %cl,%eax
  8029e8:	89 c2                	mov    %eax,%edx
  8029ea:	8b 44 24 08          	mov    0x8(%esp),%eax
  8029ee:	d3 e0                	shl    %cl,%eax
  8029f0:	89 44 24 04          	mov    %eax,0x4(%esp)
  8029f4:	8b 44 24 08          	mov    0x8(%esp),%eax
  8029f8:	89 f1                	mov    %esi,%ecx
  8029fa:	d3 e8                	shr    %cl,%eax
  8029fc:	09 d0                	or     %edx,%eax
  8029fe:	d3 eb                	shr    %cl,%ebx
  802a00:	89 da                	mov    %ebx,%edx
  802a02:	f7 f7                	div    %edi
  802a04:	89 d3                	mov    %edx,%ebx
  802a06:	f7 24 24             	mull   (%esp)
  802a09:	89 c6                	mov    %eax,%esi
  802a0b:	89 d1                	mov    %edx,%ecx
  802a0d:	39 d3                	cmp    %edx,%ebx
  802a0f:	0f 82 87 00 00 00    	jb     802a9c <__umoddi3+0x134>
  802a15:	0f 84 91 00 00 00    	je     802aac <__umoddi3+0x144>
  802a1b:	8b 54 24 04          	mov    0x4(%esp),%edx
  802a1f:	29 f2                	sub    %esi,%edx
  802a21:	19 cb                	sbb    %ecx,%ebx
  802a23:	89 d8                	mov    %ebx,%eax
  802a25:	8a 4c 24 0c          	mov    0xc(%esp),%cl
  802a29:	d3 e0                	shl    %cl,%eax
  802a2b:	89 e9                	mov    %ebp,%ecx
  802a2d:	d3 ea                	shr    %cl,%edx
  802a2f:	09 d0                	or     %edx,%eax
  802a31:	89 e9                	mov    %ebp,%ecx
  802a33:	d3 eb                	shr    %cl,%ebx
  ...
  802a3e:	c3                   	ret    
  802a3f:	90                   	nop
  802a40:	89 fd                	mov    %edi,%ebp
  802a42:	85 ff                	test   %edi,%edi
  802a44:	75 0b                	jne    802a51 <__umoddi3+0xe9>
  802a46:	b8 01 00 00 00       	mov    $0x1,%eax
  802a4b:	31 d2                	xor    %edx,%edx
  802a4d:	f7 f7                	div    %edi
  802a4f:	89 c5                	mov    %eax,%ebp
  802a51:	89 f0                	mov    %esi,%eax
  802a53:	31 d2                	xor    %edx,%edx
  802a55:	f7 f5                	div    %ebp
  802a57:	89 c8                	mov    %ecx,%eax
  802a59:	f7 f5                	div    %ebp
  802a5b:	89 d0                	mov    %edx,%eax
  802a5d:	e9 44 ff ff ff       	jmp    8029a6 <__umoddi3+0x3e>
  802a62:	66 90                	xchg   %ax,%ax
  802a64:	89 c8                	mov    %ecx,%eax
  802a66:	89 f2                	mov    %esi,%edx
  ...
  802a6e:	5d                   	pop    %ebp
  802a6f:	c3                   	ret    
  802a70:	3b 04 24             	cmp    (%esp),%eax
  802a73:	72 06                	jb     802a7b <__umoddi3+0x113>
  802a75:	3b 7c 24 04          	cmp    0x4(%esp),%edi
  802a79:	77 0f                	ja     802a8a <__umoddi3+0x122>
  802a7b:	89 f2                	mov    %esi,%edx
  802a7d:	29 f9                	sub    %edi,%ecx
  802a7f:	1b 54 24 0c          	sbb    0xc(%esp),%edx
  802a83:	89 14 24             	mov    %edx,(%esp)
  802a86:	89 4c 24 04          	mov    %ecx,0x4(%esp)
  802a8a:	8b 44 24 04          	mov    0x4(%esp),%eax
  802a8e:	8b 14 24             	mov    (%esp),%edx
  ...
  802a9c:	2b 04 24             	sub    (%esp),%eax
  802a9f:	19 fa                	sbb    %edi,%edx
  802aa1:	89 d1                	mov    %edx,%ecx
  802aa3:	89 c6                	mov    %eax,%esi
  802aa5:	e9 71 ff ff ff       	jmp    802a1b <__umoddi3+0xb3>
  802aaa:	66 90                	xchg   %ax,%ax
  802aac:	39 44 24 04          	cmp    %eax,0x4(%esp)
  802ab0:	72 ea                	jb     802a9c <__umoddi3+0x134>
  802ab2:	89 d9                	mov    %ebx,%ecx
  802ab4:	e9 62 ff ff ff       	jmp    802a1b <__umoddi3+0xb3>
